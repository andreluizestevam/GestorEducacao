...
namespace BoletoNet
{
    ...
    internal class Banco_Sicoob : AbstractBanco, IBanco
    {
        ...
        public String FormataNumeroTitulo(Boleto boleto)
        {
            ...
            //Formatando
            for (int i = 0; i < (8 - boleto.NossoNumero.Length); i++)
            {
                novoTitulo.Append("0");
            }
            novoTitulo.Append(boleto.NossoNumero);
        ...
        public override void FormataLinhaDigitavel(Boleto boleto)
        {
            ...
            campo1 = boleto.Banco.Codigo.ToString() + boleto.Banco.Digito.ToString() + boleto.Carteira + boleto.Cedente.ContaBancaria.Agencia;
            //Calculando CAMPO 1
            for (int i = 0; i < campo1.Length; i++)
            {
                //Calculando indice
                temp = (Convert.ToInt16(campo1.Substring(i, 1)) * Convert.ToInt16(indice.Substring(i, 1)));
        ...
        public override string GerarHeaderRemessa(string numeroConvenio, Cedente cedente, TipoArquivo tipoArquivo, int numeroArquivoRemessa)
        {
            ...
            try
            {
                ...
                _header.Append(Utils.FitStringLength(Convert.ToString(cedente.Codigo), 9, 9, '0', 0, true, true, true)); //Posição 032 a 039
        ...
        public override string GerarDetalheRemessa(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            ...
            try
            {
                ...
                _detalhe.Append("01"); //Posição 148 a 149 - DUPLICATA MERCANTIL
                ...
                _detalhe.Append(Utils.FitStringLength(boleto.DataDesconto.ToString("ddMMyy"), 6, 6, '0', 0, true, true, true)); //Posição 174 a 179
