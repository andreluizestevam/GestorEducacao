    ...
    internal class Banco_Brasil : AbstractBanco, IBanco
    {
        ...
        public override void ValidaBoleto(Boleto boleto)
        {
            if (string.IsNullOrEmpty(boleto.Carteira))
                throw new NotImplementedException("Carteira não informada. Utilize a carteira 16, 17, 17-019, 17-027, 18, 18-019, 18-027, 18-035 ou 18-140.");
        ...
        public override void FormataNossoNumero(Boleto boleto)
        {
            ...
            else if (boleto.Carteira.Equals("17-027"))
        ...
        public override string GerarDetalheSegmentoPRemessa(Boleto boleto, int numeroRegistro, string numeroConvenio)
        {
            try
            {
                ...
                {
                    _segmentoP += "1";
                    _segmentoP += Utils.FitStringLength(boleto.DataMulta.ToString("ddMMyyyy"), 8, 8, '0', 0, true, true, false);
                ...
                {
                    _segmentoP += "1";
                    _segmentoP += Utils.FitStringLength(boleto.DataDesconto.ToString("ddMMyyyy"), 8, 8, '0', 0, true, true, false);
