        ...
        public void LerDetalheSegmentoTRetornoCNAB240(string registro)
        {
            try
            {
                ...
                if (CodigoBanco == 1)
                {
                    ...
                    dataVencimento = Convert.ToInt32(registro.Substring(73, 8));
                    if (dataVencimento != 0)
                        DataVencimento = Convert.ToDateTime(dataVencimento.ToString("##-##-####"));
                    
                    valorTitulo = Convert.ToInt64(registro.Substring(81, 15));
                    ...
                    valorTarifas = Convert.ToUInt64(registro.Substring(198, 15));
                    ValorTarifas = valorTarifas / 100;
                    CodigoRejeicao = Convert.ToInt32(registro.Substring(213, 10));
                }
                else if (CodigoBanco == 104)
                {
                    Agencia = Convert.ToInt32(registro.Substring(17, 5));
                    DigitoAgencia = registro.Substring(22, 1);
                    Conta = Convert.ToInt64(registro.Substring(23, 12));
                    ...
                    NossoNumero = registro.Substring(45, 11);
                    CodigoCarteira = Convert.ToInt32(registro.Substring(57, 1));
                    NumeroDocumento = registro.Substring(58, 11);
                    dataVencimento = Convert.ToInt32(registro.Substring(73, 8));
                    if (dataVencimento != 0)
                        DataVencimento = Convert.ToDateTime(dataVencimento.ToString("##-##-####"));
                ...
                else// if (CodigoBanco == 33)
                {
                    ...
                    Conta = Convert.ToInt64(registro.Substring(22, 9));
                    ...
                    dataVencimento = Convert.ToInt32(registro.Substring(69, 8));
                    DataVencimento = Convert.ToDateTime(dataVencimento.ToString("##-##-####"));
                    valorTitulo = Convert.ToInt64(registro.Substring(77, 15));
                    ValorTitulo = valorTitulo / 100;
                    ...
                    valorTarifas = Convert.ToUInt64(registro.Substring(193, 15));
                    ValorTarifas = valorTarifas / 100;
