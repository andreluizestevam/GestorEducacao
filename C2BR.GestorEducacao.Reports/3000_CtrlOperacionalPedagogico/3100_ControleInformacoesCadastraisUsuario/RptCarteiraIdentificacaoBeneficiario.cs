...
namespace C2BR.GestorEducacao.Reports._GSAUD._3000_ControleInformacoesUsuario._3100_ControleInformacoesCadastraisUsuario
{
    public partial class RptCarteiraIdentificacaoBeneficiario : C2BR.GestorEducacao.Reports.RptRetrato
    {
        public RptCarteiraIdentificacaoBeneficiario()
        {
            InitializeComponent();
        }
                             ...
                             )
        {
            try
            {
                ...
                var res = (from tb07 in ctx.TB07_ALUNO
                           ...
                           select new CarteiraIdentificacaoBeneficiario
                           {
                               // Dados Gerais
                               ...
                               respCPF = tb07.TB108_RESPONSAVEL.NU_CPF_RESP,
                               respNome =  tb07.TB108_RESPONSAVEL.NO_RESP,
                ...
                foreach (CarteiraIdentificacaoBeneficiario at in res)
                {
                    ...
                    at.empEnd = "ISSEG - Instituto de Saúde dos Servidores de Gravataí \n Rua Adolfo Inácio Barcelos, 783 - Sala 401 \n Gravataí - RS - CEP 94.010-200";
                    at.empTel = "5131915030";
                    at.noWebEmp = "E-mail: saude@issegrs.com.br - http://www.issegrs.com.br";
                    at.noDirecao = Dir;
        ...
        public class CarteiraIdentificacaoBeneficiario
        {
            // Dados gerais
            ...
            public string empTelF
            {
                get
                {
                    return this.empTel != null || this.empTel != "" ? "Telefone: " + String.Format("{0:(###) ####-####}", double.Parse(this.empTel)) : "********";
                }
            }
            ...
            public string Curso
            {
                get
                {
                    string infosCurso = respCPF + " - " + respNome;
