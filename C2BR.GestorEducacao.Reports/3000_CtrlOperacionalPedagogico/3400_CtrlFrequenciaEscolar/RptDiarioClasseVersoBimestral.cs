...
{
    public partial class RptDiarioClasseVersoBimestral : DevExpress.XtraReports.UI.XtraReport
    {
        public RptDiarioClasseVersoBimestral()
        {
            InitializeComponent();
        }
        ...
        public class DiarioClasseVerso
        {
            ...
            public string nomeTempo
            {
                get
                {
                    return ((this.numTempo != null && this.numTempo == 0) ? " - " : this.numTempo.ToString() + "º");
                }
            }
