...
{
    public partial class RptDiarioClasseVersoBP : DevExpress.XtraReports.UI.XtraReport
    {
        public RptDiarioClasseVersoBP()
        {
            InitializeComponent();
        }
        #region Init Report
                                ...
                                )
        {
            try
            {
                ...
                string noCol = dadosResp.CO_MAT_COL + " - " + dadosResp.NO_COL;
                ...
                var lst = (from tb119 in ctx.TB119_ATIV_PROF_TURMA
                           ...
                           && (turmaUnica == "S" ? 0 == 0 : tbresp.CO_MAT == tb119.CO_MAT)
                           && tbresp.CO_ANO_REF == ano
                           && tbresp.CO_COL_RESP == CO_COL

                           select new DiarioClasseVersoP
                           {
                ...
                int i = 1;
                foreach (DiarioClasseVersoP dcv in res)
                {
                ...
                bsReport.Clear();
                foreach (DiarioClasseVersoP at in res)
                    bsReport.Add(at);
        ...
        public class DiarioClasseVersoP
        {
