...
{
    public partial class RptStatusLancNotaAtiv : C2BR.GestorEducacao.Reports.RptRetrato
    {
        public RptStatusLancNotaAtiv()
        {
            InitializeComponent();
        }
        #region Init Report
                    ...
                    foreach (var at in res)
                    {
                        ...
                        #region e
                            ...
                            int qtLancMedia = (from tb079 in TB079_HIST_ALUNO.RetornaTodosRegistros()
                                               join tb08 in TB08_MATRCUR.RetornaTodosRegistros() on tb079.CO_ALU equals tb08.CO_ALU
                                                    ...
                                                    select new
                                                    {
                                                        tb079.CO_ALU, tb079.CO_CUR, tb079.CO_ANO_REF,
                                                    }).Count();
                        ...
                        //Faz uma lista ampla de atividades
                         ...
                         foreach (var l in qtAluAtiv)
                         {
                             ...
                             //Se for atividade incrementa o contador
                             if (l.CO_SIGLA_ATIV == "AT")
                                 ativ++;

                             //Se for Simulado incrementa o contador
                        ...
                        //Nota 1
                        at.np1 = (at.DiscAgrupadora != "S" ? (nota1 == 0 ? "SL" : nota1 == qtTotAlunos ? "OK" : nota1 < qtTotAlunos ? "PL" : " - " ) : "***");
                        //Nota 2
                        at.np2 = (at.DiscAgrupadora != "S" ? (nota2 == 0 ? "SL" : nota2 == qtTotAlunos ? "OK" : nota2 < qtTotAlunos ? "PL" : " - " ) : "***");
                        //Simulado 1
                        at.ns1 = (simu == 0 ? "SL" : simu == qtTotAlunos ? "OK" : simu < qtTotAlunos ? "PL" : " - "); 
                        //Atividade 1
                        at.na1 = (at.DiscAgrupadora != "S" ? (ativ == 0 ? "SL" : ativ == qtTotAlunos ? "OK" : ativ < qtTotAlunos ? "PL" : " - ") : "***");
                        //Média
