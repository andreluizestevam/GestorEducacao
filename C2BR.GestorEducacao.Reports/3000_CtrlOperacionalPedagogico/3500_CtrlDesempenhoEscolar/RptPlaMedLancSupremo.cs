...
{
    public partial class RptPlaMedLancSupremo : C2BR.GestorEducacao.Reports.RptRetrato
    {
        public RptPlaMedLancSupremo()
        {
            InitializeComponent();
        }
        #region Init Report
                    ...
                    foreach (var at in res)
                    {
                        ...
                        if (formulario == false)
                        {
                            ...
                            foreach (var l in result)
                            {
                                ...
                                {
                                    at.Av1 += "  " + l.VL_NOTA.ToString("N1");

                                }
                                if (l.CO_REFER_NOTA == "AV2")
                                {
                                    at.Av2 += "  " + l.VL_NOTA.ToString("N1");


                                }
                                if (l.CO_REFER_NOTA == "AV3")
                                {
                                    at.Av3 += " " + l.VL_NOTA.ToString("N1");

                                }
                                if (l.CO_REFER_NOTA == "AV4")
                                {
                                    at.Av4 += "  " + l.VL_NOTA.ToString("N1");

                                }
                                if (l.CO_REFER_NOTA == "AV5")
                                {
                                    at.Av5 += " " + l.VL_NOTA.ToString("N1");
