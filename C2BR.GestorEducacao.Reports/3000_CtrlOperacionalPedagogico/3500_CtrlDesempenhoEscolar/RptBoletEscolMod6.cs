...
{
    public partial class RptBoletEscolMod6 : C2BR.GestorEducacao.Reports.RptRetrato
    {
        public RptBoletEscolMod6()
        {
            InitializeComponent();
        }
                              ...
                              )
        {
            try
            {
                ...
                if (tb01 != null)
                {
                    lblSecretario.Text = (tb01.matriculaSecretario != "" ? tb01.matriculaSecretario : "XXXXX") + " - " + tb01.nomeSecretario;
                }
                else
                    lblSecretario.Text = "";
