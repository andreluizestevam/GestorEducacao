...
{
    public partial class RptPlaMedLancFenix : C2BR.GestorEducacao.Reports.RptRetrato
    {
        public RptPlaMedLancFenix()
        {
            InitializeComponent();
        }
        #region Init Report
                    ...
                    foreach (var at in res)
                    {
                        ...
                        if (formulario == false)
                        {
                            ...
                            var nota = (from tb079 in TB079_HIST_ALUNO.RetornaTodosRegistros()
                                        ...
                                        select new
                                        {
                                            media = (strP_CO_TRIMESTRE == "T1" ? tb079.VL_MEDIA_TRI1 : strP_CO_TRIMESTRE == "T2" ? tb079.VL_MEDIA_TRI2 : tb079.VL_MEDIA_TRI3),
                            ...
                            var result = (from tb49 in TB49_NOTA_ATIV_ALUNO.RetornaTodosRegistros()
                                          ...
                                          && tb49.CO_ANO == ano
                                          && tb49.CO_BIMESTRE == strP_CO_TRIMESTRE
                            ...
                            {
                                string refer = l.CO_REFER_NOTA.Trim();
                                if (at.DiscAgrupadora == "S")
                                        at.np1 = at.NP1_AGRUPADORA;
                                
                                if (at.DiscAgrupadora == "S")
                                    at.np2 = at.NP2_AGRUPADORA;
                                ...
                                if (l.CO_SIGLA_ATIV ==  "PR")
                                {
                                    ...
                                    {
                                        prov1++;
                                        if (prov1 == 1) // Apresenta a nota da disciplina agrupadora calculada, se ela o for
                                            at.np1 = (at.DiscAgrupadora == "S" ? at.NP1_AGRUPADORA : l.VL_NOTA.ToString("N1"));
                                    ...
                                    {
                                        prov2++;
                                        if (prov2 == 1)// Apresenta a nota da disciplina agrupadora calculada, se ela o for
                                            at.np2 = (at.DiscAgrupadora == "S" ? at.NP2_AGRUPADORA : l.VL_NOTA.ToString("N1"));
        ...
        public class PlaMedLanc
        {
            ...
            //Coletar np1 e np2 de disciplinas agrupadoras
            public string cotrimestre { get; set; }
            public decimal? NT_MAX_PROV { get; set; }
            public string NP1_AGRUPADORA
            {
                get
                {
                    var liagrup = (from tb43 in TB43_GRD_CURSO.RetornaTodosRegistros()
                                   ...
                                   where tb43.TB44_MODULO.CO_MODU_CUR == this.coModalidade
                                   && tb43.CO_CUR == this.coCur
                                   && tb43.ID_MATER_AGRUP == this.coMat
                                   && tb43.CO_ANO_GRADE == this.coAno
                    ...
                    foreach (var li in liagrup)
                    {
                        var lisAgruAtiv = (from tb49 in TB49_NOTA_ATIV_ALUNO.RetornaTodosRegistros()
                                           ...
                                           && tb49.TB01_CURSO.CO_CUR == this.coCur
                                           && tb49.CO_ANO == ano
                                           && tb49.CO_BIMESTRE == this.cotrimestre
