...
{
    public partial class RptRelacDepPorAlu : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        public RptRelacDepPorAlu()
        {
            InitializeComponent();
        }
                           ...
                           )
        {
            try
            {
                ...
                var lst = (from tb07 in TB07_ALUNO.RetornaTodosRegistros()
                           ...
                           join tb129 in TB129_CADTURMAS.RetornaTodosRegistros() on tb48.CO_TUR equals tb129.CO_TUR
                ...
                foreach (AlunosDependencia at in lst)
                {
                    ...
                    bsReport.Add(at);
                    at.infosTop = "     Ano Letivo: " + at.ano + " - " + "Aluno: " + at.alunoValid;
                    ...
                    //Pega o nome do professor responsável por uma determinada matéria na grade de horários de Dependência
        ...
        public class AlunosDependencia
        {
            ...
            public string alunoValid
            {
                get
                {
                    ...
                    string nome = this.NomeAluno.ToUpper();
