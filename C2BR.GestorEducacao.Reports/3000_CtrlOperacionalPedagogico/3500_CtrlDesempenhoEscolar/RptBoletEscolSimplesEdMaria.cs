...
{
    public partial class RptBoletEscolSimplesEdMaria : C2BR.GestorEducacao.Reports.RptRetrato
    {
        public RptBoletEscolSimplesEdMaria()
        {
            InitializeComponent();
        }
        ...
        public class BoletimAluno
        {
            ...
            public decimal? MediaSemestre
            {
                get
                {
                    return this.MediaB1 == null && this.MediaB2 == null ? null : (decimal?)((this.MediaB1 ?? 0) + (this.MediaB2 ?? 0)) / 2;
                }
            }
