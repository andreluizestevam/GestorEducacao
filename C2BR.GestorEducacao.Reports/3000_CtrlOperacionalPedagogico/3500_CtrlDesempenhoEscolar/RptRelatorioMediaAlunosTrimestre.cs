...
{
    public partial class RptRelatorioMediaAlunosTrimestre : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        public RptRelatorioMediaAlunosTrimestre()
        {
            InitializeComponent();
        }
            ...
            try
            {
                ...
                var lst = (from tb079 in ctx.TB079_HIST_ALUNO
                           ...
                           select new MediaAluno
                           {
                               ...
                               MediaB1 = tb079.VL_MEDIA_TRI1,
                               MediaB2 = tb079.VL_MEDIA_TRI2,
                               MediaB3 = tb079.VL_MEDIA_TRI3,
                               NotaB1 = tb079.VL_NOTA_TRI1_ORI,
                               NotaB2 = tb079.VL_NOTA_TRI2_ORI,
                               NotaB3 = tb079.VL_NOTA_TRI3_ORI,
                               RecupB1 = tb079.VL_RECU_TRI1,
                               RecupB2 = tb079.VL_RECU_TRI2,
                               RecupB3 = tb079.VL_RECU_TRI3,
        ...
        public class MediaAluno
        {
            ...
            public string NomeAluno
            {
                get
                {
                    return (this.nomeAlunoReceb.Length > 35 ? this.nomeAlunoReceb.Substring(0, 35) + "..." : this.nomeAlunoReceb);
                }
            }
