...
{
    public partial class RptRelacDepCurso : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        public RptRelacDepCurso()
        {
            InitializeComponent();
        }
                           ...
                           )
        {
            try
            {
                ...
                foreach (AlunosDependencia at in lst)
                {
                    ...
                    bsReport.Add(at);
                    at.infosTop = "     Ano Letivo: " + at.ano + " - " + "Curso: " + at.NoSerieAnoAnter;
