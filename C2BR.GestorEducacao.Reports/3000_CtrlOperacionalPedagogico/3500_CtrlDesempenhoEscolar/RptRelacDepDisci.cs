...
{
    public partial class RptRelacDepDisci : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        public RptRelacDepDisci()
        {
            InitializeComponent();
        }
                           ...
                           )
        {
            try
            {
                ...
                foreach (AlunosDependencia at in lst)
                {
                    ...
                    bsReport.Add(at);
                    at.infosTop = "     Ano Letivo: " + at.ano + " - " + "Disciplina: " + at.Disciplina;
