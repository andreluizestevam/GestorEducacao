...
{
    public partial class RptGuiaTransfAlunoTrimestre : C2BR.GestorEducacao.Reports.RptRetrato
    {
        public RptGuiaTransfAlunoTrimestre()
        {
            InitializeComponent();
        }
        ...
        public class RelListaMedias
        {
            ...
            public int TotalFaltas
            {
                get
                {
                    return (this.FaltaT1 ?? 0) + (this.FaltaT2 ?? 0) + (this.FaltaT3 ?? 0);
                }
            }
        }
        #endregion
