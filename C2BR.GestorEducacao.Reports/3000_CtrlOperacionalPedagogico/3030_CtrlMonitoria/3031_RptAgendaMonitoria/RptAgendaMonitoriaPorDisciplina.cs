...
{
    public partial class RptAgendaMonitoriaPorDisciplina : C2BR.GestorEducacao.Reports.RptRetrato
    {
        public RptAgendaMonitoriaPorDisciplina()
        {
            InitializeComponent();
        }
                        ...
                        )
        {
            ...
            try
            {
                ...
                var res = ( from tb189 in TB189_AGEND_MONIT_PROFE.RetornaTodosRegistros()
                           ...
                           }).OrderBy(m => m.Materia).ThenBy(n => n.dt).Distinct().Distinct().ToList();
