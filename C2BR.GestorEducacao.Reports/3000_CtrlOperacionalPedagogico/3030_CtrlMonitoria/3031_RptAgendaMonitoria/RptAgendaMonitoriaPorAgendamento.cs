...
{
    public partial class RptAgendaMonitoriaPorAgendamento : C2BR.GestorEducacao.Reports.RptRetrato
    {
        public RptAgendaMonitoriaPorAgendamento()
        {
            InitializeComponent();
        }
                        ...
                        )
        {
            ...
            try
            {
                ...
                var res = (from tb189 in TB189_AGEND_MONIT_PROFE.RetornaTodosRegistros()
                           ...
                           select new ExtratoAgendaPorModCurTur
                           {
                               ...
                               temaMonit = tb189.TM_MONIT,
							   situacao = tb189.FL_SITUA,
							   hrini = tb189.HR_INICIO,
							   hrFim = tb189.HR_FIM,

                           }).OrderBy(m => m.Professor).ThenBy(n => n.dt).Distinct().ToList();
                ...
                bsReport.Clear();
                foreach (ExtratoAgendaPorModCurTur at in res)
                    bsReport.Add(at);
        ...
        public class ExtratoAgendaPorModCurTur
        {
