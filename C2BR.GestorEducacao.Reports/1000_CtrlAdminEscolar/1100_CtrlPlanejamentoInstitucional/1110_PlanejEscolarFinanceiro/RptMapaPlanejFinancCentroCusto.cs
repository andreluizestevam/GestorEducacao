...
{
    public partial class RptMapaPlanejFinancCentroCusto : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        ...
        public RptMapaPlanejFinancCentroCusto()
        {
            InitializeComponent();
        }
                             ...
                             string infos)
        {
            try
            {
                ...
                var lst = from tb099 in ctx.TB099_CENTRO_CUSTO
                          ...
                          && (intP_DEPTO != 0 ? tb099.TB14_DEPTO.CO_DEPTO == intP_DEPTO : 0 == 0)
                          orderby tb099.NU_CTA_CENT_CUSTO, tb112.CO_ANO_REF
                          select new RelPlanejCentroCusto
                          {
                ...
                bsReport.Clear();
                foreach (RelPlanejCentroCusto at in res)
                    bsReport.Add(at);
        ...
        public class RelPlanejCentroCusto
        {
