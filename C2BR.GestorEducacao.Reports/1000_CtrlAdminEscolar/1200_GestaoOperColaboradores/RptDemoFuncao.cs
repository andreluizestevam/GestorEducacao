...
{
    public partial class RptDemoFuncao : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        public static double media, total = 0;

        public RptDemoFuncao()
        {
            InitializeComponent();
        }
            ...
            try
            {
                ...
                var lst = (from tb03 in ctx.TB03_COLABOR
                           ...
                           where tb03.CO_FUN == tb15.CO_FUN && tb03.CO_TPCON == tb20.CO_TPCON &&
                            ...
                            && (codFunCol != 0 ? tb03.CO_FUN == codFunCol : codFunCol == 0)
