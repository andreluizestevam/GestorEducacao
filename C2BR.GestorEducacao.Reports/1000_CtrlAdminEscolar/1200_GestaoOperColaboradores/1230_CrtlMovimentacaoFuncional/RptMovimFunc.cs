...
{
    public partial class RptMovimFunc : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        int total, remun, nRemun = 0;   
            ...
            try
            {
                ...
                var lst = (from tb286 in ctx.TB286_MOVIM_TRANSF_FUNCI
                           ...
                           where tb03.CO_COL == tb286.TB03_COLABOR.CO_COL && tb03.CO_EMP == tb286.TB25_EMPRESA1.CO_EMP &&
                            ...
                            && (TpMov != "T" ? tb286.CO_TIPO_MOVIM == TpMov : tb286.CO_TIPO_MOVIM == tb286.CO_TIPO_MOVIM)
                           ...
                           }).OrderBy(p => p.TipoMov).ThenBy(p => p.Nome);
        ...
        public class MovimFunc
        {
            ...
            {                
                get
                {
                    ...
                    result = DataInicioMov.ToString("dd/MM/yy");
                    ...
                    {
                        result = result + " - " + DataFinalMov.ToString("dd/MM/yy");
                    }

                    result = result + " - " + TpRemuneracao;
        ...
        {
            lbltotal.Text = String.Format("Quantidade de movimentações: (" + total.ToString() + " Geral) - (" + remun.ToString() + " Remunerado(s) - " + nRemun.ToString() + " Não Remunerado(s))");

            total = 0;
        }       

        private void lblTipoRenum_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (lblTipoRenum.Text == "S")
            {
                nRemun++;
            }
            else
