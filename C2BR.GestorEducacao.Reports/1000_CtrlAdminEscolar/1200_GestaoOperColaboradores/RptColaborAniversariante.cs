...
{
    public partial class RptColaborAniversariante : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        public RptColaborAniversariante()
        {
            InitializeComponent();
        }
            ...
            )
        {
            try
            {
                ...
                {
                    lblTitulo.Text = "EMISSÃO DA RELAÇÃO DE COLABORADORES ANIVERSARIANTES * ";
                }
                else
                {
        ...
        public class ColaborAniversariante
        {
            ...
            public string DataNasctoDesc
            {
                get
                {
                    ...
                    {
                        return DataNascto.ToString("dd/MM");
                    }
                }
            }
