...
{
    public partial class RptDemoTpContrato : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        public static double media, total = 0;

        public RptDemoTpContrato()
        {
            InitializeComponent();
        }
            ...
            try
            {
                ...
                var lst = (from tb03 in ctx.TB03_COLABOR
                           ...
                           where tb03.CO_FUN == tb15.CO_FUN && tb03.CO_TPCON == tb20.CO_TPCON &&
                            ...
                            && (codTpContratoCol != 0 ? tb03.CO_TPCON == codTpContratoCol : codTpContratoCol == 0)
                ...
                bsReport.Clear();
                foreach (DemoTpContrato at in res)
                    bsReport.Add(at);
