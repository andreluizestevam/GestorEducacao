...
{
    public partial class RptUnidadeEscolaTipo : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        #region ctor

        public RptUnidadeEscolaTipo()
        {
            InitializeComponent();
        }
        ...
        public int InitReport(int codEmp, int codTpUnid, string infos)
        {
            try
            {
                ...
                var res = (from tb25 in ctx.TB25_EMPRESA
                           ...
                           where tb25.TB24_TPEMPRESA.CO_TIPOEMP == codTpUnid
                           select new UnidadePorTipo
                           {
                               Inep = tb25.NU_INEP,
                               ...
                               Tipo = tb25.TB24_TPEMPRESA.NO_TIPOEMP,
        ...
        #region Class UnidadePorTipo

        public class UnidadePorTipo
        {
