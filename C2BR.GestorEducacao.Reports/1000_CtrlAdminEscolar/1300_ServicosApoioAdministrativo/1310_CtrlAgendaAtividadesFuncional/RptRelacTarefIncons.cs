...
{
    public partial class RptRelacTarefIncons : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        public RptRelacTarefIncons()
        {
            InitializeComponent();
        }
            ...
            try
            {
                ...
                var lst = (from tb137 in ctx.TB137_TAREFAS_AGENDA
                           where tb137.TB000_INSTITUICAO.ORG_CODIGO_ORGAO == codInst
                            ...
                            && tb137.DT_LIMIT_TAREF_AGEND < DateTime.Now 
                            && (strP_CO_SOLIC != 0 ? tb137.TB03_COLABOR1.CO_COL == strP_CO_SOLIC : strP_CO_SOLIC == 0)
                            && (tb137.TB139_SITU_TAREF_AGEND.CO_SITU_TAREF_AGEND != "CO" && tb137.TB139_SITU_TAREF_AGEND.CO_SITU_TAREF_AGEND != "CR"
                            && tb137.TB139_SITU_TAREF_AGEND.CO_SITU_TAREF_AGEND != "TF")
                           select new TarefaAgendIncon
                           {
                ...
                bsReport.Clear();
                foreach (TarefaAgendIncon at in res)
                    bsReport.Add(at);
        ...
        #region Classe Tarefas Agendadas Inconsistentes do Relatorio

        public class TarefaAgendIncon
        {
