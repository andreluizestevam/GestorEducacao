...
{
    public partial class RptRelacTarefAgendadas : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        public RptRelacTarefAgendadas()
        {
            InitializeComponent();
        }
        ...
        #region Classe Tarefas Agendadas do Relatorio

        public class TarefaAgend
        {
            ...
            public string ResponDesc
            {
                get
                {
                    return this.MatricRespo.Insert(5, "-").Insert(2, ".") + " / " + this.SiglaUnidRespo;
                }
            }
            ...
            public string SolicDesc
            {
                get
                {
                    return this.MatricSolic.Insert(5, "-").Insert(2, ".") + " / " + this.SiglaUnidSolic;
                }
            }
