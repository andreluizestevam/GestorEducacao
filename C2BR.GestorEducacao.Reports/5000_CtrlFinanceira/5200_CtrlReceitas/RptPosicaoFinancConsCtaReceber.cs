...
{
    public partial class RptPosicaoFinancConsCtaReceber : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        public RptPosicaoFinancConsCtaReceber()
        {
            InitializeComponent();
        }
                                ...
                                string infos)
        {
            try
            {
                ...
                List<FinancConsolidadaCtaReceber> lst = null;
                if (strP_TIPO == "C")
                {
                    lst = (from tb47 in ctx.TB47_CTA_RECEB
                           ...
                           select new FinancConsolidadaCtaReceber
                           {
                ...
                bsReport.Clear();
                foreach (FinancConsolidadaCtaReceber at in res)
                    bsReport.Add(at);
    ...
    public class FinancConsolidadaCtaReceber
    {
