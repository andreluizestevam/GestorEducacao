...
{
    public partial class RptRelacaoTituloAlunosRecursReceitas : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        ...
        public RptRelacaoTituloAlunosRecursReceitas()
        {
            InitializeComponent();
        }
                              ...
                              string infos)
        {
            try
            {
                ...
                var lst = (from tb47 in ctx.TB47_CTA_RECEB
                           ...
                           && (strP_DT_INI_VENC != "" ? tb47.DT_VEN_DOC >= dtIniVenc : strP_DT_INI_VENC == "")
                           && (strP_DT_FIM_VENC != "" ? tb47.DT_VEN_DOC <= dtFimVenc : strP_DT_FIM_VENC == "")
                           && (strP_DT_INI_CADAS != "" ? tb47.DT_VEN_DOC >= dtIniCadas : strP_DT_INI_CADAS == "")
                           && (strP_DT_FIM_CADAS != "" ? tb47.DT_VEN_DOC <= dtFimCadas : strP_DT_FIM_CADAS == "")
