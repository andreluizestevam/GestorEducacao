    ...
    public partial class RptRelatoPosicaoRecursosReceitas : C2BR.GestorEducacao.Reports.RptPaisagem
    {
            ...
            try
            {
                ...
                if (srtPesqPor != "R")
                {
                    ...
                    var lst = (from tb47 in ctx.TB47_CTA_RECEB
                               join tb07 in ctx.TB07_ALUNO on tb47.CO_ALU equals tb07.CO_ALU into sr
                               from x in sr.DefaultIfEmpty()
                               where tb47.TB000_INSTITUICAO.ORG_CODIGO_ORGAO == codInst
                               && (IntUniContr != 0 ? tb47.CO_EMP_UNID_CONT == IntUniContr : IntUniContr == 0)
                               && (strP_NU_DOC != "" ? tb47.NU_DOC == strP_NU_DOC : strP_NU_DOC == "")
                               && (strP_CO_EMP_REF != 0 ? tb47.CO_EMP == strP_CO_EMP_REF : strP_CO_EMP_REF == 0)
                               && (strP_IC_SIT_DOC != "T" ? tb47.IC_SIT_DOC == strP_IC_SIT_DOC : strP_IC_SIT_DOC == "T")
                               && (strP_CO_ALU != 0 ? tb47.CO_ALU == strP_CO_ALU : strP_CO_ALU == 0)
                               && (strP_CO_CLIENTE != 0 ? tb47.TB103_CLIENTE.CO_CLIENTE == strP_CO_CLIENTE : strP_CO_CLIENTE == 0)
                               ...
                               && (strP_CO_ANO_MES_MAT != "T" ? tb47.CO_ANO_MES_MAT == strP_CO_ANO_MES_MAT : strP_CO_ANO_MES_MAT == "T")
                               && (strP_CO_TUR != 0 ? tb47.CO_TUR == strP_CO_TUR : strP_CO_TUR == 0)
                                   //&& tb47.DT_VEN_DOC >= strP_DT_INI && tb47.DT_VEN_DOC <= strP_DT_FIM
                               && (srtPesqPor == "M" ? (tb47.DT_CAD_DOC >= strP_DT_INI && tb47.DT_CAD_DOC <= strP_DT_FIM) :
                               (srtPesqPor == "V" ? (tb47.DT_VEN_DOC >= strP_DT_INI && tb47.DT_VEN_DOC <= strP_DT_FIM) :
                               ...
                               {
                                   TipoCliente = tb47.TP_CLIENTE_DOC,
                                   Identificacao = (tb47.TP_CLIENTE_DOC == "A" ? tb47.TB108_RESPONSAVEL.NU_CPF_RESP : tb47.TB103_CLIENTE.CO_CPFCGC_CLI),
                                   Nome = (tb47.TP_CLIENTE_DOC == "A" ? tb47.TB108_RESPONSAVEL.NO_RESP : tb47.TB103_CLIENTE.NO_FAN_CLI),
                                   Codigo = (tb47.TP_CLIENTE_DOC == "A" ? (x != null ? x.NU_NIRE : 0) : tb47.TB103_CLIENTE.CO_CLIENTE),
                                   Data = (srtPesqPor == "M" ? tb47.DT_CAD_DOC : (srtPesqPor == "V" ? tb47.DT_VEN_DOC :
                                                (srtPesqPor == "P") ? tb47.DT_REC_DOC : null)),
                                   DataMov = tb47.DT_CAD_DOC,
                                   Parcela = tb47.NU_PAR,
                                   Status = tb47.IC_SIT_DOC,
                                   Documento = tb47.NU_DOC,
                                   DataVencimento = tb47.DT_VEN_DOC,
                                   DataPagamento = (srtPesqPor != "P" ? tb47.DT_REC_DOC : tb47.DT_VEN_DOC),
                                   ValorDocumento = tb47.VR_PAR_DOC,
                                   Juros = tb47.VR_JUR_DOC,
                                   Multa = tb47.VR_MUL_DOC,
                                   Desconto = tb47.VR_DES_DOC,
                                   DescontoBolsa = tb47.VL_DES_BOLSA_ALUNO,
                ...
                else
                {
                    ...
                    var lst = (from tb47 in ctx.TB47_CTA_RECEB
                               ...
                               && (strP_CO_AGRUP != 0 ? tb47.CO_AGRUP_RECDESP == strP_CO_AGRUP : strP_CO_AGRUP == 0)
                               && (!incluCance && strP_IC_SIT_DOC != "C" ? tb47.IC_SIT_DOC != "C" : 0 == 0)
                               && (strP_CO_RESP != 0 ? tb47.TB108_RESPONSAVEL.CO_RESP == strP_CO_RESP : strP_CO_RESP == 0)
                               select new RelPosRecReceitas
                               {
                                   TipoCliente = tb47.TP_CLIENTE_DOC,
                                   Identificacao = tb47.TP_CLIENTE_DOC == "A" ? tb47.TB108_RESPONSAVEL.NU_CPF_RESP : tb47.TB103_CLIENTE.CO_CPFCGC_CLI,
        ...
        public class RelPosRecReceitas
        {
            ...
            public string Referencia
            {
                get
                {
                    return (this.TipoCliente == "A") ? "(A) " + this.Codigo.ToString().PadLeft(7, '0') : "(C) " + this.Codigo.ToString();
                }
            }
