...
{
    public partial class RptDeclaracaoMatricula : C2BR.GestorEducacao.Reports.Base.RptDeclaracao
    {
        public RptDeclaracaoMatricula()
        {
            InitializeComponent();
        }
        ...
        public int InitReport(int codEmp, string codAluCad)
        {
            try
            {
                ...
                var lst = (from tb009 in ctx.TB009_RTF_DOCTOS
                           ...
                           where tb009.TP_DOCUM == "DE" && tb009.CO_SIGLA_DOCUM == "DXXX001MATRI"//tb009.TP_DOCUM == "DE" && tb009.CO_SIGLA_DOCUM == "DA"
