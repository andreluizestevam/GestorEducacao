...
{
    public partial class RptDeclaracaoTransferenciaInsef : C2BR.GestorEducacao.Reports.Base.RptDeclaracao
    {
        public RptDeclaracaoTransferenciaInsef()
        {
            InitializeComponent();
        }
        public int InitReport(int codEmp, string codAluCad)
        {
            try
            {
                ...
                var lst = (from tb009 in ctx.TB009_RTF_DOCTOS
                           ...
                           where tb009.TP_DOCUM == "DE" && tb009.CO_SIGLA_DOCUM == "DXXX004TRANS"
