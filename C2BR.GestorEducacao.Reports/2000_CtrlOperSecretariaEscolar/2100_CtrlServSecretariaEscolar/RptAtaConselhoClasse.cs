...
{
    public partial class RptAtaConselhoClasse : C2BR.GestorEducacao.Reports.RptPaisagemOficio
    {
        public RptAtaConselhoClasse()
        {
            InitializeComponent();
        }
                             ...
                             )
        {
            try
            {
                ...
                this.lblTitulo.Text = (!string.IsNullOrEmpty(NO_RELATORIO) ? NO_RELATORIO : "ATA DE CONSELHO DE CLASSE");
