...
{
    public partial class RptFolhadePontoS : C2BR.GestorEducacao.Reports._1000_CtrlAdminEscolar._1200_GestaoOperColaboradores.RptFolhadePonto
    {
        string mesAno;
        #region ctor

        public RptFolhadePontoS()
        {
            InitializeComponent();
        }
