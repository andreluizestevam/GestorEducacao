...
{
    public partial class RptRleFuncParamCid : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        public RptRleFuncParamCid()
        {
            InitializeComponent();
        }
                        ...
                        )
        {
            ...
            try
            {
                ...
                var res = (from tb03 in TB03_COLABOR.RetornaTodosRegistros()
                           join tb905 in TB905_BAIRRO.RetornaTodosRegistros() on tb03.CO_BAIRRO equals tb905.CO_BAIRRO into l1 
                           ...
                           select new
                           {
                               ...
                               noCidade = (ls != null ? ls.NO_BAIRRO + ", " + tb904.NO_CIDADE : tb904.NO_CIDADE),
                               coCidade = tb904.CO_CIDADE,
