...
{
    public partial class RptRelFuncParamPorUnid : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        public RptRelFuncParamPorUnid()
        {
            InitializeComponent();
        }
                        ...
                        )
        {
            ...
            try
            {
                ...
                if (tipoUnid == "U") // Tipo de unidade Funcional
                {
                    #region Por Unidade Funcional
                ...
                else // por unidade de lotação
                {
                    #region Por unidade de Lotação/Contrato
