...
{
    public partial class RptGuiaExame : C2BR.GestorEducacao.Reports.RptRetrato
    {
        public RptGuiaExame()
        {
            InitializeComponent();
                        ...
                        )
        {
            ...
            try
            {
                ...
                var res = (from tbs219 in TBS219_ATEND_MEDIC.RetornaTodosRegistros()
                           ...
                           join tbs218 in TBS218_EXAME_MEDICO.RetornaTodosRegistros() on tbs219.ID_ATEND_MEDIC equals tbs218.ID_ATEND_MEDIC
                           ...
                           && (ID_EXAME != 0 ? tbs218.ID_EXAME == ID_EXAME : 0 == 0)
                           && (CO_TIPO_IMPRESSAO != "0" ? tbs218.CO_TIPO_EXECU == CO_TIPO_IMPRESSAO : 0 == 0)
                           select new GuiaExame
                           {
                               ...
                               nomeExame = tbs218.TBS356_PROC_MEDIC_PROCE.NM_PROC_MEDI,
                               NR_REGISTRO = tbs218.NU_REGIS_EXAME,
                               FL_APROV_ENCAM = tbs218.TBS356_PROC_MEDIC_PROCE.FL_AUTO_PROC_MEDI,
                               dt_exame = tbs218.DT_EXAME,
                               UNID_EXAME = (tbs218.TB25_EMPRESA != null ? tbs218.TB25_EMPRESA.NO_FANTAS_EMP : "*Fora da Instituição*"),
                               LOCAL_EXAME = (tbs218.TB14_DEPTO != null ? tbs218.TB14_DEPTO.NO_DEPTO : "*Fora da Instituição*"),
                               CO_TIPO_EXECU = tbs218.CO_TIPO_EXECU,
