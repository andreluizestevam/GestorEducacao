...
{
    public partial class RptEncamLivre : C2BR.GestorEducacao.Reports.RptRetratoCentro
    {
        public RptEncamLivre()
        {
            InitializeComponent();
        }
        #region Init Report
                        ...
                        )
        {
            ...
            try
            {
                ...
                var res = (from tbs390 in TBS390_ATEND_AGEND.RetornaTodosRegistros()
                           ...
                           join tbs462 in TBS462_ATEND_ENCAM_LIVRE.RetornaTodosRegistros() on tbs390.ID_ATEND_AGEND equals tbs462.TBS390_ATEND_AGEND.ID_ATEND_AGEND
                           join tb25 in TB25_EMPRESA.RetornaTodosRegistros() on tbs462.CO_EMP_CADAS equals tb25.CO_EMP
                           join tb904 in TB904_CIDADE.RetornaTodosRegistros() on tb25.CO_CIDADE equals tb904.CO_CIDADE
                           where (coAtendimento != 0 ? tbs462.TBS390_ATEND_AGEND.ID_ATEND_AGEND == coAtendimento : 0 == 0)
                           select new Encaminhamento
                           {
                               //Informações do Paciente
                               Paciente = tb07.NO_ALU,
                               IdEncam = tbs462.ID_ATEND_ENCAM_LIVRE,
                               ...
                               Texto = tbs462.DE_CONTE_MODEL
                           }).OrderByDescending(x => x.IdEncam).First();
                ...
                this.xrRichText1.Text = res.Texto;
