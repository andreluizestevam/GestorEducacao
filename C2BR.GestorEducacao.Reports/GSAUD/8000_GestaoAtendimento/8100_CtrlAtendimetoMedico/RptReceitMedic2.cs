...
{
    public partial class RptReceitMedic2 : C2BR.GestorEducacao.Reports.RptRetratoCentro
    {
        public RptReceitMedic2()
        {
            InitializeComponent();
        }
        #region Init Report
                        ...
                        )
        {
            ...
            try
            {
                ...
                var res = (from tbs390 in TBS390_ATEND_AGEND.RetornaTodosRegistros()
                           ...
                           join tb90 in TB90_PRODUTO.RetornaTodosRegistros() on tbs399.TB90_PRODUTO.CO_PROD equals tb90.CO_PROD
                           ...
                           where (tbs390.ID_ATEND_AGEND == coAtendimento)
                           ...
                           select new GuiaExame
                           {
                               ...
                               //Nascimento = tb07.DT_NASC_ALU.Value,
                               SexoPac = !String.IsNullOrEmpty(tb07.CO_SEXO_ALU) ? tb07.CO_SEXO_ALU == "F" ? "Feminino" : "Masculino" : "-",
                               //SexoPac = tb07.CO_SEXO_ALU == "F" ? "Feminino" : "Masculino",
                               //SexoPac = tb07.CO_SEXO_ALU,
                               ...
                               ModoUso = tbs399.QT_USO.HasValue ? tbs399.QT_USO.Value : 0,
                               //ModoUso = tbs399.QT_USO.Value,
                               Prescricao = tbs399.DE_PRESC == null ? " - " : tbs399.DE_PRESC,
                               //Prescricao = tbs399.DE_PRESC,
                               //Informações gerais
                               nomeCidade = tb904.NO_CIDADE,
                               nomeUF = tb904.CO_UF,
                               unidEmiss = tb25.NO_FANTAS_EMP,
                               PrinciAtivo = tbs399.DE_PRINC_ATIVO == null ? " - " : tbs399.DE_PRINC_ATIVO,
                ...
                foreach (GuiaExame at in res)
                {
                    ...
                    xrLabel11.Visible = at.TipoControle;
                    xrLabel10.Visible = at.TipoControle;
                    xrLabel9.Visible = at.TipoControle;
                    if (at.TipoControle)
                    {
        ...
        public class GuiaExame
        {
            ...
            public string Prescricao_;
            public string Prescricao
            {
                get
                {
             
                        return (this.ModoUso == 0 ? "USO CONTÍNUO - " : "USO POR " + this.ModoUso + " DIAS - ") + Prescricao_;
                }
                set
                {
                    Prescricao_ = value;
            ...
            public string MedicamentoValid
            {
                get
                {
                    return this.nomeMedicamento.ToUpper();
                }
            }
