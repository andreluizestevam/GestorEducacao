...
{
    public partial class RptMapaFaturColab : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        public RptMapaFaturColab()
        {
            InitializeComponent();
        }
        #region Init Report
        ...
        public class Relatorio
        {
            ...
            public string Colaborador
            {
                get
                {
                    return (this.Colaborador_R.Length > 32 ? this.Colaborador_R.Substring(0, 32) : this.Colaborador_R);
                }
            }
