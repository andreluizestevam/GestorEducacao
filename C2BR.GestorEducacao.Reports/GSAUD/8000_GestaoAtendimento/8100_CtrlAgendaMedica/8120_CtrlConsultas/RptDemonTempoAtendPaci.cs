...
{
    public partial class RptDemonTempoAtendPaci : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        public RptDemonTempoAtendPaci()
        {
            InitializeComponent();
        }
        ...
        public class Relatorio
        {
            ...
            public String IntervAgendRecep
            {
                get
                {
                    ...
                    {
                        return difAgendRecep.Value.Duration().Hours.ToString("00") + ":" + difAgendRecep.Value.Duration().Minutes.ToString("00");
                    }
                    else
                    {
                        return "-";
            ...
            public String IntervRecepCRisco
            {
                get
                {
                    ...
                    {
                        return difRecepCRisco.Value.Duration().Hours.ToString("00") + ":" + difRecepCRisco.Value.Duration().Minutes.ToString("00");
                    }
                    else
                    {
                        return "-";
            ...
            public String IntervEncamTriagem
            {
                get
                {
                    ...
                    {
                        return difEncamTriagem.Value.Duration().Hours.ToString("00") + ":" + difEncamTriagem.Value.Duration().Minutes.ToString("00");
                    }
                    else
                    {
                        return "-";
            ...
            public String IntervEncamAtendIni
            {
                get
                {
                    ...
                    {
                        return difEncamAtendIni.Value.Duration().Hours.ToString("00") + ":" + difEncamAtendIni.Value.Duration().Minutes.ToString("00");
                    }
                    else
                    {
                        return "-";
            ...
            public String IntervAtendIni
            {
                get
                {
                    ...
                    {
                        return difAtendIni.Value.Duration().Hours.ToString("00") + ":" + difAtendIni.Value.Duration().Minutes.ToString("00");
                    }
                    else
                    {
                        return "-";
            ...
            public string DuracaoTotal
            {
                get
                {
                    ...
                    if (this.difAgendRecep.HasValue && !this.IntervAgendRecep.Equals("-"))
                    {
                        timeTotal += this.difAgendRecep.Value;
                    }
                    if (this.difRecepCRisco.HasValue && !this.IntervRecepCRisco.Equals("-"))
                    {
                        timeTotal += this.difRecepCRisco.Value;
                    }
                    if (this.difEncamTriagem.HasValue && !this.IntervEncamTriagem.Equals("-"))
                    {
                        timeTotal += this.difEncamTriagem.Value;
                    }
                    if (this.difEncamAtendIni.HasValue && !this.IntervEncamAtendIni.Equals("-"))
                    {
                        timeTotal += this.difEncamAtendIni.Value;
                    }
                    if (this.difAtendIni.HasValue && !this.IntervAtendIni.Equals("-"))
                    {
                        timeTotal += this.difAtendIni.Value;
                    }
                    if ((timeTotal.Hours < 0 || Double.IsNaN(timeTotal.Hours)) || (timeTotal.Minutes < 0 || Double.IsNaN(timeTotal.Minutes)))
                        ...
                        return (timeTotal.Days.ToString("00") + ":" + timeTotal.Hours.ToString("00") + ":" + timeTotal.Minutes.ToString("00")).ToString();
                }
            }
            public string DuracaoTotalFinal
            {
                get
                {
                    TimeSpan timeTotal = new TimeSpan();
                    ...
                    if ((timeTotal.TotalMinutes < 0 || Double.IsNaN(timeTotal.TotalMinutes)))
                        ...
                        return timeTotal.TotalMinutes.ToString("N2");
                }
            }
