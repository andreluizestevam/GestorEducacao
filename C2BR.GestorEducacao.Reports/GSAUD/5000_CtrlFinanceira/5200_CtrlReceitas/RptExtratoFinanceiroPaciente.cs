...
{
    public partial class RptExtratoFinanceiroPaciente : C2BR.GestorEducacao.Reports.RptPaisagem
    {
        public RptExtratoFinanceiroPaciente()
        {
            InitializeComponent();
        }
            ...
            try
            {
                ...
                var lst = (from tbs174 in ctx.TBS174_AGEND_HORAR
                           ...
                           select new
                           {
                               ...
                               Operadora = tbs356.TB250_OPERA.NM_SIGLA_OPER,
                ...
                foreach (var at in res)
                {
                    ...
                    rel.Nome = at.Nome;
                    rel.NIRE = at.NIRE;
                    rel.Responsavel = at.Responsavel;
                    rel.CpfResp = at.CpfResp;
                    rel.Profissional = at.Profissional;
                    rel.DataAgendamento = at.DataAgendamento;
                    rel.OrigemProcedimento = at.OrigemProcedimento;
                    rel.CodigoProcedimento = at.CodigoProcedimento;
                    rel.Procedimento = at.Procedimento;
                    rel.Operadora = at.Operadora;
                    rel.ValorUnit = at.ValorUnit == null ? 0 : at.ValorUnit;
                    rel.RLZ = at.RLZ;
                    rel.Rap = at.Rap;
                    rel.CO_SITU = at.CO_SITU;
                    rel.SIGLA_ENTI_PROFI = at.SIGLA_ENTI_PROFI;
                    rel.NU_ENTI_PROFI = at.NU_ENTI_PROFI;
                    rel.SiglaUnid = at.SiglaUnid;
                    rel.QTProced = at.QTProced == null ? 1 : at.QTProced;
                    rel.Local = at.Local;
                    rel.HR = at.HR;
                ...
                result.RelExtratoFinanceiro = listExtrato;
                bsReport.Add(result);
                return 1;
            }
            catch { return 0; }
        ...
        public class Resultado
        {
            ...
            public string DesRealizados
            {
                get;
                set;
                //get
                //{
                //    return "(Realizados: " + this.qtRLZ + " - R$" + this.ValorRLZ + " / " + "Não Realizados: " + this.qtRLZ + " - R$" + this.ValorRLZ + ")";
                //}
            }
        ...
        public class RelExtratoFinanceiroPaciente
        {
            ...
            public string Procedimento_V
            {
                get
                {
                    return (this.CodigoProcedimento + " - " + this.Procedimento).Length > 85 ? ((this.CodigoProcedimento + " - " + this.Procedimento).Substring(0, 85) + "...") : (this.CodigoProcedimento + " - " + this.Procedimento);
                }
            }
