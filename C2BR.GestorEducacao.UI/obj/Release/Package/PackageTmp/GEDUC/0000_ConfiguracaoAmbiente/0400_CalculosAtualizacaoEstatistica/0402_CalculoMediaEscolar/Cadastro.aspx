<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F0000_ConfiguracaoAmbiente.F0400_CalculosAtualizacaoEstatistica.F0402_CalculoMediaEscolar.Cadastro" %>
...
<style type="text/css">  
    ...
    .divGrid { height: 220px; overflow-y:auto; width: 601px; border: 1px solid #D2DFD1;} 
...
<ul id="ulDados" class="ulDados">  
        ...
        <li class="liUnidadeEscolar">
            <label id="Label6" class="lblObrigatorio" title="Série">
                Série</label>
            <asp:DropDownList ID="ddlSerieCurso" ToolTip="Selecione a Série" AutoPostBack="true" OnSelectedIndexChanged="ddlSerieCurso_SelectedIndexChanged"
                CssClass="ddlSerieCurso" runat="server">
            </asp:DropDownList>    
        </li>  
        <li class="liUnidadeEscolar">
        ...
        <ul>
            <li style="margin-left: 278px;"><label style="text-transform:uppercase;">---------------------------------------------- TURMAS ----------------------------------------------</label></li>
            <li id="liGrid" style="margin-left: 90px;">
            ...
            <li style="width:179px;margin-right: 0px;margin-left: 90px;">
                <label>Média Geral</label>
            </li> 
            <li class="liTotais">
                <asp:Label ID="lblTotT1" runat="server"></asp:Label>
            </li>
            <li class="liTotais" style="width:45px;">
                <asp:Label ID="lblTotT2" runat="server"></asp:Label>
            </li>
            <li class="liTotais" style="width:47px;">
            ...
            <li class="liTotais" style="width:50px;">
         ...
         <li style="clear:none; margin-left: 20px; margin-right: 0px;" id="liLegMCFF" runat="server" clientidmode="Static" visible="false">
            <ul>
                ...
                <li style="padding-left: 2px; color:#838B83;width: 130px;">
                    <asp:Label runat="server" id="lblTit1" style="width:40px;float:left;"/>
                    <asp:Label runat="server" id="lblT1" style="clear:none;width:83px;float:left;"/>
                    <asp:Label runat="server" id="lblTit2" style="width:40px;clear: both;float:left;"/>
                    <asp:Label runat="server" id="lblT2" style="clear:none;width:83px;float:left;"/>
                    <asp:Label runat="server" id="lblTit3" style="width:40px;clear: both;float:left;"/>
                    <asp:Label runat="server" id="lblT3" style="clear:none;width:83px;float:left;"/>
                    <asp:Label runat="server" id="lblTit4" style="width:40px;clear: both;float:left;"/>
                    <asp:Label runat="server" id="lblT4" style="clear:none;width:83px;float:left;"/>
                    <asp:Label runat="server" id="lblTit5" style="width:40px;clear: both;float:left;"/>
                    <asp:Label runat="server" id="lblT5" style="clear:none;width:83px;float:left;"/>
                    <asp:Label runat="server" id="lblTit6" style="width:40px;clear: both;float:left;"/>
                    <asp:Label runat="server" id="lblT6" style="clear:none;width:83px;float:left;"/>
                    <asp:Label runat="server" id="lblTit7" style="width:40px;clear: both;float:left;"/>
                    <asp:Label runat="server" id="lblT7" style="clear:none;width:83px;float:left;"/>
                    <asp:Label runat="server" id="lblTit8" style="width:40px;clear: both;float:left;"/>
                    <asp:Label runat="server" id="lblT8" style="clear:none;width:83px;float:left;"/>
                </li>
            </ul>
        </li>        
</ul>
