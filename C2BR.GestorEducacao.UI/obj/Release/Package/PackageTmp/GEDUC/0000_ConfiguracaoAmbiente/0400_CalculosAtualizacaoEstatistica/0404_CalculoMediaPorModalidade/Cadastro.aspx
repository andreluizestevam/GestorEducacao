<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F0000_ConfiguracaoAmbiente.F0400_CalculosAtualizacaoEstatistica.F0404_CalculoMediaPorModalidade.Cadastro" %>
...
<ul id="ulDados" class="ulDados">  
        ...
        <ul>
            <li style="margin-left: 375px;"><label style="text-transform:uppercase;">----------------------------- MODALIDADES -----------------------------</label></li>
            <li id="liGrid" style="margin-left: 115px;">
            ...
            <li style="width:255px;margin-right: 0px;margin-left: 115px;">
            ...
            <li class="liTotais" style="width:29px;">
                <asp:Label ID="lblTotT5" runat="server"></asp:Label>
            </li>
            <li class="liTotais" style="width:30px;">
