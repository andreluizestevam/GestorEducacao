<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoGenericas.Master"
    AutoEventWireup="true" CodeBehind="AtualFrequAlunoPortal.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F0000_ConfiguracaoAmbiente.F0500_SuporteOperacionalGE.F0508_AtualFrequAlunoPortal.AtualFrequAlunoPortal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <ul class="ulDados">     
        <li id="liLnkAtualBD" runat="server" class="liLnkAtualBD">
            <asp:LinkButton ID="lnkAtualBP" runat="server" OnClick="lnkAtualBP_Click" CssClass="lnkAtualBP" ToolTip="Atualizar Frequência do Aluno">
                <img id="imgIconAtualBP" width="20" height="20" src='/Library/IMG/Gestor_DBRestore.png' alt="Atualizar Frequência do Aluno a partir do Portal de Relacionamento" />
                <asp:Label runat="server" ID="lblAtuaBDPorRelac" CssClass="lblAtuaBDPorRelac" Text="Atualizar Frequência do Aluno"></asp:Label>
            </asp:LinkButton>
        </li>
        <li class="liClear">
