<%@ Page Language="C#" MasterPageFile="~/App_Masters/PadraoBuscas.Master" AutoEventWireup="true"
    CodeBehind="Busca.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F2000_CtrlOperSecretariaEscolar.F2100_CtrlServSecretariaEscolar.F2107_MatriculaAluno.AlteraStatusMatricula.Busca"
    Title="Busca" %>
    ...
    <ul id="ulParamsFormBusca" class="ulParamsFormBusca">
        ...
        <li>
            ...
            <asp:DropDownList ID="ddlTurma" runat="server" CssClass="ddlTurma" 
                ToolTip="Selecione a Turma" AutoPostBack="True" 
        ...
        <li>
            <label for="ddlSituacao" title="Turma" class="lblObrigatorio">
                Situação</label>
            <asp:DropDownList ID="ddlSituacao" runat="server" CssClass="ddlTurma" ToolTip="Selecione a Turma">
           
            </asp:DropDownList>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddlSituacao" ErrorMessage="A situação deve ser informado"
                Display="None"></asp:RequiredFieldValidator>
        </li>
        </ContentTemplate>
        </asp:UpdatePanel>
