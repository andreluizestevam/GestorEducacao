<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    Inherits="C2BR.GestorEducacao.UI.GEDUC.F2000_CtrlOperSecretariaEscolar.F2100_CtrlServSecretariaEscolar.F2107_MatriculaAluno.ExclusaoMatricula.Cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <div id="div1" class="bar">
        <div id="divBarraComoChegar" class="boxRoundCorner" style="border-radius: 10px 10px 10px 10px;">
            ...
            <ul id="ulExcluirCancelar" style="width: 39px;">
                <li id="btnExcluir">
                    <asp:LinkButton ID="btnDelete" CssClass="btnDelete" runat="server" OnClick="btnDelete_Click">
    ...
    <ul id="ulDados" class="ulDados">
        ...
        <li class="liLeft">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlAlunos"
