<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoBuscas.Master" AutoEventWireup="true" CodeBehind="Busca.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F2000_CtrlOperSecretariaEscolar.F2100_CtrlServSecretariaEscolar.F2101_SolicitacaoItensSecretaria.AnaliseSolicitacaoServicos.Busca" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 <style type="text/css">
     /*--> CSS DADOS */
    .ddlSolicitacoes {width: 255px;} 
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ul id="ulParamsFormBusca" class="ulParamsFormBusca">
        ...
        <li>
            ...
            <asp:DropDownList ID="ddlSolicitacoes" runat="server" CssClass="ddlSolicitacoes" AutoPostBack="True">
            </asp:DropDownList>
        </li>
    </ul>
</asp:Content>
