<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master"
    AutoEventWireup="true" CodeBehind="DemonEnvioEmail.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3050_CtrlEmail._3059_Relatorios.DemonEnvioEmail" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <li id="liModalidade" runat="server" class="liModalidade">
                    ...
                    <asp:DropDownList ID="ddlModalidade" ToolTip="Selecione uma Modalidade" runat="server"
                        Width="130px" AutoPostBack="true" OnSelectedIndexChanged="ddlModalidade_SelectedIndexChanged"
                ...
                <li id="liSerie" runat="server" class="liSerie">
                    ...
                    <asp:DropDownList ID="ddlSerieCurso" ToolTip="Selecione uma Série/Curso" runat="server"
                        Width="110px" AutoPostBack="true" OnSelectedIndexChanged="ddlSerieCurso_SelectedIndexChanged"
                        CssClass="clear">
                    </asp:DropDownList>
                </li>
                <li id="liTurma" class="liTurma" runat="server">
                    <label title="Turma">Turma</label>
                ...
                <li id="liAlun" runat="server">
                    <label title="Selecione o Aluno para visualização no relatório">Aluno</label>
                    <asp:DropDownList runat="server" ID="ddlAluno" ToolTip="Selecione o Aluno para visualização no relatório"
                        Width="230px" OnSelectedIndexChanged="ddlAluno_SelectedIndexChanged" AutoPostBack="true">
                    </asp:DropDownList>
                </li>
                <li style="margin-bottom: 10px;" id="liResponsavel" runat="server">
                    <label title="Selecione o Responsável para visualização no relatório">Responsável</label>
                    <asp:DropDownList runat="server" ID="ddlResponsavel" ToolTip="Selecione o Responsável para visualização no relatório" Width="230px">
                    </asp:DropDownList>
                </li>
                <li class="liPeriodo">
