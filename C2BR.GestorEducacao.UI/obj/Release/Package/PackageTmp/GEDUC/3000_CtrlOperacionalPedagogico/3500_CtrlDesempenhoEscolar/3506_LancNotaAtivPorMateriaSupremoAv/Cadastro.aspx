<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3500_CtrlDesempenhoEscolar._3506_LancNotaAtivPorMateriaSupremoAv.Cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <ul id="ulDados" class="ulDados">
        ...
        <li class="liClear" style="margin-left: -60px">
            <li style="float: right; margin:5px 5px 2px 0">
                <label>
            ...
            <div id="divGrid" runat="server" class="divGrid">
                <asp:GridView ID="grdBusca" CssClass="grdBusca" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="AV1 / SIMUL">
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="txtNotaAv1" CssClass="mascaradecimal" runat="server" Text='<%# bind("NOTA_AV1") %>'  Enabled='<%# bind("MEDIA_HOMOLOGADA") %>'></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="AV2 / DATA">
                            <ItemStyle HorizontalAlign="Center" Width="80px" />
                            <HeaderStyle HorizontalAlign="Center" />
                            <HeaderTemplate>
                                <ul style="text-align: center;">
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="txtNotaAv2" CssClass="mascaradecimal" runat="server" Text='<%# bind("NOTA_AV2") %>'  Enabled='<%# bind("MEDIA_HOMOLOGADA") %>'></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="AV3 / DATA">
                            <ItemStyle HorizontalAlign="Center" Width="80px" />
                            <HeaderStyle HorizontalAlign="Center" />
                            <HeaderTemplate>
                                <ul style="text-align: center;">
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="txtNotaAv3" CssClass="mascaradecimal" runat="server" Text='<%# bind("NOTA_AV3") %>'  Enabled='<%# bind("MEDIA_HOMOLOGADA") %>'></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="AV4 / DATA">
                            <ItemStyle HorizontalAlign="Center" Width="80px" />
                            <HeaderStyle HorizontalAlign="Center" />
                            <HeaderTemplate>
                                <ul style="text-align: center;">
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="txtNotaAv4" CssClass="mascaradecimal" runat="server" Text='<%# bind("NOTA_AV4") %>'  Enabled='<%# bind("MEDIA_HOMOLOGADA") %>'></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="AV5 / DATA">
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="txtNotaAv5" CssClass="mascaradecimal" runat="server" Text='<%# bind("NOTA_AV5") %>'  Enabled='<%# bind("MEDIA_HOMOLOGADA") %>'></asp:TextBox>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $(".mascaradecimal").maskMoney({ symbol: "", decimal: ",", thousands: ".", precision: 1 });
        });
