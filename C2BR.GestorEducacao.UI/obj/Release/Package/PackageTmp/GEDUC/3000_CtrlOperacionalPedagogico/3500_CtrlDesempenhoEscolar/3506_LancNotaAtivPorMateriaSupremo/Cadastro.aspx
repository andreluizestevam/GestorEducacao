<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3500_CtrlDesempenhoEscolar._3506_LancNotaAtivPorMateriaSupremo.Cadastro" %>
    ...
    <ul id="ulDados" class="ulDados">
        ...
        <li>
            <label for="ddlBimestre" class="lblObrigatorio" title="Classificação">
                Classificação</label>
            <asp:DropDownList ID="ddlClassi" CssClass="ddlClassi" runat="server" ToolTip="Selecione a Classificação" Width="106px">
                <asp:ListItem Value="">Selecione</asp:ListItem>
                <asp:ListItem Value="AV1">AV1 - Avaliação 1</asp:ListItem>
                <asp:ListItem Value="AV2">AV2 - Avaliação 2</asp:ListItem>
                <asp:ListItem Value="AV3">AV3 - Avaliação 3</asp:ListItem>
                <asp:ListItem Value="AV4">AV4 - Avaliação 4</asp:ListItem>
                <asp:ListItem Value="AV5">AV5 - Avaliação 5</asp:ListItem>
            </asp:DropDownList>
        ...
        <li>
            <label title="Grava a mesma nota lançada ao aluno em todas as Disciplinas">
                Lancto TM</label>
            <asp:DropDownList runat="server" ID="ddlLanctoTM" ToolTip="Grava a mesma nota lançada ao aluno em todas as Disciplinas" Width="50px" OnSelectedIndexChanged="ddlLanctoTM_OnSelectedIndexChanged" AutoPostBack="true">
