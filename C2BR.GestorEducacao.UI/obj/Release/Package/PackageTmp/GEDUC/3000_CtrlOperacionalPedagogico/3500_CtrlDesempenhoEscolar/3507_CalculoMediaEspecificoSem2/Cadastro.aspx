<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3500_CtrlDesempenhoEscolar._3507_CalculoMediaEspecificoSem2.Cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <div id="divMensEfe" style="display: none; position: absolute; left: 50%; right: 50%;
        ...
        <p id="pEfeM" clientidmode="Static" style="color: #6495ED; font-weight: bold; text-align:center;"></p>
    ...
    <div id="div1" class="bar">
        <div id="divBarraLanctoExameFinal" class="boxRoundCorner" style="border-radius: 10px 10px 10px 10px;">
            ...
            <ul id="ulGravar">
                <li>
                    <asp:LinkButton ID="btnSave" runat="server" OnClick="btnSave_Click" ClientIDMode="Static" OnClientClick="geraPadrao(this);">
    ...
    <ul id="ulDados" class="ulDados">
        ...
        <li style="clear: both; margin-left: 90px">
        ...
        <li style="margin-top:13px; margin-right:10px !important;">
            <asp:CheckBox runat="server" ID="chkCalculAgrupadora" class="chk" Text="Média de Agrupadoras" ToolTip="Calcula a Média da(s) Disciplinas agrupadoras apartir das médias lançadas nas disciplinas associadas."/>
        </li>
        <li class="liPesqAtiv">
            <asp:LinkButton ID="btnPesqGride" runat="server" OnClick="btnPesqGride_Click" ValidationGroup="vgBtnPesqGride" ClientIDMode="Static" OnClientClick="geraPadrao(this);__doPostBack('btnPesqGride', '')">
                ...
                <asp:GridView ID="grdBusca" CssClass="grdBusca" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="NOTA">
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="txtNota1" CssClass="txtNota" runat="server" Text='<%# bind("NTBIM_VALID") %>'
                                ...
                                <asp:HiddenField runat="server" ID="hidAgrupadora" Value='<%# bind("FL_AGRUPADORA_V") %>' />
                                <asp:HiddenField runat="server" ID="hidCoMatAgrupadora" Value='<%# bind("ID_AGRUP_MATER") %>' />
                                <asp:HiddenField runat="server" ID="hidNotaBim1" Value='<%# bind("hdNota1Aux_Valid") %>' />
                                <asp:HiddenField runat="server" ID="hidNtMDB1" Value='<%# bind("NTMediaBim1") %>' />
                                <asp:HiddenField runat="server" ID="hidNTMDB3" Value='<%# bind("NTMediaBim2") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="RECUP">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtRecup" CssClass="txtNota" runat="server" Text='<%# bind("NTRECUP_VALID") %>'
                                    Enabled="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="MD BIM">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtMedBim" CssClass="txtNota" runat="server" Text='<%# bind("MEDBIM_VALID") %>'
                                    Enabled="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="MD SEM">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtMedSem" CssClass="txtNota" runat="server" Text='<%# bind("MEDSEM_VALID") %>'
                                    Enabled="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="SIMUL">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtNota3" CssClass="txtNota" runat="server" Text='<%# bind("NOTA3") %>'
                                    Enabled="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="SM EXT">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtNotaS" CssClass="txtNota" runat="server" Text='<%# bind("NOTA_SIMU") %>'
                                    Enabled="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
