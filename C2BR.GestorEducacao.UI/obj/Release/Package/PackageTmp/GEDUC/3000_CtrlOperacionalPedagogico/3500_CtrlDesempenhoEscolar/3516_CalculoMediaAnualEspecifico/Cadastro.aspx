<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3500_CtrlDesempenhoEscolar._3516_CalculoMediaAnualEspecifico.Cadastro" %>
    ...
    <ul id="ulDados" class="ulDados">
        ...
        <li class="liEspaco">
            ...
            <asp:DropDownList ID="ddlModalidade" ToolTip="Selecione a Modalidade" CssClass="campoModalidade"
                runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlModalidade_SelectedIndexChanged" Width="150px">
            </asp:DropDownList>
        ...
        <li class="liEspaco">
            ...
            <asp:DropDownList ID="ddlTurma" ToolTip="Selecione a Turma" CssClass="campoTurma"
                runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlTurma_SelectedIndexChanged" Width="140px">
            </asp:DropDownList>
        ...
        <li style="clear: both; margin-left: 110px;">
            ...
            <div id="divGrid" runat="server" class="divGrid">
                <asp:GridView ID="grdBusca" CssClass="grdBusca" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="MDB1">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtNota1" CssClass="txtNota" runat="server" Text='<%# bind("media1") %>'
                                    Enabled="false"></asp:TextBox>
                                <asp:HiddenField runat="server" ID="hidCoMat" Value='<%# bind("CO_MAT") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="MDB2">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtNota2" CssClass="txtNota" runat="server" Text='<%# bind("media2") %>'
                                    Enabled="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="SEM1">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtSem1" CssClass="txtNota" runat="server" Text='<%# bind("sem1") %>'
                                    Enabled="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="MDB3">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtNota3" CssClass="txtNota" runat="server" Text='<%# bind("media3") %>'
                                    Enabled="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="MDB4">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtNota4" CssClass="txtNota" runat="server" Text='<%# bind("media4") %>'
                                    Enabled="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="SEM2">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtSem2" CssClass="txtNota" runat="server" Text='<%# bind("sem2") %>'
                                    Enabled="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="" HeaderText="">
                        ...
                        <asp:TemplateField HeaderText="MÉDIA FINAL">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtMediaFinal" CssClass="txtNota" runat="server" Text='<%# bind("vlMediaFinal") %>'
                                    Enabled="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
