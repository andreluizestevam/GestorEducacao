<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F3000_CtrlOperacionalPedagogico.F3500_CtrlDesempenhoEscolar.F3510_LancNotaProvaFinal.Cadastro" %>
                ...
                <asp:GridView ID="grdBusca" CssClass="grdBusca" runat="server" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="NOTA">
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="txtNota" CssClass="mascaradecimal" runat="server" Text='<%# bind("NOTA") %>' Enabled='<%# bind("ENABLED") %>'></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
