<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master" AutoEventWireup="true" CodeBehind="RelacAlunosRecuperacaoBimestral.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3500_CtrlDesempenhoEscolar._3599_Relatorios.RelacAlunosRecuperacaoBimestral" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ul id="ulDados" class="ulDados">
        ...
        <li class="liAluno">
            <label class="lblObrigatorio" title="Categoria">
                Categoria</label>               
            <asp:DropDownList ID="ddlCategoria" CssClass="ddlCategoria" runat="server"
                ToolTip="Selecione a Categoria">
                <asp:ListItem Text="Todos" Value="T"></asp:ListItem>
                <asp:ListItem Text="Com Recuperação" Value="R"></asp:ListItem>
                <asp:ListItem Text="Sem Recuperação" Value="S"></asp:ListItem>
            </asp:DropDownList>    
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="validatorField"
                ControlToValidate="ddlCategoria" Text="*" 
                ErrorMessage="Campo Categoria é requerido" SetFocusOnError="true"></asp:RequiredFieldValidator>                 
        </li>                                  
    </ul>
</asp:Content>
