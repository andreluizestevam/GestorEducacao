<%@ Page Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master" AutoEventWireup="true" CodeBehind="BoletEscolSimplesModelo2.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F3000_CtrlOperacionalPedagogico.F3500_CtrlDesempenhoEscolar.F3599_Relatorios.BoletEscolSimplesModelo2" Title="Untitled Page" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ul id="ulDados" class="ulDados">
        ...
        <li class="liModalidade">
            <label for="ddlBimestre"  title="Bimestre">Bimestre</label>
        ...
        <li class="liAluno" style="margin-top: 10px;">
            <asp:CheckBox CssClass="chkLocais" ID="chkFlagFoto" Checked="true" TextAlign="Right" runat="server" Text="Incluir foto no boletim?"/>                                
        </li>                               
    </ul>
</asp:Content>
