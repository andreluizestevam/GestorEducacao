<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3500_CtrlDesempenhoEscolar._3512_CalculoMediaBarao.Cadastro" %>
            ...
            <div id="divGrid" runat="server" class="divGrid">
                <asp:GridView ID="grdBusca" CssClass="grdBusca" runat="server" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="AV. FORMAL">
                        ...
                        <asp:TemplateField HeaderText="PARTICULAR">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtPartPM" CssClass="txtNota" runat="server" Text='<%# bind("NOTA2") %>' Enabled="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="AUTO AVALIAÇÃO">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtNota2" CssClass="txtNota" runat="server" Text='<%# bind("NOTA3") %>' Enabled="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="FORMATIVA">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtPartPB" CssClass="txtNota" runat="server" Text='<%# bind("NOTA4") %>' Enabled="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="SIMULADO">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtNota3" CssClass="txtNota" runat="server" Text='<%# bind("NOTA5") %>' Enabled="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="PROVA TEMÁTICA">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtNotaS" CssClass="txtNota" runat="server" Text='<%# bind("NOTA6") %>' Enabled="false"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="MÉDIA">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hidMediaAgr" runat="server" Value='<%# bind("NOTAAGR") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
