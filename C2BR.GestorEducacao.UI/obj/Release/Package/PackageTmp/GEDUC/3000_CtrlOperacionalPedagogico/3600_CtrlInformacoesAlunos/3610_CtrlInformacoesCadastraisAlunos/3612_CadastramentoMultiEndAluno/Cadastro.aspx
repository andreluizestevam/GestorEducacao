<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F3000_CtrlOperacionalPedagogico.F3600_CtrlInformacoesAlunos.F3610_CtrlInformacoesCadastraisAlunos.F3612_CadastramentoMultiEndAluno.Cadastro" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        ...
        .liBairro, .liUF { margin-top: -5px !important; }
        .liEndereco
        {
            clear: both;
            margin-bottom: 5px;
        ...
        /*--> CSS DADOS */
        .ddlAluno { width: 254px; }
        .ddlTipoEndereco { width: 118px; }
        ...
        .txtLogradouro { width: 150px; }
        .txtComplemento { width: 110px; }
        .ddlCidade { width: 178px; }
        .ddlBairro { width: 150px; }
        .txtNumero { width: 40px; }
        .ddlSituacao { width: 70px; }
        .ddlPrincipal { width: 50px; }
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <ul class="ulDados">
        ...
        <li>
            ...
            <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlTipoEndereco" ErrorMessage="Tipo de Endereço deve ser informado"
                Display="None">
            </asp:RequiredFieldValidator>
        </li>
        <li class="liEndereco">
            <fieldset class="fldEndereco">
                <ul>
                    <li>
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtLogradouro" ErrorMessage="Logradouro deve ser informado"
                    ...
                    <li>
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtCep" ErrorMessage="CEP deve ser informado"
                            Display="None" CssClass="validatorField"> </asp:RequiredFieldValidator>
                    </li>
                    <li class="liCidade">
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlCidade" ErrorMessage="Cidade deve ser informada"
                            Display="None" CssClass="validatorField"> </asp:RequiredFieldValidator>
                    </li>
                    <li class="liBairro">
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlBairro" ErrorMessage="Bairro deve ser informado"
                            Display="None" CssClass="validatorField"> </asp:RequiredFieldValidator>
                    </li>
                    <li class="liUF">
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlUf" ErrorMessage="UF deve ser informado"
                            Display="None" CssClass="validatorField"> </asp:RequiredFieldValidator>
                    </li>
                    </ContentTemplate>
                    </asp:UpdatePanel>
