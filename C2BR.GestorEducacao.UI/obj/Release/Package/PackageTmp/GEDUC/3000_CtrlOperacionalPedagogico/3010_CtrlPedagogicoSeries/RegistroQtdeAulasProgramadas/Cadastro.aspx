<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F3000_CtrlOperacionalPedagogico.F3010_CtrlPedagogicoSeries.RegistroQtdeAulasProgramadas.Cadastro" %>
...
<asp:ScriptManager ID="ScriptManager2" runat="server">
    ...
    <ul id="ul1" class="ulDados">
        <li class="liClear" style="width: 100%; text-align: center;"><span style="color:#3366FF; font-size:1.3em;font-weight:bold;">Planejamento Aulas Programadas</span></li>            

        <li class="liClear" style="margin-top: 2px; margin-left: 353px;">
            <label for="txtTipoCtrlPlaneFinan" style="float:left;" title="Tipo de Controle de Planejamento">Por</label>                        
        ...
        <li class="liClear" style="margin-top: 22px; margin-right: 0px; width: 100%; margin-left: 10px;">
            <ul>
                <li style="border-right: 1px solid #CCCCCC; padding-right: 10px; height: 180px;">
                    <ul>                                                    
                        <li class="liPlanejFinan" style="width: 331px; background-color: #006699; color: White; margin-bottom: 3px;"><span style="font-size: 1.0em;text-transform:uppercase;font-weight:bold;">Planejamento Aulas Programadas</span></li>                                                
                        <li style="margin-top: -10px;">
                            <label class="lblObrigatorio" title="Ano de Referência">ANO</label>
                            <asp:DropDownList ID="ddlAno" runat="server" CssClass="ddlAno" ToolTip="Informe o Ano">
                            </asp:DropDownList>
                        ...
                        <li class="liClear">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="ddlModalidade"
                        ...
                        <li style="margin-left: 10px;">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="ddlSerieCurso"
                        ...
                        <li class="liClear" style="margin-top: 5px;">
                            <label for="ddlMateria" class="lblObrigatorio" title="Matéria">Matéria</label>
                            <asp:DropDownList ID="ddlMateria" runat="server" CssClass="ddlMateria" ToolTip="Selecione a Matéria">
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="ddlMateria"
                                CssClass="validatorField" ErrorMessage="Matéria deve ser informada" Text="*" Display="Static"></asp:RequiredFieldValidator>
                        </li>
                        </ContentTemplate>
                        </asp:UpdatePanel>
                    </ul>
                ...
                <li style="padding-left: 20px;">
                    <ul>        
                        ...
                        <ContentTemplate>                    
                        <li class="liPlanejFinan" style="width: 285px; text-align:left; padding-left: 7px; background-color: #F0F0FF;"><span style="font-size: 1.0em;text-transform:uppercase;font-weight:bold;">Quantidade Aulas Mês</span></li>
