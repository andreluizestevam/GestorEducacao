<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master"
    AutoEventWireup="true" CodeBehind="DemonEnvioEmailPaci.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3070_CtrlEmailSaude._3079_Relatorios.DemonEnvioEmailPaci" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>                
                <li id="liAlun" runat="server">
                    <label title="Selecione o Paciente para visualização no relatório">Pacientes</label>
                    <asp:DropDownList runat="server" ID="ddlParce" ToolTip="Selecione o Paciente para visualização no relatório"
                        Width="230px" >
                    </asp:DropDownList>
                </li>
                <li class="liPeriodo">
