<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master"
    AutoEventWireup="true" CodeBehind="DarioBimestralSupremo.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3400_CtrlFrequenciaEscolar._3499_Relatorios._3499_ModelosDiarios.DarioBimestralSupremo" %>
            ...
            <ContentTemplate>
                ...
                <li class="liTipo">
                    <label class="lblObrigatorio" title="Layout">
                        Layout</label>
                    <asp:DropDownList ID="ddlTipo" CssClass="ddlTipo" OnSelectedIndexChanged="ddlTipo_SelectedIndexChanged"   AutoPostBack="true" runat="server" ToolTip="Selecione o Tipo de Layout">
                ...
                <li class="liTipo" style="margin-left:-10px;">
                    ...
                    <asp:DropDownList runat="server" ID="ddlTipoDiario" ToolTip="Selecione o tipo de diário que deseja imprimir"  Width="164px">
