<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master"
    AutoEventWireup="true" CodeBehind="DiarioBimestralEspecifico.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3400_CtrlFrequenciaEscolar._3499_Relatorios._3499_ModelosDiarios.DiarioBimestralEspecifico" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        ...
        .liAnoRefer, .liTurma, .liReferencia
        {
            clear: both;
            margin-top: 5px;
        }
            ...
            <ContentTemplate>
                ...
                <li class="liBimestre">
                    ...
                    <asp:DropDownList ID="ddlReferencia" CssClass="ddlReferencia" ToolTip="Selecione a Referência em que a frequência será lançada"
                        runat="server" OnSelectedIndexChaged="ddlReferencia_SelectedIndexChanged" AutoPostBack="true">   
                    </asp:DropDownList>
                ...
                <li class="liTipo">
                    <label class="lblObrigatorio" title="Layout">
                        Layout</label>
                    <asp:DropDownList ID="ddlTipo" CssClass="ddlTipo" runat="server" ToolTip="Selecione o Tipo de Layout" OnSelectedIndexChanged="ddlTipo_SelectedIndexChanged"
                        AutoPostBack="true">
                ...
                <li class="liTipo" style="margin-left:-10px;">
                    <label title="Selecione o tipo de diário que deseja imprimir">
                        Tipo de Diário</label>
                    <asp:DropDownList runat="server" ID="ddlTipoDiario" ToolTip="Selecione o tipo de diário que deseja imprimir"
                        Width="164px">
                        <asp:ListItem Text="Impressão Completa" Value="1"></asp:ListItem>
                        <asp:ListItem Text="Impressão sem Folha Resumo" Value="2"></asp:ListItem>
                        <asp:ListItem Text="Impressão apenas Folha Resumo" Value="3"></asp:ListItem>
                    </asp:DropDownList>
                </li>
