<%@ Page Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true"
    CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3060_CtrlEmailInstitucional._3061_EnvioDeEmailInstitucional.Cadastro" %>
        ...
        <ContentTemplate>
            <ul id="ulDados" class="ulDados contentCenter">
                <ul>
                    <ul class="ulBuscar">
                        <li class="liClear">
                            ...
                            <asp:DropDownList ID="rblTipoEmail" OnSelectedIndexChanged="rblTipoEmail_SelectedChanged" ToolTip="Selecione para quem quer enviar o email" CssClass="rblTipoEmail" runat="server"
                                ...
                                <asp:ListItem Text="Colaborador" Value="C" />
                                <asp:ListItem Text="Parceiro" Value="P" />--%>
                            </asp:DropDownList>
                        </li>
                    ...
                    <li class="liGrid">
                        <div id="divGridC" runat="server" class="divGrid grdColaborador">
                            <asp:GridView ID="grdColaborador" runat="server" CssClass="grdBusca" Width="100%"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="CPF_C" HeaderText="CPF" HeaderStyle-CssClass="th">
                                        <ItemStyle Width="40px" />
                                    </asp:BoundField>
                                    <asp:TemplateField HeaderText="Nome" ControlStyle-CssClass="thNome">
                                        <ItemTemplate>
                                            <asp:Label ID="txtNomeCol"  CssClass="txtResponsavel" runat="server" Text='<%# bind("NOME_C") %>'>
                                            </asp:Label>
                                            <asp:HiddenField ID="hdCoCol" runat="server" Value='<%# bind("CO_COL") %>' />
                                            <asp:HiddenField ID="hdCoEmp" runat="server" Value='<%# bind("CO_EMP") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Função" ControlStyle-CssClass="thFunc">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:Label ID="txtFuncao" CssClass="txtResponsavel" runat="server" Text='<%# bind("FUNCAO_C") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Departamento" ControlStyle-CssClass="thDepart">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:Label ID="txtDepart" CssClass="txtResponsavel" runat="server" Text='<%# bind("DEPART_C") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Telefone" ControlStyle-CssClass="thTel">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:Label ID="txtTelefone" CssClass="txtResponsavel" runat="server" Text='<%# bind("TELEFONE_C") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Email" ControlStyle-CssClass="thEmail">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtEmail" CssClass="txtResponsavel" runat="server" Text='<%# bind("EMAIL_C") %>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                    ...
                    <li class="liGrid">
                        <div id="divGridP" runat="server" class="divGrid grdParceiro">
                            <asp:GridView ID="grdParceiro" runat="server" CssClass="grdBusca" Width="100%" AutoGenerateColumns="False"
                                GridLines="Vertical">
                                <AlternatingRowStyle CssClass="alternatingRowStyle" />
                                <EmptyDataRowStyle CssClass="emptyDataRowStyle" />
                                <EmptyDataTemplate>
                                ...
                                <Columns>
                                    <asp:BoundField DataField="COD_P" HeaderText="CPF/CNPJ" HeaderStyle-CssClass="th">
                                        <ItemStyle Width="40px" />
                                    </asp:BoundField>
                                    <asp:TemplateField HeaderText="TIPO" ControlStyle-CssClass="th">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:Label ID="txtTIPO" CssClass="txtResponsavel" runat="server" Text='<%# bind("DESC_TIPO") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Nome" ControlStyle-CssClass="thNome">
                                        <ItemTemplate>
                                            <asp:Label ID="txtNomeParce" CssClass="txtResponsavel" runat="server" Text='<%# bind("NOME_P") %>'>
                                            </asp:Label>
                                            <asp:HiddenField ID="hdCoParce" runat="server" Value='<%# bind("CO_PARCE") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Responsável" ControlStyle-CssClass="thNome">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:Label ID="txtResp" CssClass="txtResponsavel" runat="server" Text='<%# bind("RESP_P") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Telefone" ControlStyle-CssClass="thTel">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:Label ID="txtTelefone" CssClass="txtResponsavel" runat="server" Text='<%# bind("TELEFONE_P") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Email" ControlStyle-CssClass="thEmail">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtEmail" CssClass="txtResponsavel" runat="server" Text='<%# bind("EMAIL_P") %>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="">
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chcSelecionarEmail" runat="server" AutoPostBack="True" ToolTip="Selecione o Parceiro"
                                                Checked="false" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
