<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F6000_CtrlProcessosInternos.F6200_CtrlOperMateriais.F6230_CtrlOperacionalItensEstoque.F6234_CadastroFornecedorProdServ.Cadastro" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    .liNome{clear: both; margin-left: 185px; margin-bottom: 20px !important;}
    .liRazaoSocial{clear: both; margin-left: 185px; }
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <li class="liUnidade">
        <ul>
            ...
            <li>
                <label for="ddlTipo" title="Tipo de Fornecedor">Tipo</label>
                <asp:DropDownList ID="ddlTipo" ToolTip="Selecione o Tipo de Fornecedor" CssClass="ddlTipo" runat="server" onchange="SetCpfCnpj(this);">
            ...
            <li id="liInscEstadual">
                ...
                <asp:TextBox ID="txtInscEstadual" ToolTip="Informe a Inscrição Estadual" MaxLength="20" runat="server"></asp:TextBox>
            </li>
            <li class="liRazaoSocial">
                ...
                <asp:TextBox ID="txtRazaoSocial" ToolTip="Informe a Razão Social" CssClass="txtRazaoSocial" MaxLength="100" runat="server"></asp:TextBox>
            ...
            <li class="liNome">
                ...
                <asp:TextBox ID="txtNome" ToolTip="Informe o Nome da Unidade" CssClass="txtNome" MaxLength="100" runat="server"></asp:TextBox>
    ...
    <li class="liPessoaContato">
        <fieldset class="fldPessoaContato">
            ...
            <ul>
                <li>
                    <label for="txtNomeContato" title="Nome do Contato">Contato</label>
                ...
                <li>
                    <label for="txtCargoContato" title="Função/Cargo do Contato">Função/Cargo</label>
                ...
                <li class="liClear">
                    <label for="txtTelFixoContato" title="Telefone Fixo do Contato">Telefone Fixo</label>
                ...
                <li class="liTelCelularContato">
                    <label for="txtTelCelularContato" title="Telefone Celular do Contato">Telefone Celular</label>
                ...
                <li>
                    <label for="txtEmailContato" title="E-mail do Contato">E-mail</label>
        ...
        <fieldset class="fldObservacao">
            ...
            <ul>
                <li>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtObservacao" ErrorMessage="Obsevação deve ter no máximo 150 caracteres" 
        ...
        <fieldset class="fldSituacao">
            ...
            <ul>
                ...
                <li>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="ddlStatus" ErrorMessage="Status deve ser informado" Display="None"></asp:RequiredFieldValidator>
                </li>
                <li>
