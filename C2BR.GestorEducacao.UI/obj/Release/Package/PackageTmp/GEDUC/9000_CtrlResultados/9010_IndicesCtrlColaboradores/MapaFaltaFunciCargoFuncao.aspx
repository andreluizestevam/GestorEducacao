<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="MapaFaltaFunciCargoFuncao.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F9000_CtrlResultados.F9010_IndicesCtrlColaboradores.MapaFaltaFunciCargoFuncao" %>
...
<style type="text/css">      
    ...
    .divGrid { height: 308px; overflow-y:auto; width: 572px; border: 1px solid #D2DFD1;}
...
<ul id="ulDados" class="ulDados">        
        ...
        <li style="margin-left: 9px;" id="liGridMFFCF" runat="server" clientidmode="Static" visible="false">
            <ul>
                <li style="margin-left: 175px;"><label style="text-transform:uppercase;">-------------------------------------------- MESES --------------------------------------------</label></li>
                <li>
                    <div id="divGrid" runat="server" class="divGrid">
                        <asp:GridView ID="grdResulParam" CssClass="grdBusca" Width="550px" runat="server" AutoGenerateColumns="False">
                            ...
                            <Columns>
                                <asp:BoundField DataField="NO_FUN" HeaderText="Cargo/Função">
                ...
                <li style="width:170px;margin-right: 0px;visibility:hidden;">
                    <label>Total</label>
                </li> 
                ...
                <li class="liTotais" style="width:40px;visibility:hidden;">
                    <asp:Label ID="lblTotal" runat="server"></asp:Label>
                </li>   
            </ul>
        </li>
        <li style="clear:none; margin-left: 10px; margin-right: 0px;" id="liLegMFFCF" runat="server" clientidmode="Static" visible="false">
