<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="MapaDistColUnidEsc.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F9000_CtrlResultados.F9010_IndicesCtrlColaboradores.MapaDistColUnidEsc" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<style type="text/css">      
    .ulDados { width: 975px;margin-top: 20px !important;}
    .ulDados input{ margin-bottom: 0;}   
    .ulDados label {clear:none !important;}
    
    /*--> CSS LIs */
    .ulDados li{ margin-bottom: 5px; margin-right: 5px;clear:both;}   
    .liBairro, .liCidade {clear:none !important; display:inline !important;margin-left:10px;}    
    .liBtnAnaRecPag
    {
    ...
    /*--> CSS DADOS */
    .ddlCidade { width: 165px; }
    .ddlBairro { width: 145px; }
    .ddlTpUnidade { width: 165px; }
    .imgliLnk { width: 15px; height: 13px; }    
    .divGrid { height: 308px; overflow-y:auto; width: 600px; border: 1px solid #D2DFD1;}    
...
<ul id="ulDados" class="ulDados">  
        <li style="margin-left: 205px;">
            ...
            <asp:DropDownList ID="ddlTpUnidade" ToolTip="Selecione o Tipo de Unidade" CssClass="ddlTpUnidade" runat="server">
            </asp:DropDownList>     
        </li>  
        <li class="liCidade">
            <label id="Label1" class="lblObrigatorio" title="Cidade">
                Cidade</label>
            <asp:DropDownList ID="ddlCidade" ToolTip="Selecione a Cidade" AutoPostBack="true" OnSelectedIndexChanged="ddlCidade_SelectedIndexChanged"
                CssClass="ddlCidade" runat="server">
            </asp:DropDownList>     
        </li>
        <li class="liBairro">
            <label id="Label2" class="lblObrigatorio" title="Bairro">
                Bairro</label>
            <asp:DropDownList ID="ddlBairro" ToolTip="Selecione o Bairro" 
        ...
        <li style="margin-left: 13px;" id="liGridMDCUE" runat="server" clientidmode="Static" visible="false">
            <ul>
                <li style="margin-left: 258px;"><label style="text-transform:uppercase;">---------------------------- SITUAÇÃO FUNCIONAL ----------------------------</label></li>
                <li>
                    <div id="divGrid" runat="server" class="divGrid">
                        <asp:GridView ID="grdResulParam" CssClass="grdBusca" Width="580px" runat="server" AutoGenerateColumns="False">
                ...
                <li style="width:258px;margin-right: 0px;visibility:hidden;">
                    <label>Total</label>
                </li> 
        ...
        <li style="clear:none; margin-left: 10px; margin-right: 0px;" id="liLegMDCUE" runat="server" clientidmode="Static" visible="false">
