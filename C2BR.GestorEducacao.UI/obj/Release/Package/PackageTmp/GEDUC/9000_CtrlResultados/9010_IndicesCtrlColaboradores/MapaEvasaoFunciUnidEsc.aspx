<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="MapaEvasaoFunciUnidEsc.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F9000_CtrlResultados.F9010_IndicesCtrlColaboradores.MapaEvasaoFunciUnidEsc" %>
...
<ul id="ulDados" class="ulDados">        
        ...
        <li style="margin-left: 7px;" id="liGridMEFUE" runat="server" clientidmode="Static" visible="false">
            <ul>
        ...
        <li style="clear:none; margin-left: 10px; margin-right: 0px;" id="liLegMEFUE" runat="server" clientidmode="Static" visible="false">
