<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="MapaDesMatAnoUniEsc.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F9000_CtrlResultados.F9020_IndicesCtrlPedagogico.MapaDesMatAnoUniEsc" %>
...
<style type="text/css">      
    ...
    .divGrid { height: 220px; overflow-y:auto; overflow-x:auto; width: 696px; border: 1px solid #D2DFD1;}    
    .imgFixIII { width: 240px; }
...
<ul id="ulDados" class="ulDados">  
        ...
        <li class="liUnidadeEscolar">
            <label class="lblObrigatorio" title="Modalidade de Ensino">
                Modalidade</label>
            <asp:DropDownList ID="ddlModalidade" ToolTip="Selecione a Modalidade de Ensino" CssClass="ddlModalidade" runat="server">
            </asp:DropDownList>    
        </li>     
        <li class="liUnidadeEscolar">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" CssClass="validatorField"
                runat="server" ControlToValidate="ddlAnoRefer" ErrorMessage="Ano Letivo deve ser informado"
        ...
        <ul>
            <li style="margin-left: 300px;"><label style="text-transform:uppercase;">------------------------------------ MATÉRIAS ------------------------------------</label></li>
            <li style="margin-left: 5px;">
                <div id="divGrid" runat="server" class="divGrid">
                    <asp:GridView ID="grdResulParam" CssClass="grdBusca" Width="1055px" runat="server" AutoGenerateColumns="False">
         ...
         <li style="clear:none; margin-left: 10px; margin-right: 0px;" id="liLegMCFF" runat="server" clientidmode="Static" visible="false">
            <ul>
                ...
                <li style="padding-left: 2px; color:#838B83;width: 130px;">
                    ...
                    <asp:Label runat="server" id="lblS1" style="clear:none;width:83px;float:left;"/>
                    <asp:Label runat="server" id="lblSig2" style="width:40px;clear: both;float:left;"/>
                    <asp:Label runat="server" id="lblS2" style="clear:none;width:83px;float:left;"/>
                    <asp:Label runat="server" id="lblSig3" style="width:40px;clear: both;float:left;" />
                    <asp:Label runat="server" id="lblS3" style="clear:none;width:83px;float:left;"/>
                    <asp:Label runat="server" id="lblSig4" style="width:40px;clear: both;float:left;"/>
                    <asp:Label runat="server" id="lblS4" style="clear:none;width:83px;float:left;"/>
                    <asp:Label runat="server" id="lblSig5"  style="width:40px;clear: both;float:left;"/>
                    <asp:Label runat="server" id="lblS5" style="clear:none;width:83px;float:left;"/>
                    <asp:Label runat="server" id="lblSig6" style="width:40px;clear: both;float:left;"/>
                    <asp:Label runat="server" id="lblS6" style="clear:none;width:83px;float:left;"/>
                    <asp:Label runat="server" id="lblSig7"  style="width:40px;clear: both;float:left;"/>
                    <asp:Label runat="server" id="lblS7" style="clear:none;width:83px;float:left;"/>
                    <asp:Label runat="server" id="lblSig8"  style="width:40px;clear: both;float:left;"/>
                    <asp:Label runat="server" id="lblS8" style="clear:none;width:83px;float:left;"/>
                    <asp:Label runat="server" id="lblSig9" style="width:40px;clear: both;float:left;"/>
                    <asp:Label runat="server" id="lblS9" style="clear:none;width:83px;float:left;"/>
                    <asp:Label runat="server" id="lblSig10" style="width:40px;clear: both;float:left;"/>
                    <asp:Label runat="server" id="lblS10" style="clear:none;width:83px;float:left;"/>
                    <asp:Label runat="server" id="lblSig11" style="width:40px;clear: both;float:left;"/>
                    <asp:Label runat="server" id="lblS11" style="clear:none;width:83px;float:left;"/>
                    <asp:Label runat="server" id="lblSig12" style="width:40px;clear: both;float:left;"/>
                    <asp:Label runat="server" id="lblS12" style="clear:none;width:83px;float:left;"/>
                </li>
            </ul>
        </li>        
</ul>
