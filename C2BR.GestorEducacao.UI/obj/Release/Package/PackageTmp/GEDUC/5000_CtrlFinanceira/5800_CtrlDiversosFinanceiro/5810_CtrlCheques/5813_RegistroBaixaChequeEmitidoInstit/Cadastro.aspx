<%@ Page Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true"
    CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F5000_CtrlFinanceira.F5800_CtrlDiversosFinanceiro.F5810_CtrlCheques.F5813_RegistroBaixaChequeEmitidoInstit.Cadastro"
    Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <ul id="ulDados" class="ulDados">
        <li class="liBanco">
            <label id="Label1" title="Banco" runat="server">
                Banco</label>
            ...
            <div id="divGrid" runat="server" class="divGrid">
                <asp:GridView ID="grdCheques" CssClass="grdBusca" Width="644px" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="nu_doc" HeaderText="Nº Contrato">
                            <ItemStyle Width="80px" HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="valor" DataFormatString ="{0:N}" HeaderText="Valor">
                            <ItemStyle Width="50px" HorizontalAlign="Right" />
                        </asp:BoundField>                                                                                                 
                        <asp:BoundField DataField="dt_vencimento" DataFormatString="{0:d}" HeaderText="Data Vencto">
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="Observação">
                            <ItemStyle Width="200px" HorizontalAlign="Left" VerticalAlign="Bottom" />
                            <ItemTemplate>                                
