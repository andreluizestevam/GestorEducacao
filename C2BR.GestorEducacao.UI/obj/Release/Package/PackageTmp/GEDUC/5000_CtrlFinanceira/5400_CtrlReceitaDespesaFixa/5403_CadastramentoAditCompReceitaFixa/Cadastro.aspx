<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F5000_CtrlFinanceira.F5400_CtrlReceitaDespesaFixa.F5403_CadastramentoAditCompReceitaFixa.Cadastro" %>
...
<style type="text/css">  
    ...
    .liCNPJ {margin-left:211px; margin-top:-27px !important;}
    ...
    <li class="liUnidade2"><ul>
        ...
        <li>
            ...
            <asp:TextBox ID="txtLogradouro" 
                ...
                CssClass="txtLogradouro" MaxLength="60" runat="server"
                Enabled="false">
            </asp:TextBox>
        </li>
        <li class="liClear">
            ...
            <asp:TextBox ID="txtComplemento" 
                ...
                CssClass="txtComplemento" MaxLength="30" runat="server"
                Enabled="false"></asp:TextBox>
        </li>
        <li>
            <label for="txtBairro" title="Bairro">Bairro</label>
            <asp:TextBox ID="txtBairro" 
                CssClass="txtBairro" runat="server"
                Enabled="false">
            </asp:TextBox>
        </li>
        <li class="liClear">
    ...
    <legend>Informações de Controle/Contábil</legend>
        <ul>
            <li>
                ...
                <asp:DropDownList ID="ddlTipoReceita" runat="server" Width="90px"
                    ToolTip="Selecione o Tipo de Receita" Enabled="false"
            ...
            <li>
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlSubGrupoReceita" 
            ...
            <li>
                ...
                <asp:DropDownList ID="ddlHistLancamento" 
                    ToolTip="Selecione o Histórico Padrão de Lançamento"
                    CssClass="ddlHistLancamento" runat="server">
                </asp:DropDownList>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlHistLancamento" 
                    ErrorMessage="Selecione o Histórico Padrão" Display="None">
                </asp:RequiredFieldValidator>
            </li>            
        ...
        <ul>
            ...
            <li>
                ...
                <asp:TextBox ID="txtNumPublicacao" 
                    ...
                    CssClass="txtNumDoc" runat="server"></asp:TextBox>
            </li>            
            <li>
            ...
            <li class="liClear">
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlTipoDocumento" 
                    ErrorMessage="Selecione o Tipo de Documento" Display="None">
                </asp:RequiredFieldValidator>
            </li>            
            <li>
            ...
            <li class="liClear">
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtQtParcelas" 
            ...
            <li class="liDtPrimeiroVencto">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDtPrimeiroVencto" 
            ...
            <li>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDiasIntervalo" 
                    ErrorMessage="Dias de intervalo entre parcelas deve ser informada" Display="None">
                </asp:RequiredFieldValidator>
            </li>            
            <li class="liValorDocumento">
                <label for="txtValorDocumento" class="lblObrigatorio" title="Valor do Contrato">R$ Contrato</label>
                <asp:TextBox ID="txtValorDocumento" ToolTip="Informe o Valor do Contrato" CssClass="txtMoney" runat="server" MaxLength="9"></asp:TextBox>
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtValorDocumento" 
                    ErrorMessage="Valor Documento deve ser informado" Display="None">
                </asp:RequiredFieldValidator>
            </li>            
            ...
            <li style="clear:both; border-right: 1px solid #F0F0F0; padding-right: 5px;">
                <label for="txtMultaPercent" title="Valor da Multa sobre a parcela">Multa</label>
                <asp:TextBox ID="txtMulta" ToolTip="Informe o Valor da Multa sobre a parcela" runat="server"
            ...
            <li style="border-right: 1px solid #F0F0F0; padding: 0 5px 0 5px;">
                ...
                <asp:TextBox ID="txtJuros" ToolTip="Informe o Valor dos Juros/Mês sobre a parcela" runat="server"
            ...
            <li style="padding: 0 0 0 5px;">
                ...
                <asp:TextBox ID="txtDesconto" ToolTip="Informe o Valor do Desconto/Mês sobre a parcela" runat="server"
                    CssClass="txtMoney"></asp:TextBox>
