<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master" AutoEventWireup="true" CodeBehind="SimplifColaborAniversariante.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._1000_CtrlAdminEscolar._1200_GestaoOperColaboradores._1299_Relatorios.SimplifColaborAniversariante" %>
...
<ul id="ulDados" class="ulDados">
        ...
        <li class="liMesReferencia">
            ...
            <asp:DropDownList ID="ddlMesReferencia" CssClass="ddlMesReferencia" runat="server" ToolTip="Selecione o Mês de Referência">
