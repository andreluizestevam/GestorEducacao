<%@ Page Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master" AutoEventWireup="true" CodeBehind="RelacTarefAgendadas.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F1000_CtrlAdminEscolar.F1300_ServicosApoioAdministrativo.F1310_CtrlAgendaAtividadesFuncional.F1319_Relatorios.RelacTarefAgendadas" Title="Untitled Page" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ul id="ulDados" class="ulDados">    
        ...
        <li class="liPeriodo">
            ...
            ErrorMessage="Campo Data Início é requerido" SetFocusOnError="true"></asp:RequiredFieldValidator>                
            ...
            ErrorMessage="Campo Data Fim é requerido" SetFocusOnError="true"></asp:RequiredFieldValidator>                                                                                                 
        </li>
    </ul>
</asp:Content>
