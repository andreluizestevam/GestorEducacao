<%@ Page Language="C#" MasterPageFile="~/App_Masters/PadraoBuscas.Master" AutoEventWireup="true" CodeBehind="Busca.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F1000_CtrlAdminEscolar.F1300_ServicosApoioAdministrativo.F1310_CtrlAgendaAtividadesFuncional.F1314_ReativaAgendaAtividadeFinaCanc.Busca" Title="Untitled Page" %>
...
<ul id="ulParamsFormBusca" class="ulParamsFormBusca">
    ...
    <li>
        <label for="ddlPrioridade">Prioridade</label>
            <asp:DropDownList ID="ddlPrioridade" CssClass="ddlPrioridade" runat="server" ToolTip="Informe a Prioridade">
    ...
    <li>
        ...
        <asp:TextBox ID="txtDtInicial" CssClass="campoData" runat="server" ToolTip="Data Início"></asp:TextBox>
    </li>
</ul>
</asp:Content>
