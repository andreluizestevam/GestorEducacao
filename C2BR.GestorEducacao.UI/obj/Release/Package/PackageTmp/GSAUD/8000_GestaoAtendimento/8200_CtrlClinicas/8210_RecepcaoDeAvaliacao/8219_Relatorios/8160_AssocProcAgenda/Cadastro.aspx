<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._8000_GestaoAtendimento._8100_CtrlAgendaMedica._8160_AssocProcAgenda.Cadastro" %>
    ...
    <ul id="ulDados" class="ulDados">
        <li style="margin-right: 0px;">
            <ul id="ulDadosMatricula">
                <li style="margin-top: -5px; margin-left: 44px; float: right;">
                    <div id="divBotoes">
                        <ul style="width: 1000px;">
                            ...
                            <li style="margin-left: 8px">
                                ...
                                <asp:DropDownList ID="ddlNomeUsu" runat="server" ToolTip="Paciente para o qual a consulta será marcada"
                                    Width="270px" OnSelectedIndexChanged="ddlNomeUsu_OnSelectedIndexChanged" AutoPostBack="true">
                                </asp:DropDownList>
                            </li>
                            <li>
            ...
            <div id="tabResConsultas" runat="server" clientidmode="Static">
                <ul id="ul10">
                    <li style="margin-top: 10px !important; width: 1000px;">
                        <ul>
                            <li style="width: 510px; float: left; margin-left: 6px;">
                                ...
                                <ul>
                                    ...
                                    <li style="margin-top: 5px">
                                        <div id="div1" runat="server" class="divGridData" style="height: 159px; width: 510px;
                                            ...
                                            <asp:GridView ID="grdHistorPaciente" CssClass="grdBusca" runat="server" Style="width: 100%;"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="OPER" HeaderText="OPERAD">
                                                        <ItemStyle Width="50px" HorizontalAlign="Left" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="TP_PROCED_V" HeaderText="TP PROC">
                                                        <ItemStyle Width="50px" HorizontalAlign="Left" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="PROCED" HeaderText="PROCED">
                                                        <ItemStyle Width="60px" HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="NR_ACAO" HeaderText="AÇÃO">
                                                        <ItemStyle Width="20px" HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="NO_PROFI" HeaderText="PROFISSIONAL">
                                                        <ItemStyle Width="50px" HorizontalAlign="Left" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="CO_CLASS_V" HeaderText="CLASS">
                            ...
                            <li style="width: 442px; float: right; margin-right: 20px !important;">
                                <%--   <asp:UpdatePanel runat="server" ID="UpdProfi" UpdateMode="Conditional">
                                    <ContentTemplate>--%>
                                <%-- Grid de profissionais --%>
                                <ul>
                                        ...
                                        <div style="float: right; margin-top: 5px">
                                            <ul>
                                                <li style="margin-top: 0px">
                                                    <asp:Label runat="server" ID="lblUnidResCons" for="ddlUnidResCons" ToolTip="Selecione a Unidade para filtrar os Profissionais">
                                                        Uni</asp:Label>
                                                    <asp:DropDownList ID="ddlUnidResCons" Width="80px" runat="server" ToolTip="Selecione a Unidade para filtrar os Profissionais"
                                                        OnSelectedIndexChanged="ddlUnidResCons_OnSelectedIndexChanged" AutoPostBack="true">
                                                    </asp:DropDownList>
                                                </li>
                                                <li style="margin-top: 0px; margin-bottom: 5px">
                                                    <asp:Label runat="server" ID="lblDept" ToolTip="Selecione o Local para filtrar os Profissionais">
                                                        Loc</asp:Label>
                                                    <asp:DropDownList runat="server" ID="ddlDept" Width="80px" ToolTip="Selecione o Local para filtrar os Profissionais">
                                                    </asp:DropDownList>
                                                </li>
                                                <li>
                                                    <asp:Label runat="server" ID="lblClassProfi" title="Selecione a Classificação Profissional para filtrar os Profissionais">
                                                        Clas
                                                    </asp:Label>
                                    ...
                                    <li style="margin-top: 0px">
                                        <div id="divGrdProfi" runat="server" class="divGridData" style="height: 139px; width: 440px;
                                            overflow-y: scroll !important; border: 1px solid #ccc;">
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="CK">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:TextBox runat="server" ID="txtNmCol" Text='<%# Eval("NO_APEL_COL") %>' style="display:none"></asp:TextBox>
                                    ...
                                    <li>
                                        <ul style="margin: 4px 0 0 35px">
                                            <li style="margin: 1px 5px 0 0">
                                                <label>
                                                    Período de Agendamento do Paciente</label>
                                            </li>
                                            <li>
                                                <asp:Label runat="server" ID="lblNomeProfi"></asp:Label>
                                            </li>
                                            <li>
                                                <asp:TextBox ID="txtDtIniAgenda" runat="server" CssClass="campoData">
                                                </asp:TextBox>
                                                &nbsp até &nbsp
                                                <asp:TextBox ID="txtDtFimAgenda" runat="server" CssClass="campoData">
                                                </asp:TextBox>
                                            </li>
                            ...
                            <li style="width: 980px; margin: 4px 0 0 7px !important; clear: both;">
                                ...
                                <ul>
                                        ...
                                        <div style="float: left; margin-left: 2px; margin-top: 4.5px;">
                                            <ul>
                                                <li style="margin-top: 1px; margin-left: 5px;">
                                                    <asp:CheckBox runat="server" ID="chkReplicar" Text="Replicar em todas" CssClass="chk"
                                                ...
                                                <li style="margin-left: 3px;">
                                                    <asp:TextBox runat="server" ID="txtDesProcedimento" Width="230px" Enabled="false"></asp:TextBox>
                                                </li>
                                                <li style="margin-left: 3px;">
                                                    <asp:TextBox runat="server" ID="txtNrAcao" Width="30px" Enabled="false"></asp:TextBox>
                                                </li>
                                                <li style="margin-left: 3px;">
                                                    <asp:TextBox runat="server" ID="txtDeAcao" Width="230px" OnTextChanged="txtDeAcao_OnTextChanged"
                                    ...
                                    <li style="margin-top: 1px">
                                        ...
                                        <div id="div3" runat="server" class="divGridData" style="height: 140px; width: 980px;
                                            ...
                                            <asp:GridView ID="grdHorario" CssClass="grdBusca1 grdBusca" runat="server" AutoGenerateColumns="false"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="CK">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:CheckBox ID="ckSelectHr" CssClass="chk" runat="server" OnCheckedChanged="ckSelectHr_OnCheckedChanged"
                                                                AutoPostBack="true" Enabled='<%# Eval("ItemAberto") %>' />
                                                            <asp:HiddenField runat="server" ID="hidCoAgenda" Value='<%# Eval("CO_AGEND") %>' />
                                                            <asp:HiddenField runat="server" ID="hidDtAgenda" Value='<%# Eval("dt") %>' />
                                                            ...
                                                            <asp:HiddenField runat="server" ID="hidSituaItemPlanej" Value='<%# Eval("coSituaItemPlanej") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="DES">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:TextBox runat="server" Text='<%# Eval("NM_PROCED") %>' ID="txtDesProced" Width="230px"
                                                    ...
                                                    <asp:TemplateField HeaderText="AÇÃO">
                                                        <ItemStyle Width="30px" HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <asp:TextBox runat="server" ID="txtNuAcao" Width="30px" Style="margin: 0 0 0 0 !important;
                                                    ...
                                                    <asp:TemplateField HeaderText="DESCRIÇÃO AÇÃO">
                                                        <ItemStyle Width="230px" HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <asp:TextBox runat="server" ID="txtDesAcao" Width="230px" Style="margin: 0 0 0 0 !important;"
                                                    ...
                                                    <asp:TemplateField HeaderText="CAN">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:ImageButton runat="server" ID="imgExc" ImageUrl="/Library/IMG/Gestor_BtnDel.png"
                                                                ToolTip="Cancelar/Descancela item de planejamento" OnClientClick="if (!window.confirm('Tem certeza de que deseja alterar a situação do item de planejamento ?')) return false;"
                                                                OnClick="imgExc_OnClick" Enabled='<%# Eval("podeExcluir") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
