<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits=" C2BR.GestorEducacao.UI.GSAUD._8000_GestaoAtendimento._8200_CtrlClinicas._8260_Atendimento._8273_AtendimentoServFarmaceuticos.Cadastro" %>
    ...
    <ul class="ulDados">
        ...
        <li style="clear: both">
            <label class="lblTitulo">
                <strong>GRADE DE PACIENTES COM ITENS FARMACÊUTICOS SOLICITADOS</strong></label>
        ...
        <li runat="server" id="liServAmbulatoriais" visible="false">
            <label class="lblTitulo" style="background-color: rgba(0, 255, 31, 0.31);">
                <strong>ITENS FARMACÊUTICOS</strong></label>
