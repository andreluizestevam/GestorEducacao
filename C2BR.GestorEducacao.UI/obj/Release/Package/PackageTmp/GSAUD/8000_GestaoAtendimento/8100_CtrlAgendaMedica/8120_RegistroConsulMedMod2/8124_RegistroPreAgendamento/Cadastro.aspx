<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._8000_GestaoAtendimento._8100_CtrlAgendaMedica._8120_RegistroConsulMedMod2._8124_RegistroPreAgendamento.Cadastro" %>
    ...
    <ul id="ulDados" class="ulDados">
        <li style="margin-right: 0px;">
            <ul id="ulDadosMatricula">
                <li style="margin-top: -5px; margin-left: 90px; float: right;">
                    <div id="divBotoes">
                                ...
                                <ul>
                                    ...
                                    <li class="liTituloGrid" style="width: 100%; height: 24px !important; margin-right: 40px !important;
                                        ...
                                        <div style="float: left; margin-left: 10px !important;">
                                            <label style="font-family: Tahoma; font-weight: bold; margin-top: 5px;">
                                                HÓRARIOS PRÉ-AGENDADOS</label>
                                        </div>
                                        <div style="float: right; margin-top: 5px">
                                            <ul>
                                                <li>
                                                    <asp:TextBox ID="txtDtIniPreAgend" runat="server" CssClass="campoData">
                                                    </asp:TextBox>
                                                    &nbsp até &nbsp
                                                    <asp:TextBox ID="txtDtFimPreAgend" runat="server" CssClass="campoData">
                                                    </asp:TextBox>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li style="margin-top: 0px">
                                        <label for="ddlUnidResCons" title="Pesquise pela unidade da consulta do paciente">
                                            Unidade</label>
                                        <asp:DropDownList ID="ddlUnidPreAgend" Width="210px" runat="server" ToolTip="Pesquise pela unidade da consulta do paciente"
                                            OnSelectedIndexChanged="ddlUnidPreAgend_OnSelectedIndexChanged" AutoPostBack="true" />
                                    </li>
                                    <li>
                                        <label>
                                            Especialidade</label>
                                        <asp:DropDownList runat="server" ID="ddlTipoPreAgend" Width="130px">
                                        </asp:DropDownList>
                                    </li>
                                    <li style="margin-top: 12px; margin-left: 0px;">
                                        <asp:ImageButton ID="imgPesqPreAgends" runat="server" ImageUrl="~/Library/IMG/Gestor_BtnPesquisa.png"
                                            OnClick="imgPesqPreAgends_OnClick" />
                                    </li>
                                    <li style="margin-top: 5px">
                                        <div id="divHistoricoAgenda" class="divGridData" style="height: 132px; width: 458px;
                                            ...
                                            <asp:GridView ID="grdHrsPreAgend" CssClass="grdBusca" runat="server" Style="width: 100%;"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="CK">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:HiddenField ID="hidIdAgenda" Value='<%# Eval("ID_AGEND") %>' runat="server" />
                                                            <asp:CheckBox ID="chkSelectAgend" runat="server" Width="100%" style="margin: 0 0 0 -15px !important;"
                                                                OnCheckedChanged="chkSelectAgend_OnCheckedChanged" AutoPostBack="true" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:BoundField DataField="NO_PAC" HeaderText="PACIENTE">
                                                        <ItemStyle Width="135px" HorizontalAlign="Left" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="TELEFONE" HeaderText="">
                                                        <ItemStyle Width="80px" HorizontalAlign="Left" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="OPER" HeaderText="CONTRT">
                                                        <ItemStyle Width="80px" HorizontalAlign="Left" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="TP_AGENDA" HeaderText="ESPC">
                                                    ...
                                                    <asp:TemplateField HeaderText="EX">
                                                        <ItemStyle Width="10px" HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <asp:ImageButton runat="server" ID="imgbExcluirPreAg" ImageUrl="~/Library/IMG/Gestor_BtnDel.png"
                                                                ToolTip="Excluir Pré-Agendamento" Style="width: 16px !important; height: 16px !important;
                                                                margin: 0 0 0 0 !important" OnClick="imgbExcluirPreAg_OnClick" OnClientClick="return confirm('Tem certeza que deseja EXCLUIR o pré-agendamento?');" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
