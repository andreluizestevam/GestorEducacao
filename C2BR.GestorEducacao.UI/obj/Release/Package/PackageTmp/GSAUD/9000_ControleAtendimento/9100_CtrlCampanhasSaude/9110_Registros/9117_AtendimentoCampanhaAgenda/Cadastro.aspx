<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._9000_ControleAtendimento._9100_CtrlCampanhasSaude._9110_Registros._9117_AtendimentoCampanhaAgenda.Cadastro" %>
    ...
    <ul class="ulDados">
                        ...
                        <div style="float: right; width: 265px;">
                            <ul style="margin: -12px 0 0 2px;">
                                <li class="liTituloGrid" style="width: 99%; height: 20px !important; margin-right: 0px;
                                    margin-left: 0px !important; margin-bottom: -7px;">
                                    <label style="font-family: Tahoma; margin-top: 3px; margin-left:10px; color: #A4A4A4" title="Grid de Usuários atendidos na Campanhas de Saúde de saúde selecionada">
                                        USUÁRIOS ATENDIDOS</label>
                                    <ul style="margin:-19px 0 0 135px;">
                                        <li>
                                            <asp:TextBox runat="server" ID="txtPesqVacina" Width="100px" placeholder="Pesquise pela Vacina"></asp:TextBox>
                                        </li>
                                        <li style="margin: 5px 2px 0 -2px;">
                                            <asp:ImageButton ID="imbPesqVacina" runat="server" ImageUrl="~/Library/IMG/Gestor_BtnPesquisa.png"
                                        ...
                                        <asp:GridView ID="grdHistUsuariosAtendidos" CssClass="grdBusca" runat="server" Style="width: 100%;
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="AÇÃO">
                                                    <ItemStyle Width="25px" CssClass="grdHisto" HorizontalAlign="Center" />
                                                    <HeaderStyle CssClass="grdHistoHead" />
                                                    <ItemTemplate>
                                                        <asp:ImageButton runat="server" ID="imgInfosVacina" ImageUrl="/Library/IMG/Gestor_ImgDocto.png"
                                                            ToolTip="Informações da vacina tomada"
        ...
        <li style="width: 420px; float: right;">
            <ul class="ulDadosUsu">
                ...
                <li class="liTituloGrid" style="width: 415px !important; height: 20px !important;
                    ...
                    <ul>
                        ...
                        <li style="margin-left: 10px; float: right; margin-top: 2px;">
                            <ul class="ulPer">
                                <li>
                                    <asp:TextBox runat="server" ID="txtNomePacPesqAgendAtend" Width="100px" placeholder="Pesquise pelo Nome"></asp:TextBox>
                                </li>
                                <li>
                ...
                <li style="clear: both;">
                    <div style="width: 413px; height: 120px; border: 1px solid #CCC; overflow-y: scroll"
                        id="divAgendasRecp">
                ...
                <li class="liTituloGrid" style="width: 415px; height: 20px !important; margin-right: 0px;
                    ...
                    <ul>
                        ...
                        <li style="clear: both; margin: 5px 0 0 0px;">
                            <div id="divDemonAge" style="width: 413px; height: 90px; border: 1px solid #CCC;
                                overflow-y: scroll">
                                ...
                                <asp:GridView ID="grdHistoricoAgenda" CssClass="grdBusca" runat="server" Style="width: 100%;
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="CK">
                                            <ItemStyle Width="10px" HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:CheckBox runat="server" ID="chkSelectHistAge" Width="100%" style="margin: 0 -5px 0 -20px !important;" Enabled='<%# Eval("podeClicar") %>'
                ...
                <li class="liTracejada" style="margin-top:100px;"></li>
                ...
                <li style="clear: both; margin-bottom: -26px;">
                    <label>Próxima Dose</label>
                    <asp:TextBox runat="server" ID="txtProxDose" CssClass="campoData"></asp:TextBox>
                </li>
                <li style="margin-bottom: -26px;">
                    <label>Dose Aplicada</label>
                    <asp:DropDownList runat="server" ID="drpDoseAplicada" Width="60px" ToolTip="Dose aplicada">
                        <asp:ListItem Value="1" Text="1ª dose" Selected="True"></asp:ListItem>
                        <asp:ListItem Value="2" Text="2ª dose"></asp:ListItem>
                        <asp:ListItem Value="3" Text="3ª dose"></asp:ListItem>
                        <asp:ListItem Value="4" Text="4ª dose"></asp:ListItem>
                        <asp:ListItem Value="5" Text="5ª dose"></asp:ListItem>
                        <asp:ListItem Value="6" Text="6ª dose"></asp:ListItem>
                        <asp:ListItem Value="7" Text="7ª dose"></asp:ListItem>
                        <asp:ListItem Value="8" Text="8ª dose"></asp:ListItem>
                        <asp:ListItem Value="9" Text="9ª+"></asp:ListItem>
                    </asp:DropDownList>
                </li>
