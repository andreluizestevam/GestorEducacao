<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master" AutoEventWireup="true" CodeBehind="QntProceAmbul.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._9000_ControleAtendimento._9110_CtrlProcedimentosMedicos._9119_Relatorios.QntProceAmbul" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <ul id="ulDadosPesquisa" runat="server" class="ulDados">
        <li style="clear: both">
            ...
            <asp:DropDownList runat="server" ID="ddlUnidade" Width="195px" />
        </li>         
        <li style="clear: both">
