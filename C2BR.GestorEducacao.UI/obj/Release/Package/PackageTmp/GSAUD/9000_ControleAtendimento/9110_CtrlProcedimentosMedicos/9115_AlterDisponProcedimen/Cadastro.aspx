<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._9000_ControleAtendimento._9110_CtrlProcedimentosMedicos._9115_AlterDisponProcedimen.Cadastro" %>
...
<ul id="ulDados" class="ulDados">
         <li style="margin:-5px 0 10px 150px !important;">
            <label for="ddlUnidadeTPA" class="lblObrigatorio" title="Unidade/Escola">
                Unidade</label>
            <asp:DropDownList ID="ddlUnidadeTPA" runat="server" CssClass="campoUnidadeEscolar" AutoPostBack="True" ToolTip="Selecione a Unidade" Enabled="false" Width="270px">
            </asp:DropDownList>
        ...
        <li class="liBarraTituloTPA">
            <label>MARQUE PARA TORNAR DISPONÍVEL O(S) PROCEDIMENTO(S) ASSOCIADO(S) À UNIDADE</label>
        </li>        
