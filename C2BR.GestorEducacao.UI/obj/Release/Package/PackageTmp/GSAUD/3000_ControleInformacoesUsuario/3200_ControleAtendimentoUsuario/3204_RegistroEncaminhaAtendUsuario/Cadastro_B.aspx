<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro_B.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._3000_ControleInformacoesUsuario._3200_ControleAtendimentoUsuario._3204_RegistroEncaminhaAtendUsuario.Cadastro_B" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <ul class="ulDados">
        ...
        <asp:HiddenField runat="server" ID="hdIdEncam" />
            ...
            <ul>
                <li style="margin-left: 330px;">
                    <label style="font-family: Tahoma; font-weight: bold; margin-top: 5px;">
                        GRADE DE AGENDAMENTO DE PACIENTES</label>
                </li>
            ...
            <ContentTemplate>
                <div class="divPaciPreAtend">
                    <asp:GridView ID="grdAgendaPlantoes" CssClass="grdBusca" runat="server" Style="width: 100%;
                        ...
                        DataKeyNames="CO_AGEND_MEDIC" OnSelectedIndexChanged="grdAgendaPlantoes_SelectedIndexChanged"
                        AutoGenerateSelectButton="false">
                        <RowStyle CssClass="rowStyle" />
                        <AlternatingRowStyle CssClass="alternatingRowStyle" />
                        <EmptyDataRowStyle HorizontalAlign="Center" CssClass="emptyDataRowStyle" />
                        <EmptyDataTemplate>
                            Neenhuma consulta pré-agendada<br />
                        </EmptyDataTemplate>
                        <Columns>
                            <asp:BoundField Visible="false" DataField="CO_AGEND_MEDIC" HeaderText="Cod." SortExpression="CO_EMP"
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:HiddenField ID="hidCoClassProfi" Value='<%# Eval("CO_CLASS_PROFI") %>' runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        ...
                        <ul>
                            <li class="liTituloGrid" style="width: 96.8%; height: 20px !important; margin-right: 0px;
                                ...
                                <ul style="float: right; margin: 3px 5px 0 0;">
                                    <li>
                                        <asp:CheckBox runat="server" ID="chkEncaComPreAtend" Text="Direcionamento para Avaliação"
                                            CssClass="chk" Checked="true" ToolTip="Marque caso deseje que o direcionamento seja enviado para o acolhimento (avaliação)." />
                                    </li>
                                </ul>
                            </li>
                            <div class="DivResp">
                                <ul class="ulDadosResp">
                                    <li style="clear: both; margin-left: -5px; margin-top: 0px;">
                                        <ul>
                                    ...
                                    <li style="margin: -105px 0 0 87px;">
                                    ...
                                    <li style="margin-top: -5px;">
                                        <ul style="margin-left: 0px" class="ulEndResiResp">
                                            ...
                                            <li style="margin-left: 10px; margin-top: -8px;">
                                                <label>
                                                    Email</label>
                                                <asp:TextBox runat="server" ID="txtEmailPaci" Width="197px"></asp:TextBox>
                                            </li>
                                        </ul>
                                    </li>
                                    <li style="margin: -10px 0 -5px 0px">
                                        <label class="lblTop">
                                    ...
                                    <li style="margin: -46px 0 0 179px;">
                                        <ul class="ulDadosContatosResp">
                                            ...
                                            <li>
                                                <label>
                                                    Tel. Celular</label>
                                                <asp:TextBox runat="server" ID="txtTelCelResp" Width="76px" CssClass="campoTel"></asp:TextBox>
                                            </li>
                                            <li>
                                                <label>
                                                    Tel. Comercial</label>
                                            ...
                                            <li>
                                                <label>
                                                    Nº WhatsApp</label>
                                                <asp:TextBox runat="server" ID="txtNuWhatsResp" Width="76px" CssClass="campoTel"></asp:TextBox>
                                            </li>
                                            <li>
                                                <label>
                                                    Facebook</label>
                                ...
                                <ul>
                                    <li style="margin-left: 10px;">
                                        <label style="font-family: Tahoma; font-weight: bold; margin-top: 3px; color: #8B1A1A">
                                            DIRECIONAMENTO
                                            <br />
                                            PARA ATENDIMENTO</label>
                                    </li>
                                    <li style="margin-left: 23px;">
                                        <label>
                                            Pesquisa por Classificação Profi. e/ou Local</label>
                                        <%-- <asp:DropDownList runat="server" ID="ddlPesqEspec" Width="140px">
                                        </asp:DropDownList>--%>
                                        <asp:DropDownList runat="server" ID="ddlPesqClassProfi" Width="140px">
                                        </asp:DropDownList>
                            ...
                            <asp:UpdatePanel ID="updProfiPlantao" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:GridView ID="grdMedicosPlanto" CssClass="grdBusca" runat="server" Style="width: 100%;
                                        ...
                                        <EmptyDataRowStyle HorizontalAlign="Center" CssClass="emptyDataRowStyle" />
                                        <EmptyDataTemplate>
                                            Nenhum Plantonista agendado para este horário hoje<br />
                                        </EmptyDataTemplate>
                                        <Columns>
                ...
                <ul>
                    <asp:UpdatePanel ID="updInfosBottom" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <li id="li16" runat="server" class="liBtnAddA liPrima" style="margin-left: 0px !important;
                                margin-top: 10px !important; clear: both !important; height: 15px;">
                                <asp:LinkButton ID="lnkEfetAtendMed" runat="server" ValidationGroup="atuEndAlu" OnClick="lnkEfetAtendMed_OnClick">
                            ...
                            <li id="li17" runat="server" class="liBtnAddA" style="margin-left: 5px !important;
                                ...
                                <asp:LinkButton ID="lnkImpFichaAtendMed" Enabled="false" runat="server" ValidationGroup="atuEndAlu"
                                    OnClick="lnkImpFichaAtendMed_OnClick">
                            ...
                            <li id="li1" runat="server" class="liBtnAddA" style="margin-left: 101px !important;
                                margin-top: 10px !important; clear: none !important; height: 15px;">
                                    <asp:LinkButton ID="lnkNovo" runat="server" ValidationGroup="atuEndAlu" OnClick="lnkNovo_OnClick">
                                        <asp:Label runat="server" ID="Label3" Text="NOVO" Style="margin-left: 4px;"></asp:Label>
                                    </asp:LinkButton>
                                </li>
                        </ContentTemplate>
                    </asp:UpdatePanel>
...
//            }
//            if ($('.campoTel8dig').val().length <= 10) {
//                $('.campoTel8dig').mask("(99)9?999-99999");
//            } else {
//                $('.campoTel8dig').mask("(99)9?9999-9999");
//            }
