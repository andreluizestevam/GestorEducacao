        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <ContentTemplate>
                <div class="divPaciPreAtend">
                    <asp:GridView ID="grdEncamMedic" Visible="false" CssClass="grdBusca" runat="server"
                        Style="width: 100%; height: 15px;" AutoGenerateColumns="false" ToolTip="Grade de pacientes direcionados ainda sem Acolhimento"
