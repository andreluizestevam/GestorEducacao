...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <ul class="ulDados">
        <li style="margin-left: 0px; margin-bottom:23px; clear:both; margin-top: -38px;">
            <label style="display:inline-block; color: Blue;">SEU LOCAL: </label>
            <asp:DropDownList AutoPostBack="true" ID="ddlLocal" runat="server" OnSelectedIndexChanged="ddlLocal_OnSelectedIndexChanged"></asp:DropDownList>
        </li>
            ...
            <div class="divClassRisco">
                <ul class="ulQuest">
                    ...
                    <li style="margin: 0 0 0 0;">
                        <label class="" title="Profissional médico responsável pelo processo de triagem">
                            Profissional</label>
                        <asp:DropDownList runat="server" ID="drpProfissional" Width="184px" ClientIDMode="Static" ToolTip="Profissional médico responsável pelo processo de triagem">
                        </asp:DropDownList>
                    </li>
                    <li style="width: 100%; height: 17px; text-align: center; text-transform: uppercase;
                        margin-top: 32px; margin-left: auto; background-color: #FFA07A; margin-bottom: 10px;">
                    ...
                    <li style="margin: 0 0 0 0;">
                        <label style="color: Red; font-size: 12px; font-weight: bold;" class="lblObrigatorio">
                            Classf. Risco</label>
                        <asp:DropDownList runat="server" ID="ddlClassRisco" Width="92px" ClientIDMode="Static" OnTextChanged="ddlClassRisco_OnTextChanged" AutoPostBack="true">
                        </asp:DropDownList>
                    </li>
