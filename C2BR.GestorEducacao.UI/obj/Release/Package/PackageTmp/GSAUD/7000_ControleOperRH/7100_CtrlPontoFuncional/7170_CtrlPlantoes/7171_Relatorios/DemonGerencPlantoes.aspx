<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master"
    AutoEventWireup="true" CodeBehind="DemonGerencPlantoes.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._7000_ControleOperRH._7100_CtrlPontoFuncional._7170_CtrlPlantoes._7171_Relatorios.DemonGerencPlantoes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <ul class="ulDados">
        ...
        <li style="clear: both">
            ...
            <asp:DropDownList runat="server" ID="ddlUnidadePlantao" Width="270px" ToolTip="Selecione a Unidade do Plantão para pesquisa">
            </asp:DropDownList>
        </li>
        <li style="clear: both">
        ...
        <li style="margin-left: 0px; margin-top: 9px;">
            <asp:CheckBox runat="server" ID="chkSomComAgendamentos" class="chk" ToolTip="Ao marcar, apenas os profissionais com agendamentos dentro dos parâmetros serão apresentados no Relatório"
                Text="Apenas plantonistas com Agendamento" Checked="true" />
        </li>
        <li style="clear: both">
        ...
        <li>
            ...
            <asp:DropDownList runat="server" ID="ddlClassificacao" ToolTip="Selecione a ordenação desejada"
                ...
                <asp:ListItem Value="4" Text="QTUP - Unidades de Plantão"></asp:ListItem>
                <asp:ListItem Value="5" Text="QTHT - Horas de Plantão"></asp:ListItem>
                <asp:ListItem Value="6" Text="QTTP - Total de Plantões"></asp:ListItem>
                <asp:ListItem Value="7" Text="QTEP - Especialidades de Plantão"></asp:ListItem>
                <asp:ListItem Value="8" Text="QTPI - Plantões Inconsistentes"></asp:ListItem>
                <asp:ListItem Value="9" Text="MHP - Valor Médio da Hora"></asp:ListItem>
                <asp:ListItem Value="10" Text="VTP - Valor Total do Plantão"></asp:ListItem>
            </asp:DropDownList>
        </li>
