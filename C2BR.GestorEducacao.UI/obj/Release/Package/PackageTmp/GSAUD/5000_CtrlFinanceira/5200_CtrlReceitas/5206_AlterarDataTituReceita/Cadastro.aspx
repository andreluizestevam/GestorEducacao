<%@ Page Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true"
    CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD.F5000_CtrlFinanceira.F5200_CtrlReceitas.F5206_AlterarDataTituReceita.Cadastro"
    Title="Untitled Page" %>
    ...
    <div style="height: 500px;">
        <ul id="ulDados" class="ulDados">
            ...
            <li class="liClear" style="margin-left: 50px;">
                ...
                <asp:RequiredFieldValidator ID="rfvRes" runat="server" ControlToValidate="ddlResponsavel" CssClass="validatorField"
