...
// OBJETIVO: EMISSÃO DA RELAÇÃO DOS ITENS DE PATRIMONIO
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class RelatoItensPatrimonio : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            string strP_CO_EMP, strP_CO_CLASSIF_PATR, strP_TP_PATR;
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelItensPatrimonio");
...
//--------> Inicializa as variáveis
            strP_CO_EMP = null;
            strP_CO_CLASSIF_PATR = null;
            strP_TP_PATR = null;

//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            strP_CO_EMP = ddlUnidade.SelectedValue;
            strP_CO_CLASSIF_PATR = ddlClasPatr.SelectedValue;
            strP_TP_PATR = ddlTpPatr.SelectedValue;

            lIRelatorioWeb = varRelatorioWeb.CreateChannel();

            lRetorno = lIRelatorioWeb.RelItensPatrimonio(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strP_CO_EMP, strP_CO_CLASSIF_PATR, strP_TP_PATR);
        ...
        /// <summary>
        /// Método que carrega o dropdown de Unidades Escolares e Classificação do Patrimônio
        /// </summary>
        private void CarregaDropDown()
        {
            ...
            ddlClasPatr.DataSource = TB213_CLASSIF_PATR.RetornaTodosRegistros();

            ddlClasPatr.DataTextField = "NO_CLASSIF_PATR";
            ddlClasPatr.DataValueField = "CO_CLASSIF_PATR";
            ddlClasPatr.DataBind();

            ddlClasPatr.Items.Insert(0, new ListItem("Todos", "T"));
        }
        #endregion
    }
}
