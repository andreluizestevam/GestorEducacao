...
namespace C2BR.GestorEducacao.UI.GEDUC.F6000_CtrlProcessosInternos.F6300_CtrlOperPatrimonio.F6390_TabelasGenerCtrlOperPatrimonio.F6393_CadastroGrupo
{
    public partial class Busca : System.Web.UI.Page
    {
        ...
        void CurrentPadraoBuscas_OnAcaoBuscaDefineGridView()
        {
            var resultado = (from tb260 in TB260_GRUPO.RetornaTodosRegistros()
                             ...
                             select new
                             {
                                 tb260.NOM_GRUPO, TP_GRUPO = "Patrimônio", tb260.ID_GRUPO, tb260.CO_GRUPO
