...
// SUBMÓDULO: CONTROLE DE INVENTÁRIO DE PATRIMÔNIO
// OBJETIVO: EMISSÃO DA RELAÇÃO DE INVENTÁRIO DOS ITENS DE PATRIMÔNIO
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
namespace C2BR.GestorEducacao.UI.GEDUC.F6000_CtrlProcessosInternos.F6300_CtrlOperPatrimonio.F6330_CtrlInventarioItensPatrimonio.F6339_Relatorios
{
    public partial class RelacItensPatrInven : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            string strP_CO_EMP, strP_TP_PATR;
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelRelacItensPatrInven");
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            strP_TP_PATR = ddlTpPatr.SelectedValue;

            lIRelatorioWeb = varRelatorioWeb.CreateChannel();

            lRetorno = lIRelatorioWeb.RelRelacItensPatrInven(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strP_CO_EMP, strP_TP_PATR);
