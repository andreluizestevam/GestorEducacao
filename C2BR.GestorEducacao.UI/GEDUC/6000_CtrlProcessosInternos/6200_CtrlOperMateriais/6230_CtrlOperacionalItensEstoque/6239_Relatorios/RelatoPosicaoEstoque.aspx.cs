...
// OBJETIVO: LISTAGEM DA SITUAÇÃO DE SALDO DE ITENS DE ESTOQUE
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class RelatoPosicaoEstoque : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelPosicaoEstoque");
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            lRetorno = lIRelatorioWeb.RelPosicaoEstoque(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strP_CO_EMP, strP_CO_TIP_PROD, strP_DE_TIP_PROD, strP_CO_GRUPO_ITEM, strP_CO_SUBGRP_ITEM);
