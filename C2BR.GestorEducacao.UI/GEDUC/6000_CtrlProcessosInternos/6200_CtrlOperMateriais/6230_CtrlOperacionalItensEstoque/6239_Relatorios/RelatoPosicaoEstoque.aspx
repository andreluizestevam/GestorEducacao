<%@ Page Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master" AutoEventWireup="true" CodeBehind="RelatoPosicaoEstoque.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F6000_CtrlProcessosInternos.F6200_CtrlOperMateriais.F6230_CtrlOperacionalItensEstoque.F6239_Relatorios.RelatoPosicaoEstoque" Title="Untitled Page" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ul id="ulDados" class="ulDados">
        ...
        <li class="liTpProduto">
            <label class="lblObrigatorio" title="Tipo de Produto">
                Tipo Produto</label>
            <asp:DropDownList ID="ddlTpProduto" ToolTip="Selecione o Tipo de Produto" CssClass="ddlTpProduto" runat="server">
            </asp:DropDownList>       
