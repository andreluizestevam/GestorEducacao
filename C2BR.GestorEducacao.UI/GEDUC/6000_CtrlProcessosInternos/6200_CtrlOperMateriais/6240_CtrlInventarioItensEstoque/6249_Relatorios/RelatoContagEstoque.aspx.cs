...
// SUBMÓDULO: PROCEDIMENTOS DE INVENTÁRIO DE ESTOQUE
// OBJETIVO: EMISSÃO DO FORMULÁRIO DE CONTAGEM DE INVENTÁRIO (FCI) DE ITENS DE ESTOQUE
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
namespace C2BR.GestorEducacao.UI.GEDUC.F6000_CtrlProcessosInternos.F6200_CtrlOperMateriais.F6240_CtrlInventarioItensEstoque.F6249_Relatorios
{
    public partial class RelatoContagEstoque : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelContagemEstoque");
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            lRetorno = lIRelatorioWeb.RelContagemEstoque(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strP_CO_EMP, strP_CO_TIP_PROD, strP_DE_TIP_PROD, strP_CO_GRUPO_ITEM, strP_CO_SUBGRP_ITEM);
