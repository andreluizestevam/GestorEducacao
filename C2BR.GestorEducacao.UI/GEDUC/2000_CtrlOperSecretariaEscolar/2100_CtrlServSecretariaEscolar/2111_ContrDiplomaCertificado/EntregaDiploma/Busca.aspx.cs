    ...
    public partial class Busca : System.Web.UI.Page
    {
        ...
        void CurrentPadraoBuscas_OnAcaoBuscaDefineGridView()
        {
            var resultado = (from tb211 in TB211_SOLIC_DIPLOMA.RetornaTodosRegistros()
                            ...
                            (txtNoAlu.Text != "" ? tb211.TB07_ALUNO.NO_ALU.Contains(txtNoAlu.Text) : txtNoAlu.Text == "")                               
                            select new
                            {
                                tb211.TP_USU_SOLIC, tb211.CO_USU, tb211.CO_MODU_CUR, tb01.NO_CUR, tb211.TB07_ALUNO.NO_ALU, tb211.ID_SOLIC_DIPLOMA,
                                tb211.DT_SOLIC, Status = tb211.CO_STATUS == "A" ? "Ativo" : tb211.CO_STATUS == "I" ? "Inativo" : "Cancelado"
