...
{
    public partial class ComprMatric : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelComprMatric");
...
//--------> Inicializa as variáveis
            strP_CO_EMP = null;
            strP_CO_ALU_CAD = null;

//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            strP_CO_EMP = ddlUnidade.SelectedValue;
            strP_CO_ALU_CAD = ddlAlunos.SelectedValue;            
