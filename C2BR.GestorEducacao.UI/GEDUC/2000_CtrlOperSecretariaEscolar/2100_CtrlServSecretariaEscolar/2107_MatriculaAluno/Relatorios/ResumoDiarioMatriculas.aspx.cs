...
// OBJETIVO: RESUMO DIÁRIO DE MATRÍCULAS
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class ResumoDiarioMatriculas : System.Web.UI.Page
    {
...
//--------> Variáveis obrigatórias para gerar o Relatório
            ...
            dtInicio = DateTime.Parse(txtPeriodoDe.Text);
            dtFim = DateTime.Parse(txtPeriodoAte.Text);

            infos = AuxiliRelatorioTemporario.GeraIdentFuncionarioRelatorio(Request.UserHostAddress);

            parametros = "( Unid. Contrato: " + ddlUnidade.SelectedItem.ToString() + " - Ano Refer: " + ddlAnoRefer.SelectedItem.ToString() + " - Período: " + txtPeriodoDe.Text + " à " + txtPeriodoAte.Text +" )";            

            RptResumoDiarioMatriculas rpt = new RptResumoDiarioMatriculas();
            lRetorno = rpt.InitReport(parametros, LoginAuxili.CO_EMP, strP_CO_EMP_UNID_CONT, ddlAnoRefer.SelectedValue, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, dtInicio, dtFim, infos);
            Session["Report"] = rpt;
        ...
        private void CarregaSerieCurso()
        {
            ...
            if (modalidade != 0)
            {
                ddlSerieCurso.DataSource = (from tb01 in TB01_CURSO.RetornaTodosRegistros()
                                            where tb01.TB44_MODULO.CO_MODU_CUR == modalidade && tb01.CO_EMP == LoginAuxili.CO_EMP
