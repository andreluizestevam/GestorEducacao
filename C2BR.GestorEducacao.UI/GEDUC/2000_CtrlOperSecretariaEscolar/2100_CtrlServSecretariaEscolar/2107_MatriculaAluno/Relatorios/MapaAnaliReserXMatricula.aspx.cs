...
// OBJETIVO: RELAÇÃO DO MAPA ANALÍTICO DE RESERVAS X MATRÍCULA
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class MapaAnaliReserXMatricula : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            string strP_CO_EMP, strP_ANO_REFER;
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelMapaGeralMatricula");
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            lRetorno = lIRelatorioWeb.RelMapaGeralMatricula(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strP_CO_EMP, strP_ANO_REFER);
