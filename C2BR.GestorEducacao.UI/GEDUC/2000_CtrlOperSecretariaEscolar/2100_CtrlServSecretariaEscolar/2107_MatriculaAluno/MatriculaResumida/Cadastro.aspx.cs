...
namespace C2BR.GestorEducacao.UI.GEDUC._2000_CtrlOperSecretariaEscolar._2100_CtrlServSecretariaEscolar._2107_MatriculaAluno.MatriculaResumida
{
    public partial class Cadastro : System.Web.UI.Page
    {
        ...
        private void ControlaFormularioAluno(bool habilitado)
        {
            ...
            //n_registro_mec.Enabled = habilitado;
            //n_cartao_sus.Enabled = habilitado;
            //n_plano_saude.Enabled = habilitado;
            fl_cpf_valido.Enabled = habilitado;
        ...
        protected void lnkConfirModSerTur_Click(object sender, EventArgs e)
        {
            ...
            lnkEfetMatric.Enabled = lnkConfirModSerTur.Enabled = false;
        ...
        protected void lnkAtualizaAlu_Click(object sender, EventArgs e)
        {
            ...
            //tb07.CO_NUME_CNES = this.n_registro_mec.Text;
            //tb07.NU_CARTAO_SAUDE_ALU = Decimal.TryParse(this.n_cartao_sus.Text, out decimalRetorno) ? (decimal?)decimalRetorno : null;
            //tb07.NU_CARTAO_SAUDE = this.n_plano_saude.Text;
            tb07.FL_CPF_VALIDO = this.fl_cpf_valido.Checked ? "S" : "N";
        ...
        protected void CarregaResponsaveis(int resp, string CPFResp)
        {
            ...
            if (tb108 != null)
            {
                ...
                this.txtDtNascResp.Text = tb108.DT_NASC_RESP != null ? tb108.DT_NASC_RESP.Value.ToString("dd/MM/yyyy") : "01/01/1900";
        ...
        protected void CarregaAluno(int coAlu, int coEmp, int nuNire)
        {
            ...
            if (tb07 != null)
            {
                ...
                //this.n_registro_mec.Text = tb07.CO_NUME_CNES;
                //this.n_cartao_sus.Text = tb07.NU_CARTAO_SAUDE_ALU.ToString();
                //this.n_plano_saude.Text = tb07.NU_CARTAO_SAUDE;
                this.fl_cpf_valido.Checked = tb07.FL_CPF_VALIDO == "S" ? true : false;
                ...
                this.txtDataNascimentoAluno.Text = tb07.DT_NASC_ALU != null ? tb07.DT_NASC_ALU.Value.ToString("dd/MM/yyyy") : "01/01/1900";
            ...
            else
            {
                ...
                //this.n_registro_mec.Text = "";
                //this.n_cartao_sus.Text = "";
                //this.n_plano_saude.Text = "";
                this.fl_cpf_valido.Checked = false;
        ...
        private void CarregaCidades(DropDownList ddlCidade, DropDownList ddlUF)
        {
            ...
            AuxiliCarregamentos.CarregaCidades(ddlCidade, false, ddlUF.SelectedValue, LoginAuxili.CO_EMP, true, true);
        }

        private void carregaCidadesRefeita()
        {
            string coufResp = ddlUfResp.SelectedValue;
            AuxiliCarregamentos.CarregaCidades(ddlCidadeResp, false, coufResp, LoginAuxili.CO_EMP, true, true);
            CarregaBairrosRefeito();
        }
        ...
        private void CarregaBoletosTabMatrColet()
        {
            ...
            AuxiliCarregamentos.CarregaBoletos(ddlBoletoSolicMatrColet, coEmp, "U", 0, 0, false, false);
        ...
        protected void LimparAluno()
        {
           ...
           this.txtNomeMaeAlunoValid.Text = this.txtNomePaiAluno.Text = this.txtCepAluno.Text = this.txtCertNascAlu.Text /*= this.n_registro_mec.Text = this.n_cartao_sus.Text = this.n_plano_saude.Text*/ = this.txtRGAluno.Text = this.txtOrgEmiRGAlu.Text =
        ...
        protected void ddlTurma_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ControlaTabs("GRM");
            chkMenEscAlu.Checked = false;
            lnkEfetMatric.Enabled = lnkConfirModSerTur.Enabled = true;
        }
