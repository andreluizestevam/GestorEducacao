<%@ Page Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true"
    CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F2000_CtrlOperSecretariaEscolar.F2100_CtrlServSecretariaEscolar.F2107_MatriculaAluno.RegistroSolicitacaoMaterial.Cadastro"
    Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <ul id="ulDados" class="ulDados">
        ...
        <li class="liGrid3Mat">MATERIAL DIDÁTICO</li>
        <li class="liGridMat">
            <div id="div3" runat="server" class="divGridUM">
                <asp:GridView ID="grdMaterial" CssClass="grdBusca" Width="360px" runat="server" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="NO_PROD_RED" HeaderText="Material">
                            <ItemStyle Width="220px" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="Categoria">
                            <ItemStyle Width="60px" />
                            <ItemTemplate>
                                <asp:Label ID="lblTamanho" runat="server" Text='<%# bind("DES_CATEG") %>'></asp:Label>
                                <asp:HiddenField ID="hdVlr" runat="server" Value='<%# bind("VL_UNIT_PROD") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
        ...
        <li class="liData2">
            <label for="txtDataC" title="Valor Total das Atividades">
                Valor Total</label>
            <asp:TextBox ID="txtValor" Enabled="false" CssClass="campoNumerico" Width="60px"
                ToolTip="Valor Total das Atividades" runat="server"></asp:TextBox>
        </li>
        <li class="liClear">
