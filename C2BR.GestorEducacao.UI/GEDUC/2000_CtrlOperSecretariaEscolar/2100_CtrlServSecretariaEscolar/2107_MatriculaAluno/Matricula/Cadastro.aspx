                    ...
                    <div id="divBotoes">
                        <ul>
                            ...
                            <li id="lilnkEfetMatric" runat="server" title="Clique para Efetivar Matrícula" class="lilnkEfetMatric">
                                <asp:LinkButton ID="lnkEfetMatric" OnClick="lnkEfetMatric_Click" runat="server" Style="margin: 0 auto;" ToolTip="EFETIVAR MATRÍCULA">
                                    <img id="imgEfetiMatric" runat="server" class="imgliLnk" src='/Library/IMG/Gestor_CheckSucess.png' alt="Icone Pesquisa" title="EFETIVAR MATRÍCULA" />
                                    <asp:Label runat="server" ID="lblEfetiMatric" Text="EFETIVAR" style="margin-left: 4px;"></asp:Label>
                                </asp:LinkButton>
                            </li>    
                            <li id="lilnkRecMatric" runat="server" title="Clique para Imprimir Contrato de Matrícula" class="lilnkRecMatric">
                                <asp:LinkButton ID="lnkRecMatric" OnClick="lnkRecMatric_Click" Enabled="false" runat="server" Style="margin: 0 auto;" ToolTip="Imprimir Recibo/Protocolo de Matrícula">
                            ...
                            <li id="lilnkFichaMatric" runat="server" title="Clique para Imprimir a ficha de Pré-Matrícula" class="lilnkBolCarne">
                                <asp:LinkButton ID="lnkFichaMatric" Enabled="false" runat="server" 
                                    ...
                                    onclick="lnkFichaMatric_Click"> <img id="img3" runat="server" class="imgliLnk" src='/Library/IMG/Gestor_IcoImpres.ico' alt="Icone Pesquisa" title="FICHA DE MATRÍCULA" /><asp:Label runat="server" ID="Label21" Text="FICHA" style="margin-left: 4px;"></asp:Label></asp:LinkButton>
                            </li>
            ...
            <div id="divMenuLateral">
                <ul id="ulMenuLateral">
                    ...
                    <li class="libtnInfResp">                                            
                            <img class="imgInfResp" src='/Library/IMG/Gestor_Numero1Preto.png' alt="Icone Pesquisa" title="Ativa Informações do Responsável." />
                    ...
                    <li style="margin-top: 2px;">                        
                            <img class="imgInfResp" src='/Library/IMG/Gestor_Numero2Vermelho.png' alt="Icone Pesquisa" title="Ativa Informações do Aluno." />
                    ...
                    <li style="margin-top: 2px;">                        
                        <img class="imgInfResp" src='/Library/IMG/Gestor_Numero3Vermelho.png' alt="Icone Pesquisa" title="Ativa Dados de Matrícula." />
                                ...
                                <ul>
                                    ...
                                    <li id="liUfTitulo" class="liUfTitulo">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvUfTituloResp" ValidationGroup="resp" runat="server"
                                            ControlToValidate="ddlUfTituloResp" ErrorMessage="A UF do título de eleitor do responsável deve ser informada"
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <label for="ddlNacioPassaResp" title="Nacionalidade">
                                            Nacionalidade</label>
                                        <asp:DropDownList ID="ddlNacioPassaResp" Width="70px" ToolTip="Selecione a Nacionalidade Passaporte do Responsável" CssClass="ddlNacioResp" OnSelectedIndexChanged="ddlNacioResp_SelectedIndexChanged" AutoPostBack="true"
                                            runat="server">
                                            <asp:ListItem Value="B">Brasileira</asp:ListItem>
                                            <asp:ListItem Value="E">Estrangeira</asp:ListItem>
                                        </asp:DropDownList>
                ...
                <ul id="ul10" class="ulDados2">
                    ...
                    <li class="liNIREAluETA">
                        <label for="txtNIREAluETA" title="Nº NIRE do Aluno">
                            Nº NIRE</label>
                        <asp:TextBox ID="txtNIREAluETA" runat="server" CssClass="txtNireAluno" Enabled="false" ToolTip="Nº NIRE do Aluno">
                        </asp:TextBox>
                    </li>  
                    <li class="liNISAluETA">
                        <label for="txtNISAluETA" title="Nº NIS do Aluno">
                            Nº NIS</label>
                        <asp:TextBox ID="txtNISAluETA" runat="server" CssClass="txtNisAluno" Enabled="false" ToolTip="Nº NIS do Aluno">
                        </asp:TextBox>
                    </li>   
        ...
        <div id="tabTelAdd" runat="server" clientidmode="Static" style="display: none;">                  
                <ul id="ul6" class="ulDados2">
                    ...
                    <li class="liNIREAluETA">
                        <label for="txtNIREAluETA" title="Nº NIRE do Aluno">
                            Nº NIRE</label>
                        <asp:TextBox ID="txtNIREAluTA" runat="server" CssClass="txtNireAluno" Enabled="false" ToolTip="Nº NIRE do Aluno">
                        </asp:TextBox>
                    </li>  
                    <li class="liNISAluETA">
                        <label for="txtNISAluETA" title="Nº NIS do Aluno">
                            Nº NIS</label>
                        <asp:TextBox ID="txtNISAluTA" runat="server" CssClass="txtNisAluno" Enabled="false" ToolTip="Nº NIS do Aluno">
                        </asp:TextBox>
                    </li>   
                    <li class="G2Clear" style="width: 100%; border-bottom:1px solid #CCCCCC;margin-left: 15px;padding-bottom: 5px;margin-top: 5px;">
                        <label style="font-family: Tahoma;">
                ...
                <ul id="ul4" class="ulDados2">
                    ...
                    <li class="liNIREAluETA">
                        <label for="txtNIREAluCEA" title="Nº NIRE do Aluno">
                            Nº NIRE</label>
                        <asp:TextBox ID="txtNIREAluCEA" runat="server" CssClass="txtNireAluno" Enabled="false" ToolTip="Nº NIRE do Aluno">
                        </asp:TextBox>
                    </li>  
                    <li class="liNISAluETA">
                        <label for="txtNISAluCEA" title="Nº NIS do Aluno">
                            Nº NIS</label>
                        <asp:TextBox ID="txtNISAluCEA" runat="server" CssClass="txtNisAluno" Enabled="false" ToolTip="Nº NIS do Aluno">
                        </asp:TextBox>
                    </li>   
                    <li class="G2Clear" style="width: 100%; border-bottom:1px solid #CCCCCC;margin-left: 15px;padding-bottom: 5px;margin-top: 5px;">
                    ...
                    <li style="margin-right: 0px;">
                        <label for="txtObsCEA" title="Observação">
                            Observação</label>
                        <asp:TextBox ID="txtObsCEA" style="width: 210px;" MaxLength="200" runat="server" ToolTip="Digite a Observação">
                        </asp:TextBox>
                    </li> 
            ...
            <ul id="ul7" class="ulDados2">
                ...
                <li class="liNIREAluETA">
                    <label for="txtNIREAluRAA" title="Nº NIRE do Aluno">
                        Nº NIRE</label>
                    <asp:TextBox ID="txtNIREAluRAA" runat="server" CssClass="txtNireAluno" Enabled="false" ToolTip="Nº NIRE do Aluno">
                    </asp:TextBox>
                </li>  
                <li class="liNISAluETA">
                    <label for="txtNISAluRAA" title="Nº NIS do Aluno">
                        Nº NIS</label>
                    <asp:TextBox ID="txtNISAluRAA" runat="server" CssClass="txtNisAluno" Enabled="false" ToolTip="Nº NIS do Aluno">
                    </asp:TextBox>
                </li>   
                <li class="G2Clear" style="width: 100%; border-bottom:1px solid #CCCCCC;margin-left: 15px;padding-bottom: 5px;margin-top: 5px;">
                    <label style="font-family: Tahoma;">
                ...
                <li>
                    ...
                    <asp:TextBox ID="txtDescRestri" CssClass="txtDescRestri" MaxLength="40" runat="server" ToolTip="Digite a Restrição Alimentar">
                    </asp:TextBox>
        ...
        <div id="tabAtiExtAlu" runat="server" clientidmode="Static" style="display: none;">                  
            <ul id="ul8" class="ulDados2">
                ...
                <li class="liNIREAluETA">
                    <label for="txtNIREAluRAA" title="Nº NIRE do Aluno">
                        Nº NIRE</label>
                    <asp:TextBox ID="txtNIREAluAEA" runat="server" CssClass="txtNireAluno" Enabled="false" ToolTip="Nº NIRE do Aluno">
                    </asp:TextBox>
                </li>  
                <li class="liNISAluETA">
                    <label for="txtNISAluRAA" title="Nº NIS do Aluno">
                        Nº NIS</label>
                    <asp:TextBox ID="txtNISAluAEA" runat="server" CssClass="txtNisAluno" Enabled="false" ToolTip="Nº NIS do Aluno">
                    </asp:TextBox>
                </li>   
                <li class="G2Clear" style="width: 100%; border-bottom:1px solid #CCCCCC;margin-left: 15px;padding-bottom: 5px;margin-top: 5px;">
                    <label style="font-family: Tahoma;">
        ...
        <div id="tabUniMat" style="display: none;" clientidmode="Static" runat="server">
            <ul id="ul5" class="ulDados2">
                            ...
                            <AlternatingRowStyle CssClass="alternatingRowStyle" />
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Desconto">
                                        ...
                                        <ItemTemplate>
                                                <asp:TextBox ID="txtDescSolic" ToolTip="Informe o valor de desconto do item, com ',' para separação de centavos" OnTextChanged="chkDescPer_ChenckedChanged" CssClass="txtDescSolic" Text='<%# bind("Desconto") %>' AutoPostBack="true" Enabled="false" runat="server"/>                                
                ...
                <li style="margin-top: 5px; clear: none;">
                    <asp:CheckBox ID="ckbAtualizaFinancSolic" CssClass="chkIsento" Enabled="true" Checked="true" runat="server" Text="Atualiza Financeiro" ToolTip="Selecione se atualizará o financeiro" AutoPostBack="True" 
                            oncheckedchanged="ckbAtualizaFinancSolic_CheckedChanged"/>
                </li>


                <li style="margin-top: 5px; margin-left: 3px; clear: none;">            
                    <asp:CheckBox ID="chkConsolValorTitul" CssClass="chkIsento" Enabled="false" runat="server" Text="Valores Único Título" ToolTip="Selecione se consolidará os valores em um único título financeiro" AutoPostBack="True" 
                ...
                <li style="clear: none; margin-left: 8px; margin-top: 5px;">
                    ...
                    <asp:TextBox ToolTip="Informe a Data de Vencimento da Solicitação" ID="txtDtVectoSolic" CssClass="txtDtVectoSolic campoData" runat="server"></asp:TextBox>
                </li>
        ...
        <div id="tabDocumentos" style="display: none;" clientidmode="Static" runat="server">
            <ul id="ul3" class="ulDados2">
                ...
                <li class="liNIREAluETA">
                    <label for="txtNIREAluDoc" title="Nº NIRE do Aluno">
                        Nº NIRE</label>
                    <asp:TextBox ID="txtNIREAluDoc" runat="server" CssClass="txtNireAluno" Enabled="false" ToolTip="Nº NIRE do Aluno">
                    </asp:TextBox>
                </li>  
                <li class="liNISAluETA">
                    <label for="txtNISAluDoc" title="Nº NIS do Aluno">
                        Nº NIS</label>
                    <asp:TextBox ID="txtNISAluDoc" runat="server" CssClass="txtNisAluno" Enabled="false" ToolTip="Nº NIS do Aluno">
                    </asp:TextBox>
                </li>   
                <li class="G2Clear" style="width: 100%; border-bottom:1px solid #CCCCCC;margin-left: 15px;padding-bottom: 5px;margin-top: 5px;">
                    <label style="font-family: Tahoma;">
        ...
        <div id="tabMenEsc" style="display: none;" clientidmode="Static" runat="server">
            <ul id="ul9" class="ulDados2">
                ...
                <li class="liNIREAluETA">
                    <label for="txtNIREAluDoc" title="Nº NIRE do Aluno">
                        Nº NIRE</label>
                    <asp:TextBox ID="txtNIREAluME" runat="server" Width="56px" CssClass="txtNireAluno" Enabled="false" ToolTip="Nº NIRE do Aluno">
                    </asp:TextBox>
                </li>  
                <li class="liNISAluETA">
                    <label for="txtNISAluDoc" title="Nº NIS do Aluno">
                        Nº NIS</label>
                    <asp:TextBox ID="txtNISAluME" runat="server" CssClass="txtNisAluno" Enabled="false" ToolTip="Nº NIS do Aluno">
                    </asp:TextBox>
                </li>   
