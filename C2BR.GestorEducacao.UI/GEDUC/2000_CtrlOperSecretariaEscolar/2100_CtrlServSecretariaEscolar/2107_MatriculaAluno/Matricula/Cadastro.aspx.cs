...
// ----------+----------------------------+-------------------------------------
// 27/02/2013| Victor Martins Machado     | Criação dos campos de alteração do desconto
//           |                            | na parte financeira (txtValorDescto, txtPeriodoIniDesconto, 
//           |                            | txtPeriodoFimDesconto) e adequação das regras de inserção.
// ----------+----------------------------+-------------------------------------
// 28/02/2013| Victor Martins Machado     | Criação da coluna NO_DESCONTO, que recebe o tipode desconto
//           |                            | concatenado com o nome da bolsa, para apresentação no rela
//           |                            | tório Relação de alunos - Descontos (original) e adequação
//           |                            | na inserção na tabela TB08_MATRCUR.
// ----------+----------------------------+-------------------------------------
// 28/02/2013| Victor Martins Machado     | Criação do campo chkValorContratoProporcional, que
//           |                            | serve para indicar que as parcelas não utilizarão 
//           |                            | o valor total do curso e sim o valor proporcional
//           |                            | a quantidade de parcelas a pagar.
// ----------+----------------------------+-------------------------------------
// 01/03/2013| Victor Martins Machado     | Inclusão de uma regra que bloqueia os campos de desconto
//           |                            | na parte financeira da matrícula caso o usuário não tenha
//           |                            | permissão no Page_Load.
// ----------+----------------------------+-------------------------------------
// 12/03/2013| André Nobre Vinagre        | Colocado para pegar o UF e cidade da instituição como 
//           |                            | default no responsavel e aluno.
//           |                            | 
// ----------+----------------------------+-------------------------------------
// 21/03/2013| André Nobre Vinagre        | Criada a lógica de histórico financeiro para taxa de matrícula
//           |                            | e mensalidade pegando da série.
//           |                            | 
// ----------+----------------------------+-------------------------------------
// 22/03/2013| André Nobre Vinagre        | Desenvolvida a lógica para se o responsável também
//           |                            | for um aluno.
// ----------+----------------------------+-------------------------------------
// 25/03/2013| Victor Martins Machado     | Criação da lógica do valor do desconto, onde caso o valor for
//           |                            | maior que o valor da parcela, o sistema apresentará uma menságem
//           |                            | de erro.
// ----------+----------------------------+-------------------------------------
// 25/03/2013| Victor Martins Machado     | Complementação da lógica do valor do desconto, onde caso a soma dos
//           |                            | descontos, bolsa/convênio e especial de contrato, for maior que
//           |                            | o valor da parcela, o sistema apresenta uma menságem de erro.
//           |                            | 
// ----------+----------------------------+-------------------------------------
// 25/03/2013| André Nobre Vinagre        | Corrigida a questão da duplicidade na TB079_HIST_ALUNO
//           |                            | 
//           |                            |
// ----------+----------------------------+----------------------------------------
// 25/03/2013| Caio Mendonça              | Quando são inseridas as parcelas(lnkEfetMatric_Click) 
//           |                            |  também é colocado como recebimento (fl_tipo_prev_receb) para banco (B)
//           |                            |
// ----------+----------------------------+----------------------------------------
// 26/03/2013| André Nobre Vinagre        | Implementada a opção quando informado o valor da primeira parcela.
//           |                            | 
//           |                            |
// ----------+----------------------------+----------------------------------------
// 28/03/2013| André Nobre Vinagre        | Implementada a nova logica de mensalidades.
//           |                            | 
// ----------+----------------------------+----------------------------------------
// 29/03/2013| Victor Martins Machado     | Foi retirado o campo chkValorContratoProporcional
//           |                            |
// ----------+----------------------------+----------------------------------------
// 29/03/2013| Victor Martins Machado     | Foi inserido o campo de tipo de contrato, que determina
//           |                            | se o contrato será cobrado a prazo ou a vista
//           |                            |
// ----------+----------------------------+----------------------------------------
// 01/04/2013| André Nobre Vinagre        | Corrigida a questão do carregamento da tela de aluno.
//           |                            | Criado o link para a tela de recebimento/pagamento
//           |                            |
// ----------+----------------------------+----------------------------------------
// 02/04/2013| André Nobre Vinagre        | Ajuste de layout de botões da matrícula
//           |                            | Criada a lógica de tratamento das flags vindas do usuário logado 
//           |                            |
// ----------+----------------------------+----------------------------------------
// 03/04/2013| André Nobre Vinagre        | Corrigido o controle de tabs da mensalidade
//           |                            | Corrigida a questão dos descontos de matrícula
//           |                            | 
// ----------+----------------------------+----------------------------------------
// 09/04/2013| André Nobre Vinagre        | Corrigido o carregamento de valores à vista
//           |                            | 
// ----------+----------------------------+----------------------------------------
// 09/04/2013| Victor Martins Machado     | Corrigido um problema na efetivação da matrícula,
//           |                            | quando o contrato era a vista, como a grid só tinha
//           |                            | um registro, a inserção na parte financeira apresentava erro.
//           |                            | 
// ----------+----------------------------+----------------------------------------
// 10/04/2013| André Nobre Vinagre        | Alterações nos parâmetros da gride de mensalidade
//           |                            | 
// ----------+----------------------------+----------------------------------------
// 11/04/2013| André Nobre Vinagre        | Corrigida inconsistência no carregamento de modalidade,
//           |                            | série e turma
//           |                            | 
// ----------+----------------------------+----------------------------------------
// 16/04/2013| André Nobre Vinagre        | Corrigida inconsistência no desconto especial 
//           |                            | 
// ----------+----------------------------+----------------------------------------
// 17/04/2013| André Nobre Vinagre        | Corrigida inconsistência no valor do contrato e número de parcelas
//           |                            | Implementada lógica para valor da primeira parcela
//           |                            | 
// ----------+----------------------------+----------------------------------------
// 16/05/2013| Victor Martins Machado     | Eu inserí o valor default 'N' no campo FL_TIPO_LANC_MEDIA.
//           |                            | 
// ----------+----------------------------+----------------------------------------
// 23/05/2013| Victor Martins Machado     | Eu alterei o ID do boleto utilizado para carregar a combo de boletos
//           |                            | na parte financeira da matrícula, estava pegando do campo ID_BOLETO_MATRIC
//           |                            | e passou pegar do campo ID_BOLETO_MENSA, que é o boleto das mensalidades.
//           |                            | 
// ----------+----------------------------+----------------------------------------
// 24/05/2013| Victor Martins Machado     | Eu incluí na tabela de matrícula, TB08_MATRCUR, as informações de responsável
//           |                            | e da bolsa.
//           |                            | 
// ----------+----------------------------+----------------------------------------
// 29/05/2013| André Nobre Vinagre        | Corrigida a questão de pegar o tipo de juros(valor ou porcentagem) 
//           |                            | a partir da unidade
//           |                            | 
// ----------+----------------------------+----------------------------------------
// 03/06/2013| André Nobre Vinagre        | Corrigida a questão do carregamento da cidade da empresa do responsável
//           |                            | 
// ----------+----------------------------+----------------------------------------
...
//           |                            | 
// ----------+----------------------------+----------------------------------------
// 06/02/2014| Vinicius Reis              | Corrigido erro ao passar valor null para a função ToUpper()
//           |                            | quando marcada a opção de Responsavel é aluno.
//           |                            | 
// ----------+----------------------------+----------------------------------------
// 28/03/2014| Victor Martins Machado     | Alterada a funcionalidade de registro de material coletivo / uniforme
//           |                            | para aceitar parcelamento e descontom, da mesma forma que é feita nas 
//           |                            | mensalidades.
//           |                            | 
// ----------+----------------------------+-------------------------------------
// 17/06/2014| Victor Martins Machado     | Comentada o ELSE da validação da taxa de matrícula
//           |                            | 
...
namespace C2BR.GestorEducacao.UI.GEDUC.F2000_CtrlOperSecretariaEscolar.F2100_CtrlServSecretariaEscolar.F2107_MatriculaAluno.Matricula
{
    public partial class Cadastro : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!base.IsPostBack)
            {
                ...
                else
                {
                    ...
                    CarregaHistoricos();
                    CarregaAgrupadores();
                    txtDtVectoSolic.Text = DateTime.Now.ToString("dd/MM/yyyy");
                }
        ...
        protected void lnkConfirModSerTur_Click(object sender, EventArgs e)
        {
            ...
            chkEndAddAlu.Enabled = chkTelAddAlu.Enabled = chkDocMat.Enabled =
                chkMatEsc.Enabled = chkResAliAlu.Enabled = chkCuiEspAlu.Enabled = chkRegAtiExt.Enabled = true;
        ...
        protected void imgAdd_Click(object sender, EventArgs e)
        {
            ...
            // Valida se o campo de UF do título de eleitor do responsável foi informado
            if (ddlUfTituloResp.SelectedValue == "")
            {
                AuxiliPagina.EnvioMensagemErro(this, "Informe a UF do título de eleitor do Responsável.");
                return;
            }
        ...
        protected void MontaGridNegociacao()
        {
            ...
            if ((menCur > 0) && (numNire > 0))
            {
                ...
                // Comentado por não existir a necessidade da menságem
                //else
                //{
                ...
                if (parcelas > 1)
                {
                    ...
                    for (int i = 2; i <= parcelas; i++)
                    {
                        ...
                        if (i == 2)
                        {
                            dataVectoMensa = qtdDiasInterMeses > 0 ? dataVectoMensa.AddMonths(1) : dataVectoMensa.AddMonths(i - 1);
                        }
                        else
                            dataVectoMensa = qtdDiasInterMeses > 0 ? dataVectoMensa.AddMonths(1) : dataVectoMensa.AddMonths(1);
        ...
        protected void MontaGridParcelasMaterial()
        {
            ...
            int gc = 0;
            foreach (GridViewRow l in grdSolicitacoes.Rows)
            {
                if (((CheckBox)l.Cells[0].FindControl("chkSelect")).Checked)
                {
                    gc++;
                }
            }

            if (chkConsolValorTitul.Checked || gc == 1)
            {
        ...
        protected void CarregaResponsaveis(int resp, string CPFResp)
        {
            ...
            if (tb108 != null)
            {
                ...
                if (ddlCidadeResp.Items.FindByValue(tb108.CO_CIDADE.ToString()) != null)
                {
                ...
                if ((tb108.CO_UF_TIT_ELE_RESP != null) && (tb108.CO_UF_TIT_ELE_RESP.Trim() != "") && (this.ddlUfTituloResp.Items.Contains(new ListItem(tb108.CO_UF_TIT_ELE_RESP.Trim(), tb108.CO_UF_TIT_ELE_RESP.Trim()))))
                ...
                this.CarregaUfs(this.ddlUfEmpResp);
                if (this.ddlUfEmpResp.SelectedValue == "")
                {
                ...
                {
                    this.CarregaCidades(this.ddlCidadeEmpResp, this.ddlUfEmpResp);
                    this.ddlCidadeEmpResp.SelectedValue = tb108.TB904_CIDADE != null ? tb108.TB904_CIDADE.CO_CIDADE.ToString() : this.ddlCidadeEmpResp.SelectedValue != "" ? this.ddlCidadeEmpResp.SelectedValue : "";
                    this.CarregaBairros(this.ddlBairroEmpResp, this.ddlCidadeEmpResp);
                    this.ddlBairroEmpResp.SelectedValue = tb108.CO_BAIRRO_EMPRE_RESP != null ? tb108.CO_BAIRRO_EMPRE_RESP.ToString() : this.ddlBairroEmpResp.SelectedValue != "" ? this.ddlBairroEmpResp.SelectedValue : "";
                }
        ...
        private void CarregaUfs(DropDownList ddlUF)
        {
            ...
            ddlUF.SelectedValue = LoginAuxili.CO_UF_EMP;
        }
        ...
        private void CarregaBoletos()
        {
            ...
            AuxiliCarregamentos.CarregaBoletos(ddlBoletoSolic, coEmp, "U", coMod, coCur, false, false);
        ...
        protected void GeraBoleto()
        {
            ...
            foreach (GridViewRow row in grdNegociacao.Rows)
            {
                ...
                //vlDesconto += tb47.VR_DES_DOC != null ? tb47.VR_DES_DOC.Value : 0;
                //vlDesconto += tb47.VL_DES_BOLSA_ALUNO != null ? tb47.VL_DES_BOLSA_ALUNO.Value : 0;

                ////boleto.Desconto = tb47.VR_DES_DOC.Value; // Valor do desconto do documento
                //if (vlDesconto != 0)
                //{
                //    boleto.Desconto = vlDesconto; // Valor do desconto do documento
                //}
        ...
        protected void ControlaTabs(string tab)
        {
            ...
            if (tab == "CEA") // Registro de cuidados especiais
                tabCuiEspAdd.Style.Add("display", "block");
            else if (tab == "ALU") // Registro de aluno
                tabAluno.Style.Add("display", "block");
            else if (tab == "ENA") // Registro de endereços diversos do aluno
                tabEndAdd.Style.Add("display", "block");
            else if (tab == "TEA") // Registro de telefones diversos do aluno
                tabTelAdd.Style.Add("display", "block");
            else if (tab == "RES") // Registro de responsável
                tabResp.Style.Add("display", "block");
            else if (tab == "RAD") // Registro de restrições alimentares
                tabResAliAdd.Style.Add("display", "block");
            else if (tab == "UMA") // Registro de Uniformes e materiais coletivos
                tabUniMat.Style.Add("display", "block");
            else if (tab == "DOC") // Registro de documenntos do aluno
                tabDocumentos.Style.Add("display", "block");
            else if (tab == "AEA") // Registro de atividades extras do aluno
                tabAtiExtAlu.Style.Add("display", "block");
            else if (tab == "MEN") // Registro de mensalidades
        ...
        protected void lnkMatUniAlu_Click(object sender, EventArgs e)
        {
            ...
            AuxiliPagina.EnvioMensagemSucesso(this, "Material(is) e/ou Uniforme(s) atualizado(s) com sucesso. Caso queira emitir o boleto bancário e/ou extrato clicar nos botões correspondentes na parte inferior da tela.");
...
//--------> Criação da Pasta
        ...
        protected void lnkGrava_Click(object sender, EventArgs e)
        {
            int coAlu = Convert.ToInt32(this.hdCodAluno.Value);
            var refAluno = TB07_ALUNO.RetornaPeloCoAlu(coAlu);
            int proxTurma = Convert.ToInt32(this.ddlTurma.SelectedValue);
