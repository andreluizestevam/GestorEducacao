    ...
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._2000_CtrlOperSecretariaEscolar._2100_CtrlServSecretariaEscolar._2107_MatriculaAluno.MatriculaResumidaFinanc.Cadastro" %>
                ...
                <li style="margin-top: 10px; margin-left: 15px; float: right;">
                    <div id="divBotoes">
                        <ul>
                            ...
                            <li id="lilnkRecibo" runat="server" title="Clique para Imprimir o Recibo de Pagamento"
                                class="lilnkBolCarne" style="margin-left:10px">
...
<%--                                </ContentTemplate>
					...
					<li class="lichkUniforme" style="margin-left: 16px; margin-top:2px">
                    ...
                    <li style="width: 670px; margin-left: 5px; margin-right: 0px;">
                        <ul>
                                ...
                                <ContentTemplate>
                                    ...
                                    <li class="liddlSexoAlu" style="margin-top: 0px">
                                        <label for="txtNomeAluno" class="lblObrigatorio" title="Nome do Aluno">
                                            Nome</label>
                                        <asp:TextBox ID="txtNomeAluno" Width="180px" Style="text-transform: uppercase;" runat="server"
                                    ...
                                    <li class="liddlSexoAlu" style="margin-top: 0px; margin-left: 0px;">
                                        <label for="ddlSexoAluno" class="lblObrigatorio" title="Sexo do Aluno">
                                            Sexo</label>
                                        <asp:DropDownList ID="ddlSexoAluno" CssClass="ddlSexoAluno" Width="90px" runat="server"
                                ...
                                <ContentTemplate>
                                    ...
                                    <li style="margin-top: -4px">
                                        ...
                                        <%--<asp:TextBox ID="txtNomeMaeAluno" Width="180px" CssClass="txtNomeMaeAluno" ToolTip="Informe o Nome da Mãe"
                                            runat="server" MaxLength="60"></asp:TextBox>--%>
                                            <asp:TextBox ID="txtNomeMaeAlunoValid" Width="180px" MaxLength="60" runat="server" ToolTip="Informe o Nome da Mãe"></asp:TextBox>
                                    ...
                                    <li style="margin-top: -4px;">
                                        <label for="txtNomePaiAluno" title="Nome do Pai">
                                            Nome do Pai</label>
                                        <asp:TextBox ID="txtNomePaiAluno" Width="180px" CssClass="txtNomeMaeAluno" ToolTip="Informe o Nome do Pai"
                                            runat="server" MaxLength="60"></asp:TextBox>
                                    </li>
                                    <li class="liClear" style="margin-top: -3px;">
                                        <label>Certidão de Nasc.</label>
                                        <asp:TextBox runat="server" ID="txtCertNascAlu" Width="100px" MaxLength="40"></asp:TextBox>
                                    </li>
                                    ...
                                    <li class="liUfA" style="margin-top: -3px;">
                                    ...
                                    <li style="margin-top: -7px;" class="liClear">
                            ...
                            <li id="li8" runat="server" title="Clique para Cadastrar Aluno" 
                                style="background-color: #F1FFEF; border: 1px solid #D2DFD1; margin-left: 330px;
                ...
                <ul id="ul9" class="ulDados2">
                    ...
                    <li style="margin-top: 12px; margin-left: 100px;">
                        <asp:CheckBox ID="chkAtualiFinan" CssClass="chkLocais" AutoPostBack="true" OnCheckedChanged="chkAtualiFinan_CheckedChanged"
                            Checked="true" runat="server" Text="Atualizar Financeiro" ToolTip="Marque se deverá atualizar o financeiro" />
                        <br />
                    </li>
