    ...
    public partial class Cadastro : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (QueryStringAuxili.OperacaoCorrenteQueryString.Equals(QueryStrings.OperacaoInsercao))
            {
                ...
                txtDataCadastro.Enabled = txtNire.Enabled = txtResponsavel.Enabled = txtBoletoBanca.Enabled = chkConsolValorTitul.Enabled = ddlHistorico.Enabled = ddlAgrupador.Enabled =
                txtNumeroSolicitacao.Enabled = txtAtendente.Enabled = txtValorTotal.Enabled = false;
