...
// OBJETIVO: DECLARAÇÃO DE COMPROMISSO FINANCEIRO
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class DeclaracaoDeCompromissoFinanceiro : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            if (lst != null && lst.Where(x => x.Pagina == 1).Any())
            {
                ...
                RptDeclaracaoDeCompromissoFinanceiro rpt = new RptDeclaracaoDeCompromissoFinanceiro();
            ...
            {
                AuxiliPagina.EnvioMensagemErro(this.Page, "Arquivo não cadastrado na tabela de Arquivo RTF - Sigla DCF, Tipo de documento Declaração");
                return;
            }
        }
        #endregion
