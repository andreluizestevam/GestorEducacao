...
{
    public partial class DeclaracaoTransferenciaInsef : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            {
                RptDeclaracaoTransferenciaInsef rpt = new RptDeclaracaoTransferenciaInsef();
            ...
            {
                AuxiliPagina.EnvioMensagemErro(this.Page, "Arquivo não cadastrado na tabela de Arquivo RTF - Sigla DXXX004TRANS, Tipo de documento Declaração");
                return;
            }
        }
