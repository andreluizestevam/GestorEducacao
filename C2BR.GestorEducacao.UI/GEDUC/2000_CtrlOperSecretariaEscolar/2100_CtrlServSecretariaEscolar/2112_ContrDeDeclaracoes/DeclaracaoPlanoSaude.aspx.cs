...
{
    public partial class DeclaracaoPlanoSaude : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            var lst = (from tb009 in TB009_RTF_DOCTOS.RetornaTodosRegistros()
                       ...
                       where tb009.TP_DOCUM == "DE" && tb009.CO_SIGLA_DOCUM == "DPS"
            ...
            if (lst != null && lst.Where(x => x.Pagina == 1).Any())
            {
                ...
                RptDeclaracaoPlanoSaude rpt = new RptDeclaracaoPlanoSaude();
            ...
            {
                AuxiliPagina.EnvioMensagemErro(this.Page, "Arquivo não cadastrado na tabela de Arquivo RTF - Sigla DPS, Tipo de documento Declaração");
                return;
            }
        }
        #endregion
