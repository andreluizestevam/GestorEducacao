...
{
    public partial class DeclaracaoImposRenda : System.Web.UI.Page
    {
        ...
        private void Imprime()
        {
            ...
            int strP_CO_EMP_REF, strP_CO_EMP, strP_CO_MAT, strp_CO_ALU;
            ...
            nomeFuncionalidade = AuxiliGeral.RetornaNomeFuncionalidadeCadastrada("GEDUC/2000_CtrlOperSecretariaEscolar/2100_CtrlServSecretariaEscolar/2112_ContrDeDeclaracoes/DeclaracaoImposRenda.aspx");
            ...
            RptDeclaracaoImposRenda rpt = new RptDeclaracaoImposRenda();
        ...
        private void CarregaAnos()
        {
            ...
            if (ddlAnoRefer.Items.FindByValue(ano) != null)
                ddlAnoRefer.SelectedValue = ano;
        }
