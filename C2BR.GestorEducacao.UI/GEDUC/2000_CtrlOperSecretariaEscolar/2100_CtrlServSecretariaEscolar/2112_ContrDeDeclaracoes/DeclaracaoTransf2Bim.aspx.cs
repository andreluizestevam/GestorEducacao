...
// OBJETIVO: DECLARAÇÃO DE TRANSFERENCIA 2° BIMESTRE
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class DeclaracaoTransf2Bim : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            var lst = (from tb009 in TB009_RTF_DOCTOS.RetornaTodosRegistros()
                       ...
                       where tb009.TP_DOCUM == "DE" && tb009.CO_SIGLA_DOCUM == "DT2"
            ...
            {
                RptDeclaracaoTransf2Bim rpt = new RptDeclaracaoTransf2Bim();
            ...
            {
                AuxiliPagina.EnvioMensagemErro(this.Page, "Arquivo não cadastrado na tabela de Arquivo RTF - Sigla DT2, Tipo de documento Declaração");
                return;
            }
        }
