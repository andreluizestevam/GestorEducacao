...
// OBJETIVO: DECLARAÇÃO DE PAGAMENTO
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class DeclaracaoDePagamento : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            {
                RptDeclaracaoDePagamento rpt = new RptDeclaracaoDePagamento();
            ...
            {
                AuxiliPagina.EnvioMensagemErro(this.Page, "Arquivo não cadastrado na tabela de Arquivo RTF - Sigla DP, Tipo de documento Declaração");
                return;
            }
        }
        #endregion
