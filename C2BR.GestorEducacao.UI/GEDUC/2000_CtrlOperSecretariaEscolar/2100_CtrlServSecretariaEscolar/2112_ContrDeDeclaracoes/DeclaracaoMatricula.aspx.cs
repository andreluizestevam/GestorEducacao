...
{
    public partial class DeclaracaoMatricula : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            var lst = (from tb009 in TB009_RTF_DOCTOS.RetornaTodosRegistros()
                       ...
                       where tb009.TP_DOCUM == "DE" && tb009.CO_SIGLA_DOCUM == "DXXX001MATRI"
            ...
            {
                RptDeclaracaoMatricula rpt = new RptDeclaracaoMatricula();
            ...
            {
                AuxiliPagina.EnvioMensagemErro(this.Page, "Arquivo não cadastrado na tabela de Arquivo RTF - Sigla DXXX001MATRI, Tipo de documento Declaração");
                return;
            }
        }
        #endregion
