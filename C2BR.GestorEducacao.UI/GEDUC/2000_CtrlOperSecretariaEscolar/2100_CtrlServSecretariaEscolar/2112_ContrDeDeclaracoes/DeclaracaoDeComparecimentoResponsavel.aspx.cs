...
{
    public partial class DeclaracaodeComparecimentoResponsavel : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            var lst = (from tb009 in TB009_RTF_DOCTOS.RetornaTodosRegistros()
                       ...
                       where tb009.TP_DOCUM == "DE" && tb009.CO_SIGLA_DOCUM == "DCR"
            ...
            {
                RptDeclaracaoDeComparecimentoResponsavel Report = new RptDeclaracaoDeComparecimentoResponsavel();
                //RptTeste rpt = new RptTeste();
                lRetorno = Report.InitReport(LoginAuxili.CO_EMP, strCO_ALU_CAD);
            ...
            {
                AuxiliPagina.EnvioMensagemErro(this.Page, "Arquivo não cadastrado na tabela de Arquivo RTF - Sigla DCR, Tipo de documento Declaração");
                return;
            }
        }
        #endregion
