...
{
    public partial class DeclaracaoTransferencia : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            {
                RptDeclaracaoTransferencia rpt = new RptDeclaracaoTransferencia();
            ...
            {
                AuxiliPagina.EnvioMensagemErro(this.Page, "Arquivo não cadastrado na tabela de Arquivo RTF - Sigla DXXX003TRCUR, Tipo de documento Declaração");
                return;
            }
        }
