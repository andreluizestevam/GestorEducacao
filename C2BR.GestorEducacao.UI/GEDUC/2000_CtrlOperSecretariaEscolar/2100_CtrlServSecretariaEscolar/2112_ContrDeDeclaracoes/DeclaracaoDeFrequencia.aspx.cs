...
// OBJETIVO: DECLARAÇÃO DE FREQUENCIA
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class DeclaracaoDeFrequencia : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            var lst = (from tb009 in TB009_RTF_DOCTOS.RetornaTodosRegistros()
                           ...
                           where tb009.TP_DOCUM == "DE" && tb009.CO_SIGLA_DOCUM == "DF"
            ...
            if (lst != null && lst.Where(x => x.Pagina == 1).Any())
            {
                ...
                RptDeclaracaoDeFrequencia rpt = new RptDeclaracaoDeFrequencia();
            ...
            {
                AuxiliPagina.EnvioMensagemErro(this.Page, "Arquivo não cadastrado na tabela de Arquivo RTF - Sigla DF, Tipo de documento Declaração");
                return;
            }
        }
        #endregion
