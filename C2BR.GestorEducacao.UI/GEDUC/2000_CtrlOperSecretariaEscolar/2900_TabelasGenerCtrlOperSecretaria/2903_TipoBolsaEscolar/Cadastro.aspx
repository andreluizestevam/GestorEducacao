    ...
    <ul id="ulDados" class="ulDados">  
        ...
        <li class="liClear">
            <label for="txtNome" class="lblObrigatorio" title="Nome">
                Nome</label>
            <asp:TextBox ID="txtNome" ToolTip="Informe o Agrupador da Bolsa/Convênio de Estudo" runat="server" MaxLength="20" CssClass="txtNome"></asp:TextBox>
        ...
        <li class="liClear">
            <label for="txtDescricao" title="Descrição">
                Descrição</label>
            <asp:TextBox ID="txtDescricao" ToolTip="Informe a Descrição da Bolsa/Convênio de Estudo" runat="server" MaxLength="200" CssClass="txtDescricao"></asp:TextBox>            
        </li>    
        <li class="liClear">
            <label for="txtDtInicioBolsa" title="Data de Início da Bolsa">Data Início</label>
            <asp:TextBox ID="txtDtInicioBolsa" CssClass="campoData" runat="server" MaxLength="8" ToolTip="Data de Início da Bolsa"></asp:TextBox>
        </li>      
        <li style="margin-left: 5px;">
            <label for="txtDtFinalBolsa" title="Data de Início da Bolsa">Data Fim</label>
