...
{
    public partial class RelTecnicaAlunosSerieTurma : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            ...
            RptRelTecnicaAlunosSerieTurma rpt = new RptRelTecnicaAlunosSerieTurma();
        ...
        {
            int coEmp = ddlUnidade.SelectedValue != "0" ? int.Parse(ddlUnidade.SelectedValue) : LoginAuxili.CO_EMP;
            /*
        ...
        private void CarregaSerieCurso()
        {
            ...
            if (modalidade != 0)
            {
                ddlSerieCurso.DataSource = (from tb01 in TB01_CURSO.RetornaTodosRegistros()
                                            ...
                                            where tb43.TB44_MODULO.CO_MODU_CUR == modalidade && tb43.CO_ANO_GRADE == anoGrade && (coEmp != 0 ? tb01.CO_EMP == coEmp : 0 == 0)
