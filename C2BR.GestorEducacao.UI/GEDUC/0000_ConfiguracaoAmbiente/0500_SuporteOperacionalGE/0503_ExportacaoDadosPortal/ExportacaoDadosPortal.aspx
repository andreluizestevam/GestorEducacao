<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoGenericas.Master"
    AutoEventWireup="true" CodeBehind="ExportacaoDadosPortal.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F0000_ConfiguracaoAmbiente.F0500_SuporteOperacionalGE.F0503_ExportacaoDadosPortal.ExportacaoDadosPortal" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        ...
        .liLnkGerarScriptBD { margin-top: 15px; margin-left: 120px; border: 1px solid #CCCCCC; padding: 3px; float: left !important; }
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <ul class="ulDados">
            ...
            <ul>
                <li class="liCabecalho">
                    <asp:CheckBox ID="chkSelecionarTodos" CssClass="chkSelecionarTodos" 
                        ...
                        style="float:left; margin-left: 6px; margin-top: 3px;" Text="Todas"
                    oncheckedchanged="chkSelecionarTodos_CheckedChanged" Visible="False" />
                    <label class="lblCabecalho" title="Grid de Exportação de Dados - Portal de Relacionamento">Grid de Exportação de Dados - Portal de Relacionamento</label>          
                </li>

                <li class="liClear">
                    <div id="divGrid" runat="server" class="divGrid">
                        <asp:GridView ID="grdExportacao" CssClass="grdExportacao grdBusca" Width="600px" runat="server" AutoGenerateColumns="False">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Tabelas" HeaderText="Tabelas">
                                    <ItemStyle Width="400px" />
                                </asp:BoundField>
                            </Columns>
                        </asp:GridView>
                        <%-- 
                        <asp:GridView ID="grdExportacao" CssClass="grdExportacao grdBusca" Width="990px" runat="server" AutoGenerateColumns="False">
                            <RowStyle CssClass="rowStyle" />
                            <AlternatingRowStyle CssClass="alternatingRowStyle" />
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="DE_FUNCI_EXPDADOS" HeaderText="Funcionalidade">
                                    <ItemStyle Width="230px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="DE_MODULO_EXPDADOS" HeaderText="Módulo">
                                    <ItemStyle Width="200px" />
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="Tabelas Gestor">
                                    <ItemStyle Width="200px" />
                                    <ItemTemplate>                                
                                         <asp:Label  ID="lblTabelOrigExpDados" runat="server" Text='<%# bind("DE_TABELA_ORIGEM_EXPDADOS") %>' />                                
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="DT_ULTATUA_EXPDADOS" HeaderText="Última Atual" DataFormatString="{0:dd/MM/yy HH:mm}">
                                    <ItemStyle Width="70px" />
                                </asp:BoundField>     
                                <asp:BoundField DataField="DE_TABELA_DESTIN_EXPDADOS" HeaderText="Tabelas Portal">
                                    <ItemStyle Width="200px" />
                                </asp:BoundField>
                            </Columns>
                        </asp:GridView>--%>
        ...
        <li id="liLnkAtualBD" runat="server" class="liLnkAtualBD">
            <asp:LinkButton ID="lnkAtualBP" runat="server" OnClick="lnkAtualBP_Click" CssClass="lnkAtualBP" ToolTip="Atualizar Base">
                <img id="imgIconAtualBP" width="20" height="20" src='/Library/IMG/Gestor_DBRestore.png' alt="Atualizar BD Portal Relacionamento" />
                <asp:Label runat="server" ID="lblAtuaBDPorRelac" CssClass="lblAtuaBDPorRelac" Text="Atualizar BD Portal Relacionamento"></asp:Label>
            </asp:LinkButton>
        </li>
        <li class="liClear">
