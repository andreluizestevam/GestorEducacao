<%@ Page Language="C#" MasterPageFile="~/App_Masters/PadraoBuscas.Master" AutoEventWireup="true"
    CodeBehind="Busca.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F0000_ConfiguracaoAmbiente.F0300_GerenciamentoUsuarios.F0301_ManutencaoUsuarioSistema.Busca"
    Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <ul id="ulParamsFormBusca" class="ulParamsFormBusca">
        <li>
            <label title="Unidade">
                Unidade</label>
            <asp:DropDownList ID="ddlUnidadeMUS" runat="server" CssClass="campoUnidadeEscolar" ToolTip="Selecione a Unidade">
            </asp:DropDownList>
        </li>
        <li>
            <label>
        ...
        <li>
            <label>
                Tipo</label>
            <asp:DropDownList ID="ddlTipoUsuarioMUS" runat="server" ToolTip="Selecione o Tipo de Usuário" Width="120px">
                <asp:ListItem Text="Todos" Value="" Selected="True"></asp:ListItem>
