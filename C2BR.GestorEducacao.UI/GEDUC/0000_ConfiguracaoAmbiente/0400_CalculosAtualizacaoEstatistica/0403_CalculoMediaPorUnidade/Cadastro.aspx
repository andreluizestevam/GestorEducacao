<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F0000_ConfiguracaoAmbiente.F0400_CalculosAtualizacaoEstatistica.F0403_CalculoMediaPorUnidade.Cadastro" %>
...
<style type="text/css">  
    ...
    .divGrid { height: 291px; overflow-y:auto; width: 577px; border: 1px solid #D2DFD1;}   
...
<ul id="ulDados" class="ulDados">  
        ...
        <ul>
            <li style="margin-left: 455px;"><label style="text-transform:uppercase;">----------------------------------- ANOS -----------------------------------</label></li>
            <li id="liGrid" style="margin-left: 190px;">
                <div id="divGrid" runat="server" class="divGrid">
                    <asp:GridView ID="grdResulParam" CssClass="grdBusca" Width="560px" runat="server" AutoGenerateColumns="False">
