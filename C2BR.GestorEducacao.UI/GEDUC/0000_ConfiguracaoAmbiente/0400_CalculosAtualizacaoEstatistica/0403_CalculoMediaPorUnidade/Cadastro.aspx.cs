...
namespace C2BR.GestorEducacao.UI.GEDUC.F0000_ConfiguracaoAmbiente.F0400_CalculosAtualizacaoEstatistica.F0403_CalculoMediaPorUnidade
{
    public partial class Cadastro : System.Web.UI.Page
    {
        ...
        private TB951_ESTAT_ESCOL RetornaEntidade(int coEmp, int anoRefer)
        {
            return TB951_ESTAT_ESCOL.RetornaPeloOcorrEstatEscol(coEmp, anoRefer);
        }
        #endregion
        ...
        protected void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            foreach (var qryM in qryUnidades)
            {
                ...
                var qryGrid = from tb079 in TB079_HIST_ALUNO.RetornaTodosRegistros()
                              where tb079.TB25_EMPRESA.CO_EMP == qryM.CO_EMP && (coAnoRef != "" ? tb079.CO_ANO_REF == coAnoRef : coAnoRef == "")
                ...
                foreach (var qryG in qryGrid)
                {
                    var qtdAluno = (from tb079 in TB079_HIST_ALUNO.RetornaTodosRegistros()
                                    where tb079.TB25_EMPRESA.CO_EMP == qryM.CO_EMP && tb079.CO_ANO_REF == qryG.CO_ANO_REF
                ...
                dt.Rows.Add(qryM.NO_FANTAS_EMP, camposTab[0], camposTab[1], camposTab[2], camposTab[3], camposTab[4], camposTab[5], camposTab[6], camposTab[7], media != 0 ? String.Format("{0:N2}", media) : "-");
            }
        ...
        protected void btnGravarMedias_Click(object sender, EventArgs e)
        {
            ...
            foreach (var qryM in qryUnidades)
            {
                ...
                foreach (var qryG in qryGrid)
                {
                    ...
                    TB951_ESTAT_ESCOL desEsc = RetornaEntidade(qryM.CO_EMP, int.Parse(qryG.CO_ANO_REF));

                    if (desEsc == null)
                    {
                        ocorrReg = true;

                        desEsc = new TB951_ESTAT_ESCOL();
