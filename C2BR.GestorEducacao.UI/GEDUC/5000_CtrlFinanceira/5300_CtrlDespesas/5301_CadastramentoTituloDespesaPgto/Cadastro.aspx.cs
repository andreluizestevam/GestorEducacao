    ...
    public partial class Cadastro : System.Web.UI.Page
    {
        ...
        void CurrentPadraoCadastros_OnAcaoBarraCadastro()
        {
            ...
            if (ddlTipoDocumento.SelectedIndex > 0 && TB086_TIPO_DOC.RetornaPeloCoTipoDoc(int.Parse(ddlTipoDocumento.SelectedValue)).SIG_TIPO_DOC == "BOL")
            {
                ...
                else if (ddlLocalCobranca.Text == "")
                {
                    AuxiliPagina.EnvioMensagemErro(this.Page, "Local de cobrança deve ser informado");
                    return;
                }
            }
            ...
            tb38.TB101_LOCALCOBRANCA = ddlLocalCobranca.SelectedValue != "" ? TB101_LOCALCOBRANCA.RetornaPelaChavePrimaria(int.Parse(ddlLocalCobranca.SelectedValue)) : null;
            ...
            tb38.TB39_HISTORICO = ddlHistorico.SelectedValue != "" ? TB39_HISTORICO.RetornaPelaChavePrimaria(int.Parse(ddlHistorico.SelectedValue)) : null;
            tb38.DE_COM_HIST = txtComplementoHistorico.Text;
            tb38.TB099_CENTRO_CUSTO = ddlCentroCusto.SelectedValue != "" ? TB099_CENTRO_CUSTO.RetornaPelaChavePrimaria(int.Parse(ddlCentroCusto.SelectedValue)) : null;
            tb38.TB56_PLANOCTA = ddlContaContabil.SelectedValue != "" ? TB56_PLANOCTA.RetornaPelaChavePrimaria(int.Parse(ddlContaContabil.SelectedValue)) : null;
            //tb38.TB56_PLANOCTA.CO_SEQU_PC = int.Parse(ddlContaContabil.SelectedValue);
            ...
            tb38.FL_TIPO_PREV_PAGAM = ddlTipPrePag.SelectedValue;
            tb38.ID_ITEM_REFER_CUSTO = (int?)int.Parse(ddlClassCusto.SelectedValue);
        ...
        private void CarregaFormulario()
        {
            ...
            if (tb38 != null)
            {
                ...
                ddlTipPrePag.SelectedValue = tb38.FL_TIPO_PREV_PAGAM;
                ddlTipoPagmRealiz.SelectedValue = tb38.FL_TIPO_PAGAM;
                ddlClassCusto.SelectedValue = tb38.ID_ITEM_REFER_CUSTO.ToString();
            }
        }
        ...
        private void CarregaClassCusto()
        {
            ddlClassCusto.DataSource = (from tb429 in TB429_REFER_CUSTO.RetornaTodosRegistros()
                                       where tb429.FL_SITUA == "A"
                                       select new { tb429.ID_ITEM_REFER_CUSTO, tb429.NO_ITEM });

            ddlClassCusto.DataTextField = "NO_ITEM";
            ddlClassCusto.DataValueField = "ID_ITEM_REFER_CUSTO";
            ddlClassCusto.DataBind();

            ddlClassCusto.Items.Insert(0, new ListItem("Selecione", ""));
        }
        ...
        protected void chkValorDescontoPercentual_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = chkValorDescontoPercentual.Checked;
        }
    }
}