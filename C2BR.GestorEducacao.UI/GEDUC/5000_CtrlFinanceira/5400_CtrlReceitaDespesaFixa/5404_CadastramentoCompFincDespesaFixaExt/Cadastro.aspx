<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F5000_CtrlFinanceira.F5400_CtrlReceitaDespesaFixa.F5404_CadastramentoCompFincDespesaFixaExt.Cadastro" %>
...
<style type="text/css">
    ...
    .txtQtd { width: 16px; text-align: right;}
...
<ul id="ulDados" class="ulDados">
    <li class="liUnidade">
        <ul>
            <li style="clear: both; margin-top: 10px !important;">
            </li>        
            <li class="liClear">
                <label for="ddlNomeFantasia" class="lblObrigatorio" title="Nome">Nome Fantasia</label>
                <asp:DropDownList ID="ddlNomeFantasia" runat="server" CssClass="ddlNomeFantasia" AutoPostBack="true" OnSelectedIndexChanged="ddlNomeFantasia_SelectedIndexChanged" Enabled="false">
                </asp:DropDownList>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlNomeFantasia" ErrorMessage="Selecione o Fornecedor" Display="None">
                </asp:RequiredFieldValidator>
            </li>        
            <li>
                <label for="txtCNPJ" title="CNPJ">CNPJ</label>
                <asp:TextBox ID="txtCNPJ" ToolTip="Informe o CNPJ" CssClass="txtCNPJ" runat="server" Enabled="false">
                </asp:TextBox>
            </li>
        </ul>
    </li>    
    ...
    <li class="liUnidade2"><ul>
        ...
        <li>
            ...
            <asp:TextBox ID="txtLogradouro" ToolTip="Informe o Endereço" CssClass="txtLogradouro" MaxLength="60" runat="server" Enabled="false">
            </asp:TextBox>
        </li>
        <li class="liClear">
            <label for="txtComplemento" title="Complemento">Complemento</label>
            <asp:TextBox ID="txtComplemento" ToolTip="Informe o Complemento" CssClass="txtComplemento" MaxLength="30" runat="server" Enabled="false"></asp:TextBox>
        </li>
        <li>
            <label for="txtBairro" title="Bairro">Bairro</label>
            <asp:TextBox ID="txtBairro" CssClass="txtBairro" runat="server" Enabled="false">
            </asp:TextBox>
        </li>
        <li class="liClear">
    ...
    <legend>Informações de Controle/Contábil</legend>
        <ul>
            <li class="liTipoReceita">
                ...
                <asp:DropDownList ID="ddlTipoReceita" runat="server" Width="90px" ToolTip="Selecione o Tipo de Receita" Enabled="false"
                    AutoPostBack="True" OnSelectedIndexChanged="ddlTipoReceita_SelectedIndexChanged">
                </asp:DropDownList>
            </li>
            <li>
                <label for="ddlSubGrupoReceita" title="Subgrupo" class="lblObrigatorio">SubGrupo</label>
                <asp:DropDownList ID="ddlSubGrupoReceita" runat="server" Width="220px"
                    ToolTip="Selecione o Subgrupo"
                    AutoPostBack="True" OnSelectedIndexChanged="ddlSubGrupoReceita_SelectedIndexChanged">
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddlSubGrupoReceita" 
                    ErrorMessage="Selecione o SubGrupo" Display="None">
                </asp:RequiredFieldValidator>
            </li>
            <li>
            ...
            <li>
                ...
                <asp:DropDownList ID="ddlHistLancamento" ToolTip="Selecione o Histórico Padrão de Lançamento" CssClass="ddlHistLancamento" runat="server">
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="ddlHistLancamento" 
    ...
    <legend>Informações do Contrato</legend>
        <ul>
            <li>
                <label for="txtNumContrato" title="Número do Contrato" class="lblObrigatorio">N° Contrato</label>
                <asp:TextBox ID="txtNumContrato" MaxLength="20"
            ...
            <li>
                ...
                <asp:TextBox ID="txtNumPublicacao" MaxLength="20"
            ...
            <li>
                ...
                <asp:TextBox ID="txtDataPublicacao" ToolTip="Informe a Data de Publicação" CssClass="campoData" runat="server">
                </asp:TextBox>
            </li>            
            <li class="liClear">
                <label for="ddlTipoDocumento" title="Tipo de Documento" class="lblObrigatorio">Tipo Documento</label>
                <asp:DropDownList ID="ddlTipoDocumento" 
                    ToolTip="Selecione o Tipo de Documento"
                    CssClass="ddlTipoDocumento" runat="server"
                    Enabled="false">
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ddlTipoDocumento" 
                    ErrorMessage="Tipo de Documento deve ser informado" Display="None">
                </asp:RequiredFieldValidator>
            </li>            
            <li>
                <label for="txtNumDoc" title="Número do Documento" class="lblObrigatorio">N° Documento</label>
                <asp:TextBox ID="txtNumDoc" MaxLength="20"
            ...
            <li>
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtDtFimContrato" 
                    ErrorMessage="Data de Término do Contrato deve ser informada" Display="None">
                </asp:RequiredFieldValidator>
                <asp:CustomValidator ControlToValidate="txtDtFimContrato" runat="server"
            ...
            <li class="liClear">
                ...
                <asp:TextBox ID="txtQtParcelas" 
                    ToolTip="Informe a Quantidade de Parcelas de Recebimento"
                    CssClass="txtQtd" runat="server"
                    Enabled="false">
                </asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtQtParcelas" ErrorMessage="Informe a Quantidade de parcelas" Display="None">
                </asp:RequiredFieldValidator>
            </li>            
            <li class="liDtPrimeiroVencto">
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtDtPrimeiroVencto" 
                    ErrorMessage="Data 1° Vencimento da Parcela deve ser informada" Display="None">
                </asp:RequiredFieldValidator>
                <asp:CustomValidator ControlToValidate="txtDtPrimeiroVencto" runat="server"
            ...
            <li>
                <label for="txtDiasIntervalo" title="Dias de intervalo entre parcelas" class="lblObrigatorio">DI</label>
                <asp:TextBox ID="txtDiasIntervalo" 
                    ToolTip="Informe a quantidade de Dias de intervalo entre parcelas"
                    CssClass="txtQtd" runat="server"
                    Enabled="false">
                </asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDiasIntervalo" ErrorMessage="Informe a Quantidade de Dias de Intervalo" Display="None">
                </asp:RequiredFieldValidator>
            </li>            
            <li class="liValorDocumento">
                <label for="txtValorDocumento" title="Valor do Contrato" class="lblObrigatorio">R$ Contrato</label>
                <asp:TextBox ID="txtValorDocumento" CssClass="txtMoney" runat="server" MaxLength="9"
                    Enabled="false"></asp:TextBox>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtValorDocumento" ErrorMessage="Informe o Valor do Documento" Display="None">
                </asp:RequiredFieldValidator>
            </li>            
            <li class="liDtCancelamento">
                ...
                <asp:CustomValidator ControlToValidate="txtDtCancelamento" runat="server"
            ...
            <li style="clear:both; border-right: 1px solid #F0F0F0; padding-right: 5px;">
                ...
                <asp:TextBox ID="txtMulta" runat="server"
                ...
                <asp:RegularExpressionValidator ControlToValidate="txtMulta" runat="server" 
            ...
            <li style="border-right: 1px solid #F0F0F0; padding: 0 5px 0 5px;">
                ...
                <asp:TextBox ID="txtJuros" runat="server"
    ...
    <ul>
        ...
        <li class="liStatus">
            ...
            <asp:CustomValidator ControlToValidate="ddlStatus" runat="server"
        ...
        <li class="liDtStatus">
            ...
            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtDtStatus" 
                ErrorMessage="Data de Status deve ser informada" Display="None">
            </asp:RequiredFieldValidator>
        </li>
    </ul>
    </li>
