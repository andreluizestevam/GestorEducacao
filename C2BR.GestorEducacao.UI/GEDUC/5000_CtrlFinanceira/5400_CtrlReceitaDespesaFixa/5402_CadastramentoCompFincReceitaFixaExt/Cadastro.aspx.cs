...
// OBJETIVO: CADASTRAMENTO DE COMPROMISSOS FINANCEIROS DE ORIGENS DE RECEITAS FIXAS EXTERNAS
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
namespace C2BR.GestorEducacao.UI.GEDUC.F5000_CtrlFinanceira.F5400_CtrlReceitaDespesaFixa.F5402_CadastramentoCompFincReceitaFixaExt
{
...
//----------------> Retorna a lista de Contas lançadas para a receita fixa selecionada
                    List<TB47_CTA_RECEB> lstTb47 = (from lTb47 in TB47_CTA_RECEB.RetornaTodosRegistros()
                                                    where lTb47.CO_EMP == tb37.CO_EMP && lTb47.CO_CON_RECFIX == tb37.CO_CON_RECDES
                                                    select lTb47).ToList();
...
//----------------> Se todas as contas estiverem com o status "Em aberto", exclui as mesmas e depois exclui a receita fixa
            ...
            if (Page.IsValid)
            {
                ...
                if (tb37 != null)
                {
                    ...
                    tb37.TB103_CLIENTEReference.Load();
                }
                else
                {
                    ...
                    tb37.TB103_CLIENTE = TB103_CLIENTE.RetornaPelaChavePrimaria(int.Parse(ddlNomeFantasia.SelectedValue));
...
//----------------> Lança cada parcela no Contas a Receber
                    for (int i = 0; i < tb37.QT_PARC_RECDES; i++)
                    {
                        ...
                        {
                            lstTb47[i].CO_EMP = tb37.TB25_EMPRESA.CO_EMP;
                            lstTb47[i].CO_EMP_UNID_CONT = tb37.TB25_EMPRESA.CO_EMP;
        ...
        private void CarregaFormulario()
        {
            ...
            if (tb37 != null)
            {
                ...
                txtDtPublicacao.Text = tb37.DT_PUBLI_RECDES != null ? tb37.DT_PUBLI_RECDES.Value.ToString("dd/MM/yyyy") : "";
                ...
                cbFlagPercentualMulta.Checked = tb37.CO_FLAG_TP_VALOR_MUL == "P";
                cbFlagPercentualJuros.Checked = tb37.CO_FLAG_TP_VALOR_JUR == "P";
                cbFlagPercentualDesconto.Checked = tb37.CO_FLAG_TP_VALOR_DES == "P";
