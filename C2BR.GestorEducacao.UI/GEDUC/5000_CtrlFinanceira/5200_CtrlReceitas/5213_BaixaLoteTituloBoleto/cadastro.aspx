<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._5000_CtrlFinanceira._5200_CtrlReceitas._5213_BaixaLoteTituloBoleto.cadastro" %>
                        ...
                        <div id="divGrid" class="divGrid" runat="server">
                            <asp:GridView ID="grdTitulos" runat="server" AutoGenerateColumns="False" CssClass="grdBusca"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="DESC BOL">
                                        <ItemTemplate>
                                            <asp:TextBox ID="tbDescBolsa" runat="server" AutoPostBack="True" CssClass="campoMoeda"
                                                Enabled='<%# bind("marcar") %>' OnTextChanged="tbDescBolsa_TextChanged" Text='<%# bind("descBolsa") %>'
                                                Width="40px"></asp:TextBox>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                    </asp:TemplateField>
