...
namespace C2BR.GestorEducacao.UI.GEDUC._5000_CtrlFinanceira._5200_CtrlReceitas._5204_LerArquivoRetorno
{
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    foreach (DetalheRetorno detalhe in cnab400.ListaDetalhe)
                    {
                        ...
                        if (tb321 == null)
                        {
                            ...
                            var tb47 = (from iTb045 in TB045_NOS_NUM.RetornaTodosRegistros()
                                            join iTb47 in TB47_CTA_RECEB.RetornaTodosRegistros()
                                                on iTb045.NU_DOC equals iTb47.NU_DOC
                            ...
                            if (tb47 != null)
                            {
                                if (tb47.IC_SIT_DOC == "Q" || tb47.IC_SIT_DOC == "P")
                                    ret.FL_STATUS = "Q";
                                else if (tb47.IC_SIT_DOC == "A")
                                    ret.FL_STATUS = "P";
                                else
                                    ret.FL_STATUS = "C";
                                ret.NU_DCTO_RECEB = tb47.NU_DOC;
                            }
                            else
                            {
                                ret.FL_STATUS = "I";
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    var tb47 = (from iT045 in TB045_NOS_NUM.RetornaTodosRegistros()
                                                    join iTb47 in TB47_CTA_RECEB.RetornaTodosRegistros()
                                                        on iT045.NU_DOC equals iTb47.NU_DOC
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    foreach (DetalheRetornoCNAB240 detalhe in cnab240.ListaDetalhes)
                    {
                        ...
                        if (tb321 == null)
                        {
                            ...
                            var tb47 = (from iTb045 in TB045_NOS_NUM.RetornaTodosRegistros()
                                        join iTb47 in TB47_CTA_RECEB.RetornaTodosRegistros() on iTb045.NU_DOC equals iTb47.NU_DOC
                                        ...
                                        where (ret.IDEBANCO == "001" ? ret.NU_NOSSO_NUMERO.Contains(iTb47.CO_NOS_NUM.Trim()) : iTb045.CO_NOS_NUM.Contains(nossoNum))
                                        select iTb47).FirstOrDefault();
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    var tb47 = (from iTb045 in TB045_NOS_NUM.RetornaTodosRegistros()
                                                    join iTb47 in TB47_CTA_RECEB.RetornaTodosRegistros()
                                                        on iTb045.NU_DOC equals iTb47.NU_DOC
                                                where iTb47.CO_NOS_NUM.Contains(nossoNum)
                                                select iTb47).FirstOrDefault();
