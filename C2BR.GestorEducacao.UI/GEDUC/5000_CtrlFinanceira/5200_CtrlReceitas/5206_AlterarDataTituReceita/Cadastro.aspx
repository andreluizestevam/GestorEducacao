        ...
        <ul id="ulDados" class="ulDados">
            ...
            <li class="liClear" style="margin-left: 50px;">
                <label for="ddlResponsavel" title="Responsável">
                    Responsável</label>
                <asp:DropDownList ID="ddlResponsavel" runat="server" ToolTip="Selecione o Responsável"
                ...
                <asp:RequiredFieldValidator ID="rfvRes" runat="server" ControlToValidate="ddlResponsavel"
                    ErrorMessage="Informe o responsavel">*</asp:RequiredFieldValidator>
            </li>
            <li>
                <asp:Label CssClass="lblObrigatorio" runat="server" ID="lblNomeAluPac">Aluno</asp:Label>
                <br />
            ...
            <li class="liResumo" id="liResumo" runat="server" visible="false" style="margin-left:290px;"><span style="font-size: 1.4em;
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Vencimento">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:TextBox ID="txtData" CssClass="campoData" Text='<%# bind("NovaData") %>' Enabled="false"
                                        runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="R$ Valor">
                                <ItemStyle Width="170px" HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <asp:TextBox ID="txtValorAtual" CssClass="campoDin" Text='<%# bind("VR_PAR_DOC") %>'
                                        Enabled="false" runat="server" />
                                    <asp:TextBox ID="txtValorNovo" CssClass="campoDin" Text='<%# bind("NovoValor") %>'
                                        Enabled="false" runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
