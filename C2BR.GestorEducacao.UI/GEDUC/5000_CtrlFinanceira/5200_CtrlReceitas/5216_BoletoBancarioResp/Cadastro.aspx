<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" 
    CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F5000_CtrlFinanceira.F5200_CtrlReceitas.F5216_BoletoBancarioResp.Cadastro" %>
...
<ul id="ulDados" class="ulDados">
    <li>
        <label runat="server" id="lblDescNome" for="txtNome">Nome do Responsável</label>
    ...
    <li>
        <label>Aluno</label>
        <asp:DropDownList ID="drpAlunos" Width="280px" OnSelectedIndexChanged="drpAlunos_SelectedIndexChanged" AutoPostBack="true" runat="server" />
    </li>
    <li>
        <label>Parcela</label>
        <asp:DropDownList ID="drpParcela" Width="50px" OnSelectedIndexChanged="drpParcela_SelectedIndexChanged" AutoPostBack="true" runat="server" />
    </li>
    <li class="liGrid">
        ...
        <asp:RadioButton ID="rbSegunda" runat="server" CssClass="chkSelecionarTodos" 
            GroupName="TipoBoleto" Text="2º Via" OnCheckedChanged="rdbNovoSegunda_CheckedChanged" AutoPostBack="True" />
        <asp:RadioButton ID="rbNovo" runat="server" CssClass="chkSelecionarTodos" 
            GroupName="TipoBoleto" Text="Novo" OnCheckedChanged="rdbNovoSegunda_CheckedChanged" AutoPostBack="True" />
            </div>
