...
namespace C2BR.GestorEducacao.UI.GEDUC.F5000_CtrlFinanceira.F5200_CtrlReceitas.F5299_Relatorios
{
    public partial class DiarioFinanceiro : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            string paramEscola = (LoginAuxili.CO_TIPO_UNID == "PGE" ? " - Mod.: " + ddlModalidade.SelectedItem.ToString() + " - Série: " + ddlSerieCurso.SelectedItem.ToString() +
                " - Turma: " + ddlTurma.SelectedItem.ToString() : "");

            strParametrosRelatorio = "( Unid. Contrato: " + siglaUnidContr + paramEscola + " - Agrupador: " + ddlAgrupador.SelectedItem.ToString()
            ...
            var res = (from adm in ADMMODULO.RetornaTodosRegistros()
                       where adm.nomURLModulo == "GEDUC/5000_CtrlFinanceira/5200_CtrlReceitas/5299_Relatorios/DiarioFinanceiro.aspx"
            ...
            lRetorno = fpcb.InitReport(strParametrosRelatorio, LoginAuxili.ORG_CODIGO_ORGAO, strP_CO_EMP, strP_CO_EMP_REF,
                strUniContr, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, strP_CO_ANO_MES_MAT, strP_CO_TIPO_DOC, strP_DT_INI,
                strP_DT_FIM, strP_CO_AGRUP, strP_ORIG_PAGTO, strP_CO_TipoPagto, strINFOS, NO_RELATORIO);
            Session["Report"] = fpcb;
        ...
        private void VerificaTipoUnid()
        {
            ...
            {
                case "PGS":
                    liItensEscola.Visible = false;
                    break;
                case "PGE":
                default:
                    liItensEscola.Visible = true;
                    break;
            }
        }
        ...
        {
            int coEmp = ddlUnidContrato.SelectedValue != "" ? int.Parse(ddlUnidContrato.SelectedValue) : 0;
