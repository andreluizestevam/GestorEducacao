<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master"
    AutoEventWireup="true" CodeBehind="PrevReceitasPorDataVencimento.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._5000_CtrlFinanceira._5200_CtrlReceitas._5299_Relatorios.PrevReceitasPorDataVencimento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <ul id="ulDados" class="ulDados">
        ...
        <li runat="server" id="divItensEscola">
            <ul>
                <li>
                    <label>
                        Modalidade</label>
                ...
                <li>
                    <label>
                        Curso</label>
                    <asp:DropDownList runat="server" ID="ddlCurso" Width="120px" OnSelectedIndexChanged="ddlCurso_OnSelectedIndexChanged"
                        AutoPostBack="true">
                    </asp:DropDownList>
                </li>
                <li style="clear: both">
                    <label>
                        Turma</label>
                    <asp:DropDownList runat="server" ID="ddlTurma" Width="110px">
                    </asp:DropDownList>
                </li>
            </ul>
        </li>
