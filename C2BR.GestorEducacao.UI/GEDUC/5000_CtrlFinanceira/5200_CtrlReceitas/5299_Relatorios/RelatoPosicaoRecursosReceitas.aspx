<%@ Page Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master" AutoEventWireup="true"
    CodeBehind="RelatoPosicaoRecursosReceitas.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F5000_CtrlFinanceira.F5200_CtrlReceitas.F5299_Relatorios.RelatoPosicaoRecursosReceitas"
    Title="Untitled Page" %>
            ...
            <ContentTemplate>
                ...
                <li class="liTipoPessoa">
                    ...
                    <asp:DropDownList ID="ddlTipoPessoa" ToolTip="Selecione o Tipo" CssClass="ddlTipoPessoa"
                        ...
                        <asp:ListItem Value="A" Selected="true">Aluno</asp:ListItem>
                ...
                <li>
                    <div runat="server" id="divItensEscola">
                        <li class="liAnoRefer" style="margin: 5px 0 0 0; clear:both" runat="server" id="liAnoRefer">
                        ...
                        <li class="liModalidade" runat="server" id="liModalidade">
                            <label title="Modalidade" for="ddlModalidade">
                                Modalidade</label>
                            <asp:DropDownList ID="ddlModalidade" ToolTip="Selecione a Modalidade" CssClass="ddlModalidade"
                        ...
                        <li class="liSerie" style="margin: 5px 0 0 0; width: 125px;" runat="server" id="liSerie">
                            <label title="Série/Curso" for="ddlSerieCurso">
                                Curso</label>
                        ...
                        <li class="liTurma" style="margin-top: 5px; width: 125px;" runat="server" id="liTurma">
                            <label id="lblTurma" title="Turma" for="ddlTurma">
                                Turma</label>
                            <asp:DropDownList ID="ddlTurma" CssClass="ddlTurma" ToolTip="Selecione a Turma" runat="server" OnSelectedIndexChanged="ddlTurma_OnSelectedIndexChanged" AutoPostBack="true">
                            </asp:DropDownList>
                        </li>
                    </div>
                </li>
                <li class="liAluno" runat="server" id="liAluno">
                    <asp:Label runat="server" ID="lblNomeAluPac">
                        Aluno</asp:Label><br />
                    <asp:DropDownList ID="ddlAlunos" ToolTip="Selecione o Aluno" CssClass="ddlNomePessoa"
                        runat="server">
                    </asp:DropDownList>
                </li>
