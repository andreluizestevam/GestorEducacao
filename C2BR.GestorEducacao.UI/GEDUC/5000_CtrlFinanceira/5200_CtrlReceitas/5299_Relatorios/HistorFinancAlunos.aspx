    ...
    <ul id="ulDados" class="ulDados">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <li class="liAnoRefer" runat="server" id="liAnoRefer">
                ...
                <li class="liSerie">
                    <label style="clear: both; margin-bottom: 5px;" title="Pesquisa Por">
                        Pesquisa Por</label>
                    <asp:CheckBox CssClass="chkLocais" Style="margin-left: -5px" ID="chkPorSerieTurma"
                        Checked="true" OnCheckedChanged="chkPorSerieTurma_CheckedChanged" TextAlign="Right"
                        AutoPostBack="true" runat="server" Text="Por Série/Turma" />
                    <asp:CheckBox CssClass="chkLocais" ID="chkPorAluno" OnCheckedChanged="chkPorAluno_CheckedChanged"
