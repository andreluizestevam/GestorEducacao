<%@ Page Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master" AutoEventWireup="true"
    CodeBehind="RelacaoTituloAlunosRecursReceitas.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F5000_CtrlFinanceira.F5200_CtrlReceitas.F5299_Relatorios.RelacaoTituloAlunosRecursReceitas"
    Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <ul id="ulDados" class="ulDados">
            ...
            <ContentTemplate>
                ...
                <li class="liUnidade">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="validatorField"
                        ControlToValidate="ddlUnidContrato" Text="*" ErrorMessage="Campo Unidade de Contrato é requerido"
                        SetFocusOnError="true"></asp:RequiredFieldValidator>
                </li>
                <li class="liAnoRefer" id="liAnoRefer" runat="server">
                    <label title="Ano de Referência">
                        Ano Referência</label>
                    <asp:DropDownList ID="ddlAnoRefer" ToolTip="Selecione o Ano de Referência" CssClass="ddlAno"
                        runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlAnoRefer_SelectedIndexChanged">
                    </asp:DropDownList>
                </li>
                <li class="liSerie">
                    <label style="clear: both;" title="Pesquisa Por">
                        Pesquisa Por</label>
                    <asp:CheckBox CssClass="chkLocais" ID="chkPorAluno" TextAlign="Right" AutoPostBack="true"
                        runat="server" Text="Por Aluno" OnCheckedChanged="chkPorAluno_CheckedChanged1" />
                    <asp:CheckBox CssClass="chkLocais" ID="chkPorResponsavel" TextAlign="Right" AutoPostBack="true"
                        runat="server" Text="Por Responsável" OnCheckedChanged="chkPorResponsavel_CheckedChanged1" />
                </li>
                <li class="liNumDoc">
                    <label class="label" title="Nº do Documento">
                        Nº do Documento</label>
                    <asp:TextBox ID="txtNumDoc" CssClass="txtNumDoc" ToolTip="Informe o Nº do Documento"
                        runat="server"></asp:TextBox>
                </li>
                <li class="liAluno" id="liAluno" runat="server" visible="false" style="margin-top:-7px;">
                    <ul>
                        <li runat="server" id="liItensEscola">
                            <ul>
                                <li class="liModalidade" id="liModalidade" runat="server">
                                    <label id="Label4" for="ddlModalidade" title="Modalidade" runat="server">
                                        Modalidade</label>
                                ...
                                <li class="liSerie" id="liSerie" runat="server">
                                    <label id="Label5" for="ddlSerieCurso" title="Série/Curso" runat="server">
                                        Série/Curso</label>
                                ...
                                <li class="liTurma" id="liTurma" runat="server">
                                    <label id="Label6" for="ddlTurma" title="Turma">
                                        Turma</label>
                        ...
                        <li style="margin-top:5px;">
                            <asp:Label runat="server" ID="lblNomeAluPac">
                Aluno</asp:Label><br />
                            <asp:DropDownList ID="ddlAlunos" runat="server" ToolTip="Selecione o desejado" CssClass="ddlNomePessoa">
                            </asp:DropDownList>
                        </li>
                    </ul>
                </li>
        ...
        <li class="liVencimento">
            ...
            <asp:TextBox ID="txtDtVenctoIni" ToolTip="Informe a Data Inicial do Vencimento" CssClass="campoData"
                runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="rfvtxtDataPeriodoIni" runat="server" CssClass="validatorField"
                ControlToValidate="txtDtVenctoIni" Text="*" ErrorMessage="Campo Data Período Início é requerido"
                SetFocusOnError="true"></asp:RequiredFieldValidator>
            ...
            <asp:CompareValidator ID="CompareValidator2" runat="server" CssClass="validatorField"
                ForeColor="Red" ControlToValidate="txtDtVenctoFim" ControlToCompare="txtDtVenctoIni"
            ...
            <asp:RequiredFieldValidator ID="rfvtxtDataPeriodoFim" runat="server" CssClass="validatorField"
                ControlToValidate="txtDtVenctoFim" Text="*" ErrorMessage="Campo Data Período Fim é requerido"
                SetFocusOnError="true"></asp:RequiredFieldValidator>
        </li>
        <li class="liPeriodo">
            <label for="txtPeriodo" title="Período de Cadastro">
                Período de Cadastro</label>
            <asp:TextBox ID="txtDataPeriodoIni" CssClass="campoData" ToolTip="Informe a Data Inicial de Cadastro"
                runat="server"></asp:TextBox>
