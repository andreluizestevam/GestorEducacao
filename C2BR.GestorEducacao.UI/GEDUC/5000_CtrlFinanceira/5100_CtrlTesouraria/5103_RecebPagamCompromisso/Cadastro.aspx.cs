    ...
    public partial class Cadastro : System.Web.UI.Page
    {
        ...
        protected void btnAbreCaixa_Click(object sender, EventArgs e)
        {
            ...
            {                
                ...
                string url = String.Format("/GEDUC/5000_CtrlFinanceira/5100_CtrlTesouraria/5103_RecebPagamCompromisso/MovimentacaoCaixa.aspx?moduloId=692&moduloNome=Registro+de+Recebimento+ou+Pagamento+de+Compromissos+Financeiros+NU_NIRE=" + NU_NIRE);
                AuxiliPagina.RedirecionaParaPaginaSucesso("Autenticação do Caixa Efetuado com sucesso", url);
            }
            else
