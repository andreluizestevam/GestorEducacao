...
// ---------+----------------------------+-------------------------------------
// 29/07/16 | Filipe Rodrigues           | Criação da flag e valor de desconto até o 5º dia útil
//
...
//====> Processo de Inclusão, Alteração e Exclusão de Registros na Entidade do BD, após a ação de salvar
        void CurrentPadraoCadastros_OnAcaoBarraCadastro()
        {
            ...
            if (Page.IsValid)
            {
                ...
                tb227.CO_MODU_CUR = ddlModalidade.SelectedValue != "0" ? (int.Parse(ddlModalidade.SelectedValue)) : (int?)null;
                tb227.CO_CUR = ddlCurso.SelectedValue != "0" ? (int.Parse(ddlCurso.SelectedValue)) : (int?)null;
                ...
                tb227.FL_DESC_DIA_UTIL = chkDescDiaUtil.Checked ? "S" : "N";
                tb227.VL_DESC_DIA_UTIL = !String.IsNullOrEmpty(txtVlDescDiaUtil.Text) ? decimal.Parse(txtVlDescDiaUtil.Text) : (decimal?)null;
        ...
        void CarregaFormulario()
        {
            ...
            if (tb227 != null)
            {
                ...
                ddlModalidade.SelectedValue = tb227.CO_MODU_CUR.ToString();
                CarregaCursos();
                ddlCurso.SelectedValue = tb227.CO_CUR.ToString();

                chkDescDiaUtil.Checked = tb227.FL_DESC_DIA_UTIL == "S" ? true : false;
                if (tb227.VL_DESC_DIA_UTIL.HasValue)
                    txtVlDescDiaUtil.Text = tb227.VL_DESC_DIA_UTIL.Value.ToString();
            }
        }
