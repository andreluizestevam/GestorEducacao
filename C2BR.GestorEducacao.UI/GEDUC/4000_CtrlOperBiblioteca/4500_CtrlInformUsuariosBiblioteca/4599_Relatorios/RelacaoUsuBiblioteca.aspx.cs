...
// OBJETIVO: EMISSÃO DA RELAÇÃO DE USUÁRIOS DA BIBLIOTECA
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class RelacaoUsuBiblioteca : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelRelacUsuBiblioteca");
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            lRetorno = lIRelatorioWeb.RelRelacUsuBiblioteca(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strP_CO_EMP, strP_CO_TP_USU, LoginAuxili.ORG_NUMERO_CNPJ.ToString());
