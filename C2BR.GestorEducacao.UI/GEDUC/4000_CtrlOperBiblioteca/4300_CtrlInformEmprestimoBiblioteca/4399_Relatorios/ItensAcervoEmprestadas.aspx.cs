...
// OBJETIVO: RELAÇÃO DE ITENS DE ACERVO BIBLIOGRÁFICOS EMPRESTADOS
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class ItensAcervoEmprestadas : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelObrasEmprestadas");
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            lRetorno = lIRelatorioWeb.RelObrasEmprestadas(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strP_CO_EMP, strP_CO_AREACON, strP_DE_ARECON, strP_DT_INI, strP_DT_FIM, LoginAuxili.ORG_NUMERO_CNPJ.ToString());
