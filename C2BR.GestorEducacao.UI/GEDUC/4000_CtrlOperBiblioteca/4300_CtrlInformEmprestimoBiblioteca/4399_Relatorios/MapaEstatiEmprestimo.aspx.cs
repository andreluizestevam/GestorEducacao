...
// OBJETIVO: MAPA ESTATÍSTICO DE EMPRÉSTIMO REALIZADOS
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class MapaEstatiEmprestimo : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelMapaEstaticEmpr");
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            lRetorno = lIRelatorioWeb.RelMapaEstaticEmpr(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strP_CO_EMP, strP_CO_ANO_REFER, LoginAuxili.ORG_NUMERO_CNPJ.ToString());
