...
// OBJETIVO: RELAÇÃO DE ITENS DE ACERVO BIBLIOGRÁFICOS COM DEVOLUÇÃO ATRASADA
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class ItensAcervoEmAtraso : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            string strP_CO_EMP, strP_CO_AREACON, strP_DE_ARECON, strP_DT_INI, strP_DT_FIM;
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelObrasEmAtraso");
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            strP_DE_ARECON = ddlAreaInteresse.SelectedItem.ToString();
            strP_DT_INI = txtDataPeriodoIni.Text;
            strP_DT_FIM = txtDataPeriodoFim.Text;

            lIRelatorioWeb = varRelatorioWeb.CreateChannel();

            lRetorno = lIRelatorioWeb.RelObrasEmAtraso(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strP_CO_EMP, strP_CO_AREACON, strP_DE_ARECON, strP_DT_INI, strP_DT_FIM, LoginAuxili.ORG_NUMERO_CNPJ.ToString());
