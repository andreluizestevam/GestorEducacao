<%@ Page Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master" AutoEventWireup="true" CodeBehind="ItensAcervoEmprestadas.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F4000_CtrlOperBiblioteca.F4300_CtrlInformEmprestimoBiblioteca.F4399_Relatorios.ItensAcervoEmprestadas" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <ul id="ulDados" class="ulDados">
        ...
        <li class="liAreaInteresse">
            ...
            <asp:DropDownList ID="ddlAreaInteresse" ToolTip="Selecione uma Área de Interesse" CssClass="ddlAreaInteresse" runat="server">           
            </asp:DropDownList>            
        </li>                                                                             
    </ul>
</asp:Content>
