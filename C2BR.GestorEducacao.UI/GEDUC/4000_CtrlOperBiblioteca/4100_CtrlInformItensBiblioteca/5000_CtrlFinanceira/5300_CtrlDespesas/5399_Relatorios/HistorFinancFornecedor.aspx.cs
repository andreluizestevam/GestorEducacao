...
{
    public partial class HistorFinancFornecedor : System.Web.UI.Page
    {
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            strParametrosRelatorio = "Unidade: " + ddlUnidade.SelectedItem.ToString().Trim() + " - Status: " + ddlStaDocumento.SelectedItem.ToString() + " - Agrupador: " + ddlAgrupador.SelectedItem.ToString();

            RptHistorFinancFornecedor fpcb = new RptHistorFinancFornecedor();
            lRetorno = fpcb.InitReport(strParametrosRelatorio, LoginAuxili.ORG_CODIGO_ORGAO, strP_CO_EMP, strP_CO_EMP_REF, strP_IC_SIT_DOC, strP_CO_AGRUP, strINFOS);
            Session["Report"] = fpcb;
