...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        ...
        * {margin-bottom:0px !important;}
        ...
        .ddlCarteira {width:290px;}
        .txtInstrucoes {width:397px;}        
        .txtCodigoCedente {text-align:right;width:75px;}        
        .txtNumeroConvenio {text-align:right;width:56px;}
        .ddlTipoTaxaBoleto {width:120px;}
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <ul id="ulDados" class="ulDados">
        ...
        <li>
            <label for="ddlConta" class="lblObrigatorio" title="Conta">Conta</label>
        ...
        <li class="liClear">
            <label for="ddlCarteira" class="lblObrigatorio" title="Carteira">Carteira</label>
            <asp:DropDownList ID="ddlCarteira" runat="server" CssClass="ddlCarteira"
                ToolTip="Selecione a Carteira">
            </asp:DropDownList>
        ...
        <li class="liClear">
            <label for="ddlTipoTaxaBoleto" class="lblObrigatorio" title="Tipo de Taxa do Boleto">Tipo</label>
            ...
            <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlTipoTaxaBoleto" CssClass="validatorField"
                ErrorMessage="Tipo de Taxa do Boleto é requerido">
            </asp:RequiredFieldValidator>
        </li>
        <li>
            <label for="txtCodigoCedente" class="lblObrigatorio" title="Código do Cedente">Código Cedente</label>
            <asp:TextBox ID="txtCodigoCedente" runat="server" CssClass="txtCodigoCedente"
                ToolTip="Informe o Código do Cedente"
                MaxLength="10">
            </asp:TextBox>
        ...
        <li>
            <label for="txtNumeroConvenio" class="lblObrigatorio" title="Número do Convênio">N° Convênio</label>
            <asp:TextBox ID="txtNumeroConvenio" runat="server" CssClass="txtNumeroConvenio"
                ToolTip="Informe o Número do Convênio"
                MaxLength="7">
            </asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtNumeroConvenio" CssClass="validatorField"
                ErrorMessage="Número do Convênio é requerido">
            </asp:RequiredFieldValidator>
        </li>
        
        <li>
            <label for="txtInstrucoesL1" title="Instruções impressas na primeira linha do Boleto">Instruções - Linha 1</label>
            <asp:TextBox ID="txtInstrucoesL1" runat="server" MaxLength="120" CssClass="txtInstrucoes"
                ToolTip="Informe as Instruções da Linha 1">
            </asp:TextBox>
        </li>
        <li>
            <label for="txtInstrucoesL2" title="Instruções impressas na segunda linha do Boleto">Instruções - Linha 2</label>
            <asp:TextBox ID="txtInstrucoesL2" runat="server" MaxLength="120" CssClass="txtInstrucoes"
                ToolTip="Informe as Instruções da Linha 2">
            </asp:TextBox>
        </li>
        <li >
            <label for="txtInstrucoesL3" title="Instruções impressas na terceira linha do Boleto">Instruções - Linha 3</label>
            <asp:TextBox ID="txtInstrucoesL3" runat="server" MaxLength="120" CssClass="txtInstrucoes"
                ToolTip="Informe as Instruções da Linha 3">
            </asp:TextBox>
        </li>
         <li style="clear:none">
             <span style="float:left"><asp:CheckBox ID="chkTxBolCli" AutoPostBack="True" 
                 oncheckedchanged="chkTxBolCliChanged_CheckedChanged" runat="server" ></asp:CheckBox></span>
             <label style="width:170px">Taxa de Boleto ao Cliente</label>
