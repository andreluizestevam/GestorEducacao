    ...
    public partial class Busca : System.Web.UI.Page
    {
        ...
        void CurrentPadraoBuscas_OnAcaoBuscaDefineGridView()
        {
            var resultado = (from tb37 in TB37_RECDES_FIXA.RetornaTodosRegistros()
                            where (txtNome.Text != "" ? tb37.TB41_FORNEC.NO_FAN_FOR.Contains(txtNome.Text) : txtNome.Text == "")
                            && tb37.CO_ADITI_RECDES == 0 && tb37.TP_CON_RECDES == "D"
                            select new
                            {
                                CO_ADITI_RECDES = 0, tb37.DT_CAD_RECDES, tb37.CO_CON_RECDES, tb37.TP_CON_RECDES, tb37.TB41_FORNEC.NO_FAN_FOR, tb37.CO_EMP,
