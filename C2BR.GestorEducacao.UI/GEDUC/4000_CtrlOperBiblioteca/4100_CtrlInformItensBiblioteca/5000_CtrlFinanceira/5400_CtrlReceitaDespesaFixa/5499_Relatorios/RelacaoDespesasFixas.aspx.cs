...
// OBJETIVO: RELAÇÃO DE DESPESAS FIXAS DA INSTITUIÇÃO
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class RelacaoDespesasFixas : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelDespesasFixas");
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            lRetorno = lIRelatorioWeb.RelDespesasFixas(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strParametrosRelatorio, strP_CO_EMP, strP_IC_SIT_RECDES, strP_CO_CON_RECDES, strP_DT_INI, strP_DT_FIM, strP_CO_CPF_CNPJ_RECDES, strP_NO_CLI_RECDES);
