...
// OBJETIVO: CURVA ABC DE VALORES DAS RECEITAS/MENSALIDADES
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class CurvaABCRecursosReceitas : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            string strP_IC_SIT_DOC, strP_TP_CLIENTE;
            int strP_CO_EMP, strP_CO_AGRUP;
            DateTime strP_DT_INI, strP_DT_FIM;

            //--------> Inicializa as variáveis
            strP_IC_SIT_DOC = null;
            strP_TP_CLIENTE = null;
            ...
            strP_TP_CLIENTE = ddlTpCliente.SelectedValue;
            ...
            strParametrosRelatorio = "( Período de: " + txtDataPeriodoIni.Text + " à " + txtDataPeriodoFim.Text + " - Situação: " + ddlSituacao.SelectedItem.ToString() +
                " - Tipo: " + ddlTpCliente.SelectedItem.ToString() + " - Agrupador: " + ddlAgrupador.SelectedItem.ToString() + " )";

            RptCurvaABCRecursosReceitas fpcb = new RptCurvaABCRecursosReceitas();
            lRetorno = fpcb.InitReport(strParametrosRelatorio, LoginAuxili.ORG_CODIGO_ORGAO, LoginAuxili.CO_EMP, strP_CO_EMP, strP_IC_SIT_DOC, strP_TP_CLIENTE, strP_DT_INI, strP_DT_FIM, strP_CO_AGRUP, strINFOS);
            Session["Report"] = fpcb;
