            ...
            try
            {
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    foreach (DetalheRetorno detalhe in cnab400.ListaDetalhe)
                    {
                        ...
                        string nossoNum = banco == 237 ? long.Parse(detalhe.NossoNumero.Substring(0, 11)).ToString() : long.Parse(detalhe.NossoNumero).ToString();
                        ...
                        if (tb321 == null)
                        {
                            ...
                            var tb47 = (from iTb47 in TB47_CTA_RECEB.RetornaTodosRegistros()
                                        where iTb47.CO_NOS_NUM.Equals(nossoNum)
                    ...
                    foreach (DetalheRetornoCNAB240 detalhe in cnab240.ListaDetalhes)
                    {
                        ...
                        if (tb321 == null)
                        {
                            ...
                            var tb47 = (from iTb47 in TB47_CTA_RECEB.RetornaTodosRegistros()
                                        ...
                                        where (ret.IDEBANCO == "001" ? ret.NU_NOSSO_NUMERO.Contains(iTb47.CO_NOS_NUM.Trim()) : iTb47.CO_NOS_NUM.Contains(nossoNum))
                                        select iTb47).FirstOrDefault();
