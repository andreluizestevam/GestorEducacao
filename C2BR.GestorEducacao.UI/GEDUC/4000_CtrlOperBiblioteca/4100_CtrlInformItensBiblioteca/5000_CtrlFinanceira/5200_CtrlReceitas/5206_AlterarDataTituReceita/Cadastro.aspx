<%@ Page Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true"
    CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F5000_CtrlFinanceira.F5200_CtrlReceitas.F5206_AlterarDataTituReceita.Cadastro"
    Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <ul id="ulDados" class="ulDados">
        <li>
            <label for="txtNomeEmp" title="Unidade/Escola">
                Unidade/Escola</label>
            <asp:TextBox ID="txtNomeEmp" CssClass="campoUnidadeEscolar" Enabled="false" runat="server" ToolTip="Nome da unidade/escola atual"></asp:TextBox>
        </li>
        <li>
            ...
            <ContentTemplate>
                ...
                <li>
                    ...
                    <asp:RequiredFieldValidator ID="rfvAluno" runat="server" 
                        ControlToValidate="ddlAluno" ErrorMessage="Informe o aluno">*</asp:RequiredFieldValidator>
                </li>
            </ContentTemplate>
        </asp:UpdatePanel>
        <li>
                    ...
                    <asp:GridView ID="grdResumo" CssClass="grdBusca" Width="580px" runat="server" AutoGenerateColumns="False">
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="">
                                <ItemStyle Width="0px" />
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkSelect" Checked='<%# bind("Checked") %>' runat="server" OnCheckedChanged="chkSelect_CheckedChanged" AutoPostBack="true"/>
                                    </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Vencimento">
                                ...
                                <ItemTemplate>                                
                                        <asp:TextBox ID="txtDataAtual" CssClass="campoData" Text='<%# bind("DT_VEN_DOC") %>' Enabled="false" runat="server"/>
                                        <asp:TextBox ID="txtData" CssClass="campoData" Text='<%# bind("NovaData") %>' Enabled="false" runat="server"/>
                                </ItemTemplate>
                            </asp:TemplateField>    
                        </Columns>
                    </asp:GridView>
