...
//------------> Campos que devem ser desabilitados na alteração
        ...
        /// <summary>
        /// Método que gera um novo boleto para o título
        /// </summary>
        private void EmitirNovoBoleto(Boolean abrirBoleto = true)
        {
            //===> Valida se foi selecionada a unidade de contrato
