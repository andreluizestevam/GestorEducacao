            ...
            <ContentTemplate>
                ...
                <li class="liAluno" runat="server" id="liResponsavel">
                    <label title="Selecione o Responsável do aluno">
                        Responsável</label>
                    <asp:DropDownList ID="ddlResponsavel" ToolTip="Selecione o Responsável do aluno" CssClass="ddlNomePessoa"
                        runat="server" OnSelectedIndexChanged="ddlResponsavel_SelectedIndexChanged" AutoPostBack="true">
                    </asp:DropDownList>
                </li>
               ...
               <li class="liAluno" runat="server" id="liCliente" visible="false">
                ...
                <li class="liAnoRefer" style="margin: 5px 0 0 0; width: 125px;" runat="server" id="liAnoRefer">
