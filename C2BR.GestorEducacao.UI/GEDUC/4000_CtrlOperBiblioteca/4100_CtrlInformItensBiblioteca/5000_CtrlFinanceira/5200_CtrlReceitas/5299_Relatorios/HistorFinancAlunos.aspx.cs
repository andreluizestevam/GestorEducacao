...
namespace C2BR.GestorEducacao.UI.GEDUC.F5000_CtrlFinanceira.F5200_CtrlReceitas.F5299_Relatorios
{
    public partial class HistorFinancAlunos : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            strParametrosRelatorio = "( Ano: " + ddlAnoRefer.SelectedItem.ToString().Trim() + " - Modalidade: " + ddlModalidade.SelectedItem.ToString() + " - Série: " + ddlSerieCurso.SelectedItem.ToString() + " - Turma: " + ddlTurma.SelectedItem.ToString() +
        ...
        private void CarregaTurma()
        {
            ...
            ddlTurma.Items.AddRange(AuxiliBaseApoio.TurmasDDL(ddlUnidade.SelectedValue, ddlModalidade.SelectedValue, ddlSerieCurso.SelectedValue, ddlAnoRefer.SelectedValue, todos:true));
        ...
        private void CarregaSerieCurso()
        {
            ...
            ddlSerieCurso.Items.AddRange(AuxiliBaseApoio.SeriesDDL(ddlUnidade.SelectedValue, ddlModalidade.SelectedValue, ddlAnoRefer.SelectedValue, todos:true));
