...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <ul id="ulDados" class="ulDados">
        ...
        <li class="liTpInadimplencia">
            ...
            <asp:ListItem Value="S">Inadimplência Série/Turma</asp:ListItem>
            <asp:ListItem Value="R">Inadimplência por Responsável</asp:ListItem>
            </asp:DropDownList>            
        ...
        <li id="liAnoRefer" class="liAnoRefer"  runat="server">
            ...
            <asp:RequiredFieldValidator ID="rfvAno" runat="server" 
                ControlToValidate="ddlAnoRefer" ErrorMessage="Informe o ano">*</asp:RequiredFieldValidator>
        </li>                              
        ...
        <label title="Série/Curso" for="ddlSerieCurso">Série/Curso</label>
        ...
        <li id="liPeriodo" class="liModalidade" runat="server">
            <label class="lblObrigatorio" title="Período" for="txtPeriodo">
                Período de Movimento</label>
