    ...
    <ul id="ulDados" class="ulDados">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <li class="liUnidContrato" style="margin: 5px 0 0 0; width: 265px;">
                    ...
                    <asp:DropDownList ID="ddlUnidContrato" ToolTip="Selecione a Unidade de Contrato"
                        CssClass="ddlUnidContrato" runat="server" AutoPostBack="True" 
                        onselectedindexchanged="ddlUnidContrato_SelectedIndexChanged">
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="rfvUnidade" runat="server" 
                        ControlToValidate="ddlUnidContrato" 
                ...
                <li class="liModalidade" runat="server" id="liModalidade">
                    <label title="Modalidade" for="ddlModalidade" class="lblObrigatorio">
                        Modalidade</label>
                    <asp:DropDownList ID="ddlModalidade" runat="server" AutoPostBack="true" 
                        CssClass="ddlModalidade" 
                        OnSelectedIndexChanged="ddlModalidade_SelectedIndexChanged" 
                        ToolTip="Selecione a Modalidade">
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="rfvModalidade" runat="server" 
                        ControlToValidate="ddlModalidade" ErrorMessage="Informe a modalidade">*</asp:RequiredFieldValidator>
                </li>
                <li class="liSerie" style="margin: 5px 0 0 0; width: 125px;" runat="server" id="liSerie">
                    <label title="Série/Curso" for="ddlSerieCurso" class="lblObrigatorio">
                        Série/Curso</label>
                    <asp:DropDownList ID="ddlSerieCurso" ToolTip="Selecione a Série/Curso" CssClass="ddlSerieCurso"
                ...
                <li class="liTurma" style="margin-top: 5px; width: 125px;" runat="server" id="liTurma">
                    <label id="lblTurma" title="Turma" for="ddlTurma" class="lblObrigatorio">
                        Turma</label>
                    <asp:DropDownList ID="ddlTurma" CssClass="ddlTurma" ToolTip="Selecione a Turma" 
                        runat="server" AutoPostBack="True" 
                        onselectedindexchanged="ddlTurma_SelectedIndexChanged">
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="rfvTurma" runat="server" 
                        ControlToValidate="ddlTurma" ErrorMessage="Informe a turma">*</asp:RequiredFieldValidator>
                </li>
                <li class="liAluno">
                    ...
                    <asp:DropDownList ID="ddlTipoDoctos" ToolTip="Selecione o Tipo de Documento" CssClass="ddlTipoDoctos"
                        runat="server" AutoPostBack="True" 
                        onselectedindexchanged="ddlTipoDoctos_SelectedIndexChanged">
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="rfvDoc" runat="server" 
                        ControlToValidate="ddlTipoDoctos" ErrorMessage="Informe o tipo de documento">*</asp:RequiredFieldValidator>
                </li>
                <li class="liAluno" style="margin-left: 5px;">
                    ...
                    <asp:DropDownList ID="ddlOrigPagto" ToolTip="Selecione a Origem de Pagamento" CssClass="ddlOrigPagto"
                        runat="server" AutoPostBack="True" 
                        onselectedindexchanged="ddlOrigPagto_SelectedIndexChanged">
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ControlToValidate="ddlOrigPagto" ErrorMessage="Informe a origem de pagamento">*</asp:RequiredFieldValidator>
                </li>
                <li class="liAluno" style="margin-left: 5px;">
                    <label id="lbDdlTipoPagto" title="Origem de Pagamento" for="ddlTipoPagto" runat="server" class="lblObrigatorio" visible="false">
                        Tipo de Pagamento</label>
                    <asp:DropDownList ID="ddlTipoPagto" ToolTip="Selecione a Tipo de Pagamento" CssClass="ddlOrigPagto"
                        runat="server" AutoPostBack="True" 
                        onselectedindexchanged="ddlTipoPagto_SelectedIndexChanged" Visible="False">
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="rfvPag" runat="server" 
                        ControlToValidate="ddlTipoPagto" ErrorMessage="Informe tipo de pagamento">*</asp:RequiredFieldValidator>
                </li>
                <li style="clear: both; margin-top: 5px;">
                    ...
                    <asp:DropDownList ID="ddlAgrupador" CssClass="ddlAgrupador" runat="server" 
                        ToolTip="Selecione o Agrupador de Receita" AutoPostBack="True" 
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                ControlToValidate="txtDataPeriodoIni" ErrorMessage=" Informe a data inicial">*</asp:RequiredFieldValidator>
            ...
            <asp:TextBox ID="txtDataPeriodoFim" ToolTip="Informe a Data Final" CssClass="campoData"
                runat="server"></asp:TextBox>
                    ...
                    <asp:CompareValidator ID="cvFim" runat="server" 
                        ControlToCompare="txtDataPeriodoIni" ControlToValidate="txtDataPeriodoFim" 
                        ErrorMessage="Data final deve ser maior que inicial" 
                        Operator="GreaterThanEqual" Type="Date">*</asp:CompareValidator>
            
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                ControlToValidate="txtDataPeriodoFim" ErrorMessage="Informe a data final">*</asp:RequiredFieldValidator>
