<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="MovimentacaoCaixa.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F5000_CtrlFinanceira.F5100_CtrlTesouraria.F5103_RecebPagamCompromisso.MovimentacaoCaixa" %>
...
<ul id="ulDados" class="ulDados">    
        ...
        <li style="clear: none;margin-left:10px;">
            ...
            <asp:CheckBox CssClass="chkLocais" ID="chkBenif1" Checked="true" OnCheckedChanged="chkBenif1_CheckedChanged" TextAlign="Right" AutoPostBack="true" runat="server" Text="Aluno"/>                                
        ...
        <li id="li5" runat="server" title="Clique para Realizar o Pagamento de Mensalidade(s)" class="lilnkRegPgto">                                    
            <a id="lnkMatriAluno" runat="server" href="" style="cursor: pointer;">MATRÍCULA</a>
        </li>
