...
// OBJETIVO: RELAÇÃO DE ALUNOS - PASSE ESCOLAR
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class AlunosPasseEscolar : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            string strP_CO_EMP, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, strP_CO_ANO_MES_MAT, strP_LIN_ONI;
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelAluPasEsc");
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            strP_LIN_ONI = ddlLinhaOnibus.SelectedValue;
            ...
            strParametrosRelatorio = "Ano referência: " + ddlAnoRefer.SelectedItem.ToString() + " - Módulo: " + ddlModalidade.SelectedItem.ToString() + " - Série: " + ddlSerieCurso.SelectedItem.ToString() +
                          " - Turma: " + ddlTurma.SelectedItem.ToString() + " - Linha de ônibus: " + ddlLinhaOnibus.SelectedItem.ToString();

            lIRelatorioWeb = varRelatorioWeb.CreateChannel();

            lRetorno = lIRelatorioWeb.RelAluPasEsc(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strParametrosRelatorio, strP_CO_EMP, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, strP_CO_ANO_MES_MAT, strP_LIN_ONI);
