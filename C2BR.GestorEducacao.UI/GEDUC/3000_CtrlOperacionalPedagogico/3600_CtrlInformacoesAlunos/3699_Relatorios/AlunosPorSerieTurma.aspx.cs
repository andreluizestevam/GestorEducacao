...
// ----------+----------------------------+-------------------------------------
// 06/08/2013| Victor Martins Machado     | Alterada a função que carrega os dados da série/curso
//           |                            | para utilizar a unidade corrente e não a unidade de contrato.
//           |                            | 
//----------+----------------------------+-------------------------------------
// 21/12/2016| Alex Ribeiro da Silva      | Alterada a função que carrega os dados da série/curso.
//           |                            | 
...
{
    public partial class AlunosPorSerieTurma : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            ...
            RptRelacaoAlunosPorSerieTurma rpt = new RptRelacaoAlunosPorSerieTurma();
            lRetorno = rpt.InitReport(parametros, LoginAuxili.CO_EMP, infos, strP_CO_EMP_REF, strP_CO_ANO_MES_MAT,
                                        strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR);
            Session["Report"] = rpt;
        ...
        private void CarregaAnos()
        {
            ...
            ddlAnoRefer.Items.Insert(1, new ListItem(proximoAno, proximoAno));
