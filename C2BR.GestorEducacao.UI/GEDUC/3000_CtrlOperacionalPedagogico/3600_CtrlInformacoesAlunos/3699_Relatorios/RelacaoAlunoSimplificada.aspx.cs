...
// OBJETIVO: RELAÇÃO DE ALUNOS SINMPLIFICADA (NIRE/NOME)
// DATA DE CRIAÇÃO: 15/02/2014
//-----------------------------------------------------------------------------
//                           HISTÓRICO ATIVIDADES DE MANUTENÇÃO
//-----------------------------------------------------------------------------
//  DATA     |  NOME DO PROGRAMADOR       | DESCRIÇÃO RESUMIDA
// ----------+----------------------------+-------------------------------------
// 15/02/2014| Débora Lohane              |Criação da funcionalidade
//           |                            | 
//           |                            | 
...
{
    public partial class RelacaoAlunoSimplificada : System.Web.UI.Page{
...
//--------> Variáveis de parâmetro do Relatório
            ...
            RptRelacaoAlunoSimplificada rpt = new RptRelacaoAlunoSimplificada();
            lRetorno = rpt.InitReport(parametros, LoginAuxili.CO_EMP, infos, strP_CO_EMP_REF, strP_CO_ANO_MES_MAT,
                                        strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, ordem);
            Session["Report"] = rpt;
