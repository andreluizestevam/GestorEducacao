...
{
    public partial class ResumoMatriculaPorPeriodoSemValor : System.Web.UI.Page
    {
        public string Sigla;
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            parametros = string.Format("(Un Cont: {0} - Modalidade: {1} - Curso: {2} - Turma: {3} - Ano: {4} - Situação: {7} - Período: {5} à {6})",
                        ddlUnidade.SelectedItem,
                        Sigla,//ddlModalidade.SelectedItem,
