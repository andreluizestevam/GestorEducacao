<%@ Page Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master" AutoEventWireup="true" CodeBehind="AtividExtraClasseAluno.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F3000_CtrlOperacionalPedagogico.F3600_CtrlInformacoesAlunos.F3699_Relatorios.AtividExtraClasseAluno" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        .ulDados { width: 300px; }
        .liUnidade,.liAtividades
        {
            margin-top: 5px;
            width: 300px;            
        }                                      
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ul id="ulDados" class="ulDados">
        ...
        <li class="liAtividades">
            <label class="lblObrigatorio" title="Atividades">
                Atividades</label>               
            <asp:DropDownList ID="ddlAtividades" ToolTip="Selecione uma Atividades" CssClass="ddlAtividades" runat="server">
            </asp:DropDownList>                
        </li>                                      
    </ul>
</asp:Content>
