...
{
    public partial class DeclaraDebitosDocumentosAluno : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            string deModalidde, noCur, noTurma, noAluno, nuAno, noUnidade;
            ...
            parametros = "( Unidade: " + noUnidade.ToUpper() + " - Ano:" + nuAno + " - Modalidade: " + deModalidde.ToUpper() + " - Série/Curso: " + noCur.ToUpper() + " - Turma: " + noTurma.ToUpper() + " )";
            infos = AuxiliRelatorioTemporario.GeraIdentFuncionarioRelatorio(Request.UserHostAddress);

            RptDeclaracaoMateriaisPendentes fpcb = new RptDeclaracaoMateriaisPendentes();
            lRetorno = fpcb.InitReport(parametros, infos, coEmp, unidade, anoRef, modalidade, serieCurso, Turma, aluno);
            Session["Report"] = fpcb;
