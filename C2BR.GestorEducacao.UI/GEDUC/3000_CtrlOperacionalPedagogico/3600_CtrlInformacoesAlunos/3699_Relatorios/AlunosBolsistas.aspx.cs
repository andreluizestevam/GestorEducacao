...
// OBJETIVO: RELAÇÃO DE ALUNOS - BOLSISTAS
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class AlunosBolsistas : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            int strP_CO_EMP_UNID_CONT, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, strP_CO_TIPO_BOLSA;
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            strP_CO_TIPO_BOLSA = int.Parse(ddlBolsa.SelectedValue);
            strP_CO_GRUPO_BOLSA = ddlGrupoBolsa.SelectedValue;
            ...
            parametros = "( Unid. Contr: " + ddlUnidade.SelectedItem.ToString() + " - Modal: " + ddlModalidade.SelectedItem.ToString() + " - Série: " + ddlSerieCurso.SelectedItem.ToString() + " - Turma: " + 
                ddlTurma.SelectedItem.ToString() + " - Ano Refer.: " + ddlAnoRefer.SelectedItem.ToString().Trim() + " - Grupo/Tipo: " + ddlGrupoBolsa.SelectedItem.ToString() + " / " + ddlBolsa.SelectedItem.ToString() + " )";

            RptAlunosBolsistas rpt = new RptAlunosBolsistas();
            lRetorno = rpt.InitReport(parametros, LoginAuxili.CO_EMP, strP_CO_EMP_UNID_CONT,strP_CO_ANO_MES_MAT, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, strP_CO_GRUPO_BOLSA, strP_CO_TIPO_BOLSA, infos);
            Session["Report"] = rpt;
        ...
        /// <summary>
        /// Método que carrega o dropdown de Bolsa/Convênio
        /// </summary>
        private void CarregaBolsa()
        {
            ddlBolsa.DataSource = TB148_TIPO_BOLSA.RetornaTodosRegistros().Where( p => p.TP_GRUPO_BOLSA == ddlGrupoBolsa.SelectedValue );

            ddlBolsa.DataTextField = "NO_TIPO_BOLSA";
            ddlBolsa.DataValueField = "CO_TIPO_BOLSA";
            ddlBolsa.DataBind();

            ddlBolsa.Items.Insert(0, new ListItem("Todos", "0"));
        }
        ...
        protected void ddlGrupoBolsa_SelectedIndexChanged(object sender, EventArgs e)
        {
            CarregaBolsa();
        }
    }
