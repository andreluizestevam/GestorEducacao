...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <ul id="ulDados" class="ulDados">
        ...
        <li style="width: 425px;">
            <ul>
                <li>
                    <label for="txtNireAlu" class="lblObrigatorio" title="Número do NIRE">
                        N° NIRE</label>
                ...
                <li class="liNisAlu" style="margin-left: 2px;">
                    <label for="txtNisAlu" title="Número do NIS">
                        N° NIS</label>
                    <asp:TextBox ID="txtNisAlu" CssClass="txtNisAlu" runat="server" ToolTip="Informe o Número do NIS"
	                    MaxLength="11"></asp:TextBox>
                    <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtNisAlu"
	                    ErrorMessage="NIS deve ser numérico de 11 dígitos" Text="*" Type="Double" MaximumValue="99999999999"
	                    MinimumValue="0"></asp:RangeValidator>
                </li>
                <li style="margin-left: 2px;">
        ...
        <li class="liBloco2" style="height: 115px;">
            <ul>
                ...
                <li class="liClear" style="margin-right: 0px;">
                    ...
                    <asp:TextBox ID="txtResponsavelAlu" CssClass="txtResponsavelAlu" ToolTip="Informe o Nome do Responsável pelo Aluno"
                ...
                <li class="liClear">
                    ...
                    <asp:TextBox ID="txtDtNascRespAlu" CssClass="campoData" runat="server" Enabled="false"
                        ToolTip="Data de Nascimento do Responsável do Aluno"></asp:TextBox>
                </li>
                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        ...
                        <li style="margin-top: 5px; margin-left: 0px;"><span title="Crédito na Lanchonete">-
                            Limite Crédito R$</span>
                            <asp:TextBox ID="txtCredLanchoAlu" CssClass="txtCredLanchoAlu" Enabled="false" runat="server"
                                Style="clear: none;" ToolTip="Digite o Crédito da Lanchonete"></asp:TextBox>
                        </li>
                    </ContentTemplate>
                </asp:UpdatePanel>
                    ...
                    <ul>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                            <ContentTemplate>
                                ...
                                <li class="lisepPeriodo" style="margin-left: -3px;"><span>à</span> </li>
                                ...
                                <li class="liClear">
                                    ...
                                    <div id="divGrid" class="divGrid" runat="server">
                                        <asp:GridView ID="grdMatriculas" runat="server" AutoGenerateColumns="False" CssClass="grdBusca"
                                            EmptyDataText="NENHUMA MATRÍCULA ENCONTRADA." Width="390px" >
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="SITUAÇÃO" DataField="nomeAprovacao" />
