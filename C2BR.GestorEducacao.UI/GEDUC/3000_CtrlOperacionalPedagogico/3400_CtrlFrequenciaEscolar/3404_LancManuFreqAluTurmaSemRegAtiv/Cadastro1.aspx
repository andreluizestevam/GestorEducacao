<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="Cadastro1.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3400_CtrlFrequenciaEscolar._3408_ReplicFreqAtivd.Cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
 ...
 <asp:HiddenField Value="" ID="hdCoAtivProfTur" runat="server" />
        ...
        <li class="liData">
            ...
            <asp:TextBox ID="txtData" CssClass="campoData" runat="server" ToolTip="Informe a Data" OnTextChanged="txtData_OnTextChanged" AutoPostBack="true"></asp:TextBox>
        </li>
        ...
        <li style="margin-top:23px !Important;">
               <%-- <li>
                    ...
                    <asp:CheckBox ID="chkRepeteFreq" CssClass="chkRepeteFreq" Checked="true" runat="server" OnCheckedChanged="chkRepeteFreq_OnCheckedChanged" AutoPostBack="true" />
                    <asp:Label ID="Label1" runat="server" style="margin-left:-5px">
                        Marca/Desm. Todos</asp:Label>
        </li>
                            ...
                            <div id="divGrid" runat="server" class="divGridData" style="margin-left: 75px;">
                                <asp:GridView ID="grdAtividades" CssClass="grdBusca" Width="300px" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="freq" HeaderText="Frequencia lançada">
