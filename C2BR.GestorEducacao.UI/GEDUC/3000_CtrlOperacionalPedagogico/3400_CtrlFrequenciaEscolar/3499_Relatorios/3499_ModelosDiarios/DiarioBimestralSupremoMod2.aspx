<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master"
    AutoEventWireup="true" CodeBehind="DiarioBimestralSupremoMod2.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3400_CtrlFrequenciaEscolar._3499_Relatorios._3499_ModelosDiarios.DiarioBimestralSupremoMod2" %>
            ...
            <ContentTemplate>
                ...
                <li class="liTipo">
                    <label class="lblObrigatorio" title="Layout">
                        Layout</label>
                    <asp:DropDownList ID="ddlTipo" CssClass="ddlTipo" runat="server" ToolTip="Selecione o Tipo de Layout" nSelectedIndexChanged="ddlTipo_SelectedIndexChanged"
                        AutoPostBack="true">
                    ...
                    <ul>
                        ...
                        <li style="margin-top: 10px;">
                            <ul>
                                ...
                                <li style="margin: 2px 0 0 0px; clear: both; display:none">
