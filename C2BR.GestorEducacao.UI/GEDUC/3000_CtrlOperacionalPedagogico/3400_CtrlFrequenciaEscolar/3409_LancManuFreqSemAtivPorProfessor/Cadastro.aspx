<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3400_CtrlFrequenciaEscolar._3409_LancManuFreqSemAtivPorProfessor.Cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <ul id="ulDados" class="ulDados">
        ...
        <li>
            <label title="Colaborador responsável">
                Colaborador</label>
            <asp:DropDownList runat="server" ID="ddlColaborador" Width="210px" ToolTip="Colaborador responsável">
            </asp:DropDownList>
        </li>
        <li class="liPesqAtiv">
        ...
        <li class="liBloco" style="margin-top: 0px !important;">
            <ul>
                <li style="margin-right: 2px; margin-top: 0px !important;">
                    <ul>
                        <li class="liGrid2" style="width: 370px; margin-right: 0px; margin-left: 75px;">ATIVIDADES
                            DO DIA</li>
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="CHK">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="hidCoMat" Value='<%# Eval("CO_MAT") %>' runat="server" />
