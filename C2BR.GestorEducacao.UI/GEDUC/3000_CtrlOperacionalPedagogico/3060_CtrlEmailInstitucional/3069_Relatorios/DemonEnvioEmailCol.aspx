<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master"
    AutoEventWireup="true" CodeBehind="DemonEnvioEmailCol.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3060_CtrlEmailInstitucional._3069_Relatorios.DemonEnvioEmailCol" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>                
                <li id="liAlun" runat="server">
                    <label title="Selecione o Parceiro para visualização no relatório">Colaboradores</label>
                    <asp:DropDownList runat="server" ID="ddlCol" ToolTip="Selecione o Parceiro para visualização no relatório"
                        Width="230px" >
                    </asp:DropDownList>
                </li>
                <li class="liPeriodo">
