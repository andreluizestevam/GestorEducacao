<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3500_CtrlDesempenhoEscolar._3540_HomologacaoMediaTrimestral.Cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <ul id="ulDados" class="ulDados">
        ...
        <%--<li runat="server" style="margin-left: 700px; margin-top: 10px; margin-bottom: -20px; width: 216px; height: 37px;"
            id="liChk">
            <asp:Label ID="lblMarcaTodos" runat="server" CssClass="chk" Text='Marcar Todos'></asp:Label>
            <asp:CheckBox runat="server" ID="Chk" AutoPostBack="true" CssClass="chk" OnCheckedChanged="ChkHomologaTodos_SelectedIndexChanged" />
        </li>--%>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="NIRE / Aluno">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Label runat="server" Style="font-weight: bold; color: Red" ID="lblAste" Text="*"
                                    Visible='<%# bind("MOSTRA_ASTERISCO") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="HOMOL">
                            <HeaderTemplate>
                                <label style="font-weight: bold !important;">
                                    HOMOL</label>
                                <asp:CheckBox runat="server" ID="ChkTodos" AutoPostBack="true" CssClass="chk" OnCheckedChanged="ChkHomologaTodos_CheckedChanged" />
                            </HeaderTemplate>
                            <ItemStyle HorizontalAlign="Center" Width="55px" />
                            <ItemTemplate>
                                <asp:HiddenField runat="server" ID="hidCoAtividade" Value='<%# bind("CO_ALU") %>' />
                                <asp:CheckBox ID="ckSelect" runat="server" Checked='<%# bind("MEDIA_HOMOLOGADA") %>' />
                                <asp:HiddenField runat="server" ID="HiddenMB" Value='<%# bind("MD") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
