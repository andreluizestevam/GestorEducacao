<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3500_CtrlDesempenhoEscolar._3530_CalculosMediasNotasAtividades.CalculoColegioSupremo.Cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <ul id="ulDados" class="ulDados">
        ...
        <li class="liClear" style="margin-left: 30px">
                ...
                <asp:GridView ID="grdBusca" CssClass="grdBusca" runat="server" AutoGenerateColumns="False">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="AV1">
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="txtSim1" CssClass="txtNota" runat="server" Text='<%# bind("AV1") %>'
                                    Enabled="false" ToolTip="Nota do 1 Simulado do(a) Aluno(a)"></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="AV2">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtProv1" CssClass="txtNota" runat="server" Text='<%# bind("AV2") %>'
                        ...
                        <asp:TemplateField HeaderText="AV3">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtSim2" CssClass="txtNota" runat="server" Text='<%# bind("AV3") %>'
                        ...
                        <asp:TemplateField HeaderText="AV4">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtProv2" CssClass="txtNota" runat="server" Text='<%# bind("AV4") %>'
                                    Enabled="false" ToolTip="Nota da Prova 2 do(a) Aluno(a)"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="AV5">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtExtra" CssClass="txtNota" runat="server" Text='<%# bind("AV5") %>'
                                    Enabled="false" ToolTip="Nota do trabalho extra-avaliativo do(a) Aluno(a)"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            //$(".txtNota").maskMoney({ symbol: "", decimal: ",", thousands: ".", precision: 1  });
        });
