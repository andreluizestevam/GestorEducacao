...
{
    public partial class BoletEscolModelo5 : System.Web.UI.Page
    {
...
//====> Processo de Geração do Relatório
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            strP_BIMESTRE = int.Parse(ddlBimestre.SelectedValue);
            strP_FLA_FOTO = chkFlagFoto.Checked;
            infos = AuxiliRelatorioTemporario.GeraIdentFuncionarioRelatorio(Request.UserHostAddress);

            int coAlu = ddlAlunos.SelectedValue != "T" ? int.Parse(ddlAlunos.SelectedValue) : 0;

            RptBoletEscolMod5 rpt = new RptBoletEscolMod5();

            lRetorno = rpt.InitReport("RES 023/2000 CEE-AP", LoginAuxili.CO_EMP, infos, int.Parse(ddlUnidade.SelectedValue), strP_CO_ANO_REF, int.Parse(strP_CO_MODU_CUR), int.Parse(strP_CO_CUR), int.Parse(strP_CO_TUR), coAlu, strP_BIMESTRE, strP_FLA_FOTO);
            Session["Report"] = rpt;
