<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master" AutoEventWireup="true" CodeBehind="RelatorioMediaAlunos.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3500_CtrlDesempenhoEscolar._3599_Relatorios.RelatorioMediaAlunos" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        .ulDados { width: 440px; margin-left:370px;}
        .liUnidade,.liAluno
        {
            margin-top: 5px;
            width: 300px;            
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ul id="ulDados" class="ulDados">
        ...
        <li class="liAnoRefer" style="clear:both">
        ...
        <li style="margin: 18px 0 0 -110px">
            <asp:CheckBox runat="server" ID="chkAgrupadora" Text="Disciplinas Agrupadoras" ToolTip="Quando selecionado, apresenta no relatório as disciplinas agrupadoras, do contrário, apresentará as agrupadas" class="chk"/>
        </li>
        <li class="liAluno">
        ...
        <li style="clear:both; color:Red; margin-top:10px; width:270px;">
            <label>Certifique-se de que o Cálculo das Médias foi feito para que as médias estejam atualizadas e não hajam divergências.</label>
        </li>                          
    </ul>
</asp:Content>
