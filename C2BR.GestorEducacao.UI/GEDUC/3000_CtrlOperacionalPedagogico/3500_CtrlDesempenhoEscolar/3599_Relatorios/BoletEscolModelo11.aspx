<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master" AutoEventWireup="true" CodeBehind="BoletEscolModelo11.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3500_CtrlDesempenhoEscolar._3599_Relatorios.BoletEscolModelo11" %>
...
<%--                <li class="liUnidade">
                    <asp:CheckBox ID="CheckRodape" runat="server" style="margin-left:-5px;" CssClass="chk"
                        Text=" Visualizar o rodapé " />
                </li>--%>
