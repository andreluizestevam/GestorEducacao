...
// OBJETIVO: BOLETIM DE DESEMPENHO ESCOLAR DO ALUNO - BÁSICO
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
// ----------+----------------------------+-------------------------------------
// 25/04/2013| André Nobre Vinagre        |Adicionada a chamada ao relatorio com DLLs para
//           |                            |diferentes clientes
//           |                            |
// ----------+----------------------------+-------------------------------------
// 30/04/2013| André Nobre Vinagre        |Criado um relatório no .NET para o cliente barão
//           |                            |de acordo com layout informado
//           |                            |
// ----------+----------------------------+-------------------------------------
// 02/05/2013| André Nobre Vinagre        |Retirada a chamada ao relatório no .NET para o cliente
//           |                            |barão e adicionada chamada para o relatório em delphi
//           |                            |
...
{
    public partial class BoletEscolSimples : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            string strP_CO_EMP, strP_CO_ALU, strP_CO_ANO_REF, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, strP_HABIL_FOTO, infos;
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelBolEscAlu");
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            strP_HABIL_FOTO = chkFlagFoto.Checked ? "S" : "N";
            ...
            {
                lRetorno = lIRelatorioWeb.RelBolEscAluBARRIOBRA(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strP_CO_EMP, strP_CO_ALU, strP_CO_ANO_REF, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, strP_HABIL_FOTO);
            ...
            //Educandário de Maria
            else if (LoginAuxili.ORG_NUMERO_CNPJ == 04120476000117)
            {
                lRetorno = lIRelatorioWeb.RelBolEscAluEDUCAMARIA(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strP_CO_EMP, strP_CO_ALU, strP_CO_ANO_REF, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, strP_HABIL_FOTO);
                string strURL = WRAuxiliares.RetornaCaminhoRelatorioPDF("/TMP_Relatorios/" + strIDSessao + "/") + strNomeRelatorio;
                Session["URLRelatorio"] = strURL;
                AuxiliPagina.TrataRetornoRelatorio(lRetorno, this.AppRelativeVirtualPath);
            ...
            {
                lRetorno = lIRelatorioWeb.RelBolEscAlu(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strP_CO_EMP, strP_CO_ALU, strP_CO_ANO_REF, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, strP_HABIL_FOTO);
                string strURL = WRAuxiliares.RetornaCaminhoRelatorioPDF("/TMP_Relatorios/" + strIDSessao + "/") + strNomeRelatorio;
                Session["URLRelatorio"] = strURL;
                AuxiliPagina.TrataRetornoRelatorio(lRetorno, this.AppRelativeVirtualPath);
            }*/
            lRetorno = lIRelatorioWeb.RelBolEscAlu(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strP_CO_EMP, strP_CO_ALU, strP_CO_ANO_REF, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, strP_HABIL_FOTO, LoginAuxili.ORG_NUMERO_CNPJ.ToString());
            string strURL = WRAuxiliares.RetornaCaminhoRelatorioPDF("/TMP_Relatorios/" + strIDSessao + "/") + strNomeRelatorio;
            Session["URLRelatorio"] = strURL;
            AuxiliPagina.TrataRetornoRelatorio(lRetorno, this.AppRelativeVirtualPath);

            varRelatorioWeb.Close();
            //lRetorno = lIRelatorioWeb.RelBolEscAlu(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strP_CO_EMP, strP_CO_ALU, strP_CO_ANO_REF, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR);            
        }                
        #endregion
