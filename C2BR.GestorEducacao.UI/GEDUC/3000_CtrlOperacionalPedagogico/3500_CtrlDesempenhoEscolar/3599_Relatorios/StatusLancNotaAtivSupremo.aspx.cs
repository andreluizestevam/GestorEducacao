...
{
    public partial class StatusLancNotaAtivSupremo : System.Web.UI.Page
    {
        ...
        private void Imprime()
        {
            ...
            string NomeFuncionalidadeCadastrada = AuxiliGeral.RetornaNomeFuncionalidadeCadastrada("GEDUC/3000_CtrlOperacionalPedagogico/3500_CtrlDesempenhoEscolar/3599_Relatorios/StatusLancNotaAtivSupremo.aspx");
            RptStatusLancNotaAtivSupremo rpt = new RptStatusLancNotaAtivSupremo();
            lRetorno = rpt.InitReport(parametros, infos, strP_CO_EMP_REF, strP_CO_ANO_MES_MAT, strP_CO_CUR, strP_CO_MODU_CUR, strP_CO_TUR, strP_CO_BIMESTRE, LoginAuxili.CO_EMP, NomeFuncionalidadeCadastrada);
            Session["Report"] = rpt;
