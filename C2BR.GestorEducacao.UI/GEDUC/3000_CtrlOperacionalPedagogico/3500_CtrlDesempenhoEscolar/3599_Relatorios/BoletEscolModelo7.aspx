<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master" AutoEventWireup="true" CodeBehind="BoletEscolModelo7.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3500_CtrlDesempenhoEscolar._3599_Relatorios.BoletEscolModelo7" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ul id="ulDados" class="ulDados">
        ...
        <li class="liTitulo">
            ...
            T&iacute;tulo</label>
            <asp:TextBox runat="server" ID="txtTitulo" Text="FICHA DE RENDIMENTO ESCOLAR" CssClass="txtTitulo" ToolTip="Degite o título apresentado no boletim."
        ...
        <li class="liTotal" style="margin-top: 5px;">
            <asp:CheckBox ID="cbLinhatotal" runat="server" style="float:left;" /><label for="cbLinhatotal" style="float:left;">Imprimir linha de totais</label>
        </li>
        <li class="liTotal" style="margin-top: 5px;">
            <asp:CheckBox ID="cblImagem" runat="server" style="float:left;" /><label for="cblImagem" style="float:left;">Imprimir as imagens</label>
        </li>
        </ContentTemplate>
        </asp:UpdatePanel>                                   
    </ul>
