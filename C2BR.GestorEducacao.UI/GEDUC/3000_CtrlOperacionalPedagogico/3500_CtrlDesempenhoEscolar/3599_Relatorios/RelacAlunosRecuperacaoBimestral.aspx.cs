...
{
    public partial class RelacAlunosRecuperacaoBimestral : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            string strP_CO_EMP, strP_CO_ALU, strP_CO_ANO_REF, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, strP_CO_MAT, infos, strP_CATEG, strParam;
            ...
            strP_CATEG = ddlCategoria.SelectedValue;
            ...
            strParam = "Ano: " + ddlAnoRefer.SelectedItem.ToString().Trim() + " - Modalidade: " + ddlModalidade.SelectedItem.ToString() + " - Série: " +
                ddlSerieCurso.SelectedItem.ToString() + " - Turma: " + ddlTurma.SelectedItem.ToString() + " - Disciplina: " + ddlDisciplina.SelectedItem.ToString();

            RptRelacAlunosRecuperacaoBimestral rpt = new RptRelacAlunosRecuperacaoBimestral();

            lRetorno = rpt.InitReport(strParam, LoginAuxili.CO_EMP, infos, int.Parse(ddlUnidade.SelectedValue), strP_CO_ANO_REF, int.Parse(strP_CO_MODU_CUR), int.Parse(strP_CO_CUR), int.Parse(strP_CO_TUR), coAlu, int.Parse(strP_CO_MAT), strP_CATEG);
            Session["Report"] = rpt;
