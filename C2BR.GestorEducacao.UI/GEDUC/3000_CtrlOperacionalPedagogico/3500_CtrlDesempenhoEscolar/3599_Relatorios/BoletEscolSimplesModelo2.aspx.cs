...
// ----------+----------------------------+-------------------------------------
// 24/05/2013| André Nobre Vinagre        | Criada a funcionalidade
//           |                            |
// ----------+----------------------------+-------------------------------------
// 14/06/2013| André Nobre Vinagre        | Adicionado o parametro de bimestre
//           |                            |
...
{
    public partial class BoletEscolSimplesModelo2 : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            string strP_CO_EMP, str_CO_BIMESTRE, strP_CO_ALU, strP_CO_ANO_REF, strP_CO_MODU_CUR, strP_CO_CUR, strP_HABIL_FOTO, strP_CO_TUR, infos;
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelBolEscAluModelo2");
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            str_CO_BIMESTRE = ddlBimestre.SelectedValue;
            strP_HABIL_FOTO = chkFlagFoto.Checked ? "S" : "N";
            infos = AuxiliRelatorioTemporario.GeraIdentFuncionarioRelatorio(Request.UserHostAddress);

            lIRelatorioWeb = varRelatorioWeb.CreateChannel();

            lRetorno = lIRelatorioWeb.RelBolEscAluModelo2(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strP_CO_EMP, strP_CO_ALU, strP_CO_ANO_REF, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, strP_HABIL_FOTO, str_CO_BIMESTRE, LoginAuxili.ORG_NUMERO_CNPJ.ToString());
