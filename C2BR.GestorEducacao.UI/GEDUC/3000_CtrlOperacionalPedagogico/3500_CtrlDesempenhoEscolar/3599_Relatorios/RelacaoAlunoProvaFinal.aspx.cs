...
{
    public partial class RelacaoAlunoProvaFinal : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            RptRelacaoAlunoProvaFinal rpt = new RptRelacaoAlunoProvaFinal();

            lRetorno = rpt.InitReport(strParam, LoginAuxili.CO_EMP, infos, int.Parse(ddlUnidade.SelectedValue), strP_CO_ANO_REF, int.Parse(strP_CO_MODU_CUR), int.Parse(strP_CO_CUR), int.Parse(strP_CO_TUR), coAlu, int.Parse(strP_CO_MAT));
            Session["Report"] = rpt;
