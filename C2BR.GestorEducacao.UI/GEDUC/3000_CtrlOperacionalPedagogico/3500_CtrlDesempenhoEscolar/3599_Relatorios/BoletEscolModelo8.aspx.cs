...
{
    public partial class BoletEscolModelo8 : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            RptBoletEscolMod8 rpt = new RptBoletEscolMod8();

            lRetorno = rpt.InitReport(strP_PARAMETROS, LoginAuxili.CO_EMP, infos, int.Parse(ddlUnidade.SelectedValue), strP_CO_ANO_REF, int.Parse(strP_CO_MODU_CUR), int.Parse(strP_CO_CUR), int.Parse(strP_CO_TUR), coAlu, strP_OBS, boolP_CO_TOT, boolP_CO_IMG, strP_TITULO, chkImpAvalAlu.Checked, chkMostraTotFal.Checked, totFal, chk1B, chk2B, chk3B, chk4B, (ImpAnalFreqAlu.Checked ? true : false), ddlNomeDisciplina.SelectedValue);
            Session["Report"] = rpt;
