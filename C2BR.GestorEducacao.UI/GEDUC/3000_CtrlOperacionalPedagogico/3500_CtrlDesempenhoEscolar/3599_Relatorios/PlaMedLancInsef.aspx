<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master"
    AutoEventWireup="true" CodeBehind="PlaMedLancInsef.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3500_CtrlDesempenhoEscolar._3599_Relatorios.PlaMedLancInsef" %>
    ...
    <ul id="ulDados" class="ulDados">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <li class="liUnidadeCont" id="liUnidadeCont" runat="server">
                ...
                <li style="clear: both;" id="liAgrupar" runat="server">
        ...
        <li id="liTipoPlan" runat="server" visible="true">
            <label>
                Escolha o tipo de Planilha</label>
        </li>
        <li style="clear: both">
