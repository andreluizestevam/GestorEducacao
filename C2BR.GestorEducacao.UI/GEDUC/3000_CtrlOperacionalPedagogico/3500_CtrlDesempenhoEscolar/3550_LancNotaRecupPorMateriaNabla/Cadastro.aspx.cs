...
namespace C2BR.GestorEducacao.UI.GEDUC.F3000_CtrlOperacionalPedagogico.F3500_CtrlDesempenhoEscolar.F3550_LancNotaRecupPorMateriaNabla
{
            ...
            foreach (GridViewRow linha in grdBusca.Rows)
            {
                ...
                if (((TextBox)linha.Cells[3].FindControl("txtNota")).Text != "")
                {
                    ...
                    if (tb079 != null)
                    {
                        ...
                        {                           
                            case "S1":
                                tb079.VL_RECU_SEM1 = nota;
                                tb079.VL_RECU_BIM1 = nota;
                                tb079.VL_RECU_BIM2 = nota;
                                break;
                            case "S2":
                                tb079.VL_RECU_SEM2 = nota;
                                tb079.VL_RECU_BIM3 = nota;
                                tb079.VL_RECU_BIM4 = nota;
                                break;
                        }
                    }
                ...
                else
                {
                    ...
                    if (tb079ob != null)
                    {
                        ...
                        {
                            case "S1":
                                tb079ob.VL_RECU_SEM1 = null;
                                tb079ob.VL_RECU_BIM1 = null;
                                tb079ob.VL_RECU_BIM2 = null;
                                break;
                            case "S2":
                                tb079ob.VL_RECU_SEM2 = null;
                                tb079ob.VL_RECU_BIM3 = null;
                                tb079ob.VL_RECU_BIM4 = null;
                                break;
                        }
                        //TirouNota = true;
        ...
        protected static int VerificaQuantRecupAluno(int CO_ALU, int modalidade, int serie, int turma, string anoMesMat, string strRefer)
        {
            ...
            var resultado = (from tb079 in TB079_HIST_ALUNO.RetornaTodosRegistros()
                             ...
                             select new NotasAluno
                             {
                                 ...
                                 b3r = tb079.VL_RECU_BIM3,
                                 b4r = tb079.VL_RECU_BIM4,
                                 s1 = tb079.VL_NOTA_SEM1,
                                 s2 = tb079.VL_NOTA_SEM2,
                                 s1r = tb079.VL_RECU_SEM1,
                                 s2r = tb079.VL_RECU_SEM2,
                                 pfr = tb079.VL_PROVA_FINAL,
                                 mdFinal = tb079.VL_MEDIA_FINAL,
                                 baseMedia = baseMedia,
                                 baseMediaFinal = tb01.MED_FINAL_CUR,
            ...
            foreach (var li in resultado)
            {
                    switch (strRefer)
                    {
                        ...
                        case "B4":
                            ...
                            break;
                        case "S1":
                            if (((li.b2 != null && li.b2 < li.baseMedia) || li.b2r != null) && ((li.b1 != null && li.b1 < li.baseMedia) || li.b1r != null))
                                qtRecu++;
                            break;
                        case "S2":
                            if (((li.b3 != null && li.b3 < li.baseMedia) || li.b3r != null) && ((li.b4 != null && li.b4 < li.baseMedia) || li.b4r != null))
                                qtRecu++;
                            break;
                        case "FI":
                ...
                get
                {
                    ...
                    switch(this.referencia)
                    {
                        ...
                        case "B4":
                            ...
                            break;
                        case "S1":
                            retorno = (this.b1r + this.b2r)/2;
                            break;
                        case "S2":
                            retorno = (this.b3r + this.b4r)/2;
                            break;
                        case "FI":
                            retorno = this.pfr;
                            break;
                ...
                get
                {
                    ...
                    switch(this.referencia)
                    {
                        ...
                        case "B4":
                            ...
                            break;
                        case "S1":
                            retorno = (((this.b1 != null && this.b1 < this.baseMediaBim) || this.b1r != null) && ((this.b2 != null && this.b2 < this.baseMediaBim) || this.b2r != null)) ? "Sim" : "Não";
                            mediaAlu = (this.b1 + this.b2)/2;
                            break;

                        case "S2":
                           retorno = (((this.b3 != null && this.b3 < this.baseMediaBim) || this.b3r != null) && ((this.b4 != null && this.b4 < this.baseMediaBim) || this.b4r != null)) ? "Sim" : "Não";
                            mediaAlu = (this.b3 + this.b4)/2;
                            break;
                    ...
                    #region Desuso
                                ...
                                decimal totalS1 = nota1 + nota2;
                                decimal totalS2 = nota3 + nota4;
                                decimal mediaS1 = totalS1 / 2;
                                decimal mediaS2 = totalS2 / 2;
                                string media1 = mediaS1.ToString("N2");
                                decimal mediaSem1 = decimal.Parse(media1);
                                string media2 = mediaS2.ToString("N2");
                                decimal mediaSem2 = decimal.Parse(media2);
                                ...
                                {
                                    case "S1":
                                        if ((nota1LC == false) && (nota2LC == false))
                                            mediaAlu = null;
                                        else
                                            mediaAlu = mediaSem1;
                                        break;
                                    ...
                                    case "S2":
                                        if ((nota3LC == false) && (nota4LC == false))
                                            mediaAlu = null;
                                        else
                                            mediaAlu = mediaSem2;
                                        break;
                    ...
                    if ((this.referencia == "S2") && (DateTime.Now.Year == 2016))
