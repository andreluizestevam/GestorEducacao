...
namespace C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3500_CtrlDesempenhoEscolar._3520_LancNotaAtivPorMateriaSupremoInsef
{
    public partial class Cadastro : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow linha in grdBusca.Rows)
            {
                ...
                decimal dcmM = 0;
                if (decimal.TryParse(((TextBox)linha.Cells[2].FindControl("txtNotaAv1")).Text, out dcmM))
                {
                    if (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv1")).Text) > 10)
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "A nota da prova/teste 1  deve estar entre 0 e 10");
                        return;
                    }

                    decimal nota = (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv1")).Text));

                }
                if (decimal.TryParse(((TextBox)linha.Cells[2].FindControl("txtNotaAv2")).Text, out dcmM))
                {
                    if (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv2")).Text) > 10)
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "A nota da prova/teste 2  deve estar entre 0 e 10");
                        return;
                    }
                    decimal nota = (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv2")).Text));

                }
                if (decimal.TryParse(((TextBox)linha.Cells[2].FindControl("txtNotaAv3")).Text, out dcmM))
                {
                    if (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv3")).Text) > 10)
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "A nota do trabalho  deve estar entre 0 e 10");
                        return;
                    }
                    decimal nota = (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv3")).Text));
                }
                if (decimal.TryParse(((TextBox)linha.Cells[2].FindControl("txtNotaAv4")).Text, out dcmM))
                {
                    if (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv4")).Text) > 10)
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "A nota do projeto deve estar entre 0 e 10");
                        return;
                    }
                    decimal nota = (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv4")).Text));

                }
                if (decimal.TryParse(((TextBox)linha.Cells[2].FindControl("txtNotaAv5")).Text, out dcmM))
                {
                    if (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv5")).Text) > 10)
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "A nota do conceito deve estar entre 0 e 10");
                        return;
                    }
                    decimal nota = (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv5")).Text));

                }
                if (decimal.TryParse(((TextBox)linha.Cells[2].FindControl("txtNotaAv6")).Text, out dcmM))
                {
                    if (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv6")).Text) > 10)
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "A nota da avalição específica deve estar entre 0 e 10");
                        return;
                    }
                    decimal nota = (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv6")).Text));

                }
                if (decimal.TryParse(((TextBox)linha.Cells[2].FindControl("txtNotaAv7")).Text, out dcmM))
                {
                    if (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv7")).Text) > 10)
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "A nota da avalição globalizada deve estar entre 0 e 10");
                        return;
                    }
                    decimal nota = (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv7")).Text));

                }
                if (decimal.TryParse(((TextBox)linha.Cells[2].FindControl("txtNotaAv8")).Text, out dcmM))
                {
                    if (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv8")).Text) > 10)
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "A nota do simulado deve estar entre 0 e 10");
                        return;
                    }
                    decimal nota = (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv8")).Text));

                }
                if (decimal.TryParse(((TextBox)linha.Cells[2].FindControl("txtNotaAv9")).Text, out dcmM))
                {
                    if (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv9")).Text) > 10)
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "A nota da atividade avaliativa deve estar entre 0 e 10");
                        return;
                    }
                    decimal nota = (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv9")).Text));

                }
                if (decimal.TryParse(((TextBox)linha.Cells[2].FindControl("txtNotaAv10")).Text, out dcmM))
                {
                    if (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv10")).Text) > 10)
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "A nota da atividade prática deve estar entre 0 e 10");
                        return;
                    }
                    decimal nota = (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv10")).Text));

                }
                if (decimal.TryParse(((TextBox)linha.Cells[2].FindControl("txtNotaAv11")).Text, out dcmM))
                {
                    if (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv11")).Text) > 10)
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "A nota da redação deve estar entre 0 e 10");
                        return;
                    }
                    decimal nota = (Decimal.Parse(((TextBox)linha.Cells[2].FindControl("txtNotaAv11")).Text));
            ...
            foreach (GridViewRow linha in grdBusca.Rows)
            {
                ...
                //Se tem nota av1
                if (((TextBox)linha.Cells[1].FindControl("txtNotaAv1")).Text != "" || (TextBox)linha.Cells[1].FindControl("txtDataAtiv1") != null)
                {
                    ...
                    if (DataAV == "")
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "Favor informar a Data da prova/teste 1");
                        return;
                    }
                    ...
                    if (decimal.TryParse(((TextBox)linha.Cells[1].FindControl("txtNotaAv1")).Text, out av1))
                    {
                        ...
                        SalvarNotasAvs(ddlTrimestre.SelectedValue, av1, coAlu, materia, modalidade, serie, anoRef, DataAtiv, coTipoAtiv, turma, idNota,1);
                    }
                }
                else
                {
                    if (((HiddenField)linha.Cells[1].FindControl("hidIdNotaAV1")).Value != "")
                    {
                ...
                if (((TextBox)linha.Cells[2].FindControl("txtNotaAv2")).Text != "" || (TextBox)linha.Cells[2].FindControl("txtDataAtiv2") != null)
                {
                    //Verifica se informou a data
                    ...
                    if (DataAV == "")
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "Favor informar a Data da prova/teste 2");
                        return;
                    }
                    ...
                    if (decimal.TryParse(((TextBox)linha.Cells[2].FindControl("txtNotaAv2")).Text, out av2))
                    {
                        ...
                        int coAlu = Convert.ToInt32(grdBusca.DataKeys[linha.RowIndex].Values[0]);
                        TB273_TIPO_ATIVIDADE coTipoAtiv = TB273_TIPO_ATIVIDADE.RetornaPelaSigla("PR");
                        SalvarNotasAvs(ddlTrimestre.SelectedValue, av2, coAlu, materia, modalidade, serie, anoRef, DataAtiv, coTipoAtiv, turma, idNota,2);
                    }
                }
                else
                {
                    if (((HiddenField)linha.Cells[2].FindControl("hidIdNotaAV2")).Value != "")
                    {
                ...
                if (((TextBox)linha.Cells[3].FindControl("txtNotaAv3")).Text != "" || (TextBox)linha.Cells[3].FindControl("txtDataAtiv3") != null)
                {
                    //Verifica se informou a data
                    ...
                    if (DataAV == "")
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "Favor informar a Data do trabalho");
                        return;
                    }
                    ...
                    if (decimal.TryParse(((TextBox)linha.Cells[3].FindControl("txtNotaAv3")).Text, out av3))
                    {
                        DateTime DataAtiv = DateTime.Parse(DataAV);
                        int coAlu = Convert.ToInt32(grdBusca.DataKeys[linha.RowIndex].Values[0]);
                        TB273_TIPO_ATIVIDADE coTipoAtiv = TB273_TIPO_ATIVIDADE.RetornaPelaSigla("TB");
                        SalvarNotasAvs(ddlTrimestre.SelectedValue, av3, coAlu, materia, modalidade, serie, anoRef, DataAtiv, coTipoAtiv, turma, idNota,1);
                    }
                }
                else
                {
                    if (((HiddenField)linha.Cells[3].FindControl("hidIdNotaAV3")).Value != "")
                    {
                ...
                if (((TextBox)linha.Cells[4].FindControl("txtNotaAv4")).Text != "" || (TextBox)linha.Cells[4].FindControl("txtDataAtiv4") != null)
                {
                    //Verifica se informou a data
                    ...
                    if (DataAV == "")
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "Favor informar a Data do projeto");
                        return;
                    }
                    ...
                    if (decimal.TryParse(((TextBox)linha.Cells[4].FindControl("txtNotaAv4")).Text, out av4))
                    {
                        DateTime DataAtiv = DateTime.Parse(DataAV);
                        int coAlu = Convert.ToInt32(grdBusca.DataKeys[linha.RowIndex].Values[0]);
                        TB273_TIPO_ATIVIDADE coTipoAtiv = TB273_TIPO_ATIVIDADE.RetornaPelaSigla("PJ");
                        SalvarNotasAvs(ddlTrimestre.SelectedValue, av4, coAlu, materia, modalidade, serie, anoRef, DataAtiv, coTipoAtiv, turma, idNota,1);
                    }
                }
                else
                {
                    if (((HiddenField)linha.Cells[4].FindControl("hidIdNotaAV4")).Value != "")
                    {
                ...
                if (((TextBox)linha.Cells[5].FindControl("txtNotaAv5")).Text != "" || (TextBox)linha.Cells[5].FindControl("txtDataAtiv5") != null)
                {
                    //Verifica se informou a data
                    ...
                    if (DataAV == "")
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "Favor informar a Data do conceito");
                        return;
                    }
                    ...
                    if (decimal.TryParse(((TextBox)linha.Cells[5].FindControl("txtNotaAv5")).Text, out av5))
                    {
                        DateTime DataAtiv = DateTime.Parse(DataAV);
                        int coAlu = Convert.ToInt32(grdBusca.DataKeys[linha.RowIndex].Values[0]);
                        TB273_TIPO_ATIVIDADE coTipoAtiv = TB273_TIPO_ATIVIDADE.RetornaPelaSigla("CT");
                        SalvarNotasAvs(ddlTrimestre.SelectedValue, av5, coAlu, materia, modalidade, serie, anoRef, DataAtiv, coTipoAtiv, turma, idNota,1);
                    }
                }
                else
                {
                    if (((HiddenField)linha.Cells[5].FindControl("hidIdNotaAV5")).Value != "")
                    {
                ...
                if (((TextBox)linha.Cells[6].FindControl("txtNotaAv6")).Text != "" || (TextBox)linha.Cells[6].FindControl("txtDataAtiv6") != null)
                {
                    //Verifica se informou a data
                    string DataAV = ((TextBox)grdBusca.HeaderRow.Cells[6].FindControl("txtDataAtiv6")).Text;
                    string idNota = (((HiddenField)linha.Cells[6].FindControl("hidIdNotaAV6")).Value);
                    if (DataAV == "")
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "Favor informar a Data da avaliação específica");
                        return;
                    }

                    decimal av6;
                    if (decimal.TryParse(((TextBox)linha.Cells[6].FindControl("txtNotaAv6")).Text, out av6))
                    {
                        DateTime DataAtiv = DateTime.Parse(DataAV);
                        int coAlu = Convert.ToInt32(grdBusca.DataKeys[linha.RowIndex].Values[0]);
                        TB273_TIPO_ATIVIDADE coTipoAtiv = TB273_TIPO_ATIVIDADE.RetornaPelaSigla("AE");
                        SalvarNotasAvs(ddlTrimestre.SelectedValue, av6, coAlu, materia, modalidade, serie, anoRef, DataAtiv, coTipoAtiv, turma, idNota,1);
                    }
                }
                else
                {
                    if (((HiddenField)linha.Cells[6].FindControl("hidIdNotaAV6")).Value != "")
                    {
                        int idAtiv = int.Parse(((HiddenField)linha.Cells[6].FindControl("hidIdNotaAV6")).Value);
                        DeletarAtividadeAluno(idAtiv);
                    }
                }
                ...
                if (((TextBox)linha.Cells[7].FindControl("txtNotaAv7")).Text != "" || (TextBox)linha.Cells[7].FindControl("txtDataAtiv7") != null)
                {
                    //Verifica se informou a data
                    string DataAV = ((TextBox)grdBusca.HeaderRow.Cells[7].FindControl("txtDataAtiv7")).Text;
                    string idNota = (((HiddenField)linha.Cells[7].FindControl("hidIdNotaAV7")).Value);
                    if (DataAV == "")
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "Favor informar a Data da avaliação globalizada");
                        return;
                    }

                    decimal av7;
                    if (decimal.TryParse(((TextBox)linha.Cells[7].FindControl("txtNotaAv7")).Text, out av7))
                    {
                        DateTime DataAtiv = DateTime.Parse(DataAV);
                        int coAlu = Convert.ToInt32(grdBusca.DataKeys[linha.RowIndex].Values[0]);
                        TB273_TIPO_ATIVIDADE coTipoAtiv = TB273_TIPO_ATIVIDADE.RetornaPelaSigla("AG");
                        SalvarNotasAvs(ddlTrimestre.SelectedValue, av7, coAlu, materia, modalidade, serie, anoRef, DataAtiv, coTipoAtiv, turma, idNota,1);
                    }
                }
                else
                {
                    if (((HiddenField)linha.Cells[7].FindControl("hidIdNotaAV7")).Value != "")
                    {
                        int idAtiv = int.Parse(((HiddenField)linha.Cells[7].FindControl("hidIdNotaAV7")).Value);
                        DeletarAtividadeAluno(idAtiv);
                    }
                }
                ...
                if (((TextBox)linha.Cells[8].FindControl("txtNotaAv8")).Text != "" || (TextBox)linha.Cells[8].FindControl("txtDataAtiv8") != null)
                {
                    //Verifica se informou a data
                    string DataAV = ((TextBox)grdBusca.HeaderRow.Cells[8].FindControl("txtDataAtiv8")).Text;
                    string idNota = (((HiddenField)linha.Cells[8].FindControl("hidIdNotaAV8")).Value);
                    if (DataAV == "")
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "Favor informar a Data do simulado");
                        return;
                    }

                    decimal av8;
                    if (decimal.TryParse(((TextBox)linha.Cells[8].FindControl("txtNotaAv8")).Text, out av8))
                    {
                        DateTime DataAtiv = DateTime.Parse(DataAV);
                        int coAlu = Convert.ToInt32(grdBusca.DataKeys[linha.RowIndex].Values[0]);
                        TB273_TIPO_ATIVIDADE coTipoAtiv = TB273_TIPO_ATIVIDADE.RetornaPelaSigla("SI");
                        SalvarNotasAvs(ddlTrimestre.SelectedValue, av8, coAlu, materia, modalidade, serie, anoRef, DataAtiv, coTipoAtiv, turma, idNota,1);
                    }
                }
                else
                {
                    if (((HiddenField)linha.Cells[8].FindControl("hidIdNotaAV8")).Value != "")
                    {
                        int idAtiv = int.Parse(((HiddenField)linha.Cells[8].FindControl("hidIdNotaAV8")).Value);
                        DeletarAtividadeAluno(idAtiv);
                    }
                }
                ...
                if (((TextBox)linha.Cells[9].FindControl("txtNotaAv9")).Text != "" || (TextBox)linha.Cells[9].FindControl("txtDataAtiv9") != null)
                {
                    //Verifica se informou a data
                    string DataAV = ((TextBox)grdBusca.HeaderRow.Cells[9].FindControl("txtDataAtiv9")).Text;
                    string idNota = (((HiddenField)linha.Cells[9].FindControl("hidIdNotaAV9")).Value);
                    if (DataAV == "")
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "Favor informar a Data da atividade avaliativa");
                        return;
                    }

                    decimal av9;
                    if (decimal.TryParse(((TextBox)linha.Cells[9].FindControl("txtNotaAv9")).Text, out av9))
                    {
                        DateTime DataAtiv = DateTime.Parse(DataAV);
                        int coAlu = Convert.ToInt32(grdBusca.DataKeys[linha.RowIndex].Values[0]);
                        TB273_TIPO_ATIVIDADE coTipoAtiv = TB273_TIPO_ATIVIDADE.RetornaPelaSigla("AA");
                        SalvarNotasAvs(ddlTrimestre.SelectedValue, av9, coAlu, materia, modalidade, serie, anoRef, DataAtiv, coTipoAtiv, turma, idNota,1);
                    }
                }
                else
                {
                    if (((HiddenField)linha.Cells[9].FindControl("hidIdNotaAV9")).Value != "")
                    {
                        int idAtiv = int.Parse(((HiddenField)linha.Cells[9].FindControl("hidIdNotaAV9")).Value);
                        DeletarAtividadeAluno(idAtiv);
                    }
                }
                ...
                if (((TextBox)linha.Cells[10].FindControl("txtNotaAv10")).Text != "" || (TextBox)linha.Cells[10].FindControl("txtDataAtiv10") != null)
                {
                    //Verifica se informou a data
                    string DataAV = ((TextBox)grdBusca.HeaderRow.Cells[10].FindControl("txtDataAtiv10")).Text;
                    string idNota = (((HiddenField)linha.Cells[10].FindControl("hidIdNotaAV10")).Value);
                    if (DataAV == "")
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "Favor informar a Data da atividade prática");
                        return;
                    }

                    decimal av10;
                    if (decimal.TryParse(((TextBox)linha.Cells[10].FindControl("txtNotaAv10")).Text, out av10))
                    {
                        DateTime DataAtiv = DateTime.Parse(DataAV);
                        int coAlu = Convert.ToInt32(grdBusca.DataKeys[linha.RowIndex].Values[0]);
                        TB273_TIPO_ATIVIDADE coTipoAtiv = TB273_TIPO_ATIVIDADE.RetornaPelaSigla("AP");
                        SalvarNotasAvs(ddlTrimestre.SelectedValue, av10, coAlu, materia, modalidade, serie, anoRef, DataAtiv, coTipoAtiv, turma, idNota,1);
                    }
                }
                else
                {
                    if (((HiddenField)linha.Cells[10].FindControl("hidIdNotaAV10")).Value != "")
                    {
                        int idAtiv = int.Parse(((HiddenField)linha.Cells[10].FindControl("hidIdNotaAV10")).Value);
                        DeletarAtividadeAluno(idAtiv);
                    }
                }
                ...
                if (((TextBox)linha.Cells[11].FindControl("txtNotaAv11")).Text != "" || (TextBox)linha.Cells[11].FindControl("txtDataAtiv11") != null)
                {
                    //Verifica se informou a data
                    string DataAV = ((TextBox)grdBusca.HeaderRow.Cells[11].FindControl("txtDataAtiv11")).Text;
                    string idNota = (((HiddenField)linha.Cells[11].FindControl("hidIdNotaAV11")).Value);
                    if (DataAV == "")
                    {
                        AuxiliPagina.EnvioMensagemErro(this.Page, "Favor informar a Data da redação");
                        return;
                    }

                    decimal av11;
                    if (decimal.TryParse(((TextBox)linha.Cells[11].FindControl("txtNotaAv11")).Text, out av11))
                    {
                        DateTime DataAtiv = DateTime.Parse(DataAV);
                        int coAlu = Convert.ToInt32(grdBusca.DataKeys[linha.RowIndex].Values[0]);
                        TB273_TIPO_ATIVIDADE coTipoAtiv = TB273_TIPO_ATIVIDADE.RetornaPelaSigla("RD");
                        SalvarNotasAvs(ddlTrimestre.SelectedValue, av11, coAlu, materia, modalidade, serie, anoRef, DataAtiv, coTipoAtiv, turma, idNota,1);
                    }
                }
                else
                {
                    if (((HiddenField)linha.Cells[11].FindControl("hidIdNotaAV11")).Value != "")
                    {
                        int idAtiv = int.Parse(((HiddenField)linha.Cells[11].FindControl("hidIdNotaAV11")).Value);
                        DeletarAtividadeAluno(idAtiv);
                    }
                }
        ...
        private void SalvarNotasAvs(string TipoAvaliacao, decimal TipoNota, int coAlu, int materia, int modalidade, int serie, string anoRef, DateTime dataAtiv, TB273_TIPO_ATIVIDADE coTipoAtiv, int turma, string idNota, int numNota)
        {
            if (TipoNota != 0)
            {
                #region individual

                String tipoNota = numNota.ToString();
                ...
                tb49.CO_BIMESTRE = ddlTrimestre.SelectedValue;
                tb49.CO_SEMESTRE = ddlTrimestre.SelectedValue == "T1" || ddlTrimestre.SelectedValue == "T2" ? "1" : "2";
