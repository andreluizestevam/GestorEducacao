...
// ----------+----------------------------+-------------------------------------
// 12/12/2014| Maxwell Almeida            | Criada a funcionalidade para lançar as notas de conselho de acordo com o status da nota/média referência
...
namespace C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3500_CtrlDesempenhoEscolar._3518_LancManutNotaAluCons2
{
    public partial class Cadastro : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow linha in grdBusca.Rows)
            {
                ...
                if (tb079 != null)
                {
                    string notaConse = ((TextBox)linha.Cells[6].FindControl("txtNtCon")).Text;
                    //----------------> Atribui o valor de STATUS informado de acordo com o bimestre
                    switch (ddlReferencia.SelectedValue)
                    {
                        case "B1":
                            tb079.VL_CONSE_BIM1 =
                            tb079.VL_MEDIA_BIM1 = (!string.IsNullOrEmpty(notaConse) ? decimal.Parse(notaConse) : (decimal?)null);
                            tb079.VL_NOTA_SEM1 = CalculaNotaSemestre(tb079.VL_MEDIA_BIM1, tb079.VL_MEDIA_BIM2);
                            break;
                        case "B2":
                            tb079.VL_CONSE_BIM2 =
                            tb079.VL_MEDIA_BIM2 = (!string.IsNullOrEmpty(notaConse) ? decimal.Parse(notaConse) : (decimal?)null);
                            tb079.VL_NOTA_SEM1 = CalculaNotaSemestre(tb079.VL_MEDIA_BIM1, tb079.VL_MEDIA_BIM2);
                            break;
                        case "B3":
                            tb079.VL_CONSE_BIM3 =
                            tb079.VL_MEDIA_BIM3 = (!string.IsNullOrEmpty(notaConse) ? decimal.Parse(notaConse) : (decimal?)null);
                            tb079.VL_NOTA_SEM2 = CalculaNotaSemestre(tb079.VL_MEDIA_BIM3, tb079.VL_MEDIA_BIM4);
                            break;
                        case "B4":
                            tb079.VL_CONSE_BIM4 =
                            tb079.VL_MEDIA_BIM4 = (!string.IsNullOrEmpty(notaConse) ? decimal.Parse(notaConse) : (decimal?)null);
                            tb079.VL_NOTA_SEM2 = CalculaNotaSemestre(tb079.VL_MEDIA_BIM3, tb079.VL_MEDIA_BIM4);
                            break;
                        case "FN":
                            tb079.VL_CONSE_FINAL =
                            tb079.VL_MEDIA_FINAL = (!string.IsNullOrEmpty(notaConse) ? decimal.Parse(notaConse) : (decimal?)null);
                            break;
                    }
        ...
        /// <summary>
        /// Calcula e retorna nota semestral
        /// </summary>
        /// <param name="nota1"></param>
        /// <param name="nota2"></param>
        /// <returns></returns>
        private decimal CalculaNotaSemestre(decimal? nota1, decimal? nota2)
        {
            //Retorna o cálculo preparado para o caso de vir nulo
            return ((nota1.HasValue ? nota1.Value : 0) + (nota2.HasValue ? nota2.Value : 0)) / 2;
        }
        ...
        private void CarregaGrid()
        {
            ...
            string Referen = ddlReferencia.SelectedValue;
            ...
            var resultado = (from tb079 in TB079_HIST_ALUNO.RetornaTodosRegistros()
                             ...
                             && tb08.CO_SIT_MAT == "A"
                             && (Referen == "B1" ? tb079.FL_STATU_MEDIA_BIM1 == "C" :
                             Referen == "B2" ? tb079.FL_STATU_MEDIA_BIM2 == "C" : Referen == "B3" ? tb079.FL_STATU_MEDIA_BIM3 == "C" : tb079.FL_STATU_MEDIA_BIM4 == "C")
