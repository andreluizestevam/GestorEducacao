<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3500_CtrlDesempenhoEscolar._3518_LancManutNotaAluCons2.Cadastro" %>
    ...
    <ul id="ulDados" class="ulDados">
        ...
        <li class="liPesqAtiv">
            <asp:LinkButton ID="btnPesqGride" runat="server" OnClick="btnPesqGride_Click" ValidationGroup="vgBtnPesqGride"
                ...
                <asp:Label runat="server" ID="lblBoleto" Text="Calcular"></asp:Label>
            </asp:LinkButton>
        </li>
                ...
                <asp:GridView ID="grdBusca" CssClass="grdBusca" runat="server" AutoGenerateColumns="False">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="NTCON">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:TextBox ID="txtNtCon" CssClass="txtNota" runat="server" Text='<%# bind("NTCON_VALID") %>'></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
