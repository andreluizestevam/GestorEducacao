...
Inherits="C2BR.GestorEducacao.UI.GEDUC.F3000_CtrlOperacionalPedagogico.F3500_CtrlDesempenhoEscolar.F3502_LancManutAlunoMediaBim.Busca"%>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ul id="ulParamsFormBusca" class="ulParamsFormBusca">
        ...
        <%--<li>
            ...
            <asp:DropDownList ID="ddlTipoMedida" Width="80px" OnSelectedIndexChanged="ddlTipoMedida_SelectedIndexChanged" AutoPostBack="true" runat="server" />
        </li>
        <li>
            ...
            <asp:DropDownList ID="ddlReferencia" CssClass="ddlReferencia" runat="server"
                ToolTip="Selecione o Bimestre de Referência" Width="80px" />
            <asp:RequiredFieldValidator ID="rfv2" runat="server" ControlToValidate="ddlReferencia" ErrorMessage="Referência deve ser informada" 
                Display="None"></asp:RequiredFieldValidator>
        </li>--%>
	    <li>
        ...
        <li>
            ...
            <asp:DropDownList ID="ddlTurma" CssClass="campoTurma" runat="server" ToolTip="Selecione a Turma"></asp:DropDownList>
