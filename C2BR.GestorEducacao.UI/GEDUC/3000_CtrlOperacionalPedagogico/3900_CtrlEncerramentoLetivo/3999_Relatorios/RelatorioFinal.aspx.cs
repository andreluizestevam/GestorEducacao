...
// OBJETIVO: RELATÓRIO FINAL DO ANO LETIVO
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class RelatorioFinal : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            string strP_CO_EMP, strP_CO_ANO_REF, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, strP_Classificacao;
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelFinalAlunos");
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            strP_Classificacao = ddlClassificacao.SelectedValue;

            strParametrosRelatorio += "( Unidade: " + ddlUnidade.SelectedItem.ToString();
            strParametrosRelatorio += " - Ano de Referência: " + ddlAnoRefer.SelectedItem.ToString();
            ...
            lRetorno = lIRelatorioWeb.RelFinalAlunos(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strParametrosRelatorio, strP_CO_EMP, strP_CO_ANO_REF, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, strP_Classificacao);
