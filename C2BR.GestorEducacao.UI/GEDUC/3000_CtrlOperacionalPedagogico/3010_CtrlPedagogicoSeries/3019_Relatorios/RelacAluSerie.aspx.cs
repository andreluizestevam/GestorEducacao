...
{
    public partial class RelacAluSerie : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            RptAlunosSeries rpt = new RptAlunosSeries();
            lRetorno = rpt.InitReport(strParametrosRelatorio, strP_CO_EMP, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_ANO_REFER, strP_CO_TUR, strP_CO_SIT_MAT, strINFOS);
            Session["Report"] = rpt;
