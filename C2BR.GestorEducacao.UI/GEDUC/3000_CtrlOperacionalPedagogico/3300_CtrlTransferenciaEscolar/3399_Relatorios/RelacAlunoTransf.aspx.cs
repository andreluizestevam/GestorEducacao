...
{
    public partial class RelacAlunoTransf : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            string strP_CO_EMP, strP_CO_EMP_REF, strP_DE_EMP_REF, strP_TP_TRANSF, strP_DT_INI, strP_DT_FIM;
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelRelacAlunoTransf");
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            strP_DE_EMP_REF = ddlUnidade.SelectedItem.ToString();
            strP_TP_TRANSF = ddlTpTransf.SelectedValue;
            strP_DT_INI = txtDataPeriodoIni.Text;
            strP_DT_FIM = txtDataPeriodoFim.Text;

            lIRelatorioWeb = varRelatorioWeb.CreateChannel();

            lRetorno = lIRelatorioWeb.RelRelacAlunoTransf(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strP_CO_EMP, strP_CO_EMP_REF, strP_DE_EMP_REF, strP_TP_TRANSF, strP_DT_INI, strP_DT_FIM, LoginAuxili.ORG_NUMERO_CNPJ.ToString());
