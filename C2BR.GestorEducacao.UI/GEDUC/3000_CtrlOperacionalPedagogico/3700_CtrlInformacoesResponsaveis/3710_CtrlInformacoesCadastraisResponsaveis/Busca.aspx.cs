...
namespace C2BR.GestorEducacao.UI.GEDUC.F3000_CtrlOperacionalPedagogico.F3700_CtrlInformacoesResponsaveis.F3710_CtrlInformacoesCadastraisResponsaveis
{
    public partial class Busca : System.Web.UI.Page
    {
        ...
        void CurrentPadraoBuscas_OnDefineColunasGridView()
        {
            ...
            BoundField cpfResp = new BoundField();
            cpfResp.DataField = "NU_CPF_RESP";
            cpfResp.HeaderText = "CPF";
            cpfResp.HeaderStyle.Width = 75;
            CurrentPadraoBuscas.GridBusca.Columns.Add(cpfResp);
        ...
        void CurrentPadraoBuscas_OnAcaoBuscaDefineGridView()
        {
            var resultado = (from tb108 in TB108_RESPONSAVEL.RetornaTodosRegistros()
                             ...
                             select new
                             {
                                 NO_RESP = tb108.NO_RESP.Length > 32 ? tb108.NO_RESP.Substring(0, 32) + "..." : tb108.NO_RESP, 
                                 tb108.NU_NIS_RESP, tb108.DT_NASC_RESP, tb108.CO_RESP, CO_SITU_RESP = tb108.CO_SITU_RESP == "I" ? "Inativo" : "Ativo",
                                 ...
                                 CO_FLAG_RESP_FUNC = tb108.CO_FLAG_RESP_FUNC == "S" ? "Sim" : "Não", tb108.CO_SEXO_RESP,
                                 ...
                                 tb108.RENDA_FAMILIAR_RESP == "3" ? "+5 SM" : "S/Renda"                                 
                             }).OrderBy( r => r.NO_RESP );
