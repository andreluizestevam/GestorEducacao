...
{
    public partial class ExtAgendaMonitoria : System.Web.UI.Page
    {
        ...
        private void porProfessor()
        {
            ...
            RptAgendaMonitoriaPorProfessor fpcb = new RptAgendaMonitoriaPorProfessor();
        ...
        private void porDisciplina()
        {
            ...
            RptAgendaMonitoriaPorDisciplina fpcb = new RptAgendaMonitoriaPorDisciplina();
            lRetorno = fpcb.InitReport(parametros, infos, coEmp, modalidade, serieCurso, Turma, materia, dataIni, dataFim, professor, situ);
            Session["Report"] = fpcb;
            Session["URLRelatorio"] = "/GeducReportViewer.aspx";
        ...
        private void PorModalidadeSerieCurso()
        {
            ...
            RptAgendaMonitoriaPorModCurTur fpcb = new RptAgendaMonitoriaPorModCurTur();
            lRetorno = fpcb.InitReport(parametros, infos, coEmp, modalidade, serieCurso, Turma, materia, dataIni, dataFim, professor, situ);
            Session["Report"] = fpcb;
            Session["URLRelatorio"] = "/GeducReportViewer.aspx";
        ...
        private void porAgendamento()
        {
            ...
            RptAgendaMonitoriaPorAgendamento fpcb = new RptAgendaMonitoriaPorAgendamento();
            lRetorno = fpcb.InitReport(parametros, infos, coEmp, modalidade, serieCurso, Turma, materia, dataIni, dataFim, professor, situ);
            Session["Report"] = fpcb;
            Session["URLRelatorio"] = "/GeducReportViewer.aspx";
        ...
        private void porProfXdisciplina()
        {
            string parametros;
            string infos;
            int coEmp, lRetorno, modalidade, serieCurso, Turma, materia, professor;
            ...
            RptAgendaMonitoriaProfessorXDisciplina fpcb = new RptAgendaMonitoriaProfessorXDisciplina();
            lRetorno = fpcb.InitReport(parametros, infos, coEmp, modalidade, serieCurso, Turma, materia, dataIni, dataFim, professor, situ);
            Session["Report"] = fpcb;
            Session["URLRelatorio"] = "/GeducReportViewer.aspx";
