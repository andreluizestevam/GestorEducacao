...
// OBJETIVO: RELAÇÃO DE PROFESSORES POR UNIDADE ESCOLAR
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class ProfesPorLocaliEscola : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            string strP_CO_EMP, strP_DE_EMP;
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelMapaLocalizacao");
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            RptProfesPorLocaliEscola rtp = new RptProfesPorLocaliEscola();
            lRetorno = rtp.InitReport(strParametrosRelatorio, LoginAuxili.CO_EMP, "", strP_CO_EMP);
            Session["Report"] = rtp;
            Session["URLRelatorio"] = "/GeducReportViewer.aspx";

            AuxiliPagina.TrataRetornoRelatorio(lRetorno, this.AppRelativeVirtualPath);

            //lRetorno = lIRelatorioWeb.RelMapaLocalizacao(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strP_CO_EMP, strP_DE_EMP);
