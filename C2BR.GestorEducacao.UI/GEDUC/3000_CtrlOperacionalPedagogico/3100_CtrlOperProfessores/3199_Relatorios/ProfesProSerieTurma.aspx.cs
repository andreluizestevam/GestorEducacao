...
// OBJETIVO: RELAÇÃO DE PROFESSORES POR SÉRIE/TURMA
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class ProfesProSerieTurma : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelMapaCursoTurmaProf");
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            strParametrosRelatorio = "( Unidade: " + ddlUnidade.SelectedItem.ToString() + " - Módulo: " + ddlModalidade.SelectedItem.ToString() + " - Série: " + ddlSerieCurso.SelectedItem.ToString() +
                          " - Turma: " + ddlTurma.SelectedItem.ToString() + " )";

            lIRelatorioWeb = varRelatorioWeb.CreateChannel();

            lRetorno = lIRelatorioWeb.RelMapaCursoTurmaProf(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strParametrosRelatorio, strP_CO_EMP, strP_CO_ANO_REF, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR);
