<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC._3000_CtrlOperacionalPedagogico._3100_CtrlOperProfessores._3110_CtrlPlanejamentoAulas._3118_ManuDiarioClasse.Cadastro" %>
        ...
        <ul>
                    ...
                    <ul id="ulDados" class="ulDados">
                        ...
                        <li style="margin-left: 10px;">
                            <label for="ddlSerie" title="Selecione a série" class="lblObrigatorio">
                                S&eacute;rie</label>
                            <asp:DropDownList ID="ddlSerie" runat="server" ToolTip="Selecione a série" AutoPostBack="true"
                        ...
                        <li style="margin-left: 10px;">
                            <label for="ddlTempo" title="Selecione o tempo da frequência" class="lblObrigatorio">
                                Tempo</label>
                            <asp:DropDownList ID="ddlTempo" runat="server" ToolTip="Selecione o tempo da frequência">
                            </asp:DropDownList>
                        ...
                        <li style="margin-left: 250px; clear: both">
                            <label title="professor do qual você deseja pesquisar as atividades/frequências">
                                Professor</label>
                            <asp:DropDownList runat="server" ID="ddlProfessor" OnSelectedIndexChanged="ddlProfessor_OnSelectedIndexChanged"
                                AutoPostBack="true" ToolTip="Selecione o professor do qual você deseja pesquisar as atividades/frequências"
                                Width="230px">
                            </asp:DropDownList>
                        </li>
                        <li style="margin-left: 10px;">
                            <label for="ddlMateria" title="Selecione a matéria" class="lblObrigatorio">
                                Disciplina</label>
                            <asp:DropDownList ID="ddlMateria" runat="server" ToolTip="Selecione a matéria" Width="215px">
                            </asp:DropDownList>
            ...
            <li style="clear: both">
                <div>
                    ...
                    <!---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
                    <div id="atividades" style="float: left">
                        <!-- GRID DE NOTAS -->
                        <div class="divMarcar">
                        </div>
                        <div class="divTitulo" style="width: 565px; margin-top: 12px;">
                            GRADE DE ATIVIDADES
                        </div>
                        <div id="divGrid" runat="server" class="divGrid" style="width: 564px; height: 350px;">
                            <asp:GridView ID="grdAtividades" CssClass="grdBusca" Width="100%" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="DATA">
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtDataAtiv" runat="server" Enabled="false" Width="60px" Style="text-align: center !important;
                                                margin-top: 10px;" Text='<%# bind("DT_ATIV") %>' CssClass="campoData">
                                            </asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="TIPO">
                                        ...
                                        <ItemTemplate>
                                            <asp:DropDownList ID="ddlTipoAtiv" ToolTip="Tipo de Atividade" runat="server" Width="70px"
                                                Enabled="false" Style="text-align: center !important;">
                                            </asp:DropDownList>
                                            <asp:HiddenField runat="server" ID="hidTipoAtiv" Value='<%# bind("CO_TIPO_ATIVIDADE") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="TEMA / DESCRIÇÃO">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtTema" runat="server" Enabled="false" Width="300px" Height="15px"
                                                TextMode="multiline" Text='<%# bind("DE_TEMA") %>' placeholder="Tema da Atividade (Obrigatório)"
                                                Style="margin-top: 2px">
                                            </asp:TextBox>
                                            <asp:TextBox ID="txtResumo" runat="server" Enabled="false" Width="300px" Height="50px"
                                                TextMode="multiline" Text='<%# bind("DE_RES_ATIV") %>' Style="margin: 3px 0 2px 0"
                    ...
                    <!---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
                    <div id="frequencias" style="float: right !important; margin-left: 50px;">
                        <!-- GRID DE FREQUÊNCIAS -->
                        <div class="divMarcar">
                            <asp:HiddenField ID="hidCoAtivSel" runat="server" Value="0" />
                            <asp:HiddenField ID="hidHomAtivSel" runat="server" Value="" />
                        </div>
                        <div class="divTitulo" style="width: 401px; margin-top: 12px; margin-left: 10px;">
                            GRADE DE FREQUÊNCIAS
                        </div>
                        <div id="divFreq" runat="server" class="divGrid" style="width: 400px; height: 350px;
                            margin-left: 10px;">
                            <asp:GridView ID="grdFreq" CssClass="grdBusca" Width="100%" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="CK">
                                        ...
                                        <HeaderTemplate>
                                            <asp:CheckBox runat="server" ID="chkMarcaTodosItensPendentes" OnCheckedChanged="chkMarcaTodosItensPendentes_OnCheckedChanged"
                                                AutoPostBack="true" Style="margin-left: -2px;" ToolTip="Marca ou desmarca todos os itens da grid" />
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:CheckBox ID="ckSelect" Enabled='<%# bind("chk") %>' runat="server" OnCheckedChanged="ckSelect_OnCheckedChanged"
                                                AutoPostBack="true" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="FALTA">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:CheckBox runat="server" ID="chkAlunoFalta" ToolTip="Marque caso o(a) aluno(a) tenha faltado "
                                                Enabled="false" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
