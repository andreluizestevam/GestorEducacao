...
// OBJETIVO: MOVIMENTAÇÕES DE COLABORADORES
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class MovimFuncTipoUnid : System.Web.UI.Page
    {
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            strP_TP_MOV = ddlTpMovim.SelectedValue;
            strP_DT_INI = DateTime.Parse(txtDataPeriodoIni.Text);
            strP_DT_FIM = DateTime.Parse(txtDataPeriodoFim.Text);
            strINFOS = AuxiliRelatorioTemporario.GeraIdentFuncionarioRelatorio(Request.UserHostAddress);

            strParametrosRelatorio = "(Tipo Movimentação: " + ddlTpMovim.SelectedItem + " - Unidade: " + ddlUnidade.SelectedItem +
                                         " - Período: " + txtDataPeriodoIni.Text + " à " + txtDataPeriodoFim.Text + ")";

            RptMovimFunc rpt = new RptMovimFunc();
            lRetorno = rpt.InitReport(strParametrosRelatorio, LoginAuxili.ORG_CODIGO_ORGAO, strP_CO_EMP, strP_CO_EMP_REF, strP_TP_MOV, strP_DT_INI, strP_DT_FIM, strINFOS);
            Session["Report"] = rpt;
