...
{
    public partial class HistMovimFunc : System.Web.UI.Page
    {
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            RptHistMovimFunc rpt = new RptHistMovimFunc();
            lRetorno = rpt.InitReport(strParametrosRelatorio, LoginAuxili.ORG_CODIGO_ORGAO, strP_CO_EMP, strP_CO_EMP_COL, strP_CO_COL, strP_DT_INI, strP_DT_FIM, strINFOS);
            Session["Report"] = rpt;
