...
//====> Processo de Alteração e Inserção de Registros na Entidade do BD, após a ação de salvar
        ...
        private void MontaGridFrequencias()
        {
            ...
            var resultado = (from tb199 in TB199_FREQ_FUNC.RetornaTodosRegistros().ToList()
                             ...
                             select new
                             {
                                 DATA = tb199.DT_FREQ.ToString("dd/MM/yyyy"), TIPO = tb199.TP_FREQ == "E" ? "Entrada" : "Saída",
                                 HORA = tb199.HR_FREQ.ToString("00:00"), MOTIVO_CANCELAMENTO = tb199.DE_MOTIV_CANC_FREQ_FUNC,
                                 tb199.CO_EMP, tb199.CO_COL, tb199.CO_SEQ_FREQ
                             });
...
//====> 
        ...
        private void CarregaAno()
        {
            ...
            var res = (from tb199 in TB199_FREQ_FUNC.RetornaTodosRegistros()
            ...
            if (res != null)
            {
                ...
                ddlAno.Items.Insert(0, new ListItem("Não Há Reg. de Ponto", ""));
