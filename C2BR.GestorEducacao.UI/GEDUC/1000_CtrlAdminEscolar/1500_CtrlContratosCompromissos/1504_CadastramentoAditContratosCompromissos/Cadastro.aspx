<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F1000_CtrlAdminEscolar.F1500_CtrlContratosCompromissos.F1504_CadastramentoAditContratosCompromissos.Cadastro" %>
        ...
        <ul>
            ...
            <li class="liEspaco">
                ...
                <asp:DropDownList ID="ddlNomeFantasia" ToolTip="Selecione o Nome Fantasia" runat="server"
                     CssClass="ddlNomeFantasia" Enabled="false">
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlNomeFantasia" 
        ...
        <ul>
            <li>
                ...
                <asp:TextBox ID="txtNumContrato" MaxLength="10"
                    ...
                    Enabled="false"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtNumContrato" 
    ...
    <li class="liConta">
        <ul>
            <li>
                ...
                <asp:DropDownList ID="ddlCateg" Enabled="false"  CssClass="ddlCateg" runat="server" ToolTip="Selecione a Categoria"
            ...
            <li style="clear: none;">
                ...
                <asp:DropDownList ID="ddlSubCateg" CssClass="ddlCateg" Enabled="false" runat="server" ToolTip="Selecione a SubCategoria">
                </asp:DropDownList>
            </li>
            <li class="liClear" style="margin-top: 10px;">
                ...
                <asp:TextBox ID="txtTitulContrat" MaxLength="60"
                    ToolTip="Informe o Título do Contrato"  Enabled="false"
            ...
            <li class="liClear liObjetContr">
                ...
                <asp:TextBox ID="txtObjetContrat" Enabled="false" TextMode="MultiLine" onkeyup="javascript:MaxLength(this, 500);"
            ...
            <li class="liEspaco">
                ...
                <asp:TextBox ID="txtDtPublicacao" Enabled="false"
            ...
            <li class="liClear">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtDtContrato" 
            ...
            <li>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator25" runat="server" ControlToValidate="txtDtInicioContrato" 
                    ...
                    <li class="liLeftFinanceiro">
                        <ul>
                            ...
                            <li class="liDtPrimeiroVencto">
                                ...
                                <asp:TextBox ID="txtValorPrimParc" ToolTip="Informe o Valor da Primeira Parcela do Contrato" CssClass="txtMoney" runat="server" MaxLength="9"></asp:TextBox>
                            ...
                            <li class="liClear">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddlTipoDocumento" 
                            ...
                            <li style="margin-left: 5px;">
                                ...
                                <asp:TextBox ID="txtNumDoc" 
                                    ...
                                    CssClass="txtNumDoc" runat="server"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtNumDoc" 
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <asp:DropDownList ID="ddlTipoReceita" runat="server" Width="90px"
                            ToolTip="Selecione o Grupo" AutoPostBack="True" OnSelectedIndexChanged="ddlTipoReceita_SelectedIndexChanged">
                            <asp:ListItem Value="C" Text="Receita" Selected="true"></asp:ListItem>
                    ...
                    <li style="clear: none; margin-left: 5px;">
                        ...
                        <asp:DropDownList ID="ddlSubGrupoReceita" runat="server" Width="210px"
