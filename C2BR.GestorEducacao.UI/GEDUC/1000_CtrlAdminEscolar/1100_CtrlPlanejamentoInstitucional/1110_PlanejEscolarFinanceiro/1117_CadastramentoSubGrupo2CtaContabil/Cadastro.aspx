<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    Title="Cadastro" Inherits="C2BR.GestorEducacao.UI.GEDUC.F1000_CtrlAdminEscolar.F1100_CtrlPlanejamentoInstitucional.F1110_PlanejEscolarFinanceiro.F1117_CadastramentoSubGrupo2CtaContabil.Cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <ul id="ulDados" class="ulDados">
        ...
        <li class="liDescricao">
            <label for="ddlGrupo" title="SubGrupo" class="lblObrigatorio labelPixel">SubGrupo</label>
            <asp:DropDownList ID="ddlSubGrupo" ToolTip="Selecione o SubGrupo" Width="240px" runat="server">
            </asp:DropDownList>
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddlSubGrupo"
        ...
        <li class="liDescricao">
            ...
            <asp:TextBox ID="txtNumSubGrupo" ToolTip="Informe o Número do SubGrupo2" MaxLength="3" runat="server" CssClass="txtNumSubGrupo"></asp:TextBox>           
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtNumSubGrupo" 
            ErrorMessage="Número do SubGrupo2 deve ser informado" Display="None">
            </asp:RequiredFieldValidator>
        </li>
        <li class="liDescricao" style="margin-top: -5px;">
            ...
            <asp:RegularExpressionValidator runat="server" ControlToValidate="txtDescricaoSubGrupo"
                ErrorMessage="Descrição do SubGrupo2 deve ter no máximo 50 caracteres"
