...
namespace C2BR.GestorEducacao.UI.GEDUC.F1000_CtrlAdminEscolar.F1100_CtrlPlanejamentoInstitucional.F1130_DotacaoOrcamentaria.F1137_CadastroGrupoDotac
{
    public partial class Busca : System.Web.UI.Page
    {
        ...
        void CurrentPadraoBuscas_OnAcaoBuscaDefineGridView()
        {
            var resultado = (from tb260 in TB260_GRUPO.RetornaTodosRegistros()
                             ...
                             select new
                             {
                                 tb260.NOM_GRUPO, TP_GRUPO = "Dotação Orçamentária", tb260.ID_GRUPO, tb260.CO_GRUPO
