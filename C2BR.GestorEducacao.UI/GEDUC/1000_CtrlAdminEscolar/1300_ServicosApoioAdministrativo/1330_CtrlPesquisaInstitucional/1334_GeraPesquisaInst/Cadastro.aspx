...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <ul id="ulDados" class="ulDados">
        ...
        <ul>
            <li>
                <label for="txtTituloAvaliacao" class="lblObrigatorio" title="Título da Avaliação">Título Avaliação</label>
                ...
                <asp:RequiredFieldValidator runat="server" CssClass="validatorField" ControlToValidate="txtTituloAvaliacao"
                    ErrorMessage="Título da Avaliação deve ser informado">
            ...
            <li class="liClear">
                ...
                <asp:RequiredFieldValidator runat="server" CssClass="validatorField" ControlToValidate="ddlPublicoAlvo"
                    ErrorMessage="Público Alvo deve ser informado">
                </asp:RequiredFieldValidator>
            </li>
            <li class="liEspaco">
                <label for="ddlIdentificada" class="lblObrigatorio" title="Avaliação será identificada?">Identificada?</label>
                ...
                <asp:RequiredFieldValidator runat="server" CssClass="validatorField" ControlToValidate="ddlIdentificada"
                    ErrorMessage="Informe se a Avaliação será identificada">
                </asp:RequiredFieldValidator>
            </li>
            <li class="liClear">
            ...
            <li class="liClear">
                <label for="ddlStatus" class="lblObrigatorio" title="Status da Avaliação">Status</label>
                <asp:DropDownList ID="ddlStatus" CssClass="ddlStatus" runat="server"
                    ToolTip="Selecione o Status da Avaliação">
                    <asp:ListItem Value="A">Ativo</asp:ListItem>
                    <asp:ListItem Value="I">Inativo</asp:ListItem>
                </asp:DropDownList>
                <asp:RequiredFieldValidator runat="server" CssClass="validatorField" ControlToValidate="ddlStatus"
                    ErrorMessage="Status da Avaliação deve ser informado">
                </asp:RequiredFieldValidator>
            </li>
            <li>
                <label for="txtDataStatus" class="lblObrigatorio" title="Data de Status da Avaliação">Data do Status</label>
        ...
        <li>
            <label for="ddlAvaliacao" class="lblObrigatorio" title="Tipo de Avaliação">Tipo Avaliação</label>
            ...
            <asp:RequiredFieldValidator runat="server" CssClass="validatorField" ControlToValidate="ddlAvaliacao"
                ErrorMessage="Avaliação deve ser informada">
            </asp:RequiredFieldValidator>
        </li>
        <li class="liBarraTitulo"><span>Selecione uma ou mais questões</span></li>
