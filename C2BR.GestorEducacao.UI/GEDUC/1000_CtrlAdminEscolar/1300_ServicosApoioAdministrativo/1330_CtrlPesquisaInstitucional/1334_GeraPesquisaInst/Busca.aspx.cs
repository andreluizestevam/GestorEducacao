    ...
    public partial class Busca : System.Web.UI.Page
    {
        ...
        void CurrentPadraoBuscas_OnAcaoBuscaDefineGridView()
        {
            ...
            var resultado = (from tb201 in TB201_AVAL_MASTER.RetornaTodosRegistros()
                             ...
                             select new
                             {
                                tb201.NU_AVAL_MASTER, tb201.DT_CADASTRO, STATUS = tb201.STATUS.Equals("A") ? "Ativo" : "Inativo",
                                tb201.CO_TIPO_AVAL, tb201.TB25_EMPRESA.NO_FANTAS_EMP, tb201.NM_TITU_AVAL,
                                FLA_PUBLICO_ALVO = tb201.FLA_PUBLICO_ALVO.Equals("A") ? "Alunos" : tb201.FLA_PUBLICO_ALVO.Equals("P") ? "Professores" :
            ...
            var resultado2  = (from result2 in resultado
                              select new
                              {
                                  ID = result2.NU_AVAL_MASTER, result2.STATUS, result2.DT_CADASTRO,
                                  ...
                                  result2.NO_FANTAS_EMP, result2.NM_TITU_AVAL, result2.FLA_PUBLICO_ALVO
                              }).ToList();
