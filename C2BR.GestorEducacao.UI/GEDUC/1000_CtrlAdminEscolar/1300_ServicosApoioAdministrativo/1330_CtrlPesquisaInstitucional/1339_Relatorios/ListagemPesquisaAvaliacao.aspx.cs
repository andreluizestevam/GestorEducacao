...
// OBJETIVO: LISTAGEM DE PESQUISA/AVALIAÇÃO
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class ListagemPesquisaAvaliacao : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            string strP_CO_EMP, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, strP_CO_MAT, strP_CO_ANO_MES_MAT, strP_CO_BIMESTRE;
            ...
            strNomeRelatorio = WRAuxiliares.GeraNomeRelatorio("RelListagemProva");
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            ddlTurma.SelectedItem.ToString() + " - Matéria: " + ddlMateria.SelectedItem.ToString() + " - Bimestre: " + ddlBimestre.SelectedItem.ToString() + " )";

            lIRelatorioWeb = varRelatorioWeb.CreateChannel();

            lRetorno = lIRelatorioWeb.RelListagemProva(strIdentFunc, strCaminhoRelatorioGerado, strNomeRelatorio, strParametrosRelatorio, strP_CO_EMP, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, strP_CO_MAT, strP_CO_ANO_MES_MAT, strP_CO_BIMESTRE);
