    ...
    public partial class Busca : System.Web.UI.Page
    {
        ...
        void CurrentPadraoBuscas_OnAcaoBuscaDefineGridView()
        {
            ...
            var resultado = (from tb137 in TB137_TAREFAS_AGENDA.RetornaTodosRegistros()
                             ...
                             && ((tb137.TB139_SITU_TAREF_AGEND.CO_SITU_TAREF_AGEND.Equals(TB139_SITU_TAREF_AGEND.TC.CO_SITU_TAREF_AGEND))
                                || (tb137.TB139_SITU_TAREF_AGEND.CO_SITU_TAREF_AGEND.Equals(TB139_SITU_TAREF_AGEND.TA.CO_SITU_TAREF_AGEND))
                                || (tb137.TB139_SITU_TAREF_AGEND.CO_SITU_TAREF_AGEND.Equals(TB139_SITU_TAREF_AGEND.EA.CO_SITU_TAREF_AGEND)))
                             && tb137.CO_COL.Equals(LoginAuxili.CO_COL) && tb137.CO_EMP.Equals(LoginAuxili.CO_UNID_FUNC) 
                             && tb137.ORG_CODIGO_ORGAO.Equals(LoginAuxili.ORG_CODIGO_ORGAO)
                             select new
                             {
                                tb137.DT_COMPR_TAREF_AGEND, tb137.DT_LIMIT_TAREF_AGEND, tb137.NM_RESUM_TAREF_AGEND, tb137.TB03_COLABOR.NO_COL,
                                tb137.TB139_SITU_TAREF_AGEND.DE_SITU_TAREF_AGEND, tb137.CO_CHAVE_UNICA_TAREF, tb137.CO_IDENT_TAREF
