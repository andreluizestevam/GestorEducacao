<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F1000_CtrlAdminEscolar.F1300_ServicosApoioAdministrativo.F1310_CtrlAgendaAtividadesFuncional.F1313_AtualizaPosicaoAgendaAtividade.Cadastro" %>
...
<style type="text/css">
    ...
    .txtEmissor, .txtUnidadeEmissor, .ddlUnidade, .ddlNomeResponsavel { width: 210px; }  
...
<ul id="ulDados" class="ulDados">
    ...
    <legend>Respons&aacute;vel Tarefa</legend>
        <ul>
            ...
            <li class="liDepartamento">
                ...
                <asp:DropDownList ID="ddlDepartamento" CssClass="ddlDepartamento" Enabled="false" ToolTip="Departamento"
            ...
            <li class="liFuncao">
                ...
                <asp:DropDownList ID="ddlFuncao" CssClass="ddlFuncao" Enabled="false" runat="server" ToolTip="Função" 
            ...
            <li class="liClear">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlNomeResponsavel" ErrorMessage="Respons&aacute;vel deve ser informado" Display="None"></asp:RequiredFieldValidator>
            </li>
        </ul>
    </fieldset>
    </li>
        ...
        <ul>
            ...
            <li class="liDtLimite">
                ...
                <asp:CustomValidator ControlToValidate="txtDtLimite" ID="cvDataLimite" runat="server"
                    ErrorMessage="Data Limite não pode ser maior que a Data de Cadastro" Display="None"
            ...
            <li class="liPrioridade">
                ...
                <asp:DropDownList ID="ddlPrioridade" CssClass="ddlPrioridade" Enabled="false" runat="server" ToolTip="Prioridade">
                </asp:DropDownList>
            </li>
        </ul>
    </fieldset>
    ...
    <li class="liSMS">
        ...
        <asp:CustomValidator ControlToValidate="ddlEnviarSMS" ID="cvCelularResponsavel" runat="server"
            ...
            CssClass="validatorField" EnableClientScript="false" OnServerValidate="cvCelular_ServerValidate">
        </asp:CustomValidator>
    </li>
</ul>
</asp:Content>