...
namespace C2BR.GestorEducacao.UI.GEDUC.F1000_CtrlAdminEscolar.F1300_ServicosApoioAdministrativo.F1310_CtrlAgendaAtividadesFuncional.F1311_RegistroAgendaAtividade
{
    public partial class Busca : System.Web.UI.Page
    {
        ...
        {
            CurrentPadraoBuscas.GridBusca.DataKeyNames = new string[] { "CO_IDENT_TAREF", "CO_CHAVE_UNICA_TAREF" };
        ...
        void CurrentPadraoBuscas_OnAcaoBuscaDefineGridView()
        {
            ...
            var resultado = (from tb137 in TB137_TAREFAS_AGENDA.RetornaTodosRegistros().OrderBy(t => t.DT_COMPR_TAREF_AGEND)
