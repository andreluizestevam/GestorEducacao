...
// OBJETIVO: EMISSÃO DA RELAÇÃO DE TAREFAS INCONSISTENTES
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class RelacTarefIncons : System.Web.UI.Page
    {
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário
            ...
            RptRelacTarefIncons fpcb = new RptRelacTarefIncons();
            lRetorno = fpcb.InitReport(strParametrosRelatorio, LoginAuxili.ORG_CODIGO_ORGAO, LoginAuxili.CO_EMP, strP_CO_EMP, strP_CO_RESP, strP_CO_SOLIC, strINFOS);
            Session["Report"] = fpcb;
