...
// OBJETIVO: EMISSÃO DA RELAÇÃO DE TAREFAS AGENDADAS
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class RelacTarefAgendadas : System.Web.UI.Page
    {
...
//--------> Variáveis de parâmetro do Relatório
            int strP_CO_EMP_REF, strP_CO_RESP, strP_CO_SOLIC;
            string strP_PRIOR;
...
//--------> Lança nas variáveis dos parâmetros os valores escolhidos no formulário            
            ...
            RptRelacTarefAgendadas fpcb = new RptRelacTarefAgendadas();
            lRetorno = fpcb.InitReport(strParametrosRelatorio, LoginAuxili.ORG_CODIGO_ORGAO, LoginAuxili.CO_EMP, strP_CO_EMP_REF, strP_DT_INI, strP_DT_FIM, strP_CO_RESP, strP_PRIOR, strP_CO_SOLIC, strINFOS);
            Session["Report"] = fpcb;
