...
// OBJETIVO:  MAPA DE COLABORADORES POR CARGO/FUNÇÃO
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class MapaColCargoFuncao : System.Web.UI.Page
    {
        ...
        /// <summary>
        /// Método que carrega o dropdown de Funções
        /// </summary>
        private void CarregaFuncao()
        {
            ...
            ddlFuncao.Items.Insert(0, new ListItem("Todas", "T"));
        }
        #endregion
        ...
        protected void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            int coFun = ddlFuncao.SelectedValue != "T" ? int.Parse(ddlFuncao.SelectedValue) : 0;
            ...
            var qryFuncoes = (from tb03 in TB03_COLABOR.RetornaTodosRegistros()
                              ...
                              where (coFun != 0 ? tb03.CO_FUN == coFun : coFun == 0)
            ...
            foreach (var qryF in qryFuncoes)
            {
                ...
                var qryGrid = from tb03 in TB03_COLABOR.RetornaTodosRegistros()
                              where (coUnidade != 0 ? tb03.TB25_EMPRESA.CO_EMP == coUnidade : coUnidade == 0) && (tb03.CO_FUN == qryF.CO_FUN)
                              && (coTpUnidade != 0 ? tb03.TB25_EMPRESA.TB24_TPEMPRESA.CO_TIPOEMP == coTpUnidade : coTpUnidade == 0)
                              && tb03.ORG_CODIGO_ORGAO == LoginAuxili.ORG_CODIGO_ORGAO
                ...
                dt.Rows.Add(qryF.NO_FUN, parcSitu[0], parcSitu[1], parcSitu[2], parcSitu[3], parcSitu[4], parcSitu[5], parcSitu[6], parcSitu[7], parcSitu[8], parcSitu[9], total);
            }
            ...
            liGridMCCF.Visible = true;
            liLegMCCF.Visible = true;
