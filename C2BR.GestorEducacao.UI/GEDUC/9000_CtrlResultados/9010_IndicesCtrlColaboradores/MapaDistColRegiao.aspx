<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="MapaDistColRegiao.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F9000_CtrlResultados.F9010_IndicesCtrlColaboradores.MapaDistColRegiao" %>
...
<style type="text/css">      
    ...
    .liBairro, .liUnidadeEscolar {clear:none !important; display:inline !important;margin-left:10px;}    
    .liBtnAnaRecPag
    {
    ...
    .liTotais{ width:32px;clear:none !important;text-align:right;margin-right: 0px !important; }
...
<ul id="ulDados" class="ulDados">        
       <li style="margin-left: 95px;">
        ...
        <li class="liBairro">
            <label id="Label4" class="lblObrigatorio" title="Tipo de Unidade">
        ...
        <li style="margin-left: 9px;" id="liGridMDCR" runat="server" clientidmode="Static" visible="false">
            <ul>
                <li style="margin-left: 186px;"><label style="text-transform:uppercase;">--------------------------------- SITUAÇÃO FUNCIONAL ---------------------------------</label></li>
                <li>
                ...
                <li style="width:185px;margin-right: 0px;visibility:hidden;">
                    <label>Total</label>
                </li> 
                ...
                <li class="liTotais" style="width:46px;visibility:hidden;">
                    <asp:Label ID="lblTotal" runat="server"></asp:Label>
                </li>
            </ul>
        </li>   
        <li style="clear:none; margin-left: 10px; margin-right: 0px;" id="liLegMDCR" runat="server" clientidmode="Static" visible="false">
