...
// OBJETIVO:  MAPA ANUAL DE FALTAS FUNCIONAIS POR CARGO/FUNÇÃO
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class MapaFaltaFunciCargoFuncao : System.Web.UI.Page
    {
        ...
        protected void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            foreach (var qryB in qryFuncoes)
            {
                ...
                var qryGrid = from tb03 in TB03_COLABOR.RetornaTodosRegistros()
                              ...
                              && (tb03.CO_FUN == qryB.CO_FUN) && (coUnidade != 0 ? tb03.TB25_EMPRESA.CO_EMP == coUnidade : coUnidade == 0)
                              && tb199.TP_FREQ == "F" && tb199.DT_FREQ.Year == anoRefer && tb199.STATUS == "A"
                              && tb03.ORG_CODIGO_ORGAO == LoginAuxili.ORG_CODIGO_ORGAO
                ...
                dt.Rows.Add(qryB.NO_FUN, parcSitu[0], parcSitu[1], parcSitu[2], parcSitu[3], parcSitu[4], parcSitu[5], parcSitu[6], parcSitu[7], parcSitu[8], parcSitu[9], parcSitu[10], parcSitu[11], total);
            }
            ...
            liGridMFFCF.Visible = true;
            liLegMFFCF.Visible = true;
