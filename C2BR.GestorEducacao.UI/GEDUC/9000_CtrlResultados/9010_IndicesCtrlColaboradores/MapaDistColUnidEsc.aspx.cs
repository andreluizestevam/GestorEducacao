...
// OBJETIVO:  MAPA DE DISTRIBUIÇÃO DE COLABORADORES POR UNIDADE ESCOLAR
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class MapaDistColUnidEsc : System.Web.UI.Page
    {
        ...
        protected void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            var qryUnidades = (from tb03 in TB03_COLABOR.RetornaTodosRegistros()
                               where (coCidade != 0 ? tb03.CO_CIDADE == coCidade : coCidade == 0)
                               && (coBairro != 0 ? tb03.CO_BAIRRO == coBairro : coBairro == 0)
            ...
            foreach (var qryU in qryUnidades)
            {
                ...
                var qryGrid = from tb03 in TB03_COLABOR.RetornaTodosRegistros()
                              ...
                              && (tb03.TB25_EMPRESA.CO_EMP == qryU.CO_EMP)
                ...
                dt.Rows.Add(qryU.NO_FANTAS_EMP, parcSitu[0], parcSitu[1], parcSitu[2], parcSitu[3], parcSitu[4], parcSitu[5], parcSitu[6], parcSitu[7], parcSitu[8], parcSitu[9], total);
            }
            ...
            liGridMDCUE.Visible = true;
            liLegMDCUE.Visible = true;
