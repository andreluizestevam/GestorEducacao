...
// OBJETIVO:  INDICADORES DEMOGRÁFICOS E EDUCACIONAIS (PARAMETRIZADO)
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class IDEMEC : System.Web.UI.Page
    {
        #region Variáveis
...
//====> 
        ...
        private string RemoveAdditionalData(string strDados)
        {
            ...
            strDados = strDados.Replace(@"src=""/novo/img/nova_consulta.gif""", @"src=""../../../../Library/IMG/Gestor_IndiDemoNovaConsul.gif""");
            ...
            strDados = strDados.Replace(@"<div align=""center"">", @"--><div style=""overflow-y: auto; height: 310px;"" align=""center"">");
        ...
        {
            string strCaminhoArquivoXML = HttpContext.Current.Request.MapPath("~/GEDUC/9000_CtrlResultados/9210_IndicesEducacaoExterno/9212_IDE_MEC/Library/Municipios.xml");
