<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="MapaDesEscUniSer.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F9000_CtrlResultados.F9020_IndicesCtrlPedagogico.MapaDesEscUniSer" %>
...
<style type="text/css">      
    ...
    .divGrid { height: 220px; overflow-y:auto; width: 586px; border: 1px solid #D2DFD1;}    
...
<ul id="ulDados" class="ulDados">  
        ...
        <li style="margin-left: 15px;" id="liGridMCFF" runat="server" clientidmode="Static" visible="false">
            <ul>
                <li style="margin-left: 355px;"><label style="text-transform:uppercase;">-------------------------- ANOS --------------------------</label></li>
                <li style="margin-left: 10px;">
                    <div id="divGrid" runat="server" class="divGrid">
                        <asp:GridView ID="grdResulParam" CssClass="grdBusca" Width="570px" runat="server" AutoGenerateColumns="False">
                ...
                <li style="width:285px;margin-right: 0px;margin-left: 10px;visibility:hidden;">
                    <label>Total</label>
                </li> 
                <li class="liTotais" style="visibility:hidden;">
                    <asp:Label ID="lblTotT1" runat="server"></asp:Label>
                </li>
                <li class="liTotais" style="width:32px;visibility:hidden;">
                    <asp:Label ID="lblTotT2" runat="server"></asp:Label>
                </li>
                <li class="liTotais" style="width:64px;visibility:hidden;">
         ...
         <li style="clear:none; margin-left: 20px; margin-right: 0px;" id="liImgMDEUS" runat="server" clientidmode="Static" visible="false">
            <asp:chart id="Grafico1" runat="server" Width="320px" Height="260px" Palette="BrightPastel" imagetype="Png" BorderlineDashStyle="Solid" BackSecondaryColor="White" BackGradientStyle="TopBottom" BorderWidth="2" backcolor="#D3DFF0" BorderColor="26, 59, 105">
                <legends>
                    <asp:Legend Name="Legend1" IsTextAutoFit="False" BackColor="Transparent" Font="Trebuchet MS, 8.25pt, style=Bold"></asp:Legend>
                </legends>
                <borderskin skinstyle="Emboss"></borderskin>
                <series>
                    <asp:Series Name="Series1" IsXValueIndexed="True" BorderColor="180, 26, 59, 105"
                         Legend="Legend1" XValueMember="Ano" YValueMembers="Media" 
                         IsValueShownAsLabel="True" IsVisibleInLegend="False" LabelFormat="F2" 
                         YValuesPerPoint="2" YValueType="Double">
                     </asp:Series>
                </series>
                <chartareas>
