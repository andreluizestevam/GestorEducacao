    ...
    <div id="divSistemasPublicosContainer">
            ...
            <asp:GridView runat="server" ID="grdSistemasPublicos" AutoGenerateColumns="False" CssClass="grdSistemasPublicos"
                ...
                <Columns>                    
                    ...
                    <asp:BoundField HeaderText="DESCRIÇÃO" DataField="DE_OBJETO_CONEX_WEB">       
                        <ItemStyle Width="555px"></ItemStyle>                 
                    </asp:BoundField>      
        ...
        <div id="divHelpTxtSP">
            <p id="pAcesso" class="pAcesso">
                ...
                Para maiores informações sobre o Sistema, posicione o mouse na linha de seu interesse.<br />
                Para acessar o Sistema, posicione o Mouse e Clique na linha de seu interesse (Abrirá nova Página).
