    ...
    public partial class Cadastro : System.Web.UI.Page
    {
        ...
        protected void btnAbreCaixa_Click(object sender, EventArgs e)
        {
            ...
            if (varTb295 != null)
            {
                ...
                AuxiliPagina.RedirecionaParaPaginaSucesso("Autenticação do Caixa Efetuado com sucesso", "/GSAUD/5000_CtrlFinanceira/5100_Recebimento/5103_RecebPagamCompromisso/MovimentacaoCaixa.aspx?moduloId=692&moduloNome=Registro+de+Recebimento+ou+Pagamento+de+Compromissos+Financeiros");
            }
            else
