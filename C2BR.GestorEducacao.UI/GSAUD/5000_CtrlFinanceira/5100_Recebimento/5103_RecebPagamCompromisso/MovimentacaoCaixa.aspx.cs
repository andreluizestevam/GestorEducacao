...
namespace C2BR.GestorEducacao.UI.GSAUD.F5000_CtrlFinanceira.F5100_Recebimento.F5103_RecebPagamCompromisso
{
    public partial class MovimentacaoCaixa : System.Web.UI.Page
    {
        ...
        private void CarregaFormulario()
        {
            ...
            var listaContratos = from tbs47 in TBS47_CTA_RECEB.RetornaTodosRegistros()
                                 join tb07 in TB07_ALUNO.RetornaTodosRegistros() on tbs47.CO_ALU equals tb07.CO_ALU
                                 join resp in TB108_RESPONSAVEL.RetornaTodosRegistros() on tbs47.TB108_RESPONSAVEL.CO_RESP equals resp.CO_RESP
                                 where (tbs47.CO_EMP == LoginAuxili.CO_EMP) && tbs47.CO_EMP == tb07.CO_EMP && (tbs47.IC_SIT_DOC == "A" || tbs47.IC_SIT_DOC == "R")
                                 && tbs47.TP_CLIENTE_DOC == "A" && tbs47.CO_ALU == 0
                                 select new
                                 {
                                     tbs47.CO_EMP,
                                     tbs47.NU_DOC,
                                     ...
                                     tbs47.VL_DES_DOC,
                                     tbs47.DE_COM_HIST,
                                     VR_DEBITO = tbs47.VL_PAR_DOC +
                                     (tbs47.CO_FLAG_TP_VALOR_JUR == "V" ? (tbs47.VL_JUR_DOC != null ? tbs47.VL_JUR_DOC : 0) : (tbs47.VL_JUR_DOC != null ? (tbs47.VL_JUR_DOC * tbs47.VL_PAR_DOC) / 100 : 0)) -
                                     (tbs47.CO_FLAG_TP_VALOR_DES == "V" ? (tbs47.VL_DES_DOC != null ? tbs47.VL_DES_DOC : 0) : (tbs47.VL_DES_DOC != null ? (tbs47.VL_DES_DOC * tbs47.VL_PAR_DOC) / 100 : 0)) +
                                     (tbs47.CO_FLAG_TP_VALOR_MUL == "V" ? (tbs47.VL_MUL_DOC != null ? tbs47.VL_MUL_DOC : 0) : (tbs47.VL_MUL_DOC != null ? (tbs47.VL_MUL_DOC * tbs47.VL_PAR_DOC) / 100 : 0)),
        ...
        private void MontaContratoSelecionado(string NU_DOC, int NU_PAR, DateTime DT_CAD_DOC, string strTpBenef)
        {
            ...
            if (strTpBenef == "A")
            {
                var conta = (from tbs47 in TBS47_CTA_RECEB.RetornaTodosRegistros()
                             join tb07 in TB07_ALUNO.RetornaTodosRegistros() on tbs47.CO_ALU equals tb07.CO_ALU                             
                             where tbs47.CO_EMP == LoginAuxili.CO_EMP && tbs47.NU_DOC == NU_DOC && tbs47.NU_PAR == NU_PAR && tbs47.DT_CAD_DOC.Day == DT_CAD_DOC.Day
                             && tbs47.DT_CAD_DOC.Month == DT_CAD_DOC.Month && tbs47.DT_CAD_DOC.Year == DT_CAD_DOC.Year && tbs47.CO_EMP == tb07.CO_EMP
                             select new
                             {
                                 tb07.NO_ALU,
                                 tb07.NO_APE_ALU,
                                 ...
                                 tb07.NU_CPF_ALU,
                                 DES_TIPO_DOC = tbs47.TB086_TIPO_DOC.DES_TIPO_DOC != null ? tbs47.TB086_TIPO_DOC.DES_TIPO_DOC : null,
                                 tbs47.VL_DES_DOC,
                                 tbs47.NU_DOC,
                                 tbs47.NU_PAR,
                                 tbs47.DT_CAD_DOC,
                                 ...
                                 tbs47.VL_PAR_DOC,
                                 tbs47.VL_MUL_DOC,
                                 tbs47.CO_FLAG_TP_VALOR_MUL,
                                 tbs47.CO_FLAG_TP_VALOR_JUR,
                                 tbs47.VL_JUR_DOC,
                                 tbs47.CO_FLAG_TP_VALOR_DES,
                                 DE_HISTORICO = tbs47.TB39_HISTORICO != null ? tbs47.TB39_HISTORICO.DE_HISTORICO : ""
                             }).FirstOrDefault();
                ...
                if (conta != null)
                {
                    ...
                    lblValDoctoSis.Text = conta.VL_PAR_DOC.ToString("#,##0.00");
                    lblValDoctoInf.Text = conta.VL_PAR_DOC.ToString("#,##0.00");
                    ...
                    if (diasAtraso <= 0)
                    {
                        ...
                        descto = conta.VL_DES_DOC != null ? conta.CO_FLAG_TP_VALOR_DES == "V" ? (decimal)conta.VL_DES_DOC : (decimal)(conta.VL_PAR_DOC * (conta.VL_DES_DOC / 100)) : 0;
                        lblValDesctoSis.Text = String.Format("{0:N}", descto);
                    }
                    else
                    {
                        txtValMulInf.Enabled = txtValCorInf.Enabled = true;
                        lblValMulSis.Text = conta.CO_FLAG_TP_VALOR_MUL == "V" ? String.Format("{0:N}", conta.VL_MUL_DOC) : String.Format("{0:N}", conta.VL_PAR_DOC * (conta.VL_MUL_DOC / 100));
                        lblValCorSis.Text = conta.CO_FLAG_TP_VALOR_JUR == "V" ? String.Format("{0:N}", conta.VL_JUR_DOC * diasAtraso) : String.Format("{0:N}", (conta.VL_PAR_DOC * (conta.VL_JUR_DOC / 100)) * diasAtraso);
                    ...
                    lblValSubTotalSis.Text = String.Format("{0:N}", conta.VL_PAR_DOC + Decimal.Parse(lblValMulSis.Text) + Decimal.Parse(lblValCorSis.Text));
                    txtValAdcInf.Text = String.Format("{0:N}", Decimal.Parse(lblValAdcSis.Text));
                    lblValSubTotInf.Text = lblValSubTotalSis.Text;
                    lblValTotalSis.Text = String.Format("{0:N}", (conta.VL_PAR_DOC + Decimal.Parse(lblValMulSis.Text) + Decimal.Parse(lblValCorSis.Text) - Decimal.Parse(lblValDesctoSis.Text)));
            ...
            {
                var conta = (from tbs47 in TBS47_CTA_RECEB.RetornaTodosRegistros()
                             where tbs47.CO_EMP.Equals(LoginAuxili.CO_EMP) && tbs47.NU_DOC == NU_DOC && tbs47.NU_PAR == NU_PAR
                             && tbs47.DT_CAD_DOC.Day == DT_CAD_DOC.Day && tbs47.DT_CAD_DOC.Month == DT_CAD_DOC.Month && tbs47.DT_CAD_DOC.Year == DT_CAD_DOC.Year
                             select new
                             {
                                 tbs47.TB103_CLIENTE.NO_FAN_CLI,
                                 tbs47.TB103_CLIENTE.NO_SIGLA_CLIEN,
                                 tbs47.TB103_CLIENTE.CO_TEL1_CLI,
                                 tbs47.CO_BARRA_DOC,
                                 tbs47.NU_DOC,
                                 DES_TIPO_DOC = tbs47.TB086_TIPO_DOC.DES_TIPO_DOC != null ? tbs47.TB086_TIPO_DOC.DES_TIPO_DOC : null,
                                 tbs47.VL_DES_DOC,
                                 tbs47.NU_PAR,
                                 tbs47.TB103_CLIENTE.CO_CPFCGC_CLI,
                                 tbs47.DT_CAD_DOC,
                                 tbs47.DT_VEN_DOC,
                                 tbs47.DE_COM_HIST,
                                 tbs47.VL_PAR_DOC,
        ...
        protected void MontaGridContratos(string strTipoMovi, string strTipoBenef, int intCodigoBenef, int intAgrupador)
        {
            ...
            if (strTipoMovi == "C")
            {
                if (strTipoBenef == "A")
                {
                    var listaContratos = from tbs47 in TBS47_CTA_RECEB.RetornaTodosRegistros()
                                         join tb07 in TB07_ALUNO.RetornaTodosRegistros() on tbs47.CO_ALU equals tb07.CO_ALU
                                         join tb108 in TB108_RESPONSAVEL.RetornaTodosRegistros() on tbs47.TB108_RESPONSAVEL.CO_RESP equals tb108.CO_RESP
                                         where (tbs47.CO_EMP == LoginAuxili.CO_EMP) && tbs47.CO_EMP == tb07.CO_EMP && (tbs47.IC_SIT_DOC == "A" || tbs47.IC_SIT_DOC == "R")
                                         && tbs47.TP_CLIENTE_DOC == "A" && tbs47.TB108_RESPONSAVEL.CO_RESP == intCodigoBenef
                                         && (intAgrupador != 0 ? tbs47.CO_AGRUP_RECDESP == intAgrupador : intAgrupador == 0)
                                         select new
                                         {
                                             tbs47.CO_EMP,
                                             tbs47.NU_DOC,
                                             ...
                                             tbs47.DT_VEN_DOC,
                                             tbs47.VL_DES_DOC,
                                             DE_COM_HIST = tbs47.TB39_HISTORICO.DE_HISTORICO,
                                             VR_DEBITO = tbs47.VL_PAR_DOC +
                                             (tbs47.CO_FLAG_TP_VALOR_JUR == "V" ? (tbs47.VL_JUR_DOC != null ? tbs47.VL_JUR_DOC : 0) : (tbs47.VL_JUR_DOC != null ? (tbs47.VL_JUR_DOC * tbs47.VL_PAR_DOC) / 100 : 0)) -
                                             (tbs47.CO_FLAG_TP_VALOR_DES == "V" ? (tbs47.VL_DES_DOC != null ? tbs47.VL_DES_DOC : 0) : (tbs47.VL_DES_DOC != null ? (tbs47.VL_DES_DOC * tbs47.VL_PAR_DOC) / 100 : 0)) +
                                             (tbs47.CO_FLAG_TP_VALOR_MUL == "V" ? (tbs47.VL_MUL_DOC != null ? tbs47.VL_MUL_DOC : 0) : (tbs47.VL_MUL_DOC != null ? (tbs47.VL_MUL_DOC * tbs47.VL_PAR_DOC) / 100 : 0)),
                ...
                {
                    var listaContratos = from tbs47 in TBS47_CTA_RECEB.RetornaTodosRegistros()
                                         join tb103 in TB103_CLIENTE.RetornaTodosRegistros() on tbs47.TB103_CLIENTE.CO_CLIENTE equals tb103.CO_CLIENTE
                                         where (tbs47.CO_EMP == LoginAuxili.CO_EMP) && (tbs47.IC_SIT_DOC == "A" || tbs47.IC_SIT_DOC == "R")
                                         && tbs47.TP_CLIENTE_DOC == "O" && tbs47.TB103_CLIENTE.CO_CLIENTE == intCodigoBenef
                                         && (intAgrupador != 0 ? tbs47.CO_AGRUP_RECDESP == intAgrupador : intAgrupador == 0)
                                         select new
                                         {
                                             tbs47.CO_EMP,
        ...
        protected void ListaBeneficiarios(string strTipoMovi, string strTipoBenef)
        {
            if (strTipoMovi == "C")
            {
                if (strTipoBenef == "A")
                {
                    ddlBenef.DataSource = (from itbs47 in TBS47_CTA_RECEB.RetornaTodosRegistros()
                                           where itbs47.TB108_RESPONSAVEL.TB000_INSTITUICAO.ORG_CODIGO_ORGAO == LoginAuxili.ORG_CODIGO_ORGAO &&
                                           itbs47.CO_EMP == LoginAuxili.CO_EMP
                                           select new { itbs47.TB108_RESPONSAVEL.CO_RESP, itbs47.TB108_RESPONSAVEL.NO_RESP, itbs47.TB108_RESPONSAVEL.NU_CPF_RESP }
        ...
        protected void btnQuitarTitulo_Click(object sender, EventArgs e)
        {
            ...
            if (varTb295 != null)
            {
                ...
                if (chkCredito.Checked)
                {
                    var vartbs47 = (from tbs47 in TBS47_CTA_RECEB.RetornaTodosRegistros()
                                   where tbs47.CO_EMP == LoginAuxili.CO_EMP && tbs47.NU_DOC == lblDocNum.Text && tbs47.NU_PAR == intNuPar
                                   && tbs47.DT_CAD_DOC.Year == dataCadastro.Year && tbs47.DT_CAD_DOC.Month == dataCadastro.Month
                                   && tbs47.DT_CAD_DOC.Day == dataCadastro.Day
                                   select tbs47).FirstOrDefault();

                    if (vartbs47 != null)
                    {
                        vartbs47.TB086_TIPO_DOCReference.Load();
                        vartbs47.TB56_PLANOCTAReference.Load();
                        vartbs47.TB39_HISTORICOReference.Load();
                        vartbs47.TB099_CENTRO_CUSTOReference.Load();
                        tb296.CO_TIPO_DOC = vartbs47.TB086_TIPO_DOC != null ? (int?)vartbs47.TB086_TIPO_DOC.CO_TIPO_DOC : null;
                        tb296.DT_VEN_DOC = vartbs47.DT_VEN_DOC;
                        tb296.CO_SEQU_PC = vartbs47.TB56_PLANOCTA != null ? (int?)vartbs47.TB56_PLANOCTA.CO_SEQU_PC : null;
                        tb296.NU_DOC_CAIXA = vartbs47.NU_DOC;
                        tb296.NU_PAR_DOC_CAIXA = vartbs47.NU_PAR;
                        tb296.DT_DOC_CAIXA = vartbs47.DT_CAD_DOC;
                        tb296.CO_EMP_CAIXA = vartbs47.CO_EMP;
                        tb296.DT_PAGTO_DOC = DateTime.Parse(txtDataQuitacao.Text);
                        tb296.VR_DOCU = vartbs47.VL_PAR_DOC;
                        tb296.CO_HISTORICO = vartbs47.TB39_HISTORICO != null ? (int?)vartbs47.TB39_HISTORICO.CO_HISTORICO : null;
                        tb296.CO_CENT_CUSTO = vartbs47.TB099_CENTRO_CUSTO != null ? (int?)vartbs47.TB099_CENTRO_CUSTO.CO_CENT_CUSTO : null;
                        tb296.IDEBANCO = vartbs47.IDEBANCO;
                        tb296.NU_AGE_DOC = vartbs47.CO_AGENCIA != null ? vartbs47.CO_AGENCIA.ToString() : null;
                        tb296.NU_CTA_DOC = vartbs47.NU_CTA_DOC;
                        tb296.TP_CLIENTE_DOC = vartbs47.TP_CLIENTE_DOC;
                        tb296.DE_OBS_DOC = vartbs47.DE_OBS;
                        ...
                        if (chkBenif1.Checked)
                            tb296.CO_ALU = vartbs47.CO_ALU; //int.Parse(ddlBenef.SelectedValue);
                        else
                            tb296.CO_CLIENTE = int.Parse(ddlBenef.SelectedValue);

                        TB296_CAIXA_MOVIMENTO.SaveOrUpdate(tb296, true);

                        vartbs47.VL_JUR_PAG = txtValCorInf.Text != "" ? (decimal?)Decimal.Parse(txtValCorInf.Text) : null;
                        vartbs47.VL_MUL_PAG = txtValMulInf.Text != "" ? (decimal?)Decimal.Parse(txtValMulInf.Text) : null;
                        vartbs47.VL_DES_PAG = txtValDesInf.Text != "" ? (decimal?)Decimal.Parse(txtValDesInf.Text) : null;
                        vartbs47.VL_PAG = lblValTotInf.Text != "" ? (decimal?)Decimal.Parse(lblValTotInf.Text) : null;
                        vartbs47.DT_REC_DOC = DateTime.Parse(txtDataQuitacao.Text);
                        vartbs47.CO_CAIXA = coCaixa;
                        vartbs47.CO_COL_BAIXA = varTb295.CO_COLABOR_CAIXA;
                        vartbs47.DT_MOV_CAIXA = DateTime.Now;
                        vartbs47.DT_ALT_REGISTRO = DateTime.Now;
                        vartbs47.IC_SIT_DOC = "Q";
                        vartbs47.FL_ORIGEM_PGTO = "C";
                        ...
                        else
                        {
                            if (idTipoRecbto != 0)
                            {
                                ...
                                vartbs47.FL_TIPO_RECEB = idTipoRecbto == 5 ? "D" : idTipoRecbto == 2 ? "H" : (idTipoRecbto == 9 || idTipoRecbto == 16) ? "C" : "B";
                            }
                        }
                        
                        TBS47_CTA_RECEB.SaveOrUpdate(vartbs47, true);
                    }
                    else
                    {
                    ...
                    if (varTb38 != null)
                    {
                        ...
                        foreach (GridViewRow linha in grdFormPag.Rows)
                        {
                            if (((TextBox)linha.Cells[3].FindControl("txtValorFP")).Text != "")
                            {
                                ...
                                idTipoPagto = int.Parse(((HiddenField)linha.Cells[4].FindControl("hdCO_TIPO_REC")).Value);
