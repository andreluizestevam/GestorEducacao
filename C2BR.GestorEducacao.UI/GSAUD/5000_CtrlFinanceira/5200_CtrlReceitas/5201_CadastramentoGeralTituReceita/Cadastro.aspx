<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD.F5000_CtrlFinanceira.F5200_CtrlReceitas.F5201_CadastramentoGeralTituReceita.Cadastro" %>
                ...
                <li>
                    <ul>
                        ...
                        <li class="liNomeFonte">
                            ...
                            <asp:DropDownList ID="ddlNomeFonte" Visible="false" CssClass="ddlNomeFonte" runat="server" ToolTip="Selecione o Nome da Fonte" 
                                OnSelectedIndexChanged="ddlNomeFonte_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                            <asp:TextBox ID="txtNomePacPesq" Width="260px" ValidationGroup="pesqPac" ToolTip="Digite o nome ou parte do nome do paciente" runat="server" />
