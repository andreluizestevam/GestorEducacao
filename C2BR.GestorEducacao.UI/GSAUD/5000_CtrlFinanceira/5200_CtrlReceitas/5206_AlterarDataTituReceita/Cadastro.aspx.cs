...
namespace C2BR.GestorEducacao.UI.GSAUD.F5000_CtrlFinanceira.F5200_CtrlReceitas.F5206_AlterarDataTituReceita
{
    public partial class Cadastro : System.Web.UI.Page
    {
        ...
        protected void HabilitaCamposGride()
        {
            foreach (GridViewRow linha in grdResumo.Rows)
            {
                ...
                else
                {
                    ...
                    //Trata os valores
                    ((TextBox)linha.Cells[5].FindControl("txtValorNovo")).Enabled = false;
        ...
        protected void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            AuxiliPagina.RedirecionaParaPaginaSucesso("Datas/Valor Alterados com Sucesso!", "/GSAUD/5000_CtrlFinanceira/5200_CtrlReceitas/5206_AlterarDataTituReceita/Cadastro.aspx?moduloId=981&moduloNome=Alteração+de+Datas+de+Vencimento+de+Títulos+de+Receitas");
        }
