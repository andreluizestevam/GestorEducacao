<%@ Page Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true"
    CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD.F5000_CtrlFinanceira.F5200_CtrlReceitas.F5207_CancelarTituReceita.Cadastro"
    Title="Untitled Page" %>
    ...
    <ul id="ulDados" class="ulDados">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <li>
                    <asp:Label CssClass="lblObrigatorio" runat="server" ID="lblAluPaci">Paciente</asp:Label><br />
                ...
                <div id="divGrid" runat="server" class="divGrid">
                    <asp:GridView ID="grdResumo" CssClass="grdBusca" Width="580px" runat="server" AutoGenerateColumns="False">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="VL_PAR_DOC" HeaderText="R$ Valor">
