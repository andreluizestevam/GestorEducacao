...
namespace C2BR.GestorEducacao.UI.GSAUD.F5000_CtrlFinanceira.F5200_CtrlReceitas.F5207_CancelarTituReceita
{
    public partial class Cadastro : System.Web.UI.Page
    {
        ...
        protected void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            var lst = from tbs47 in TBS47_CTA_RECEB.RetornaTodosRegistros()
                      where tbs47.DT_VEN_DOC >= dtInicio && tbs47.DT_VEN_DOC <= dtFim
                      && tbs47.IC_SIT_DOC == "A" && tbs47.CO_ALU == coAlu
                      && (agrupador != 0 ? tbs47.CO_AGRUP_RECDESP == agrupador : agrupador == 0)
                      && (undContrato != 0 ? tbs47.CO_EMP_UNID_CONT == undContrato : undContrato == 0)
                      select new Dummy
                      {
                          Checked = false,
                          NU_DOC = tbs47.NU_DOC,
