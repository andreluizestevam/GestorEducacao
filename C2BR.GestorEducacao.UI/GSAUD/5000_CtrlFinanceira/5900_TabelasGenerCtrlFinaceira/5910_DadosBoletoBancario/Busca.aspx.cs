        ...
        void CurrentPadraoBuscas_OnAcaoBuscaDefineGridView()
        {
            ...
            var resultado = (from tb227 in TB227_DADOS_BOLETO_BANCARIO.RetornaTodosRegistros()
                            ...
                            select new
                            {
                                ...
                                TP_TAXA_BOLETO = tb227.TP_TAXA_BOLETO.Equals("C") ? "Consulta" :
                                                    tb227.TP_TAXA_BOLETO.Equals("P") ? "Procedimentos" :
                                                    tb227.TP_TAXA_BOLETO.Equals("S") ? "Serviços" :
                                                    tb227.TP_TAXA_BOLETO.Equals("E") ? "Exames" : "Outros",
