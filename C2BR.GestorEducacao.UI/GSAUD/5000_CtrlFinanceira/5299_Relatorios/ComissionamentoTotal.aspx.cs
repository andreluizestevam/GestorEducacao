...
{
    public partial class ComissionamentoTotal : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            titulo = AuxiliGeral.RetornaNomeFuncionalidadeCadastrada("GSAUD/5000_CtrlFinanceira/5299_Relatorios/ComissionamentoTotal.aspx");
            infos = AuxiliRelatorioTemporario.GeraIdentFuncionarioRelatorio(Request.UserHostAddress);

            RptComissaoTotal rpt = new RptComissaoTotal();
            var lRetorno = rpt.InitReport(titulo, parametros, infos, LoginAuxili.CO_EMP, unidade, profissional, grupo, subgrupo, procedimento, tipo);
