...
{
    public partial class ExtratoFinanceiroPaciente : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            strParametrosRelatorio = "( Unid. Contrato: " + siglaUnidContr + " - RAP: " + ddlRap.SelectedItem.ToString()
                + " - Local: " + ddlLocal.SelectedItem.ToString()
            ...
            if (chkPorLocal.Checked)
            {
                RptExtratoFinanceiroPacientePorLocal rpt = new RptExtratoFinanceiroPacientePorLocal();
                lRetorno = rpt.InitReport(strParametrosRelatorio, strUniContr, strP_CO_EMP, strPac, strRap, int.Parse(ddlLocal.SelectedValue), strOrigem,
            ...
            {
                RptExtratoFinanceiroPaciente rpt = new RptExtratoFinanceiroPaciente();
                lRetorno = rpt.InitReport(strParametrosRelatorio, strUniContr, strP_CO_EMP, strPac, strRap, int.Parse(ddlLocal.SelectedValue), strOrigem,
                    strProf, strOper, strSitua, strP_DT_INI, strP_DT_FIM, strINFOS, NO_RELATORIO);
                Session["Report"] = rpt;
                Session["URLRelatorio"] = "/GeducReportViewer.aspx";
        ...
        {
            AuxiliCarregamentos.CarregaDepartamentos(ddlLocal, int.Parse(ddlUnidContrato.SelectedValue), true);
        }
