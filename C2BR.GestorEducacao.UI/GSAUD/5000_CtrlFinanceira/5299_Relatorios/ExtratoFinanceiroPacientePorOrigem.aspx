<%@ Page Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master" AutoEventWireup="true"
    CodeBehind="ExtratoFinanceiroPacientePorOrigem.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD.F5000_CtrlFinanceira.F5299_Relatorios.ExtratoFinanceiroPacientePorOrigem"
    Title="Untitled Page" %>
            ...
            <ContentTemplate>
                ...
                <li class="liAluno" style="margin-left: 5px;">
                    <label title="Registro de Agendamento Paciente">
                        RAP</label>
                    <asp:DropDownList ID="ddlRap" ToolTip="Selecione o RAP" CssClass="ddlRap"
                ...
                <li style="clear: both; margin-top: 5px;">
                    <label for="ddlProfissional" title="Profissional">
                        Profissional</label>
                    <asp:DropDownList ID="ddlProfissional" CssClass="ddlProfissional" runat="server" ToolTip="Selecione o Profissional"/>
                </li>
                <li style="clear: both; margin-top: 5px;">
