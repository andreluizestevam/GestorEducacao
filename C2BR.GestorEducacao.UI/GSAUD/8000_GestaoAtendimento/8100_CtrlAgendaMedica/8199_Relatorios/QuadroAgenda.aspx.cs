...
{
    public partial class QuadroAgenda : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            var NO_RELATORIO = AuxiliGeral.RetornaNomeFuncionalidadeCadastrada("GSAUD/8000_GestaoAtendimento/8100_CtrlAgendaMedica/8199_Relatorios/QuadroAgenda.aspx");

            var res = TB03_COLABOR.RetornaTodosRegistros().Where(a => a.CO_COL == ProfissionalSaude ).SingleOrDefault();

            parametros = "( Profissional : " + res.CO_MAT_COL + " - " + ddlMedico.SelectedItem + " - Classificação: " + ddlClassificacaoProfissional.SelectedItem + " - Período de " + DateTime.Parse(IniPeri.Text).ToString("dd/MM/yy") + " à " + DateTime.Parse(dataFim).ToString("dd/MM/yy") + " - Local: " + ddlDeptLocal.SelectedItem.ToString() +" )";
            #endregion

            RptQuadroAgendamentos fpcb = new RptQuadroAgendamentos();
