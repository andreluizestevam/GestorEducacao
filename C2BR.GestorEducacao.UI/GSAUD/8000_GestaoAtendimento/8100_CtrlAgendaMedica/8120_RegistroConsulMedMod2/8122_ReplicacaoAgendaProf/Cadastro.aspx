<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._8000_GestaoAtendimento._8100_CtrlAgendaMedica._8120_RegistroConsulMedMod2._8122_ReplicacaoAgendaProf.Cadastro" %>
                                ...
                                <ul>
                                    <li class="liTituloGrid" style="width: 100%; height: 24px !important; margin-right: 40px !important;
                                        ...
                                        <div style="float: right; margin-top: 5px">
                                            <ul>
                                                <li>
                                                    <asp:TextBox ID="txtDtIniHistoUsuar" runat="server" class="campoData" Enabled="true">
                                                    </asp:TextBox>
                                                    &nbsp até &nbsp
                                                    <asp:TextBox ID="txtDtFimHistoUsuar" runat="server" class="campoData" Enabled="true">
                                                    </asp:TextBox>
                                                </li>
                                                <li>
                                                    <asp:ImageButton ID="imgBtnPesqHistoUsuar" runat="server" ImageUrl="~/Library/IMG/Gestor_BtnPesquisa.png" OnClick="imgBtnPesqHistoUsuar_OnClick" />
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="CK">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:CheckBox ID="ckSlctHora" runat="server" OnCheckedChanged="ckSlctHora_OnCheckedChanged" AutoPostBack="true" style="margin-right:-5px; margin-left:-5px;" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                ...
                                <ul>
                                    <li class="liTituloGrid" style="width: 100%; height: 24px !important; margin-right: 0px;
                                        ...
                                        <div style="float: right; margin-top: 4px;">
                                            <ul>
                                                <li>
                                                    <asp:CheckBox runat="server" ID="chkDom" Text="Do" CssClass="chk" Enabled="false" ToolTip="Marque caso deseje ver as agendas incluindo os Domingos" />
                                                </li>
                                                <li>
                                                    <asp:CheckBox runat="server" ID="chkSeg" Text="Se" CssClass="chk" Enabled="false" ToolTip="Marque caso deseje ver as agendas incluindo as Segundas"
                                                        Checked="true" />
                                                </li>
                                                <li>
                                                    <asp:CheckBox runat="server" ID="chkTer" Text="Te" CssClass="chk" Enabled="false" ToolTip="Marque caso deseje ver as agendas incluindo as Terças"
                                                        Checked="true" />
                                                </li>
                                                <li>
                                                    <asp:CheckBox runat="server" ID="chkQua" Text="Qa" CssClass="chk" Enabled="false" ToolTip="Marque caso deseje ver as agendas incluindo as Quartas"
                                                        Checked="true" />
                                                </li>
                                                <li>
                                                    <asp:CheckBox runat="server" ID="chkQui" Text="Qi" CssClass="chk" Enabled="false" ToolTip="Marque caso deseje ver as agendas incluindo as Quintas"
                                                        Checked="true" />
                                                </li>
                                                <li>
                                                    <asp:CheckBox runat="server" ID="chkSex" Text="Sx" CssClass="chk" Enabled="false" ToolTip="Marque caso deseje ver as agendas incluindo as Sextas"
                                                        Checked="true" />
                                                </li>
                                                <li>
                                                    <asp:CheckBox runat="server" ID="chkSab" Text="Sb" CssClass="chk" Enabled="false" ToolTip="Marque caso deseje ver as agendas incluindo os Sábados" />
                                                </li>
                                                <li style="margin-left: 20px;">
                                                    Período de agendamento 
                                                    <asp:TextBox ID="txtDtIniResCons" runat="server" class="campoData" Enabled="true">
                                                    </asp:TextBox>
                                                    &nbsp até &nbsp
                                                    <asp:TextBox ID="txtDtFimResCons" runat="server" class="campoData" Enabled="true">
                                                    </asp:TextBox>
                                                </li>
                                                <li>
                                                    <asp:ImageButton ID="imgBtnPesqResCons" runat="server" ImageUrl="~/Library/IMG/Gestor_BtnPesquisa.png" OnClick="imgBtnPesqResCons_OnClick" />
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li style="margin-top: 1px">
                                        ...
                                        <div id="divAgenda" class="divGridData" style="height: 190px; width: 780px; border: 1px solid #ccc;">
                                            ...
                                            <asp:GridView ID="grdHorario" CssClass="grdBusca" runat="server" 
                                                AutoGenerateColumns="false" Style="width: 100%;" onrowdatabound="grdHorario_RowDataBound">
                                                <RowStyle CssClass="rowStyle" />
                                                <AlternatingRowStyle CssClass="alternatingRowStyle" />
                                                <EmptyDataRowStyle HorizontalAlign="Center" CssClass="emptyDataRowStyle" />
                                                <EmptyDataTemplate>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="PACIENTE">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblPaciente" Text="-" runat="server" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
