...
namespace C2BR.GestorEducacao.UI.GSAUD._8000_GestaoAtendimento._8100_CtrlAgendaMedica._8120_RegistroConsulMedMod2
{
    public partial class Cadastro : System.Web.UI.Page
    {
        ...
        /// <summary>
        /// Após desmarcar o checkbox na Agenda de Horários esse método irá limpar os campos das ddl's
        /// </summary>
        /// <param name="check"></param>
        /// <param name="sender"></param>
        protected void LimparCampos(bool check, object sender)
        {
            CheckBox uncheck = (CheckBox)sender;
            if (!check)
            {
                GridViewRow linha = (GridViewRow)uncheck.Parent.Parent;

                DropDownList ddlOper = (DropDownList)linha.Cells[5].FindControl("ddlOperAgend");
                DropDownList ddlPlan = (DropDownList)linha.Cells[6].FindControl("ddlPlanoAgend");
                DropDownList ddlProcAgenda = (DropDownList)linha.Cells[7].FindControl("ddlProcedAgend");
                DropDownList ddlClass = (((DropDownList)linha.Cells[3].FindControl("ddlTipoAgendam")));
                DropDownList ddlTipo = (((DropDownList)linha.Cells[4].FindControl("ddlTipo")));
                DropDownList textPreco = (DropDownList)linha.Cells[8].FindControl("txtValorAgend");

                ddlOper.SelectedIndex = 0;
                ddlPlan.SelectedIndex = 0;
                ddlClass.SelectedIndex = 0;
                ddlTipo.SelectedIndex = 0;
                ddlProcAgenda.SelectedIndex = 0;
                textPreco.Text = "";
            }
        }
        ...
        protected void ckSelectHr_OnCheckedChanged(object sender, EventArgs e)
        {
            CheckBox atual = (CheckBox)sender;
            bool selec = false;
            LimparCampos(atual.Checked, sender);
            foreach (GridViewRow l in grdHorario.Rows)
            {
                CheckBox chk = ((CheckBox)l.Cells[0].FindControl("ckSelectHr"));
        ...
        protected void lnkSalvar_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (string.IsNullOrEmpty(hidCoPac.Value))
                {
                    ...
                    tb07.FL_ALCOO = "X";
                    tb07.FL_ALERGIA = "X";
                    tb07.FL_AUTORI_SAIDA = "X";
                    tb07.FL_NEGAT_SPC = "X";
                    tb07.FL_SEM_RG = "X";
                    tb07.FL_NEGAT_CHEQUE = "X";
                    tb07.FL_NEGAT_SERASA = "X";
                    ...
                    tb07.NU_REGI_SUS_ALU = txtNuCarSaude.Text;
