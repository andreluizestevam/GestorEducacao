<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master" AutoEventWireup="true" CodeBehind="ExtPlanejamentoPaciente.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._8000_GestaoAtendimento._8200_CtrlClinicas._8210_RecepcaoDeAvaliacao._8219_Relatorios.ExtPlanejamentoPaciente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
 <ul class="ulDados">
        ...
        <li class="liboth">
            ...
            <asp:ListItem Value="NP">Numero do Procedimento</asp:ListItem>
             <asp:ListItem Value="DTF">Data Início</asp:ListItem>
              <asp:ListItem Value="DTI">Data Final</asp:ListItem>  
            </asp:DropDownList>
        </li>
        <li class="liboth">
