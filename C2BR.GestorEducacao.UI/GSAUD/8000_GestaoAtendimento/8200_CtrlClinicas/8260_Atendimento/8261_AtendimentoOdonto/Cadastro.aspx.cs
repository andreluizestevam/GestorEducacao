...
namespace C2BR.GestorEducacao.UI.GSAUD._8000_GestaoAtendimento._8200_CtrlClinicas._8260_Atendimento._8261_AtendimentoOdonto
{
    public partial class Cadastro : System.Web.UI.Page
    {
        ...
        private void Persistencias()
        {
            try
            {
                ...
                //tbs390.TB14_DEPTO = TB14_DEPTO.RetornaPelaChavePrimaria(int.Parse());
                ...
                foreach (GridViewRow i in grdProcedOrcam.Rows)
                {
                    ...
                    tbs396.CO_EMP_COL_CADAS = TB03_COLABOR.RetornaPeloCoCol(LoginAuxili.CO_COL).CO_EMP;
