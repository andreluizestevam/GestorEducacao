<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" validateRequest="false" 
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._8000_GestaoAtendimento._8200_CtrlClinicas._8260_Atendimento._8274_AtendimentoClinicoSimplificado.Cadastro" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">
       ...
       .btns-finalizar  input
        
       {
           background-color: rgba(251, 236, 135, 0.77) !important; 
       }
       .colunaBotoes  input
        {
            height: 17px;
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <div style="float: right; margin-right: 10px; margin-top: -18px; color: Green;">
        <asp:CheckBox ID="chkSalvarAutomat" Text="Salvar Atendimento Automaticamente" Visible="false" CssClass="chk"
            runat="server" />
              <asp:Button ID="btnSalvaAtend" CssClass="btnSalvarAtend" runat="server" Text="SALVAR ATENDIMENTO" OnClick="BtnSalvar_OnClick"
            Style="float: right; margin-right: 2px; margin-top: 2px;" ToolTip="Salvar o atendimento em andamento do Paciente" />
    </div>
    <ul class="ulDados">
      
        <li style="float: left; margin-left: 3px; width: 461px !important; border-right: 2px solid #EE9A00;
            padding-right: 10px; height: 446px;">
            <ul>
                <li>
                    <ul>
                        <li class="liTituloGrid" style="width: 450px !important; height: 20px !important;
                            ...
                            <ul>
                                <li style="display: flex;">
                                    <label style="font-family: Tahoma; font-weight: bold; margin-top: 3px; margin-right: 10px; color: #FFF">
                                      ...
                                      <div>
                                            ...
                                            <asp:RequiredFieldValidator runat="server" ID="rfvFimPeri" CssClass="validatorField"
                                                ErrorMessage="O campo data Final é requerido" ControlToValidate="FimPeriAG"></asp:RequiredFieldValidator>
                        ...
                        <li style="clear: both">
                            <div style="width: 448px; height: 180px; border: 1px solid #CCC; overflow-y: scroll"
                                id="divAgendasRecp">
                ...
                <li style="clear: both">
                    <ul style="float: left;">
                        <li class="liTituloGrid" style="width: 450px; height: 20px !important; margin-right: 0px;
                            ...
                            <ul>
                                <li  style="display: flex;">
                                    <label style="font-family: Tahoma; font-weight: bold; margin-top: 3px; margin-right: 10px;">
                                ...
                                <li style="clear: both; margin: -14px 0 0 0px;">
                                    <div id="divDemonAge" style="width: 448px; height: 200px; border: 1px solid #CCC;
                                        overflow-y: scroll">
        ...
        <li style="float: right; width: 550px !important;">
            <ul style="margin-left: -18px;">
                <li>
                    <ul>
                        <li>
                            ...
                            <asp:DropDownList AutoPostBack="true" ID="ddlLocal" runat="server" OnSelectedIndexChanged="ddlLocal_OnSelectedIndexChanged" Width="112px">
                            </asp:DropDownList>
                        </li>
                        <li style="margin-left: 20px; margin-right: -123px;">
                            <label>
                                Profissional Atendimento</label>
                            <asp:DropDownList ID="drpProfResp" AutoPostBack="true" OnSelectedIndexChanged="drpProfResp_OnSelectedIndexChanged" Width="185px" runat="server" />
                        </li>
                        ...
                        <li style="width: 508px; color: Blue; border-bottom: 2px solid #58ACFA; margin-bottom: 0px;
                            margin-top: -10px;">
                           <label style="font-family: Tahoma; font-weight: bold; margin-top: 3px; margin-bottom: 4px; color: Black;
                        ...
                        <li class="liTituloGrid" style="width: 508px !important; height: 20px !important;
                            ...
                            <div style="margin-right: 35px; float: left; margin-top: 4px; display: -webkit-inline-box;">
                                
                            <label style="margin-left:4px;">
                                Classificação Prontuário</label>&nbsp
                            <asp:DropDownList runat="server" ID="DropDownList1" Width="140px" ClientIDMode="Static">
                            </asp:DropDownList>
                       
                            </div>
                        <div style="margin-right: 37px; float: right; margin-top: 4px; display: -webkit-inline-box;">
                                
                            <label>
                                Classificação Risco</label>&nbsp
                            <asp:DropDownList runat="server"  ID="ddlClassRisco" Width="90px" ClientIDMode="Static">
                            </asp:DropDownList>
                             <asp:HiddenField runat="server" ID="hidDivAberta"  />
                            <div id="divClassRisc" title="Selecione a Classificação de risco pela cor" style="cursor: pointer;
                                margin: -15px 0 0 98px; width: 26px; height: 9px; border: 1px solid #CCCCCC;
                        ...
                        <li style="margin: 1px 0 0 5px; border: 1px solid #FFEC8B; border-top: 0;">
                            <ul>
                                ...
                                <li style="clear: both;">
                                    <label style="color: Orange; margin-left: 3px; font-size: 9px;">
                                        Digite as informações do atendimento relacionadas a Classificação de Prontuário escolhida</label>
                                    <asp:TextBox runat="server" ID="txtHDA" BackColor="#FAFAFA" TextMode="MultiLine"
                                        Rows="4" Style="width: 496px;height: 249px; margin-top: 1px; border-top: 1px solid #BDBDBD;
                                        border-left: 0; border-right: 0; border-bottom: 0;" Font-Size="12px"></asp:TextBox>
                                </li>
                            </ul>
                        </li>
              ...
              <li>  
               <div id="""" class="colunasDeBotoes">
                    <div class="colunaBotoes">
                     <span >PRONTUÁRIO</span>
                        <asp:Button ID="BtnProntuCon" runat="server" ToolTip="Emissão do Prontuário do Paciente no Modelo Convencional" Text="PADRÃO"  OnClick="BtnProntuCon_Click" />
                        <asp:Button ID="ButtonProntuMod" runat="server" ToolTip="Emissão do Prontuário do Paciente no Modelo Modular" Text="MODULAR"  OnClick="lnkbProntuario_OnClick" />
                          <span style="margin-bottom: 22px"></span>
                    </div>
                    <div class="colunaBotoes">
                       <span>PRESCRIÇÃO</span>
               
                        <asp:Button ID="lnkMedic" runat="server" Text="RECEITA"  OnClick="lnkMedic_OnClick" ToolTip="Prescrever medicamentos ao Paciente" />
                        <asp:Button ID="lnkExame" runat="server" Text="EXAMES" OnClick="lnkExame_OnClick" ToolTip="Prescrever exames ao Paciente"/>
                        <asp:Button ID="lnkAmbul" runat="server" Text="AMBULATÓRIO" OnClick="lnkAmbul_OnClick" ToolTip="Prescrever serviços ambulatoriais ao Paciente" />
                     
                    </div>
                    <div class="colunaBotoes">
                      <span>EMISSÃO</span>
                        <asp:Button ID="BtnGuia" runat="server"  Text="GUIA CONV" OnClick="BtnGuia_OnClick" ToolTip="Emitir a Guia TISS do Plano/Convênio do Paciente" />
                        <asp:Button ID="BtnFicha" runat="server" Text="FICHA ATEND."  OnClick="lnkFicha_OnClick" ToolTip="Emitir a Ficha de Atendimento do Paciente" />
                        <asp:Button ID="BtnAtestado" runat="server"  Text="ATESTADO"  OnClick="BtnAtestado_Click" ToolTip="Emitir Atestado Médico e/ou Comparecimento" />
                       
                    </div>
                    <div class="colunaBotoes">
                      <span>AÇÃO</span>
                          <asp:Button ID="lnkbAnexos"  runat="server" Text="ANEXO" OnClick="lnkbAnexos_OnClick"  ToolTip="Anexar arquivos (Exames; Laudos; Imagens; etc.) ao Prontuário do Paciente"/>
                            <asp:Button ID="BtnObserv" 
                            runat="server" Text="OBSERVAÇÔES" OnClick="BtnObserv_OnClick" ToolTip="Registrar observações sobre o atendimento ao Paciente" />
                                <asp:Button ID="ButtonEncam"  runat="server"  Text="ENCAMINHAM"
                            OnClick="BtnEncam_OnClick" ToolTip="Fazer o encaminhamento do Paciente a Profissional Especializado"/>
                            
                   
                    </div>
                    <div  class="colunaBotoes">
                      <span style="margin-bottom: 17px"></span>
                       <asp:Button ID="BtnInternar" runat="server" Text="INTERNAÇÃO" 
                          OnClick="BtnInternar_OnClick" ToolTip="Fazer a solicitação de Registro de Internação para o Paciente" />
                      
                    <asp:Button ID="BtnLaudo" runat="server" Text="LAUDO TÉC"  OnClick="BtnLaudo_Click" ToolTip="Elaborar Laudo Técnico para o Paciente" />
                        <asp:Button ID="ButtonCirurgia"  runat="server"  Text="CIRURGIA"
                            OnClick="BtnObserv_OnClick" ToolTip="Fazer a solicitação de Cirurgia do Pacinte com a emissão da GUIA" />
                                <span style="margin-bottom: 22px"></span>
                    </div>
                    <div class="colunaBotoes ">
                     <span>FINALIZAÇÃO</span>
                             <asp:Button ID="ButtonEspera" runat="server" Text="ESPERA" ToolTip="Manter o atendimento do Paciente em Espera"  Style="background-color: SkyBlue; font-weight: bold !important; height: 18px; width: 74px; color: #fff; margin-bottom: 4px; cursor: pointer; border: 1px solid #ccc;" />
                        <asp:Button ID="BtnFinalizar" 
                             runat="server" Text="ALTA" OnClick="BtnFinalizar_OnClick" ToolTip="Finalizar (Encerrar) o atendimento ao Paciente"  Style="background-color: Green; font-weight: bold !important; height: 18px; width: 74px; color: #fff; cursor: pointer; border: 1px solid #ccc; margin-bottom: 4px;" />
                         <asp:Button ID="BtnObito" runat="server" Text="ÓBITO" Font-Bold="true" OnClick="BtnObito_OnClick" ToolTip="Finalizar (Encerrar) o atendimento por óbito do Paciente"
                                                        Style="background-color: Black; font-weight: bold !important; height: 18px; width: 74px; color: #fff; cursor: pointer; border: 1px solid #ccc; margin-bottom: 4px;" />
                      <%--  <asp:Button ID="BtnSalvar"
                            runat="server" Text="SALVAR"  OnClick="BtnSalvar_OnClick" ToolTip="Salvar o atendimento do Paciente" />--%>
                    </div>
                </div>
              </li>
  ...
  <%--  Medicamnetos inicio --%>          
        ...
        <div style="display:flex">
          <div style="margin-top: 5px">
            ...
            <div style="margin-bottom: 9px; margin-top: 3px;">
                <a href="#" onclick="AbreModalSalvarModeloReceita();" runat="server" style="margin-left: 7px;" class="linkButton">
                    SALVAR MODELO</a>
            </div>
        </div>
    ...
    <div id="divSalvarModeloReceita" style="display: none; margin-left: 12px;overflow: hidden;z-index: 99999999;">
        ...
        <asp:RequiredFieldValidator runat="server" ValidationGroup="ModeloReceita" ControlToValidate="TextBoxNomeModelo" ></asp:RequiredFieldValidator>
        <asp:LinkButton ID="LinkButton1"  ValidationGroup="ModeloReceita"  CssClass="linkButton" runat="server" Style="margin-left: 96px;" Text="SALVAR" OnClick="ButtonSalvarModelo_Click"
    ...
    <div id="divSalvarModeloEncam" style="display: none; margin-left: 12px;overflow: hidden;z-index: 99999999;">
        ...
        <asp:TextBox runat="server" Style="width: 258px; height: 17px;" MaxLength="30" ID="TextBoxModeloEncam"></asp:TextBox><br />
         <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="ModeloEncam" ControlToValidate="TextBoxModeloEncam" ></asp:RequiredFieldValidator>
            ...
            <li>
                <ul style="width: 875px">
                    ...
                    <li id="li1" runat="server" title="Clique para cadastrar um novo Serviço Ambulatorial (Procedimento)"
                        ...
                        <img alt="" style="margin: -1px 0 1px 0;" title="Adicionar Formulário" src="../../../../../Library/IMG/Gestor_BtnEdit.png"
                            height="15px" width="15px" />
                        <asp:LinkButton ID="LinkButton2" runat="server" OnClick="imgNovoExam_OnClick" Enabled="false">Novo</asp:LinkButton>
                    </li>
    ...
    <div id="divAvisoPermissao" style="display: none; height: 70px !important;">
        <asp:HiddenField ID="hdfAvisoPermissao" runat="server" ClientIDMode="Static" />
        <ul>
            <li>
                <label>
    ...
    <div id="divProntuCon" style="display: none; height: 450px !important;overflow:hidden">
        ...
        <ul class="ulDados" style="width: 730px; margin-top: 0px !important">
            ...
            <li style="margin-top: 11px; margin-left: -4px;">
                <asp:ImageButton ID="imgbPesqPacienteProntuCon" style="width: 16px;" runat="server" ImageUrl="~/Library/IMG/Gestor_BtnPesquisa.png"
            ...
            <li style="clear: both;">
                <label title="HISTÓRICO DE ATENDIMENTO DO PACIENTE" style="color: Blue;">
            ...
            <li id="descricaoTextBox" runat="server" style="clear: both;">
                <asp:Label ID="labelCadObsProntuCon" title="Inserir descrição" style="color: Blue;" runat="server">INSIRA A DESCRIÇÃO LOGO ABAIXO</asp:Label>
            ...
            <li id="liConfirmarBotao" runat="server" class="liBtnAddA" style="clear: none !important; margin-left: 210px !important;
                margin-top: 8px !important; height: 15px;">
    ...
    <div id="divEncaminAtend" style="display: none; height: 100px !important; width: 370px; overflow:hidden">
        ...
        <ul>
            ...
            <li style="margin-bottom: 15px;">
                <asp:CheckBox style="margin-left:40px" Text="Visualizar o Histórico do Paciente" runat="server" ID="divEncaminAtendCheck"/> 
            </li>          
    ...
    <div id="dvIntarnar" class="" style="display: none; width: 870px;">
        <ul class="ulDados" style="margin-top: 4px !important;">
            ...
            <li style="clear: both">
                <ul>
                    <li>
                        <asp:Label runat="server" CssClass="colorTextBlue" ID="Label15">PROCEDIMENTOS SOLICITADOS</asp:Label>
                    </li>
                    <li style="clear: both;">
            ...
            <li style="clear: both">
                <ul>
                    <li>
                        <asp:Label runat="server" CssClass="color€TextBlue" ID="Label16">OPM (Órteses, Próteses e Materiais especiais) SOLICITADOS</asp:Label>
                    </li>
                    <li style="clear: both;">
    ...
    <div id="divAnexos" style="display: none; height: 360px !important;">
        ...
        <ul class="ulDados">
            ...
            <li style="clear: both">
                <asp:Label runat="server" ID="Label7" CssClass="txtNomePacienteInternar">OBSERVAÇÃO:</asp:Label><br />
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            MaintainScroll1();
            $('#editorReceituario').hide();
            if ($('#ctl00_content_RadioButtonLivre').is(':checked') && $('#divMedicamentos').is(':visible')) {
                $('#editorReceituario').show();
            }
            $('#editorExame').hide();
            if ($('#ctl00_content_RadioButtonLivreExames').is(':checked') && $('#divExames').is(':visible')) {
                $('#editorExame').show();
            }
            $('#editorProcedimento').hide();
            if ($('#ctl00_content_RadioButtonAmbLivre').is(':checked') && $('#divAmbulatorio').is(':visible')) {
                $('#editorProcedimento').show();
            }
            $('#editorEncam').hide();
            if ($('#divEncam').is(':visible')) {
                $('#editorEncam').show();
            }

            if ($("#hdfAvisoPermissao").val() == "N") {
                AbreModalAvisoPermissao();
            }
        }
        ...
        function AbreModalGuiaPlano() {
            $('#divGuiaPlano').dialog({
                autoopen: false, modal: true, width: 450, height: 230, resizable: false, title: "IMPRESSÃO DA GUIA DE ATENDIMENTO",
                open: function (type, data) { $(this).parent().appendTo("form"); },
                close: function (type, data) { ($(this).parent().replaceWith("")); }
            });
        }
        ...
        function AbreModalAvisoPermissao() {
            $('#divAvisoPermissao').dialog({
                autoopen: false, modal: true, width: 300, height: 70, resizable: false, title: "AVISO DE PERMISSÃO", dialogClass: 'divAvisoPermissao',
                //                open: function () { $('#divLoadInfosCadas').show(); }
                open: function (type, data) { $(this).parent().appendTo("form"); },
