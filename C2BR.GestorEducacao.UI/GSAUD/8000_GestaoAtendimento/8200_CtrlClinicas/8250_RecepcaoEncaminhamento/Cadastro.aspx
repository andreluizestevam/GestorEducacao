<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._8000_GestaoAtendimento._8200_CtrlClinicas._8250_RecepcaoEncaminhamento.Cadastro" %>
    ...
    <ul class="ulDados">
                        ...
                        <li style="float: right; margin-top: 1px;">
                            <ul>
                                ...
                                <li style="margin-left: 5em;">
                                    <asp:Button runat="server" ID="FinalizarAgend" Style="cursor: pointer; color: #000000;
                                        border: none; background-color: #add8e6; font-weight: 600" Text="FINALIZAR" ToolTip="Alterar a situação do agendamento para 'ATENDIDO'."
                                ...
                                <asp:TemplateField HeaderText="CA">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:ImageButton runat="server" ID="imgCancelar" ImageUrl="/Library/IMG/PGS_SF_AgendaEmAberto.png"
                                            ToolTip="Cancela agendamento de consulta" OnClick="imgCancelar_OnClick" Style="width: 17px !important;
                                            height: 17px !important; margin: 0 0 0 0 !important" />
                                    </ItemTemplate>
                                </asp:TemplateField>
        ...
        <li class="liTituloGrid" style="width: 98.5%; height: 19px !important; margin-right: 0px;
            ...
            <ul>
                <li style="margin: 0px 0 0 10px; float: left">
                    <label style="font-family: Tahoma; font-weight: bold; margin-top: 3px;">
                        AGENDA DE PACIENTES PARA CONSULTA/AVALIAÇÃO</label>
                </li>
        ...
        <li id="tabSelAgenda" runat="server" clientidmode="Static">
            ...
            <ul style="width: 100%;">
                    ...
                    <div style="width: 985px; height: 100px; border: 1px solid #CCC; margin-bottom: 2px;">
                        <asp:GridView ID="grdAgendaAvaliacoes" CssClass="grdBusca headFixo" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="TELEFONE_V" HeaderText="TEL">
                                ...
                                <asp:TemplateField HeaderText="Registro Inf.">
                                    <ItemStyle Width="8%" HorizontalAlign="Center" />
                                    <ItemTemplate>
                ...
                <li runat="server" id="LiRecCaixa" class="liBtnFinAten" style="height: 15px; margin-top: 5px;
                    background-color: #607d8b; margin-right: 10px; float: right;">
                ...
                <li runat="server" id="LiRecSimples" class="liBtnFinAten" style="height: 15px; margin-top: 5px;
                    background-color: #04B486; margin-right: 10px; float: right;">
                ...
                <li runat="server" id="LiRecContrato" class="liBtnFinAten" style="height: 15px; margin-top: 5px;
                    background-color: #04B486; margin-right: 10px; float: right;">
                ...
                <li runat="server" id="LiFichaAten" class="liBtnFinAten" style="height: 15px; margin-top: 5px;
                ...
                <li runat="server" id="LiGuia" class="liBtnFinAten" style="height: 15px; margin-top: 5px;
                ...
                <li runat="server" id="LiMovimentacao" class="liBtnFinAten" style="height: 15px;
                    margin-top: 5px; background-color: #5858FA; margin-right: 5px; float: right;">
                ...
                <!--
                <li runat="server" id="LiEncaixe" class="liBtnFinAten" style="height: 15px; margin-top: 5px;
                    background-color: DarkOrange; margin-right: 10px; float: right;">
                ...
                -->
                <li runat="server" id="LiAgenda" class="liBtnFinAten" style="height: 15px; margin-top: 5px;
                    background-color: DarkOrange; margin-right: 10px; float: right;">
            ...
            <div id="divEncaminharAtend" style="display: none; height: 100px;">
                <ul>
                    ...
                    <li class="liBtnConfirm" style="margin: 12px 0 0 55px; width: 116px; cursor: pointer;">
                        <asp:LinkButton ID="LinkButton3" OnClick="lnkNaoEncaminhar_OnClick" runat="server"
                            ToolTip="Não realiza o encaminhamento">
            ...
            <div id="divProximoPasso" style="display: none;">
                <ul>
                    ...
                    <li class="liBtnConfirm" style="margin: 12px 0 0 170px; width: 116px; cursor: pointer;">
                        <asp:LinkButton ID="lnkNaoEncaminhar" OnClick="lnkNaoEncaminhar_OnClick" runat="server"
                            ToolTip="Não realiza o encaminhamento">
                            <label style="margin-left:5px; color:White; cursor:pointer;">REGISTRAR PRESENÇA</label>
                        </asp:LinkButton>
                    </li>
            ...
            <div id="divGuiaPlano" style="display: none; height: 180px !important;">
                <ul class="ulDados" style="width: 420px; margin-top: 0px !important">
                    <li style="margin-left: 5px;">
                        ...
                        <asp:TextBox runat="server" ID="txtProntuarioGuia" CssClass="campoNire" Width="50px"
                            Style="margin-left: -7px" Enabled="false" ClientIDMode="Static" />
                    </li>
                    <li>
                        <label>
                            CPF</label>
                        <asp:CheckBox runat="server" ID="chkCpfGuia" Style="margin-left: -5px" ClientIDMode="Static" />
                        <asp:TextBox runat="server" ID="txtCpfGuia" CssClass="campoCpf" Width="75px" Style="margin-left: -7px"
                    ...
                    <li style="margin-left: 8px;">
                        ...
                        <asp:DropDownList ID="drpPacienteGuia" runat="server" ToolTip="Paciente para o qual a consulta será marcada"
                            Width="210px" Visible="false" OnSelectedIndexChanged="drpPacienteGuia_OnSelectedIndexChanged"
                            AutoPostBack="true">
                        </asp:DropDownList>
                        <asp:TextBox ID="txtPacienteGuia" Width="210px" ToolTip="Digite o nome ou parte do nome do paciente"
                    ...
                    <li>
                        ...
                        <asp:TextBox ID="txtDtGuia" runat="server" ValidationGroup="guia" class="campoData"
                            ToolTip="Informe a data de comparecimento" />
                        <asp:RequiredFieldValidator runat="server" ValidationGroup="guia" ID="rfvDtGuia"
                            Display="Dynamic" CssClass="validatorField" ErrorMessage="O campo data é requerido"
                            ControlToValidate="txtDtGuia"></asp:RequiredFieldValidator>
                    </li>
                    <li style="margin-left: 10px;">
                        <label>
                            Responsável Técnico GUIA</label>
            ...
            <div id="divFinalizarAgend" style="display: none; height: 438px !important;">
                <ul class="" style="width: auto; margin-top: 0px !important; float: left;">
                    ...
                    <li style="margin: -33px 0 0 203px;">
                        ...
                        <asp:ImageButton ID="imgPesProfSolicitado" ToolTip="Pesquisar nome do profissional"
                            runat="server" ImageUrl="~/Library/IMG/IC_PGS_Recepcao_Avaliador.png" OnClick="imgPesProfSolicitado_OnClick" />
                    ...
                    <li style="margin: -29px 0 0 407px;">
                        <label title="Nome do profissional que atendeu o paciente">
                            Paciente</label>
                        <asp:TextBox runat="server" ID="txtNomePaciente" Style="margin: 0; width: 177px;"
                        ...
                        <asp:ImageButton ID="imgPesqAgendMod" runat="server" Style="margin: -20px 0 0 20px;"
                            ImageUrl="~/Library/IMG/Gestor_BtnPesquisa.png" OnClick="imgPesqAgendMod_OnClick"
                            ToolTip="Preencher grid pelo período e/ou profissional e/ou paciente" />
                    </li>
                    ...
                    <li class="liBtnFinAten" style="float: right; margin: 14px 0 0 0; height: 15px; background-color: #0b3e6e;">
                        <asp:LinkButton ID="lnkFinalizarAgend" runat="server" OnClick="lnkFinalizarAgend_OnClick"
                            ToolTip="Finalizar atendlimento">
                            <asp:Label runat="server" ID="Label26" Text="FINALIZAR" Style="font-weight: bold;
                                margin-left: 5px; margin-right: 5px; color: White;"></asp:Label>
                        </asp:LinkButton>
                    </li>
                </ul>
            </div>
