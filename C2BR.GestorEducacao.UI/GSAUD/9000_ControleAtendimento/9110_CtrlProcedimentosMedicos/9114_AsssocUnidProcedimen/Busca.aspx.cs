    ...
    public partial class Busca : System.Web.UI.Page
    {
        ...
        void CurrentPadraoBuscas_OnAcaoBuscaDefineGridView()
        {
            ...
            var resultado = (from tb25 in TB25_EMPRESA.RetornaTodosRegistros()
                             ...
                             select new
                             {
                                 CO_CPFCGC_EMP = tb25.CO_CPFCGC_EMP, //String.IsNullOrEmpty(tb25.CO_CPFCGC_EMP) ? tb25.CO_CPFCGC_EMP.Length == 11 ? tb25.CO_CPFCGC_EMP.Insert(9, "-").Insert(6, ".").Insert(3, ".") : tb25.CO_CPFCGC_EMP.Insert(2, ".").Insert(6, ".").Insert(9, "/").Insert(15, "-") : "-",
                                 NO_FANTAS_EMP = tb25.NO_FANTAS_EMP.Substring(0, 30) + (tb25.NO_FANTAS_EMP.Length > 30 ? "..." : ""), //String.IsNullOrEmpty(tb25.NO_FANTAS_EMP) ? tb25.NO_FANTAS_EMP.Substring(0, 30) + (tb25.NO_FANTAS_EMP.Length > 30 ? "..." : "") : "-",
                                 DE_END_EMP = tb25.DE_END_EMP.Substring(0, 25) + (tb25.DE_END_EMP.Length > 25 ? "..." : ""), //String.IsNullOrEmpty(tb25.DE_END_EMP) ? tb25.DE_END_EMP.Substring(0, 25) + (tb25.DE_END_EMP.Length > 25 ? "..." : "") : "-",
                                 tb25.CO_EMP,
                                 tb25.CO_UF_EMP,
