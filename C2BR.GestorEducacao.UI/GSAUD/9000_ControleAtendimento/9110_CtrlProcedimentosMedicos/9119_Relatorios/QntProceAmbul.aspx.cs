...
{
    public partial class QntProceAmbul : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            RptQntProceAmbul rpt = new RptQntProceAmbul();
            var lRetorno = rpt.InitReport(nmFunc, parametros, infos, unid, idProc, dtInical, dtFinal);
        ...
        private void CarregaProcedimentos()
        {
            ...
            CarregarProcedimentos(ddlProcedimento, 0, "SA");
        }
