...
namespace C2BR.GestorEducacao.UI.GSAUD._9000_ControleAtendimento._9300_CtrlExames._9306_ControleValoresreferencia
{
    public partial class Busca : System.Web.UI.Page
    {
        ...
        {
            CurrentPadraoBuscas.GridBusca.DataKeyNames = new string[] { "ID_ITENS_REFER" };
            ...
            CurrentPadraoBuscas.GridBusca.Columns.Add(new BoundField
            {
                DataField = "NO_ITENS_REFER",
                HeaderText = "Vlr Referência"
            });

            CurrentPadraoBuscas.GridBusca.Columns.Add(new BoundField
            {
               DataField = "FL_SITUA_REFER",
               HeaderText = "Status"
            });
        }
        ...
        void CurrentPadraoBuscas_OnAcaoBuscaDefineGridView()
        {
            ...
            var res = (from tbs415 in TBS415_EXAME_ITENS_REFER.RetornaTodosRegistros()
                       where (!String.IsNullOrEmpty(txtReferencia.Text) ? tbs415.NO_ITENS_REFER.Contains(txtReferencia.Text) : true)
                       && (idOper != 0 ? tbs415.TBS414_EXAME_ITENS_AVALI.TBS413_EXAME_SUBGR.TBS412_EXAME_GRUPO.TBS356_PROC_MEDIC_PROCE.TB250_OPERA.ID_OPER == idOper : true)
                       && (idProc != 0 ? tbs415.TBS414_EXAME_ITENS_AVALI.TBS413_EXAME_SUBGR.TBS412_EXAME_GRUPO.TBS356_PROC_MEDIC_PROCE.ID_PROC_MEDI_PROCE == idProc : true)
                       && (idGrupo != 0 ? tbs415.TBS414_EXAME_ITENS_AVALI.TBS413_EXAME_SUBGR.TBS412_EXAME_GRUPO.ID_GRUPO == idGrupo : true)
                       && (idSubgrupo != 0 ? tbs415.TBS414_EXAME_ITENS_AVALI.TBS413_EXAME_SUBGR.ID_SUBGRUPO == idSubgrupo : true)
                       select new
                       {
                           tbs415.ID_ITENS_REFER,
                           tbs415.NO_ITENS_REFER,
                           tbs415.TBS414_EXAME_ITENS_AVALI.NO_ITEM_AVALI,
                           tbs415.TBS414_EXAME_ITENS_AVALI.TBS413_EXAME_SUBGR.NO_SUBGR_EXAME,
                           tbs415.TBS414_EXAME_ITENS_AVALI.TBS413_EXAME_SUBGR.TBS412_EXAME_GRUPO.NO_GRUPO_EXAME,
                           tbs415.TBS414_EXAME_ITENS_AVALI.TBS413_EXAME_SUBGR.TBS412_EXAME_GRUPO.TBS356_PROC_MEDIC_PROCE.TB250_OPERA.NM_SIGLA_OPER,
                           tbs415.TBS414_EXAME_ITENS_AVALI.TBS413_EXAME_SUBGR.TBS412_EXAME_GRUPO.TBS356_PROC_MEDIC_PROCE.NM_PROC_MEDI,
                           FL_SITUA_REFER   = tbs415.FL_SITUA_REFER == "A" ? "Ativo" : "Inativo",
                           tbs415.NU_ORDEM
                       }).OrderBy(x => x.NO_GRUPO_EXAME).ThenBy(x => x.NO_SUBGR_EXAME).ThenBy(x => x.NO_ITEM_AVALI).ThenBy(x => x.NU_ORDEM).ThenBy(y => y.NO_ITENS_REFER);
        ...
        void CurrentPadraoBuscas_OnDefineQueryStringIds()
        {
            ...
            queryStringKeys.Add(new KeyValuePair<string, string>("item", "ID_ITENS_REFER"));
        ...
        private void CarregaItensAvaliacao()
        {
            ...
            ddlItemAvaliacao.DataSource = (from tbs414 in TBS414_EXAME_ITENS_AVALI.RetornaTodosRegistros()
                                           where (idOper != 0 ? tbs414.TBS413_EXAME_SUBGR.TBS412_EXAME_GRUPO.TBS356_PROC_MEDIC_PROCE.TB250_OPERA.ID_OPER == idOper : true)
            ...
            ddlItemAvaliacao.DataTextField = "NO_ITEM_AVALI";
            ddlItemAvaliacao.DataValueField = "ID_ITENS_AVALI";
            ddlItemAvaliacao.DataBind();

            ddlItemAvaliacao.Items.Insert(0, new ListItem("Todos", "0"));
        }
