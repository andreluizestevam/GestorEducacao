<%@ Page Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master" AutoEventWireup="true" CodeBehind="ExtratFreqColaborador.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GEDUC.F7000_ControleOperRH.F7100_CtrlPontoFuncional.F7199_Relatorios.ExtratFreqColaborador" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        .ulDados { width: 300px; }
        .liPeriodo, .liFuncionarios, .liUnidade, .liTipoCol{margin-top: 5px;width: 300px;}        
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ul id="ulDados" class="ulDados">     
        ...
        <li class="liFuncionarios">
            ...
            ErrorMessage="Campo Colaborador é requerido" SetFocusOnError="true"></asp:RequiredFieldValidator>
        </li>
        </ContentTemplate>
        </asp:UpdatePanel>
        <li class="liPeriodo">
