...
{
    public partial class ExtratoPlantaoColabor : System.Web.UI.Page
    {
        ...
        void PadraoRelatoriosCorrente_OnAcaoGeraRelatorio()
        {
            ...
            int lRetorno, coUnidFunc, coUnidPlant, coEspecPlant, coCol, coDepto;
            string noUnidadeFuncional, noUnidadePlantao, noEspecialidade, noColaborador ;
            bool comValor;
            ...
            comValor = (chkComValor.Checked ? true : false);
            ...
            parametros = "( Unid Func: " + noUnidadeFuncional.ToUpper() + " - Unid Plantão: " + noUnidadePlantao.ToUpper() + " - Especialidade: "
                + noEspecialidade.ToUpper() + " - Colaborador: " + noColaborador + " - Período: " + dtini.ToString("dd/MM/yy") + " à " + dtfim.ToString("dd/MM/yy") + " )";
            ...
            RptExtratoPlantaoColabor rpt = new RptExtratoPlantaoColabor();
            lRetorno = rpt.InitReport(parametros, infos, LoginAuxili.CO_EMP, coUnidFunc, coUnidPlant, coEspecPlant, coCol, situacao, txtIniPeri.Text, txtFimPeri.Text, comValor, coDepto);
            Session["Report"] = rpt;
