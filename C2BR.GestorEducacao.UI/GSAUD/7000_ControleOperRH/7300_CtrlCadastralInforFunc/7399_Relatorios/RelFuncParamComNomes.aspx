<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master"
    AutoEventWireup="true" CodeBehind="RelFuncParamComNomes.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._7000_ControleOperRH._7300_CtrlCadastralInforFunc._7399_Relatorios.RelFuncParamComNomes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <ul id="ulDados" class="ulDados">
        ...
        <li class="sobe" style="width: 130px;">
            <asp:Label ID="lblGrpEspec" runat="server">Grupo da Especialização</asp:Label>
        ...
        <li class="sobeEsp" style="width: 170px;">
            <asp:Label ID="lblEspec" runat="server">Especialização</asp:Label>
        ...
        <li style="width: 120px;">
            <asp:CheckBox runat="server" ID="chkAtInter" /><asp:Label ID="lblAti" runat="server">Atividade Interna</asp:Label>
        </li>
        <li style="width: 120px;">
            <asp:CheckBox runat="server" ID="chkAtiExt" /><asp:Label ID="lblate" runat="server">Atividade Externa</asp:Label>
        </li>
        <li style="width: 120px;">
            <asp:CheckBox runat="server" ID="chkAtiDomic" /><asp:Label ID="lblatd" runat="server">Atividade Domiciliar</asp:Label>
        </li>
        <li style="width: 120px;">
            <asp:CheckBox runat="server" ID="chkPlant" /><asp:Label ID="LabelchkPlant" runat="server"></asp:Label>
        </li>
        ...
        <li>
            ...
            <asp:DropDownList runat="server" Width="100px" ID="ddlTipoPesq">
                <asp:ListItem Text="Por Unidade" Value="U" Selected="True"></asp:ListItem>
        ...
        <li style="margin: 13px 0 0 10px;">
            <asp:CheckBox runat="server" ID="chkEmiteGraf" /><asp:Label ID="Label6" runat="server">Emite Gráficos</asp:Label>
        </li>
    </ul>
</asp:Content>
