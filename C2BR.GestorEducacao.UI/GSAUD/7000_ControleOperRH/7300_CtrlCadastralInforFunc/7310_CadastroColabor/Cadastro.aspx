<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._7000_ControleOperRH._7300_CtrlCadastralInforFunc._7310_CadastroColabor.Cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <ul id="ulDados" class="ulDados">
                    ...
                    <ul>
                        ...
                        <li class="liEspaco">
                            ...
                            <asp:DropDownList ID="ddlCategFuncColab" ToolTip="Selecione a Categoria Funcional do Funcionário"
                                CssClass="ddlCategFuncColab" runat="server" Width="110px">
                        ...
                        <li class="liNIS">
                            <label for="txtNISColab" title="Nº NIS">
                                CNS</label>
                            <asp:TextBox ID="txtNISColab" ToolTip="Informe o CNS do Funcionário" CssClass="txtNISColab"
                                runat="server" MaxLength="15" Width="90px"></asp:TextBox>
                        </li>
                        <li>
                            <label for="ddlUnidadeFuncionalColab" title="Unidade Cadastro">
                                Unidade Cadastro</label>
                            <asp:DropDownList ID="ddlUnidadeFuncionalColab" Enabled="false" ToolTip="Selecione a Unidade Cadastro"
        ...
        <li class="liBloco2">
            <ul>
                <li style="margin-right: 0px; margin-top: -17px">
                    <ul>
                ...
                <li style="border-left: 1px solid #BEBEBE; padding-left: 5px; margin-top: -17px">
                    <ul>
                        <li class="liTitInfCont">
                            <label class="lblTitInf">
                ...
                <li class="liClear">
                    <ul>
                        <li>
                            <label>
                                Sigla</label>
                            <asp:DropDownList runat="server" ID="ddlSiglaEntidProfi" CssClass="ddlSiglaEntd"
                                ToolTip="Sigla da Entidade Profissional do(a) Colaborador(a)">
                                <asp:ListItem Value="" Text="" Selected="True"></asp:ListItem>
                                <asp:ListItem Value="CRM" Text="CRM"></asp:ListItem>
                                <asp:ListItem Value="CRO" Text="CRO"></asp:ListItem>
                                <asp:ListItem Value="CRF" Text="CRF"></asp:ListItem>
                                <asp:ListItem Value="CRP" Text="CRP"></asp:ListItem>
                                <asp:ListItem Value="CRQ" Text="CRQ"></asp:ListItem>
                                <asp:ListItem Value="CRC" Text="CRC"></asp:ListItem>
                                <asp:ListItem Value="COREN" Text="COREN"></asp:ListItem>
                                <asp:ListItem Value="CREFITO" Text="CREFITO"></asp:ListItem>
                        ...
                        <li>
                            <label>
                                Nº</label>
                            <asp:TextBox runat="server" ID="txtNrEntidProfi" CssClass="txtNrEntidProfi" ToolTip="Número da Entidade Profissional do(a) Colaborador(a)"></asp:TextBox>
                        </li>
                        <li>
                            <label>
                                UF</label>
                            <asp:DropDownList runat="server" ID="ddlUfEntidProfi" CssClass="ddlUF" ToolTip="UF de emissão da Entidade Profissional do(a) Colaborador(a)">
                            </asp:DropDownList>
                        </li>
                        <li>
                            <label>
                                Data</label>
                            <asp:TextBox runat="server" ID="txtDtEmissEntidProfi" CssClass="campoData" ToolTip="Data de Emissão da Entidade Profissional do(a) Colaborador(a)"></asp:TextBox>
                        </li>
                    </ul>
                </li>
                <li style="clear: both; margin-top: 0px;">
        ...
        <li style="border-left: 1px solid #BEBEBE; padding-left: 10px; margin-top: -50px;">
            <ul>
                <li class="liTitInfCont">
                    <label class="lblTitInf">
                ...
                <li class="liClear">
                    <label for="ddlUnidadeFuncionalColab" title="Unidade de Lotação/Contrato">
                        Unidade de Lotação/Contrato</label>
                    <asp:DropDownList ID="ddlUnidadeContrato" ToolTip="Selecione a Unidade Lotação/Contrato"
                        CssClass="ddlUnidadeFuncionalColab" runat="server">
                    </asp:DropDownList>
                </li>
                <li class="liClear">
                    <label for="ddlGrupoEspecialidadeColab" title="Departamento">
                        Grupo</label>
                    <asp:DropDownList ID="ddlGrupoEspecialidadeColab" OnSelectedIndexChanged="ddlGrupoEspecialidadeColab_SelectedIndexChange"
                        AutoPostBack="true" ToolTip="Selecione o Grupo da Especialidade" CssClass="ddlDepartamentoColab"
                        runat="server">
                    </asp:DropDownList>
                </li>
                <li>
                    ...
                    <asp:RequiredFieldValidator runat="server" ID="rfvddlEspecialidadeColab" ControlToValidate="ddlEspecialidadeColab"></asp:RequiredFieldValidator>
                </li>
                <li class="liClear">
                ...
                <li>
                    ...
                    <asp:DropDownList ID="ddlDepartamentoColab" ToolTip="Selecione o Departamento/Local de trabalho do Funcionário"
                        CssClass="ddlDepartamentoColab" runat="server">
                    </asp:DropDownList>
                </li>
                <li class="liClear" style="margin-top: 5px !important; margin-left: -5px !important;">
                    <asp:CheckBox CssClass="chkLocais" ID="chkPerPlantao" runat="server" TextAlign="Right"
                        Text="Permite Plantão" OnCheckedChanged="chkPerPlantao_OnCheckedChanged" AutoPostBack="true" />
                </li>
                <li style="margin-top: 5px !important; margin-left: 10px !important;">
                    <asp:CheckBox CssClass="chkLocais" ID="chkPerPlantaoMultiUnid" runat="server" TextAlign="Right"
                        Text="Permite Plantão Multi-Unidade" />
                </li>
                <li class="liClear" style="margin-top: 5px; margin-right: 0px;">
                    <div id="divVlPla" runat="server" visible="false">
                        <label id="lblvlpla">
                            R$ Plantão</label>
                        <asp:TextBox runat="server" ID="txtVlPlantao" ToolTip="O valor do plantão do colaborador em Horas"
                            CssClass="txtSalario" Width="47px"></asp:TextBox>
                    </div>
                </li>
                <li style="margin-top: 5px; margin-left: 7px;">
                    <label>
                        Hrs Plantão</label>
                    <asp:TextBox ID="txtQtdHrMaxPlantao" CssClass="txtQtdHrMaxPlantao" runat="server"
                        Width="47" MaxLength="2" ToolTip="Quantidade máxima de horas de plantão permitida">
                    </asp:TextBox>
                </li>
                <li style="margin-top: 5px">
                    <label>
                        Hrs Desc Plantões</label>
                    <asp:TextBox ID="txtQtdHrDescanPlantao" CssClass="txtQtdHrDescanPlantao" runat="server"
                        Width="40" MaxLength="2" ToolTip="Quantidade mínima de horas de descanço entre plantões">
                    </asp:TextBox>
                </li>
                <li style="margin-top: 35px; margin-left: -147px;">
                    <label>
                        IP DE REGISTRO DE PONTO
                    </label>
                    <asp:TextBox ID="txtBatimentoPontoIP" CssClass="txtBatimentoPontoIP" runat="server"
                        Width="87" ToolTip="Onde há permissão para o batimento de ponto" MaxLength="15">
                    </asp:TextBox>
                </li>
            </ul>
        </li>
        <li style="margin-top: 23px; margin-left: 6px;">
            <ul>
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        ...
                        <li>
                            <label for="txtFuncaoCol" class="lblObrigatorio" title="Informe a funçao do colaborador">
                                Cargo/Função</label>
                            <asp:TextBox ID="txtFuncaoCol" CssClass="txtFuncaoCol" runat="server" MaxLength="200"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtFuncaoCol"
                                ErrorMessage="Função deve ser informada" Text="*" Display="None"></asp:RequiredFieldValidator>
                        </li>
                    </ContentTemplate>
                </asp:UpdatePanel>
                <li class="liClear">
        ...
        <li class="liTitInfCont" style="margin: 5px 0 0 6px;">
            <label>
                Classificação Profissional Saúde</label>
            <asp:DropDownList runat="server" ID="ddlClassFuncional" ToolTip="Selecione a Classificação Funcional"
                Style="width: 130px;" />
        </li>
        <li class="liTitInfCont" style="margin: 3px 0 0 15px;">
            <asp:CheckBox ID="chkTHD" Text="Técnico(a)" CssClass="chkLocais" runat="server" ToolTip="Marque caso o colaborador seja Técnico" />
        </li>
        <li style="margin-top: 3px;">
            <asp:CheckBox ID="chkAvaliador" Text="Avaliador(a)" CssClass="chkLocais" runat="server"
                ToolTip="Marque caso o colaborador seja Avaliador" />
        </li>
        <li style="margin: 3px 0 0 15px;">
            <asp:CheckBox ID="chkRespExames" Text="Resp Exames" CssClass="chkLocais" runat="server"
                ToolTip="Marque caso o colaborador seja Responsável por Exames" />
        </li>
    </ul>
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //$(".txtTelResidencialColab").mask("(99)9?9999-9999");
            //$('.txtTelCelularColab').mask("(99)9?9999-9999");

//            $('.txtTelResidencialColab').change(function () {
//                if ($('.txtTelResidencialColab').val().length >= 11) {
//                    $('.txtTelResidencialColab').mask("(99)9?9999-9999");
//                } else {
//                    $('.txtTelResidencialColab').mask("(99)9?999-9999");
//                }
//            });

            $('.txtTelResidencialColab').focusout(function () {
                var phone, element;
                element = $(this);
                element.unmask();
            ...
            $(".txtQtdHrMaxPlantao").mask("?999");
            $(".txtQtdHrDescanPlantao").mask("?99");

            $(".txtSalarioBaseColab").maskMoney({ symbol: "", decimal: ",", thousands: "." });
            $(".txtSalario").maskMoney({ symbol: "", decimal: ",", thousands: "." });

            //Trata a apresentação do campo de valor de plantão conforme o usuário clica/desclica no checkbox permite plantão
            //        $("#chkPerPlantao").click(function (evento) {
            //            if ($("#chkPerPlantao").attr("checked")) {
            //                lblvlpla
            //                $("#txtVlPlantao").toggle();
            //                $("#lblvlpla").toggle();
            //            }
