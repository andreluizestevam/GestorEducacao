<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._7000_ControleOperRH._7950_CtrlCadastralParceiros._7952_OcorrenciasParceiros.Cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <ul id="ulDados" class="ulDados">
        <li>
            <label title="Parceiro" class="lblObrigatorio">Parceiro</label>
            <asp:DropDownList ID="drpParceiro" Visible="false" runat="server" Width="230px" />
            <asp:TextBox ID="txtNomePacPesq" Width="230px" ValidationGroup="pesqPar" style="margin-bottom:0px;" ToolTip="Digite o nome ou parte do nome do parceiro" runat="server" />
            <asp:RequiredFieldValidator runat="server" ID="rfvParceiro" CssClass="validatorField"
                ErrorMessage="O campo parceiro é requerido" ControlToValidate="drpParceiro"></asp:RequiredFieldValidator>
        </li>
