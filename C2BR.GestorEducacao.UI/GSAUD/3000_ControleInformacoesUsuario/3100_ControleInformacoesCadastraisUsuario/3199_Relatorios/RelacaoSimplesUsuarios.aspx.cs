...
// ------------+----------------------------+-------------------------------------
// 10/03/2012  |  Julio Gleisson Rodrigues  | Copia da Tela \GEDUC\3000_CtrlOperacionalPedagogico\3700_CtrlInformacoesResponsaveis\3799_Relatorios
...
{
    public partial class FichaCadasResponUsuario : System.Web.UI.Page
    {
        ...
        private void CarregaAnos()
        {
            ...
            if (coEmp != 0)
            {
                ddlAnoRefer.DataSource = (from tb07 in TB07_ALUNO.RetornaTodosRegistros()
                                          select new
                                          {
                                              tb07.CO_ANO_ORI
                                          }).Distinct().OrderByDescending(g => g.CO_ANO_ORI);

                ddlAnoRefer.DataTextField = "CO_ANO_ORI";
                ddlAnoRefer.DataValueField = "CO_ANO_ORI";
