...
namespace C2BR.GestorEducacao.UI.GSAUD._3000_ControleInformacoesUsuario._3100_ControleInformacoesCadastraisUsuario._3105_CtrlInformacoesResponsaveis
{
    public partial class Cadastro : System.Web.UI.Page
    {
        ...
        void CurrentPadraoCadastros_OnAcaoBarraCadastro()
        {
            ...
            TB108_RESPONSAVEL tb108 = RetornaEntidadeTb108();
            TBG151_HISTO_SALAR_RESPO tbg151 = RetornaEntidadeTbg151(tb108);
            ...
            tb108.NO_CONJUG_RESP = txtNomeConjugeResp.Text != "" ? txtNomeConjugeResp.Text : null;
            ...
            tb108.FL_CEL_WHATS = chkWA.Checked ? "S" : "N";
            ...
            tb108.FL_MAE_FALEC = chkObtP.Checked ? "S" : "N";
            tb108.FL_PAI_FALEC = chkObtM.Checked ? "S" : "N";
            ...
            tb108.NO_FUNCAO_RESP = ddlFuncaoResp.SelectedValue.ToString();
            ...
            tb108.FL_TEL_FUNC_WHATS = chkWAFunc.Checked ? "S" : "N";
            ...
            tb108.FL_RESTR_PLANO_SAUDE = (chkRestrPlano.Checked ? "S" : "N");
            tb108.DT_VENC_PLAN = txtDtVencimento.Text.Trim() != "" ? (DateTime?)DateTime.Parse(txtDtVencimento.Text) : null;
            ...
            tbg151.CO_SITUA = ddlSituacaoResp.SelectedValue.ToString();
            ...
            tbg151.TB108_RESPONSAVEL = tb108;
        }
        #endregion
        #region Métodos
        ...
        private void CarregaFormulario()
        {
            ...
            if (tb108 != null)
            {
                ...
                txtDtVencimento.Text = tb108.DT_VENC_PLAN != null ? tb108.DT_VENC_PLAN.Value.ToString("dd/MM/yyyy") : "";
                chkRestrPlano.Checked = tb108.FL_RESTR_PLANO_SAUDE == "S" ? true : false;
                ...
                chkWA.Checked = tb108.FL_CEL_WHATS == "S";
                ...
                CarregaFuncoes(ddlFuncaoResp, tb108.NO_FUNCAO_RESP);
                ...
                chkWAFunc.Checked = tb108.FL_TEL_FUNC_WHATS == "S";
                ...
                txtNomeConjugeResp.Text = tb108.NO_CONJUG_RESP;
                ...
                chkObtP.Checked = tb108.FL_MAE_FALEC == "S";
                chkObtM.Checked = tb108.FL_PAI_FALEC == "S";
                ...
                txtSalarioBruto.Text = tbg151.VL_PRINC_REND.ToString().PadLeft(6, '0')+",00";
                txtDescSalario.Text = tbg151.VL_PRINC_DESC.ToString().PadLeft(6, '0') + ",00";
                txtSalarioLiqui.Text = tbg151.VL_PRINC_LIQU.ToString().PadLeft(6, '0') + ",00";
        ...
        private TB108_RESPONSAVEL RetornaEntidadeTb108()
        {
