<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master" AutoEventWireup="true" CodeBehind="FichaAtendimento.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._3000_ControleInformacoesUsuario._3200_ControleAtendimentoUsuario._3299_Relatorios.FichaAtendimento" %>
   ...
   <asp:HiddenField runat="server" ID="hidIdAtend" />
    <ul class="ulDados">
        <li style="margin-left:-100px;">
            <label title="Unidade onde foi realizado o Atendimento">Unidade</label>
            <asp:DropDownList runat="server" ID="ddlUnidade" ToolTip="Unidade onde foi realizado o Atendimento" Width="230px"></asp:DropDownList>
        </li>
        <li>
            <label title="Pesquise o(a) paciente pelo nome">
                Paciente</label>
            <asp:TextBox runat="server" ID="txtNomePacie" Width="240px" ToolTip="Pesquise o(a) paciente pelo nome"></asp:TextBox>
        </li>
        <li>
        ...
        <li style="vertical-align:middle !important;">
            <div style="width: 980px; text-align: center; height: 17px; background-color: #B0E0E6;
                ...
                <div style="float: none;">
                    <label ID="Label2" runat="server" style="font-size: 1.1em; font-family: Tahoma;
                        vertical-align: middle; margin-left: 4px !important; margin-top:1px !important;">
                                    GRADE DE ATENDIMENTOS</label>
                </div>
            </div>
        </li>
                ...
                <asp:GridView ID="grdAtendimentos" CssClass="grdBusca" runat="server" Style="width: 100%;
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="CK">
                            ...
                            <ItemTemplate>
                                <asp:HiddenField ID="hidIdAtendimento" Value='<%# Eval("ID_ATEND_MEDIC") %>' runat="server" />
                        ...
                        <asp:BoundField DataField="CO_ATEND_V" HeaderText="COD">
