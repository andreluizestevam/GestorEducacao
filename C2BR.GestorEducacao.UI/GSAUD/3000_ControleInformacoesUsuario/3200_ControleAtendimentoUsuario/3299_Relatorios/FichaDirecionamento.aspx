<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoRelatorios.Master" AutoEventWireup="true" CodeBehind="FichaDirecionamento.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._3000_ControleInformacoesUsuario._3200_ControleAtendimentoUsuario._3299_Relatorios.FichaDirecionamento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <ul class="ulDados">
        <li style="margin-left:-100px;">
            <label title="Unidade onde foi realizado o direcionamento">Unidade</label>
            <asp:DropDownList runat="server" ID="ddlUnidade" ToolTip="Unidade onde foi realizado o direcionamento" Width="230px"></asp:DropDownList>
        </li>
        <li>
                ...
                <div style="float: none;">
                    <label ID="Label2" runat="server" style="font-size: 1.1em; font-family: Tahoma;
                        vertical-align: middle; margin-left: 4px !important; margin-top:1px !important;">
                                    GRADE DE DIRECIONAMENTOS/RECEPÇÕES</label>
                </div>
            </div>
        </li>
        <li style="margin: 0px 0 0 -238px !important">
            <div id="div3" runat="server" class="divGridData" style="height: 340px; width: 980px;
                ...
                <asp:GridView ID="grdAtendimentos" CssClass="grdBusca" runat="server" Style="width: 100%;
                    ...
                    <EmptyDataTemplate>
                        Nenhum Direcionamento encontrado.<br />
                    </EmptyDataTemplate>
                    <Columns>
                        ...
                        <asp:BoundField DataField="CO_ENCAM_V" HeaderText="COD">
