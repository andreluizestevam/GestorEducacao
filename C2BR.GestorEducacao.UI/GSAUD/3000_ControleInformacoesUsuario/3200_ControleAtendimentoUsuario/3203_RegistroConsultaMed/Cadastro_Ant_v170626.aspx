...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <ul id="ulDados" class="ulDados">
                        ...
                        <ul>
                            ...
                            <li style="margin-left: 8px">
                                ...
                                <asp:DropDownList ID="ddlNomeUsu" runat="server" ToolTip="Paciente para o qual a consulta será agendada"
                                  OnSelectedIndexChanged="ddlPac_SelectedIndexChanged" AutoPostBack="true"  Width="280px" Visible="false">
                                </asp:DropDownList>
                            </li>
                        ...
                        <ul>
                            <li style="width: 450px;">
                                ...
                                <ul>
                                    ...
                                    <asp:HiddenField runat="server" ID="IDProf" /><asp:HiddenField runat="server" ID="HiddenField1" />
                                    <li style="margin-top: 5px">
                                ...
                                <ul>
                                    ...
                                    <li style="">
                                        ...
                                        <asp:DropDownList ID="ddlPacAgenda" runat="server" ToolTip="Paciente para o qual a consulta será agendada"
                                            Width="280px" Visible="false" OnSelectedIndexChanged="ddlPacAgenda_SelectedIndexChanged" AutoPostBack="true">
                                        </asp:DropDownList>
                                    </li>
                                    <li style="margin-top: 14px; margin-left: -4px;">
                                        ...
                                        <asp:ImageButton ID="imgVoltaPesqPacAgenda" ImageUrl="~/Library/IMG/PGS_Desfazeer.ico" OnClick="imgVoltaPesqPacAgenda_OnClick"
                                            Visible="false" runat="server" />
                                    </li>
                                    <li style="margin-top: 1px">
                                        <div id="div3" runat="server" class="divGridData" style="height: 234px; width: 525px;
                                    ...
                                    <li style="clear: both; width: 532px">
                                        ...
                                        <ul style="float: left;">
                                            ...
                                            <li>
                                                <label>
                                                    Número</label>
                                                <asp:TextBox runat="server" ID="txtNumeroCartPla" Width="71px" MaxLength="12"></asp:TextBox>
                                            </li>
                                            <li>
                                                <label>
        ...
        <li>
                            ...
                            <li>
                                <ul style="margin-left: 0px" class="ulEndResiResp">
                                    ...
                                    <li>
                                        <label class="lblObrigatorio">
                                            UF</label>
                                        <asp:DropDownList runat="server" ID="ddlUF" Width="40px" OnSelectedIndexChanged="ddlUF_OnSelectedIndexChanged" AutoPostBack="true">
                                        </asp:DropDownList>
                                    </li>
                                    <li>
                                        <label class="lblObrigatorio">
                ...
                <li style="margin: 0px 0 0 75px;" >
                    <ul>
                        ...
                        <li style="margin-top: -37px; margin-left:330px;">
                          ...
                          <label title="Data de Vencimento do Plano">
                                N° Pasta.</label>
                            <asp:TextBox runat="server" ID="TextBoxNumeroPasta" CssClass="" Width="70px"   MaxLength="30" ToolTip="Número da pasta"></asp:TextBox>
                        </li>
                    </ul>
                </li>
         ...
         <li>
            <div id="divHoraAgenda" style="display: none; height: 400px !important;">
                <div style="margin: 0 0 -1px 0px">
                    <label class="lblTop">
                        DESEJA ALTERAR A HORA PARA O NOVO REGISTRO?</label>
...
atendimento"></asp:TextBox>
                    </div>
                    <asp:LinkButton ID="LinkButton1" ValidationGroup="ModeloReceita" CssClass="linkButton"
                        runat="server" Style="margin-left: 96px;" Text="CONTINUAR" OnClick="ButtonSalvarHoraio_Click"
                        ToolTip="CONTINUAR" />
                </div>
            </div>
        </li>
    ...
    <script type="text/javascript">
        ...
        function AbreModalHoraAgenda() {
            $('#divHoraAgenda').dialog({ autoopen: false, modal: true, width: 250, height: 100, resizable: false, title:
