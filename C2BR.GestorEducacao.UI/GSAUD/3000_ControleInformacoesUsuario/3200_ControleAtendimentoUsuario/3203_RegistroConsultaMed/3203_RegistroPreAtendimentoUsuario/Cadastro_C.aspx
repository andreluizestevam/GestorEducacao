<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro_C.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._3000_ControleInformacoesUsuario._3200_ControleAtendimentoUsuario._3203_RegistroPreAtendimentoUsuario.Cadastro_C" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <ContentTemplate>
                <div class="divPaciPreAtend">
                    <asp:GridView ID="grdEncamMedic" Visible="false" CssClass="grdBusca" runat="server" Style="width: 100%;
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="RESPONSÁVEL">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Image ID="imgPendFinanc" ImageUrl="/Library/IMG/PGS_CONTRT_PARTICULAR.png" Visible='<%# Eval("flPendFinanc") %>' Width="16px" Height="16px" style="margin-left:-5px;" ToolTip="O paciente possui pendencia finaceira" runat="server" />
                                    <asp:Image ID="imgFaltasConsec" ImageUrl="/Library/IMG/Gestor_ServicosAgendaAtividades.png" Visible='<%# Eval("FaltasConsec") %>' Width="16px" Height="16px" style="margin-left:-3px;" ToolTip="O paciente possui três faltas anteriores a este agendamento" runat="server" />
                                    <asp:Label ID="lblResp" Text='<%# Eval("NO_RESP_DINAMICO_V") %>' style="margin-left:-3px;" runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:BoundField DataField="NO_CLASS_PROFI" HeaderText="EXPECIALIDADE">
                                <ItemStyle Width="80px" HorizontalAlign="Left" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="CONTRAT">
                                <ItemStyle Width="50px" />
                                <ItemTemplate>
                                    <asp:Label ID="lblContratacao" CssClass='<%# Eval("tpContr_CLS") %>' Text='<%# Eval("tpContr_TXT") %>' ToolTip='<%# Eval("tpContr_TIP") %>' style="margin-left:-3px;" runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
                ...
                <ul class="ulQuest">
                    ...
                    <li style="border: none; margin-left:-2px;">
                        <asp:RadioButtonList runat="server" ID="rblEncaminhar" BorderStyle="None" CssClass="rblEncaminhar"
                            ...
                            <asp:ListItem Text="Encaminhar para recepção" Value="P" />
                            <asp:ListItem Text="Encaminhar para atendimento" Value="A" />
                        </asp:RadioButtonList>
                    </li>
                    <li style="width: 100%; height: 17px; text-align: center; text-transform: uppercase;
                        margin-top: 20px; margin-left: auto; background-color: #FFA07A; margin-bottom: 10px;">
