<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master" AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._3000_ControleInformacoesUsuario._3200_ControleAtendimentoUsuario._3202_RegistroEntregaMedicamentos.Cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <ul id="ulDados" class="ulDados" runat="server">       
        <li>
            <ul>
                <li class="liClear">
                    <label for="ddlModalidade" title="Região do Usuário" class="lblObrigatorio">Região</label>
                    <asp:DropDownList Enabled="false" ToolTip="Informe a Região do Usuário" ID="ddlModalidade" CssClass="campoModalidade" runat="server" AutoPostBack="true"
                    OnSelectedIndexChanged="ddlModalidade_SelectedIndexChanged">
                    </asp:DropDownList> 
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlModalidade"
                        ErrorMessage="Modalidade deve ser informada" CssClass="validatorField">
                    </asp:RequiredFieldValidator>
                    <asp:HiddenField ID="hdfOcorRegis" runat="server" />
                </li>
                <li class="liSerie">
                    <label class="lblObrigatorio" title="Área do Usuário" for="ddlSerieCurso">Área</label>
                    <asp:DropDownList Enabled="false" ToolTip="Informe a Área do Usuário" ID="ddlSerieCurso" CssClass="campoSerieCurso" runat="server" AutoPostBack="true"
                ...
                <li class="liTurma">
                    <label class="lblObrigatorio" title="SubÁrea do Usuário" for="ddlTurma">SubÁrea</label>
                    <asp:DropDownList Enabled="false" ToolTip="Informe a SubÁrea do Usuário" ID="ddlTurma" CssClass="campoTurma" runat="server" AutoPostBack="true"
        ...
        <li style="clear: none; margin-left: 80px;">
            <ul>
                <li>
                    <label for="ddlAluno" title="Nome do Usuário Solicitante" class="lblObrigatorio">Usuário</label>
                    <asp:DropDownList Enabled="false" ToolTip="Selecione o Usuário Solicitante" ID="ddlAluno" runat="server" CssClass="ddlAluno" 
                        AutoPostBack="true" OnSelectedIndexChanged="ddlAluno_SelectedIndexChanged"></asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" CssClass="validatorField" runat="server" ControlToValidate="ddlAluno" ErrorMessage="Usuário deve ser informado" Text="*" Display="Static"></asp:RequiredFieldValidator>
                </li>    
                <li>
                    <label for="txtNire" title="NIRS do Aluno">NIRS</label>
                ...
                <li class="liClear">
                    <label for="txtResponsavel" title="Nome do Responsável do Aluno">Responsável do Usuário</label>
                    <asp:TextBox Enabled="false" ID="txtResponsavel" runat="server" CssClass="txtResponsavel">
                    </asp:TextBox>
                </li>
                <li>
                    <label for="txtTelefoneResp" title="Telefone do Responsável do Usuário">Telefone</label>
                    <asp:TextBox Enabled="false" ToolTip="Informe o Telefone do Responsável do Usuário" ID="txtTelefoneResp" CssClass="campoTelefone" runat="server" MaxLength="20"></asp:TextBox>
                </li>
            </ul>
        </li>                
                                   ...
                                   AutoGenerateColumns="False">
                                    ...
                                    <AlternatingRowStyle CssClass="alternatingRowStyle" />
                                       <Columns>
                                           ...
                                           <asp:CheckBoxField DataField="quitar" HeaderText="ENTREGAR">
        ...
        <li style="clear: none;">
            <ul>            
                ...
                <li class="liObservacao" style="margin-left: -7px;margin-bottom: 0px;">
                    <asp:CheckBox Enabled="false" CssClass="chkIsento" Text="Enviar SMS ao concluir" ToolTip="Marque se será enviado SMS na Conclusão da Solicitação" ID="chkSMS" runat="server"> </asp:CheckBox>
                </li>
...
<%--                <li class="liObservacao" style="margin-bottom: 0px;">
                ...
                <li class="liObservacao" style="margin-left: -7px;margin-bottom: 0px;">            
                    <asp:CheckBox ID="chkIsento" CssClass="chkIsento" Enabled="true" runat="server" Text="Isento de Taxa?" ToolTip="Selecione se o Usuário for isento de Taxas" AutoPostBack="True" 
