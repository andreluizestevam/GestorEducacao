<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._3000_ControleInformacoesUsuario._3200_ControleAtendimentoUsuario._3201_RegistroAtendimentoUsuario.Cadastro" %>
                ...
                <li style="width: 98.5%; text-align: center; height: 18px; background-color: #FDF5E6; padding-top:6px; padding-right:6px; margin-top:-29px;">
                    <div>
                                ...
                                <div style="float:right">
                                     <asp:CheckBox runat="server" ID="chkEncam" Checked="true" Text="Pacientes Direcionados pelo Pré-atendimento"
                                         CssClass="chkEncam" ClientIDMode="Static" />
                                     <asp:CheckBox runat="server" ID="chkConsul" Checked="true" Text="Pacientes de Agendamento de Consultas" CssClass="chkConsul"
                                         ClientIDMode="Static" />            
                                </div>
                    </div>
                </li>
                    ...
                    <li style="clear: both; margin-top: 5px;">
                        ...
                        <div id="divPaciEnca" class="divPaciEnca" runat="server" clientidmode="static">
                            ...
                            <div style="width: 100%; text-align: center; height: 17px; background-color: #90EE90;">
                                <div style="float: left;">
                                    <asp:Label ID="Label45" runat="server" Style="font-size: 1.1em; font-family: Tahoma;
                                        vertical-align: middle; margin-left: 4px !important;">
                                                RELAÇÃO DE PACIENTES - DIRECIONADOS PELO PRÉ-ATENDIMENTO</asp:Label>
                                </div>
                            </div>
                            <asp:GridView ID="grdEncamMedic" CssClass="grdBusca" runat="server" Style="width: 100%;
                                height: 15px;" AutoGenerateColumns="false" ToolTip="Seleção do paciente encaminhado para o qual será feito o atendimento" OnRowDataBound="grdEncamMedic_OnRowDataBound">
                                <RowStyle CssClass="rowStyle" />
                                <AlternatingRowStyle CssClass="alternatingRowStyle" />
                                <EmptyDataRowStyle HorizontalAlign="Center" CssClass="emptyDataRowStyle" />
                                <EmptyDataTemplate>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="NU_SENHA" HeaderText="SENHA">
                                        <ItemStyle HorizontalAlign="Left" Width="40px" />
                                        <HeaderStyle HorizontalAlign="Left" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="DTHREncamMed" HeaderText="DIREC(DT/HR)">
                                        <ItemStyle HorizontalAlign="Left" Width="90px" />
                                        <HeaderStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="DTHRPreAtend" HeaderText="ACOLH(DT/HR)">
                                        <ItemStyle HorizontalAlign="Left" Width="90px" />
                                        <HeaderStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                            ...
                            <li>
                                <ul>
                                    <li class="liPrima" style="font-weight: bolder; color:#4682b4; margin:-6px 0 5px 8px !important; font-size:10px;">INFORMAÇÕES DO ACOLHIMENTO DO PACIENTE
                                        - PRÉ-ATENDIMENTO </li>
                                    <li class="liMarginLeft" style="margin-top: 2px !important;" runat="server" visible="false">
                                        <label title="Data de nascimento e idade do usuário selecionado">
                                            Nascimento/Idade</label>
                ...
                <ul id="ul14" class="ulDados2">
                    ...
                    <li style="width: 767px; margin-left: 5px !important;">
                        <ul>
                            ...
                            <li id="li1" runat="server" class="liBtnAddA" style="margin-top: 10px !important;
                                float: right">
