<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/PadraoCadastros.Master"
    AutoEventWireup="true" CodeBehind="Cadastro2.aspx.cs" Inherits="C2BR.GestorEducacao.UI.GSAUD._3000_ControleInformacoesUsuario._3200_ControleAtendimentoUsuario._3201_RegistroAtendimentoUsuario.Cadastro2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <ul class="ulDados">
        <li style="float: left; margin-left: 3px; width: 461px !important; height: 800px; border-right: 2px solid #EE9A00;
            padding-right: 10px;">
            <ul>
                <li>
                    <ul>
                        ...
                        <li style="clear: both">
                            <div style="width: 448px; height: 140px; border: 1px solid #CCC; overflow-y: scroll"
                                id="divAgendasRecp">
                        ...
                        <li class="liTituloGrid" style="width: 450px; height: 20px !important; margin-right: 0px;
                            ...
                            <ul>
                                ...
                                <li style="clear: both; margin: -14px 0 0 0px;">
                                    <div id="divDemonAge" style="width: 448px; height: 100px; border: 1px solid #CCC;
                                        overflow-y: scroll">
                                        ...
                                        <asp:GridView ID="grdHistoricoAgenda" CssClass="grdBusca" runat="server" Style="width: 100%;
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="dtAgenda_Atend_V" HeaderText="OBSERVAÇÃO">
                                                    <ItemStyle HorizontalAlign="Center" Width="75px" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="DE_ACAO" HeaderText="DIAGNÓSTICO">
                ...
                <li style="clear: both; margin: 107px 0 0 10px;">
                    <ul>
                        <li>
                                    ...
                                    <ul>
                                        <li style="margin: 0 0 0 10px; float: left">
                                            <label style="font-family: Tahoma; font-weight: bold; margin-top: 3px; color: #FF6347">
                                                REGISTRO DE ANAMNESE DO PACIENTE</label>
                                        </li>
                                    </ul>
                                </li>
                                <li id="li10" runat="server" title="Clique para emitir o prontuário do paciente"
                                    class="liBtnAddA" style="float: right; margin: -25px 5px 3px 5px; width: 70px">
                                    <img title="Emitir Prontuário do Paciente" style="margin-top: -1px" src="/BarrasFerramentas/Icones/Imprimir.png" height="16px" width="16px" />
                                    <asp:LinkButton ID="lnkbProntuario" runat="server" OnClick="lnkbProntuario_OnClick">Prontuário</asp:LinkButton>
                                </li>
                            </ul>
                        </li>
                        <li style="clear: both; margin: -7px 0 0 -5px;">
                            <ul style="width: 448px">
                                <li>
                                    <asp:TextBox runat="server" ID="txtAnamnese" TextMode="MultiLine" Font-Size="13px" Width="448px" Height="106px"></asp:TextBox>
                                </li>
                            </ul>
                        </li>
                    </ul>
                    ...
                    <ul>
                        <li class="liTituloGrid" style="width: 508px !important; height: 20px !important;
                            ...
                            <label style="font-family: Tahoma; font-weight: bold; margin-top: 3px; color: Black;
                                ...
                                REGISTRO DE MEDICAMENTOS E EXAMES PARA O PACIENTE</label>
                        </li>
                        <li style="clear: both">
                            <ul>
                                <li style="float: left">
                                    <ul>
                                        <li>
                                            <ul class="ulMedicExam">
                                                ...
                                                <li id="li3" runat="server" title="Clique para cadastrar um novo medicamento"
                    ...
                    <ul>
                        <li>
                            <ul style="width: 506px">
                                <li class="liTituloGrid" style="width: 384px; height: 20px !important; margin-left: -0px;
                                    ...
                                    <ul>
                                        ...
                                        <li style="float: right; margin-top: 3px;">
                                            <ul>
                                                <li>
                                                    <asp:Label runat="server" ID="Label5">Operadora</asp:Label>
                                ...
                                <li id="li8" runat="server" title="Clique para cadastrar um novo Exame (Procedimento)"
                                    class="liBtnAddA" style="float: right; margin: -25px 69px 3px 5px; width: 43px">
                            ...
                            <ul>
                                <li class="liTituloGrid" style="width: 302px; height: 20px !important; background-color: #cfcfcf;
                                    ...
                                    <ul>
                                        <li style="margin: 0px 0 0 10px; float: left">
                                            <label style="font-family: Tahoma; font-weight: bold; margin-top: 3px;">
                                                REGISTRO DE DIAGNÓSTICO / ENCAMINHAMENTO</label>
                                        </li>
                                    </ul>
                                </li>
                                <li style="clear: both">
                                ...
                                <li style="clear: both; margin-top: -11px">
                                    <label>
                                        Diagnóstico</label>
                                    <asp:TextBox runat="server" ID="txtAcaoReali" Font-Size="11px" TextMode="MultiLine" Width="298px" Height="35px"></asp:TextBox>
                                </li>
                                <li style="clear: both; margin-top: -4px">
                                    <label>
                                        Encaminhamento</label>
                                    <asp:TextBox runat="server" ID="txtAcaoPlan" Font-Size="11px" Width="298px"></asp:TextBox>
                                </li>
            ...
            <div id="divAtestado" style="display: none; width:500px; height: 350px !important;">
                <ul class="ulDados" style="float:left; width:500px; margin-top: 0px !important;">
                    ...
                    <li style="margin-top: 0px !important; margin-left:70px !important;">
                        ...
                        Dias <asp:TextBox ID="txtQtdDias" runat="server" Width="20px" MaxLength="3" ToolTip="Informe a quantidade de dias de repouso do paciente"> </asp:TextBox>
                        ...
                        CID <asp:TextBox ID="txtCid" runat="server" Width="25px" MaxLength="5" ToolTip="CID"> </asp:TextBox>
                    </li>
                ...
                <ul class="ulDados" style="width:500px; margin-top: 0px !important; margin-left:0px !important;">
                    ...
                    <li id="li9" runat="server" class="liBtnAddA" style="margin-top: 10px !important; margin-left:230px !important; height: 15px;">
                        <asp:LinkButton ID="lnkbGerarAtestado" OnClick="lnkbGerarAtestado_Click" runat="server" ValidationGroup="atestado" ToolTip="Emitir documento"> <asp:Label runat="server" ID="Label3" Text="EMITIR" Style="margin-left: 5px; margin-right: 5px;"></asp:Label></asp:LinkButton>
                    </li>
                </ul>
            </div>
        </li>
        <li>
            <div id="divGuiaPlano" style="display: none; height: 100px !important;">
                <ul class="ulDados" style="width: 430px; margin-top: 0px !important">
                    ...
                    <li class="liBtnAddA" style="clear: none !important; margin-left: 180px !important; margin-top: 8px !important; height: 15px;">
                        <asp:LinkButton ID="lnkbImprimirGuia" runat="server" ValidationGroup="guia" OnClick="lnkbImprimirGuia_OnClick" ToolTip="Imprimir guia do plano de saúde"> <asp:Label runat="server" ID="lblEmitirGuia" Text="EMITIR" Style="margin-left: 4px;"></asp:Label></asp:LinkButton>
                    </li>
                </ul>
            </div>
        </li>
        ...
        <ul class="ulDados" style="width: 350px !important;">
            ...
            <li id="li6" runat="server" class="liBtnAddA" style="margin-top: 0px !important;
                ...
                <asp:LinkButton ID="lnkNovoMedic" runat="server" ValidationGroup="novoMedicamento" OnClick="lnkNovoMedic_OnClick"
                    ToolTip="Armazena as informações na prescrição em questão"> <asp:Label runat="server" ID="Label10" Text="SALVAR" Style="margin-left: 4px; margin-right: 4px;"></asp:Label></asp:LinkButton>
            </li>
        </ul>
    </div>
        ...
        <ul class="ulDados" style="width: 480px; margin-top: 0px !important">
            ...
            <li id="li7" runat="server" class="liBtnAddA" style="margin-top: 0px !important;
                ...
                <asp:LinkButton ID="lnkNovoExam" runat="server" ValidationGroup="novoProcedimento" OnClick="lnkNovoExam_OnClick"
                    ToolTip="Armazena as informações na prescrição em questão"> <asp:Label runat="server" ID="Label11" Text="SALVAR" Style="margin-left: 4px;"></asp:Label></asp:LinkButton>
            </li>
        </ul>
    </div>
    <div id="divLaudo" style="display: none; height: 240px !important;">
        ...
        <ul class="ulDados" style="width: 545px; margin-top: 0px !important">
            ...
            <li class="liBtnAddA" style="clear: none !important; margin-left: 250px !important; margin-top: 8px !important; height: 15px;">
                <asp:LinkButton ID="lnkbImprimirLaudo" ValidationGroup="laudo" runat="server" OnClick="lnkbImprimirLaudo_OnClick" ToolTip="Imprimir laudo técnico"> <asp:Label runat="server" ID="Label7" Text="EMITIR" Style="margin-left: 4px;"></asp:Label></asp:LinkButton>
            </li>
        </ul>
    </div>
        ...
        <ul>
            ...
            <li class="liBtnConfirm" style="margin-left:85px; width: 30px">
                <asp:LinkButton ID="lnkbAtendSim" OnClick="lnkbAtendSim_OnClick" 
                    runat="server" ToolTip="Confirma o encaminhamento do paciente para atendimento"> <label style="margin-left:5px; color:White;">SIM</label> </asp:LinkButton>
            </li>
            <li class="liBtnConfirm" style="margin:-22px 0 0 135px; width: 30px;">
                <asp:LinkButton ID="lnkbAtendNao"
                    runat="server" ToolTip="Seleciona o paciente e mostra a situação atual do atendimento"> <label style="margin-left:5px; color:White;">NÃO</label> </asp:LinkButton>
            </li>
        </ul>
    </div>
