...
{
    public partial class ControleImagemAtestado : System.Web.UI.UserControl
    {        
        #region Variáveis
...
//------------> Define tamanho das imagens
                ...
                if (OperacaoCorrenteQueryString.Equals(QueryStrings.OperacaoAlteracao) && Session["ID_IMAGEM"] != null)
                {
                    if (this.ImageId.Equals(0))
                        ShowImg.ImageUrl = "../../LerImagem.ashx?idAtest=" + Session["ID_IMAGEM"];
                    else
                        ShowImg.ImageUrl = "../../LerImagem.ashx?idAtest=" + this.ImageId;
        ...
        /// <summary>
        /// Método utilizado para carregar a imagem com o parâmetro de Id do atestado
        /// </summary>
        /// <param name="idImage">Id do atestado</param>
        public void CarregaImagem(int idAtest)
        {
            HttpContext.Current.Session.Remove("ID_IMAGEM");
            if (idAtest != 0)
            {
                HttpContext.Current.Session.Add("ID_IMAGEM", idAtest);
                ShowImg.ImageUrl = "../../LerImagem.ashx?idAtest=" + idAtest;
            }
            else
            {
                HttpContext.Current.Session.Add("ID_IMAGEM", null);
                ShowImg.ImageUrl = "../../LerImagem.ashx?idAtest=" + "";
            }
...
//--------> Se item editado e a imagem não, é retornado o código da mesma
        ...
        public byte[] RetornaImagem() {
            return (byte[])Session["ID_IMAGEM_UPLOAD"];
        }
        #endregion     
