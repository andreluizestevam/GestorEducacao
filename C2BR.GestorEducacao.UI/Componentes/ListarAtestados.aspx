<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListarAtestados.aspx.cs" Inherits="C2BR.GestorEducacao.UI.Componentes.ListarAtestados" %>
...
<body>
    <div id="divListarProdutosContainer">
        ...
        <div id="divListarProdutosContent">
            <asp:GridView runat="server" ID="grdListarAtestados" AutoGenerateColumns="false"
                AllowPaging="false" GridLines="Vertical" DataKeyNames="ID_DOCUM">
                ...
                <Columns>
                    <asp:BoundField HeaderText="COD. ATE." DataField="ID_DOCUM">
                        <ItemStyle Width="60px" VerticalAlign="Middle" HorizontalAlign="Left"></ItemStyle>
                    </asp:BoundField> 
                    <asp:BoundField HeaderText="NOME" DataField="NM_DOCUM">
                        <ItemStyle Width="150px" VerticalAlign="Middle" HorizontalAlign="Left"></ItemStyle>
                    </asp:BoundField> 
                    <asp:BoundField HeaderText="DESCRIÇÃO" DataField="CO_SIGLA_DOCUM">
