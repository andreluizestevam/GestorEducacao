...
// OBJETIVO: LISTA RESPONSÁVEIS COM A REGRA DE QUANDO SE CLICAR, FAZER UM POSTBACK
// DATA DE CRIAÇÃO: 
//-----------------------------------------------------------------------------
...
{
    public partial class ListarResponsaveisClique : System.Web.UI.Page
    {
        #region Váriaveis
            ...
            if (!IsPostBack)
            {
                grdListarResponsaveis.DataSource = (from tb108 in TB108_RESPONSAVEL.RetornaTodosRegistros()
                                                    ...
                                                    select new
                                                    {
                                                        tb108.CO_RESP,
                                                        tb108.NU_CONTROLE,
                                                        NO_RESP = (tb108.NO_RESP).ToUpper(),
                                                        sexo = tb108.CO_SEXO_RESP == "M" ? "Masculino" : "Feminino",
                                                        tb108.NU_NIS_RESP,
                                                        tb108.DT_NASC_RESP,
