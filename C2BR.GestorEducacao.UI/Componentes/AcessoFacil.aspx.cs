...
{
    public partial class AcessoFacil : System.Web.UI.Page
    {
        #region Eventos
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            grdAcessoFacil.DataSource = (from tb298 in TB298_CONEXAO_WEB.RetornaTodosRegistros()
                                        where tb298.TP_CONEX_WEB.Equals("A") && tb298.CO_STAT_CONEX_WEB.Equals("A")
                                        select new
                                        {
                                            tb298.ID_CONEX_WEB, tb298.CO_ORGAO_CONEX_WEB, tb298.NO_TITULO_CONEX_WEB,
                                            tb298.DE_OBJETO_CONEX_WEB, tb298.DE_URL_CONEX_WEB
                                        }).ToList().OrderBy( a => a.NO_TITULO_CONEX_WEB );
             grdAcessoFacil.DataBind();
        }
        #endregion

        protected void grdAcessoFacil_RowDataBound(object sender, GridViewRowEventArgs e)
        {
