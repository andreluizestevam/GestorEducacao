<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListarAlunos.aspx.cs" Inherits="C2BR.GestorEducacao.UI.Componentes.ListarAlunos" %>
...
<body>
    <div id="divListarAlunosContainer">
        ...
        <div id="divListarAlunosContent">
            <asp:GridView runat="server" ID="grdListarAlunos" AutoGenerateColumns="false"
                AllowPaging="false" OnRowDataBound="grdListarAlunos_RowDataBound" DataKeyNames="CO_ALU" >
                ...
                <Columns>                    
                    <asp:BoundField HeaderText="Nº NIRE" DataField="NU_NIRE">
                        <ItemStyle Width="60px" HorizontalAlign="Right"></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField HeaderText="Aluno" DataField="NO_ALU">
                        <ItemStyle Width="290px" HorizontalAlign="Left"></ItemStyle>
                    </asp:BoundField>   
                    ...
                    <asp:BoundField DataField="situAlu" HeaderText="Situação">
                        <ItemStyle Width="60px" HorizontalAlign="Left" />
                    </asp:BoundField> 
                    <asp:BoundField DataField="Resp" HeaderText="Responsável">
                        <ItemStyle Width="290px" HorizontalAlign="Left" />
                    </asp:BoundField>  
                    <asp:BoundField DataField="cpfResp" HeaderText="Nº CPF Resp">
                        <ItemStyle Width="75px" HorizontalAlign="Right" />
                    </asp:BoundField>     
                    <asp:BoundField Visible="false" DataField="CO_ALU" HeaderText="Cod." SortExpression="CO_ALU" HeaderStyle-CssClass="noprint"
        ...
        <div id="divHelpTxtLA">           
            <p id="pAcesso" class="pAcesso">
                Verifique os alunos existentes no quadro acima para iniciar os trabalhos.</p>
