<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListarServicoesAmbulatoriais.aspx.cs"
    Inherits="C2BR.GestorEducacao.UI.Componentes.ListarServicoesAmbulatoriais" %>
...
<body>
    <div id="divListarProdutosContainer">
        ...
        <div id="divListarProdutosContent">
            <asp:GridView runat="server" ID="grdListarServAmbu" AutoGenerateColumns="false" AllowPaging="false"
                GridLines="Vertical" DataKeyNames="ID_SERVI_AMBUL">
                <EmptyDataRowStyle CssClass="emptyDataRowStyle" />
                <EmptyDataTemplate>
                    Nenhum Serviço Ambulatorial Encontrado<br />
                </EmptyDataTemplate>
                ...
                <Columns>
                    <asp:BoundField HeaderText="COD. SERV." DataField="ID_SERVI_AMBUL">
                        <ItemStyle Width="60px" VerticalAlign="Middle" HorizontalAlign="Left"></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField HeaderText="SIGLA" DataField="CO_SIGLA_SERVI_AMBUL">
                        <ItemStyle Width="100px" VerticalAlign="Middle" HorizontalAlign="Left"></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField HeaderText="NOME" DataField="DE_SERVI_AMBUL">
