<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListarProdutos.aspx.cs" Inherits="C2BR.GestorEducacao.UI.Componentes.ListarProdutos" %>
...
<body>
    <div id="divListarProdutosContainer">
        ...
        <div id="divListarProdutosContent">
            <asp:GridView runat="server" ID="grdListarProdutos" AutoGenerateColumns="false"
                AllowPaging="false" GridLines="Vertical" DataKeyNames="CO_PROD">
                ...
                <Columns>
                    <asp:BoundField Visible="false" DataField="CO_PROD" HeaderText="Cod." SortExpression="CO_PROD" HeaderStyle-CssClass="noprint"
                        ItemStyle-CssClass="noprint">
                        <HeaderStyle CssClass="noprint"></HeaderStyle>
                        <ItemStyle Width="20px" />
                    </asp:BoundField>
                    <asp:BoundField HeaderText="COD. REF." DataField="CO_REFE_PROD">
                        <ItemStyle Width="60px" VerticalAlign="Middle" HorizontalAlign="Left"></ItemStyle>
                    </asp:BoundField> 
                    <asp:BoundField HeaderText="NOME" DataField="NO_PROD">
                        <ItemStyle Width="150px" VerticalAlign="Middle" HorizontalAlign="Left"></ItemStyle>
                    </asp:BoundField> 
                    <asp:BoundField HeaderText="DESCRIÇÃO" DataField="DES_PROD">
