            ...
            <li class="liTop">
                ...
                <li class="G2Clear">
                    <label for="txtDepartamento">
                        Localização</label>
                    <asp:TextBox ID="txtDepartamento" runat="server" Enabled="false" Width="170px"  CssClass="txtDptoCurso" ToolTip="Departamento do Colaborador">
                    </asp:TextBox>
                </li>
                <li style="margin-left: 33px;">
                    <label for="txtFuncao">
                        Atividade</label>
                    <asp:TextBox ID="txtFuncao" runat="server" Enabled="false" Width="200px" ToolTip="Função do Colaborador">
                    </asp:TextBox>
                </li>
                <li style="clear: both;">
                    <label for="txtEmail">
                    ...
                    <fieldset>
                        ...
                        <ul id="ulAPPrincipal">
                            ...
                            <li  style="margin-right: 0px;">
                                <ul>
                                    <li class="liAP1">
                                        <asp:CheckBox CssClass="chkLocais" runat="server" TextAlign="Right" Enabled="false" Text="Mobile Phone" ID="CheckBox1" />                                        
                                    </li>
                                    <li>
