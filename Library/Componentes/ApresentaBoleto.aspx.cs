...
{
    public partial class ApresentaBoleto : System.Web.UI.Page
    {
        #region Eventos
        ...
        private void AtualizaNossoNumeroCodigoBarras(InformacoesBoletoBancario boleto, string codigoBarras)
        {
            try
            {
                ...
                TB47_CTA_RECEB c = TB47_CTA_RECEB.RetornaPelaChavePrimaria(boleto.CO_EMP, boleto.NU_DOC, boleto.NU_PAR, boleto.DT_CAD_DOC);
