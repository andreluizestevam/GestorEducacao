...
{
    public partial class VW_CONTR_MATRI
    {
        ...
        /// <returns>O número de entidades que foi alterada no contexto atual, quando persistido na base de dados.</returns>
        public static int Delete(VW_CONTR_MATRI entity, bool saveChanges)
        {
        ...
        public static VW_CONTR_MATRI Delete(VW_CONTR_MATRI entity)
        {
            Delete(entity, true);
        ...
        /// <param name="saveChanges">Determina se irá persistir as alterações na base de dados.</param>
        /// <returns>O número de entidades que foi alterada no contexto atual, quando persistido na base de dados.</returns>
        public static int SaveOrUpdate(VW_CONTR_MATRI entity, bool saveChanges)
        {
        ...
        /// <param name="entity">A entidade na qual será executada a ação.</param>
        /// <returns>A própria entidade VW_CONTR_MATRI.</returns>
        public static VW_CONTR_MATRI SaveOrUpdate(VW_CONTR_MATRI entity)
        {
        ...
        /// <returns>A própria entidade VW_CONTR_MATRI.</returns>
        public static VW_CONTR_MATRI GetByEntityKey(EntityKey entityKey)
        {
            return (VW_CONTR_MATRI)GestorEntities.GetByEntityKey(entityKey);
        }
        ...
        public static ObjectQuery<VW_CONTR_MATRI> RetornaTodosRegistros()
        {
            return GestorEntities.CurrentContext.VW_CONTR_MATRI.AsObjectQuery();
        }
