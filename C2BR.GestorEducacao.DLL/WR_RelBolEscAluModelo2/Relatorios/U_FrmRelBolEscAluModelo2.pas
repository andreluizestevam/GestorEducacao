...
type
  TFrmRelBolEscAluModelo2 = class(TFrmRelTemplate)
    QRShape1: TQRShape;
    qrlAluno: TQRLabel;
    qrlSexo: TQRLabel;
...
var
  FrmRelBolEscAluModelo2: TFrmRelBolEscAluModelo2;


implementation

uses U_DataModuleSGE,MaskUtils, JPEG;

{$R *.dfm}

procedure TFrmRelBolEscAluModelo2.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  q: TADOQuery;
...
begin
  ...
  if not QryRelatorio.FieldByName('nis').IsNull then  begin
  ...
  begin
    Close;
    SQl.Clear;
    SQL.Text := 'select c.no_col,c.co_mat_col from tb83_parametro e ' +
                ' join tb03_colabor c on c.co_col = e.CO_DIR1 ' +
  ...
  begin
    ...
    SQl.Clear;
    SQL.Text := 'select c.no_col,c.co_mat_col from tb83_parametro e ' +
                ' join tb03_colabor c on c.co_col = e.CO_COL_SECRE1 ' +
                ' where e.CO_EMP = ' + codigoEmpresa;
    Open;
  ...
  if not QryRelatorio.FieldByName('matricula').IsNull then begin
    QRLMatricula.Caption := QryRelatorio.FieldByName('matricula').AsString;
  end
  else
    QRLMatricula.Caption := '';

  if (not QryRelatorio.FieldByName('aprovado').IsNull) and (not QryRelatorio.FieldByName('aprovadoFreq').IsNull) then
  begin
    qrlResultFinal.Font.Size := 12;
    qrlResultFinal.Top := 166;
    if (QryRelatorio.FieldByName('aprovado').AsString = 'A') and (QryRelatorio.FieldByName('aprovadoFreq').AsString = 'A') then
  ...
  while not q.Eof do begin
    case c of
      ...
      1: begin
        ...
        if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
        begin
          if q.FieldByName('nota1').AsInteger < 15 then
          begin
            m111.Font.Color := clRed;
          end
          else
        ...
        begin
          if q.FieldByName('nota1').AsInteger < 17 then
          begin
            m111.Font.Color := clRed;
          end
          else
      ...
      //  m115.Caption := q.FieldByName('freq1').AsString;
        ...
        begin
          ...
          if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if q.FieldByName('nota2').AsInteger < 15 then
            begin
              m121.Font.Color := clRed;
            end
            else
              m121.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota2').AsInteger < 17 then
            begin
              m121.Font.Color := clRed;
            end
            else
...
//        m126.Caption := q.FieldByName('comp2').AsString;
        ...
        begin
          ...
          if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if q.FieldByName('nota3').AsInteger < 15 then
            begin
              m131.Font.Color := clRed;
            end
            else
              m131.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota3').AsInteger < 17 then
            begin
              m131.Font.Color := clRed;
            end
            else
...
//        m136.Caption := q.FieldByName('comp3').AsString;
        ...
        begin
          ...
          if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if q.FieldByName('nota4').AsInteger < 15 then
            begin
              m141.Font.Color := clRed;
            end
            else
              m141.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota4').AsInteger < 17 then
            begin
              m141.Font.Color := clRed;
            end
            else
...
//        m146.Caption := q.FieldByName('comp4').AsString;
        ...
        //Bimestre 5
        if (not q.FieldByName('nota4').IsNull) and (bimestre >= 4) then
        begin
          m151.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat+
          q.FieldByName('nota3').AsFloat+q.FieldByName('nota4').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m151.Caption) < 15 then
            begin
              m151.Font.Color := clRed;
            end
            else
              m151.Font.Color := clBlack;
          end
          else
          begin
            if StrToFloat(m151.Caption) < 17 then
            begin
              m151.Font.Color := clRed;
            end
            else
        ...
        else if not q.FieldByName('nota3').IsNull and (bimestre >= 3) then
        begin
          m151.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat+
          q.FieldByName('nota3').AsFloat), ffFixed, 3, 1);
          {
          if m151.Caption = '' then
          begin
            m151.Caption := '0';
          end;
          if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
        ...
        else if not q.FieldByName('nota2').IsNull and (bimestre >= 2) then
        begin
          m151.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat), ffFixed, 3, 1);
          {if m151.Caption = '' then
          begin
            m151.Caption := '0';
          end;
        ...
        begin
          m151.Caption := FloatToStrF(q.FieldByName('nota1').AsFloat, ffFixed, 3, 1);
          if m151.Caption = '' then
          begin
            m151.Caption := '0';
          end;
        ...
        begin
          ...
          if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if q.FieldByName('mediafinal').AsInteger < 15 then
            begin
              m154.Font.Color := clRed;
            end
            else
              m154.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('mediafinal').AsInteger < 17 then
            begin
              m154.Font.Color := clRed;
            end
            else
        ...
        if not q.FieldByName('faltas4').IsNull and (bimestre >= 4) then
        begin
        ...
        else if not q.FieldByName('faltas3').IsNull and (bimestre >= 3) then
        begin
          m155.Caption := IntToStr(q.FieldByName('faltas1').AsInteger+q.FieldByName('faltas2').AsInteger+
          q.FieldByName('faltas3').AsInteger);
          sc29 := sc29 + StrToInt(m155.Caption);
        end
        else if not q.FieldByName('faltas2').IsNull and (bimestre >= 2) then
        begin
          m155.Caption := IntToStr(q.FieldByName('faltas1').AsInteger+q.FieldByName('faltas2').AsInteger);
          sc29 := sc29 + StrToInt(m155.Caption);
        end
...
//        m216.Caption := q.FieldByName('comp1').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota2').AsInteger < 15 then
            begin
              m221.Font.Color := clRed;
            end
            else
              m221.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota2').AsInteger < 17 then
...
//        m226.Caption := q.FieldByName('comp2').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota3').AsInteger < 15 then
            begin
              m231.Font.Color := clRed;
            end
            else
              m231.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota3').AsInteger < 17 then
...
//        m236.Caption := q.FieldByName('comp3').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota4').AsInteger < 15 then
            begin
              m241.Font.Color := clRed;
            end
            else
              m241.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota4').AsInteger < 17 then
...
//        m246.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('nota4').IsNull and (bimestre >= 4) then
        begin
          m251.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat+
          q.FieldByName('nota3').AsFloat+q.FieldByName('nota4').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m251.Caption) < 15 then
            begin
              m251.Font.Color := clRed;
            end
            else
              m251.Font.Color := clBlack;
          end
          else
          begin
            if StrToFloat(m251.Caption) < 17 then
            begin
              m251.Font.Color := clRed;
            end
            else
        ...
        begin
          m251.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m251.Caption) < 15 then
            begin
        ...
        begin
          m251.Caption := FloatToStrF(q.FieldByName('nota1').AsFloat, ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m251.Caption) < 15 then
            begin
        ...
        begin
          ...
          begin
            if q.FieldByName('mediafinal').AsInteger < 15 then
            begin
              m254.Font.Color := clRed;
            end
            else
              m254.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('mediafinal').AsInteger < 17 then
      ...
      3: begin
        ...
        begin
          if q.FieldByName('nota1').AsInteger < 15 then
          begin
            m311.Font.Color := clRed;
          end
          else
            m311.Font.Color := clBlack;
        end
        else
        begin
          if q.FieldByName('nota1').AsInteger < 17 then
...
//        m316.Caption := q.FieldByName('comp1').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota2').AsInteger < 15 then
            begin
              m321.Font.Color := clRed;
            end
            else
              m321.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota2').AsInteger < 17 then
...
//        m326.Caption := q.FieldByName('comp2').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota3').AsInteger < 15 then
            begin
              m331.Font.Color := clRed;
            end
            else
              m331.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota3').AsInteger < 17 then
...
//        m336.Caption := q.FieldByName('comp3').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota4').AsInteger < 15 then
            begin
              m341.Font.Color := clRed;
            end
            else
              m341.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota4').AsInteger < 17 then
...
//        m346.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('nota4').IsNull and (bimestre >= 4) then
        begin
          m351.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat+
          q.FieldByName('nota3').AsFloat+q.FieldByName('nota4').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m351.Caption) < 15 then
            begin
              m351.Font.Color := clRed;
            end
            else
              m351.Font.Color := clBlack;
          end
          else
          begin
            if StrToFloat(m351.Caption) < 17 then
            begin
              m351.Font.Color := clRed;
            end
            else
        ...
        begin
          m351.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m351.Caption) < 15 then
            begin
        ...
        begin
          m351.Caption := FloatToStrF(q.FieldByName('nota1').AsFloat, ffFixed, 3, 1);
          if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m351.Caption) < 15 then
            begin
        ...
        begin
          ...
          begin
            if q.FieldByName('mediafinal').AsInteger < 15 then
            begin
              m354.Font.Color := clRed;
            end
            else
              m354.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('mediafinal').AsInteger < 17 then
      ...
      4: begin
        ...
        begin
          if q.FieldByName('nota1').AsInteger < 15 then
          begin
            m411.Font.Color := clRed;
          end
          else
            m411.Font.Color := clBlack;
        end
        else
        begin
          if q.FieldByName('nota1').AsInteger < 17 then
...
//        m416.Caption := q.FieldByName('comp1').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota2').AsInteger < 15 then
            begin
              m421.Font.Color := clRed;
            end
            else
              m421.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota2').AsInteger < 17 then
...
//        m426.Caption := q.FieldByName('comp2').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota3').AsInteger < 15 then
            begin
              m431.Font.Color := clRed;
            end
            else
              m431.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota3').AsInteger < 17 then
...
//        m436.Caption := q.FieldByName('comp3').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota4').AsInteger < 15 then
            begin
              m441.Font.Color := clRed;
            end
            else
              m441.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota4').AsInteger < 17 then
...
//        m446.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('nota4').IsNull and (bimestre >= 4) then
        begin
          m451.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat+
          q.FieldByName('nota3').AsFloat+q.FieldByName('nota4').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m451.Caption) < 15 then
            begin
              m451.Font.Color := clRed;
            end
            else
              m451.Font.Color := clBlack;
          end
          else
          begin
            if StrToFloat(m451.Caption) < 17 then
            begin
              m451.Font.Color := clRed;
            end
            else
        ...
        begin
          m451.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m451.Caption) < 15 then
            begin
        ...
        begin
          m451.Caption := FloatToStrF(q.FieldByName('nota1').AsFloat, ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m451.Caption) < 15 then
            begin
        ...
        begin
          ...
          begin
            if q.FieldByName('mediafinal').AsInteger < 15 then
            begin
              m454.Font.Color := clRed;
            end
            else
              m454.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('mediafinal').AsInteger < 17 then
      ...
      5: begin
        ...
        begin
          if q.FieldByName('nota1').AsInteger < 15 then
          begin
            m511.Font.Color := clRed;
          end
          else
            m511.Font.Color := clBlack;
        end
        else
        begin
          if q.FieldByName('nota1').AsInteger < 17 then
...
//        m516.Caption := q.FieldByName('comp1').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota2').AsInteger < 15 then
            begin
              m521.Font.Color := clRed;
            end
            else
              m521.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota2').AsInteger < 17 then
...
//        m526.Caption := q.FieldByName('comp2').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota3').AsInteger < 15 then
            begin
              m531.Font.Color := clRed;
            end
            else
              m531.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota3').AsInteger < 17 then
...
//        m536.Caption := q.FieldByName('comp3').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota4').AsInteger < 15 then
            begin
              m541.Font.Color := clRed;
            end
            else
              m541.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota4').AsInteger < 17 then
...
//        m546.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('nota4').IsNull and (bimestre >= 4) then
        begin
          m551.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat+
          q.FieldByName('nota3').AsFloat+q.FieldByName('nota4').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m551.Caption) < 15 then
            begin
              m551.Font.Color := clRed;
            end
            else
              m551.Font.Color := clBlack;
          end
          else
          begin
            if StrToFloat(m551.Caption) < 17 then
            begin
              m551.Font.Color := clRed;
            end
            else
        ...
        begin
          m551.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m551.Caption) < 15 then
            begin
        ...
        begin
          m551.Caption := FloatToStrF(q.FieldByName('nota1').AsFloat, ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m551.Caption) < 15 then
            begin
        ...
        begin
          ...
          begin
            if q.FieldByName('mediafinal').AsInteger < 15 then
            begin
              m554.Font.Color := clRed;
            end
            else
              m554.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('mediafinal').AsInteger < 17 then
      ...
      6: begin
        ...
        begin
          if q.FieldByName('nota1').AsInteger < 15 then
          begin
            m611.Font.Color := clRed;
          end
          else
            m611.Font.Color := clBlack;
        end
        else
        begin
          if q.FieldByName('nota1').AsInteger < 17 then
...
//        m616.Caption := q.FieldByName('comp1').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota2').AsInteger < 15 then
            begin
              m621.Font.Color := clRed;
            end
            else
              m621.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota2').AsInteger < 17 then
...
//        m626.Caption := q.FieldByName('comp2').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota3').AsInteger < 15 then
            begin
              m631.Font.Color := clRed;
            end
            else
              m631.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota3').AsInteger < 17 then
...
//        m636.Caption := q.FieldByName('comp3').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota4').AsInteger < 15 then
            begin
              m641.Font.Color := clRed;
            end
            else
              m641.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota4').AsInteger < 17 then
...
//        m646.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('nota4').IsNull and (bimestre >= 4) then
        begin
          m651.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat+
          q.FieldByName('nota3').AsFloat+q.FieldByName('nota4').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m651.Caption) < 15 then
            begin
              m651.Font.Color := clRed;
            end
            else
              m651.Font.Color := clBlack;
          end
          else
          begin
            if StrToFloat(m651.Caption) < 17 then
            begin
              m651.Font.Color := clRed;
            end
            else
        ...
        begin
          m651.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m651.Caption) < 15 then
            begin
        ...
        begin
          m651.Caption := FloatToStrF(q.FieldByName('nota1').AsFloat, ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m651.Caption) < 15 then
            begin
        ...
        begin
          ...
          begin
            if q.FieldByName('mediafinal').AsInteger < 15 then
            begin
              m654.Font.Color := clRed;
            end
            else
              m654.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('mediafinal').AsInteger < 17 then
      ...
      7: begin
        ...
        begin
          if q.FieldByName('nota1').AsInteger < 15 then
          begin
            m711.Font.Color := clRed;
          end
          else
            m711.Font.Color := clBlack;
        end
        else
        begin
          if q.FieldByName('nota1').AsInteger < 17 then
...
//        m716.Caption := q.FieldByName('comp1').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota2').AsInteger < 15 then
            begin
              m721.Font.Color := clRed;
            end
            else
              m721.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota2').AsInteger < 17 then
...
//        m726.Caption := q.FieldByName('comp2').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota3').AsInteger < 15 then
            begin
              m731.Font.Color := clRed;
            end
            else
              m731.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota3').AsInteger < 17 then
...
//        m736.Caption := q.FieldByName('comp3').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota4').AsInteger < 15 then
            begin
              m741.Font.Color := clRed;
            end
            else
              m741.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota4').AsInteger < 17 then
...
//        m746.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('nota4').IsNull and (bimestre >= 4) then
        begin
          m751.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat+
          q.FieldByName('nota3').AsFloat+q.FieldByName('nota4').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m751.Caption) < 15 then
            begin
              m751.Font.Color := clRed;
            end
            else
              m751.Font.Color := clBlack;
          end
          else
          begin
            if StrToFloat(m751.Caption) < 17 then
            begin
              m751.Font.Color := clRed;
            end
            else
        ...
        begin
          m751.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m751.Caption) < 15 then
            begin
        ...
        begin
          m751.Caption := FloatToStrF(q.FieldByName('nota1').AsFloat, ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m751.Caption) < 15 then
            begin
        ...
        begin
          ...
          begin
            if q.FieldByName('mediafinal').AsInteger < 15 then
            begin
              m754.Font.Color := clRed;
            end
            else
              m754.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('mediafinal').AsInteger < 17 then
      ...
      8: begin
        ...
        begin
          if q.FieldByName('nota1').AsInteger < 15 then
          begin
            m811.Font.Color := clRed;
          end
          else
            m811.Font.Color := clBlack;
        end
        else
        begin
          if q.FieldByName('nota1').AsInteger < 17 then
...
//        m816.Caption := q.FieldByName('comp1').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota2').AsInteger < 15 then
            begin
              m821.Font.Color := clRed;
            end
            else
              m821.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota2').AsInteger < 17 then
...
//        m826.Caption := q.FieldByName('comp2').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota3').AsInteger < 15 then
            begin
              m831.Font.Color := clRed;
            end
            else
              m831.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota3').AsInteger < 17 then
...
//        m836.Caption := q.FieldByName('comp3').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota4').AsInteger < 15 then
            begin
              m841.Font.Color := clRed;
            end
            else
              m841.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota4').AsInteger < 17 then
...
//        m846.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('nota4').IsNull and (bimestre >= 4) then
        begin
          m851.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat+
          q.FieldByName('nota3').AsFloat+q.FieldByName('nota4').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m851.Caption) < 15 then
            begin
              m851.Font.Color := clRed;
            end
            else
              m851.Font.Color := clBlack;
          end
          else
          begin
            if StrToFloat(m851.Caption) < 17 then
            begin
              m851.Font.Color := clRed;
            end
            else
        ...
        begin
          m851.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m851.Caption) < 15 then
            begin
        ...
        begin
          m851.Caption := FloatToStrF(q.FieldByName('nota1').AsFloat, ffFixed, 3, 1);
          if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m851.Caption) < 15 then
            begin
        ...
        begin
          ...
          begin
            if q.FieldByName('mediafinal').AsInteger < 15 then
            begin
              m854.Font.Color := clRed;
            end
            else
              m854.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('mediafinal').AsInteger < 17 then
      ...
      9: begin
        ...
        begin
          if q.FieldByName('nota1').AsInteger < 15 then
          begin
            m911.Font.Color := clRed;
          end
          else
            m911.Font.Color := clBlack;
        end
        else
        begin
          if q.FieldByName('nota1').AsInteger < 17 then
...
//        m916.Caption := q.FieldByName('comp1').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota2').AsInteger < 15 then
            begin
              m921.Font.Color := clRed;
            end
            else
              m921.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota2').AsInteger < 17 then
...
//        m926.Caption := q.FieldByName('comp2').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota3').AsInteger < 15 then
            begin
              m931.Font.Color := clRed;
            end
            else
              m931.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota3').AsInteger < 17 then
...
//        m936.Caption := q.FieldByName('comp3').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota4').AsInteger < 15 then
            begin
              m941.Font.Color := clRed;
            end
            else
              m941.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota4').AsInteger < 17 then
...
//        m946.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('nota4').IsNull and (bimestre >= 4) then
        begin
          m951.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat+
          q.FieldByName('nota3').AsFloat+q.FieldByName('nota4').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m951.Caption) < 15 then
            begin
              m951.Font.Color := clRed;
            end
            else
              m951.Font.Color := clBlack;
          end
          else
          begin
            if StrToFloat(m951.Caption) < 17 then
            begin
              m951.Font.Color := clRed;
            end
            else
        ...
        begin
          m951.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m951.Caption) < 15 then
            begin
        ...
        begin
          m951.Caption := FloatToStrF(q.FieldByName('nota1').AsFloat, ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(m951.Caption) < 15 then
            begin
        ...
        begin
          ...
          begin
            if q.FieldByName('mediafinal').AsInteger < 15 then
            begin
              m954.Font.Color := clRed;
            end
            else
              m954.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('mediafinal').AsInteger < 17 then
      ...
      10: begin
        ...
        begin
          if q.FieldByName('nota1').AsInteger < 15 then
          begin
            n111.Font.Color := clRed;
          end
          else
            n111.Font.Color := clBlack;
        end
        else
        begin
          if q.FieldByName('nota1').AsInteger < 17 then
...
//        n116.Caption := q.FieldByName('comp1').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota2').AsInteger < 15 then
            begin
              n121.Font.Color := clRed;
            end
            else
              n121.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota2').AsInteger < 17 then
...
//        n126.Caption := q.FieldByName('comp2').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota3').AsInteger < 15 then
            begin
              n131.Font.Color := clRed;
            end
            else
              n131.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota3').AsInteger < 17 then
...
//        n136.Caption := q.FieldByName('comp3').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota4').AsInteger < 15 then
            begin
              n141.Font.Color := clRed;
            end
            else
              n141.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota4').AsInteger < 17 then
...
//        n146.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('nota4').IsNull and (bimestre >= 4) then
        begin
          n151.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat+
          q.FieldByName('nota3').AsFloat+q.FieldByName('nota4').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n151.Caption) < 15 then
            begin
              n151.Font.Color := clRed;
            end
            else
              n151.Font.Color := clBlack;
          end
          else
          begin
            if StrToFloat(n151.Caption) < 17 then
            begin
              n151.Font.Color := clRed;
            end
            else
        ...
        begin
          n151.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n151.Caption) < 15 then
            begin
        ...
        begin
          n151.Caption := FloatToStrF(q.FieldByName('nota1').AsFloat, ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n151.Caption) < 15 then
            begin
        ...
        begin
          ...
          begin
            if q.FieldByName('mediafinal').AsInteger < 15 then
            begin
              n154.Font.Color := clRed;
            end
            else
              n154.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('mediafinal').AsInteger < 17 then
      ...
      11: begin
        ...
        begin
          if q.FieldByName('nota1').AsInteger < 15 then
          begin
            n211.Font.Color := clRed;
          end
          else
            n211.Font.Color := clBlack;
        end
        else
        begin
          if q.FieldByName('nota1').AsInteger < 17 then
...
//        n216.Caption := q.FieldByName('comp1').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota2').AsInteger < 15 then
            begin
              n221.Font.Color := clRed;
            end
            else
              n221.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota2').AsInteger < 17 then
...
//        n226.Caption := q.FieldByName('comp2').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota3').AsInteger < 15 then
            begin
              n231.Font.Color := clRed;
            end
            else
              n231.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota3').AsInteger < 17 then
...
//        n236.Caption := q.FieldByName('comp3').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota4').AsInteger < 15 then
            begin
              n241.Font.Color := clRed;
            end
            else
              n241.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota4').AsInteger < 17 then
...
//        n246.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('nota4').IsNull and (bimestre >= 4) then
        begin
          n251.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat+
          q.FieldByName('nota3').AsFloat+q.FieldByName('nota4').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n251.Caption) < 15 then
            begin
              n251.Font.Color := clRed;
            end
            else
              n251.Font.Color := clBlack;
          end
          else
          begin
            if StrToFloat(n251.Caption) < 17 then
            begin
              n251.Font.Color := clRed;
            end
            else
        ...
        begin
          n251.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n251.Caption) < 15 then
            begin
        ...
        begin
          n251.Caption := FloatToStrF(q.FieldByName('nota1').AsFloat, ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n251.Caption) < 15 then
            begin
        ...
        begin
          ...
          begin
            if q.FieldByName('mediafinal').AsInteger < 15 then
            begin
              n254.Font.Color := clRed;
            end
            else
              n254.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('mediafinal').AsInteger < 17 then
      ...
      12: begin
        ...
        begin
          if q.FieldByName('nota1').AsInteger < 15 then
          begin
            n311.Font.Color := clRed;
          end
          else
            n311.Font.Color := clBlack;
        end
        else
        begin
          if q.FieldByName('nota1').AsInteger < 17 then
...
//        n316.Caption := q.FieldByName('comp1').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota2').AsInteger < 15 then
            begin
              n321.Font.Color := clRed;
            end
            else
              n321.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota2').AsInteger < 17 then
...
//        n326.Caption := q.FieldByName('comp2').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota3').AsInteger < 15 then
            begin
              n331.Font.Color := clRed;
            end
            else
              n331.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota3').AsInteger < 17 then
...
//        n336.Caption := q.FieldByName('comp3').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota4').AsInteger < 15 then
            begin
              n341.Font.Color := clRed;
            end
            else
              n341.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota4').AsInteger < 17 then
...
//        n346.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('nota4').IsNull and (bimestre >= 4) then
        begin
          n351.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat+
          q.FieldByName('nota3').AsFloat+q.FieldByName('nota4').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n351.Caption) < 15 then
            begin
              n351.Font.Color := clRed;
            end
            else
              n351.Font.Color := clBlack;
          end
          else
          begin
            if StrToFloat(n351.Caption) < 17 then
            begin
              n351.Font.Color := clRed;
            end
            else
        ...
        begin
          n351.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n351.Caption) < 15 then
            begin
        ...
        begin
          n351.Caption := FloatToStrF(q.FieldByName('nota1').AsFloat, ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n351.Caption) < 15 then
            begin
        ...
        begin
          ...
          begin
            if q.FieldByName('mediafinal').AsInteger < 15 then
            begin
              n354.Font.Color := clRed;
            end
            else
              n354.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('mediafinal').AsInteger < 17 then
    ...
    case c of
      ...
      1: begin
        ...
        begin
          if q.FieldByName('nota1').AsInteger < 15 then
          begin
            n411.Font.Color := clRed;
          end
          else
            n411.Font.Color := clBlack;
        end
        else
        begin
          if q.FieldByName('nota1').AsInteger < 17 then
...
//        n416.Caption := q.FieldByName('comp1').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota2').AsInteger < 15 then
            begin
              n421.Font.Color := clRed;
            end
            else
              n421.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota2').AsInteger < 17 then
...
//        n426.Caption := q.FieldByName('comp2').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota3').AsInteger < 15 then
            begin
              n431.Font.Color := clRed;
            end
            else
              n431.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota3').AsInteger < 17 then
...
//        n436.Caption := q.FieldByName('comp3').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota4').AsInteger < 15 then
            begin
              n441.Font.Color := clRed;
            end
            else
              n441.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota4').AsInteger < 17 then
...
//        n446.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('nota4').IsNull and (bimestre >= 4) then
        begin
          n451.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat+
          q.FieldByName('nota3').AsFloat+q.FieldByName('nota4').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n451.Caption) < 15 then
            begin
              n451.Font.Color := clRed;
            end
            else
              n451.Font.Color := clBlack;
          end
          else
          begin
            if StrToFloat(n451.Caption) < 17 then
            begin
              n451.Font.Color := clRed;
            end
            else
        ...
        begin
          n451.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n451.Caption) < 15 then
            begin
        ...
        begin
          n451.Caption := FloatToStrF(q.FieldByName('nota1').AsFloat, ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n451.Caption) < 15 then
            begin
        ...
        begin
          ...
          begin
            if q.FieldByName('mediafinal').AsInteger < 15 then
            begin
              n454.Font.Color := clRed;
            end
            else
              n454.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('mediafinal').AsInteger < 17 then
      ...
      2: begin
        ...
        begin
          if q.FieldByName('nota1').AsInteger < 15 then
          begin
            n511.Font.Color := clRed;
          end
          else
            n511.Font.Color := clBlack;
        end
        else
        begin
          if q.FieldByName('nota1').AsInteger < 17 then
...
//        n516.Caption := q.FieldByName('comp1').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota2').AsInteger < 15 then
            begin
              n521.Font.Color := clRed;
            end
            else
              n521.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota2').AsInteger < 17 then
...
//        n526.Caption := q.FieldByName('comp2').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota3').AsInteger < 15 then
            begin
              n531.Font.Color := clRed;
            end
            else
              n531.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota3').AsInteger < 17 then
...
//        n536.Caption := q.FieldByName('comp3').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota4').AsInteger < 15 then
            begin
              n541.Font.Color := clRed;
            end
            else
              n541.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota4').AsInteger < 17 then
...
//        n546.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('nota4').IsNull and (bimestre >= 4) then
        begin
          n551.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat+
          q.FieldByName('nota3').AsFloat+q.FieldByName('nota4').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n551.Caption) < 15 then
            begin
              n551.Font.Color := clRed;
            end
            else
              n551.Font.Color := clBlack;
          end
          else
          begin
            if StrToFloat(n551.Caption) < 17 then
            begin
              n551.Font.Color := clRed;
            end
            else
        ...
        begin
          n551.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n551.Caption) < 15 then
            begin
        ...
        begin
          n551.Caption := FloatToStrF(q.FieldByName('nota1').AsFloat, ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n551.Caption) < 15 then
            begin
        ...
        begin
          ...
          begin
            if q.FieldByName('mediafinal').AsInteger < 15 then
            begin
              n554.Font.Color := clRed;
            end
            else
              n554.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('mediafinal').AsInteger < 17 then
      ...
      3: begin
        ...
        begin
          if q.FieldByName('nota1').AsInteger < 15 then
          begin
            n611.Font.Color := clRed;
          end
          else
            n611.Font.Color := clBlack;
        end
        else
        begin
          if q.FieldByName('nota1').AsInteger < 17 then
...
//        n616.Caption := q.FieldByName('comp1').AsString;
        ...
        begin
          if q.FieldByName('nota2').AsInteger < 15 then
          begin
            n621.Font.Color := clRed;
          end
          else
            n621.Font.Color := clBlack;
        end
        else
        begin
          if q.FieldByName('nota2').AsInteger < 17 then
...
//        n626.Caption := q.FieldByName('comp2').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota3').AsInteger < 15 then
            begin
              n631.Font.Color := clRed;
            end
            else
              n631.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota3').AsInteger < 17 then
...
//        n636.Caption := q.FieldByName('comp3').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota4').AsInteger < 15 then
            begin
              n641.Font.Color := clRed;
            end
            else
              n641.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota4').AsInteger < 17 then
...
//        n646.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('nota4').IsNull and (bimestre >= 4) then
        begin
          n651.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat+
          q.FieldByName('nota3').AsFloat+q.FieldByName('nota4').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n651.Caption) < 15 then
            begin
              n651.Font.Color := clRed;
            end
            else
              n651.Font.Color := clBlack;
          end
          else
          begin
            if StrToFloat(n651.Caption) < 17 then
            begin
              n651.Font.Color := clRed;
            end
            else
        ...
        begin
          n651.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n651.Caption) < 15 then
            begin
        ...
        begin
          n651.Caption := FloatToStrF(q.FieldByName('nota1').AsFloat, ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n651.Caption) < 15 then
            begin
        ...
        begin
          ...
          begin
            if q.FieldByName('mediafinal').AsInteger < 15 then
            begin
              n654.Font.Color := clRed;
            end
            else
              n654.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('mediafinal').AsInteger < 17 then
      ...
      4: begin
        ...
        begin
          if q.FieldByName('nota1').AsInteger < 15 then
          begin
            n711.Font.Color := clRed;
          end
          else
            n711.Font.Color := clBlack;
        end
        else
        begin
          if q.FieldByName('nota1').AsInteger < 17 then
...
//        n716.Caption := q.FieldByName('comp1').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota2').AsInteger < 15 then
            begin
              n721.Font.Color := clRed;
            end
            else
              n721.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota2').AsInteger < 17 then
...
//        n726.Caption := q.FieldByName('comp2').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota3').AsInteger < 15 then
            begin
              n731.Font.Color := clRed;
            end
            else
              n731.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota3').AsInteger < 17 then
...
//        n736.Caption := q.FieldByName('comp3').AsString;
        ...
        begin
          ...
          begin
            if q.FieldByName('nota4').AsInteger < 15 then
            begin
              n741.Font.Color := clRed;
            end
            else
              n741.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('nota4').AsInteger < 17 then
...
//        n746.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('nota4').IsNull and (bimestre >= 4) then
        begin
          n751.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat+
          q.FieldByName('nota3').AsFloat+q.FieldByName('nota4').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n751.Caption) < 15 then
            begin
              n751.Font.Color := clRed;
            end
            else
              n751.Font.Color := clBlack;
          end
          else
          begin
            if StrToFloat(n751.Caption) < 17 then
            begin
              n751.Font.Color := clRed;
            end
            else
        ...
        begin
          n751.Caption := FloatToStrF((q.FieldByName('nota1').AsFloat+q.FieldByName('nota2').AsFloat), ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n751.Caption) < 15 then
            begin
        ...
        begin
          n751.Caption := FloatToStrF(q.FieldByName('nota1').AsFloat, ffFixed, 3, 1);
          {if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
            if StrToFloat(n751.Caption) < 15 then
            begin
        ...
        begin
          ...
          begin
            if q.FieldByName('mediafinal').AsInteger < 15 then
            begin
              n754.Font.Color := clRed;
            end
            else
              n754.Font.Color := clBlack;
          end
          else
          begin
            if q.FieldByName('mediafinal').AsInteger < 17 then
  ...
  ***********}
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          if FieldByName('qtde_aula_sem').AsInteger > 0 then
          begin
  ...
  begin
    ...
    if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
    begin
      if StrToFloat(T1.Caption) < 15 then
      begin
        T1.Font.Color := clRed;
      end
      else
    ...
    begin
      if StrToFloat(T1.Caption) < 17 then
      begin
        T1.Font.Color := clRed;
      end
      else
  ...
  begin
    ...
    if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
    begin
      if StrToFloat(T7.Caption) < 15 then
      begin
        T7.Font.Color := clRed;
      end
      else
    ...
    begin
      if StrToFloat(T7.Caption) < 17 then
      begin
        T7.Font.Color := clRed;
      end
      else
  ...
  begin
    ...
    if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
    begin
      if StrToFloat(T13.Caption) < 15 then
      begin
        T13.Font.Color := clRed;
      end
      else
        T13.Font.Color := clBlack;
    end
    else
    begin
      if StrToFloat(T13.Caption) < 17 then
      begin
        T13.Font.Color := clRed;
      end
      else
  ...
  begin
    ...
    if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
    begin
      if StrToFloat(T19.Caption) < 15 then
      begin
        T19.Font.Color := clRed;
      end
      else
        T19.Font.Color := clBlack;
    end
    else
    begin
      if StrToFloat(T19.Caption) < 17 then
      begin
        T19.Font.Color := clRed;
      end
      else
  ...
  begin
    ...
    if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
    begin
      if StrToFloat(T25.Caption) < 15 then
      begin
        T25.Font.Color := clRed;
      end
      else
        T25.Font.Color := clBlack;
    end
    else
    begin
      if StrToFloat(T25.Caption) < 17 then
      begin
        T25.Font.Color := clRed;
      end
      else
  ...
  begin
    ...
    if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
    begin
      if StrToFloat(T28.Caption) < 15 then
      begin
        T28.Font.Color := clRed;
      end
      else
        T28.Font.Color := clBlack;
    end
    else
    begin
      if StrToFloat(T28.Caption) < 17 then
      begin
        T28.Font.Color := clRed;
      end
      else
  ...
  T19.Font.Color := clBlack;
  T25.Font.Color := clBlack;
  T27.Font.Color := clBlack;
  T28.Font.Color := clBlack;
end;

procedure TFrmRelBolEscAluModelo2.SetCo_Alu(i: integer);
begin
  co_alu := i;
end;
procedure TFrmRelBolEscAluModelo2.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  inherited;
...
procedure TFrmRelBolEscAluModelo2.PageHeaderBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  inherited;
  QRLabel1000.Left := QRSysData2.Left;
  qrlTempleData.Left := QRLabel1000.Left - 80;
