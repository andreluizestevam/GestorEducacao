unit U_FrmRelRelacTipoEndereco;
...
type
  TFrmRelRelacTipoEndereco = class(TFrmRelTemplate)
    QRLabel4: TQRLabel;
    QRLPage: TQRLabel;
    QRShape1: TQRShape;
    QRLabel10: TQRLabel;
...
var
  FrmRelRelacTipoEndereco: TFrmRelRelacTipoEndereco;
...
procedure TFrmRelRelacTipoEndereco.QuickRep1BeforePrint(
...
procedure TFrmRelRelacTipoEndereco.DetailBand1BeforePrint(
