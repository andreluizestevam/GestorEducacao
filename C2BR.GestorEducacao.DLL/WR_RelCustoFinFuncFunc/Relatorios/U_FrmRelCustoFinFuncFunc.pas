...
type
  TFrmRelCustoFinFuncFunc = class(TFrmRelTemplate)
    DetailBand1: TQRBand;
...
var
  FrmRelCustoFinFuncFunc: TFrmRelCustoFinFuncFunc;
...
procedure TFrmRelCustoFinFuncFunc.QuickRep1BeforePrint(
...
procedure TFrmRelCustoFinFuncFunc.DetailBand1BeforePrint(
...
procedure TFrmRelCustoFinFuncFunc.QRBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  inherited;
  salTotal := 0;
...
procedure TFrmRelCustoFinFuncFunc.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
...
procedure TFrmRelCustoFinFuncFunc.QRGroup1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  inherited;
  if not QryRelatoriono_fun.IsNull then
    QRLNoFun.Caption := UpperCase(QryRelatoriono_fun.AsString);
end;
