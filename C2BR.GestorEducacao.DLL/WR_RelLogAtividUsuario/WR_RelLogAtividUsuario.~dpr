library WR_RelLogAtividUsuario;
...
uses
  ...
  U_FrmRelLogAtividUsuario in 'Relatorios\U_FrmRelLogAtividUsuario.pas' {FrmRelLogAtividUsuario};

// Controle Administrativo > Pesquisa de Opinião / Avaliações Institucionais
// Relatório: EMISSÃO DO MAPA DE RESULTADO DE AVALIAÇÃO
//
function DLLRelLogAtividUsuario(strIdentFunc, strPathReportGenerate, strReportName, strP_CO_EMP, strP_CO_FUNCIO, strP_CO_EMP_COL, strP_CO_COL, strP_ACAO, strP_DT_INI, strP_DT_FIM:PChar): Integer; export; cdecl;
var
  intReturn: Integer;
  Relatorio: TFrmRelLogAtividUsuario;
...
begin
  ...
  Try
    Try
      ...
      if strP_CO_FUNCIO <> 'T' then
        SqlString := SqlString + ' and LA.ideAdmModulo = ' + strP_CO_FUNCIO;
      ...
      if strP_ACAO <> 'T' then
        SqlString := SqlString + ' and LA.CO_ACAO_ATIVI_LOG = ' + QuotedStr(strP_ACAO);
      ...
      Relatorio := TFrmRelLogAtividUsuario.Create(Nil);
