...
type
  TFrmRelCustoFinFuncDept = class(TFrmRelTemplate)
    DetailBand1: TQRBand;
...
var
  FrmRelCustoFinFuncDept: TFrmRelCustoFinFuncDept;
...
procedure TFrmRelCustoFinFuncDept.QuickRep1BeforePrint(
...
procedure TFrmRelCustoFinFuncDept.DetailBand1BeforePrint(
...
procedure TFrmRelCustoFinFuncDept.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
...
procedure TFrmRelCustoFinFuncDept.QRBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  inherited;
  salTotal := 0;
...
procedure TFrmRelCustoFinFuncDept.QRGroup1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  inherited;
  if not QryRelatorioNO_DEPTO.IsNull then
    QRLNoDepto.Caption := UpperCase(QryRelatorioNO_DEPTO.AsString);
end;
