...
uses
  ...
  U_FrmRelItensEstoque in 'Relatorios\U_FrmRelItensEstoque.pas' {FrmRelItensEstoque};
...
// STATUS: OK
function DLLRelItensEstoque(strIdentFunc, strPathReportGenerate, strReportName, strP_CO_EMP, strP_CO_TIP_PROD, strP_DE_TIP_PROD, strP_CO_GRUPO_ITEM, strP_CO_SUBGRP_ITEM: PChar): Integer; export; cdecl;
var
  intReturn: Integer;
  Relatorio: TFrmRelItensEstoque;
  ...
  Try
    Try
      ...
      SqlString := ' SET LANGUAGE PORTUGUESE                    '+
               ...
               ' WHERE P.CO_TIP_PROD   = ' + strP_CO_TIP_PROD;
      ...
      Relatorio := TFrmRelItensEstoque.Create(Nil);
