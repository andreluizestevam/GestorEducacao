...
begin
  inherited;
  QRLNumEntrevista.Caption := 'Nº ' + FormatDateTime('yyyy',QryRelatorio.FieldByName('DT_ENTRE_ESTAGIO').AsDateTime) + '.' +
  ...
  if QryRelatorio.FieldByName('FLA_RESUL').AsString = 'N' then
    QRLResulEnt.Caption := 'Não Selecionado'
    ...
    QRLResulEnt.Caption := 'Processo de Seleção'
