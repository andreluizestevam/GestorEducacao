...
uses
  ...
  U_FrmRelFicEntreEstagio in 'Relatorios\U_FrmRelFicEntreEstagio.pas' {FrmRelFicEntreEstagio};

function DLLRelFicEntreEstagio(strIdentFunc, strPathReportGenerate, strReportName, strP_CO_EMP, strP_ID_ENTRE_ESTAGIO:PChar): Integer; export; cdecl;
var
  intReturn: Integer;
  Relatorio: TFrmRelFicEntreEstagio;
  ...
  Try
    Try
      ...
      SqlString := ' select ee.*,OE.*,ce.TP_CANDID_ESTAG,ce.NO_CANDID_ESTAG,ce.CO_EMP_ALU,ce.CO_ALU, STATUS = (CASE OE.CO_STA_OFERT_ESTAG ' +
                  ...
                  ' where ee.ID_ENTRE_ESTAGIO = ' + strP_ID_ENTRE_ESTAGIO;

      // Cria uma instância do Relatório.

      Relatorio := TFrmRelFicEntreEstagio.Create(Nil);
