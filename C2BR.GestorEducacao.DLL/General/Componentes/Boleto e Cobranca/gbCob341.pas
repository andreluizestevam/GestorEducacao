...
begin
   ...
   begin
      ...
      case EspecieDocumento of
       edContrato : AEspecieDocumento := 'CT';
       edCosseguros : AEspecieDocumento := 'CS';
       edDuplicataMercantil : AEspecieDocumento := 'DM';
       edDuplicataMercantialIndicacao : AEspecieDocumento := 'DM';
       edDuplicataServico : AEspecieDocumento := 'DS';
       edDuplicataServicoIndicacao : AEspecieDocumento := 'DS';
       ...
       edNotaPromissoriaRural : AEspecieDocumento := 'NP';
       edNotaSeguro : AEspecieDocumento := 'NS';
       edRecibo : AEspecieDocumento := 'RC'
      else
       AEspecieDocumento := 'DV';
      end;
   end;
end;
...
//            ticnpjSacador   : ACedenteTipoInscricao := '04';
         end;
...
//         Registro := Registro + '  '; // Primeira Instrucao
//         Registro := Registro + '  '; // Segunda Instrucao                       
//         Registro := Registro + Formatar(Titulos[NumeroRegistro].Instrucao1,2,false,'0');
//         Registro := Registro + Formatar(Titulos[NumeroRegistro].Instrucao2,2,false,'0');
         ...
         if Titulos[NumeroRegistro].DataDesconto <> 0 then // DATA LIMITE PARA CONCESSÃO DE DESCONTO
            ...
            Registro := Registro + Formatar(' ',6,false,' ');
         ...
         Registro := Registro + Formatar(Titulos[NumeroRegistro].Sacado.Endereco.Complemento,30,true,' '); // NOME DO SACADOR/AVALISTA
         Registro := Registro + '    '; // BRANCOS =====>aqui edmilson
//         Registro := Registro + '000000'; // DATA DE MORA
         Registro := Registro + FormatDateTime('ddmmyy',Titulos[NumeroRegistro].DataMoraJuros); // DATA DE MORA
//         Registro := Registro + '00'; // PRAZO
///==========> para poder calcular data de protesto
//         Registro := Registro + Formatar(Titulos[numeroregistro].Prazo,2,false,'0');
