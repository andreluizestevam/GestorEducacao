...
begin
   ...
   begin
      ...
      Remessa.Add('0'+ // IDENT.DO REGISTRO
                  ...
                  Formatar(Titulos[NumeroRegistro].Cedente.CodigoCedente,10,false,' ')+ // IDENTIFICAÇÃO DA EMPRESA NO BANCO
...
{              edAluguel: aTitulosEspecieDocumento := '01';
        ...
        case Titulos[NumeroRegistro].AceiteDocumento of
         ...
         Registro := Registro + Formatar(Titulos[NumeroRegistro].Cedente.CodigoCedente,10,false,' '); // IDENTIFICAÇÃO DA EMPRESA NO BANCO
...
begin
 ...
 case StrToInt(sOcorrencia) of
   ...
   11: Result:='11-EM SER (POSIÇÃO EM ABERTO)' ;
   12: Result:='12-ABATIMENTO CONCEDIDO' ;
   13: Result:='13-ABATIMENTO CANCELADO' ;
   14: Result:='14-VENCIMENTO ALTERADO' ;
   15: Result:='15-LIQUIDAÇÃO EM CARTÓRIO' ;
   16: Result:='16-DEVOLUÇÃO DO CARTÓRIO' ;
   17: Result:='17-CONFIRMAÇÃO ENVIO P/ CARTÓRIO' ;
   18: Result:='18-TÍTULO NÃO PROCESSADO' ;
   19: Result:='19-BAIXA POR CRÉDITO MANUAL' ;
 end;
end;
...
begin
 ...
 case StrToInt(sRejeicao) of
   08: Result:='08-Vencimento não válido';
   12: Result:='12-Ocorrência não cadastrada';
   13: Result:='13-Cep não cadastrado - não atendido';
   14: Result:='14-Agência cobradora não permitida';
   15: Result:='15-Erro digito nosso número';
   16: Result:='16-Título vencido';
 end;
end;
