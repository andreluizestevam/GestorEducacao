...
begin
   ...
   begin
      ...
      Registro := Registro + Formatar(Titulos[NumeroRegistro].Cedente.CodigoCedente,16,false,'0'); {Código do convênio no banco}
      ...
      begin
         ...
         Registro := Registro + '1'; {Cobrança Simples}
         Registro := Registro + '1'; {Forma de cadastramento do título no banco: com cadastramento}
