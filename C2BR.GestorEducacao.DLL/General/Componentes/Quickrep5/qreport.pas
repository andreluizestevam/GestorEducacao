...
{$ifdef QRPP}
  ...
  public
    ...
    function GetVerb(Index: integer): {$IFDEF WIN32}AnsiString{$ELSE}string{$ENDIF}; override;
...
uses
  ...
  QRPDFFilt, QRWebfilt, QRAbsDatas, qrframelines, QRMBCtrls;
...
function TQRGridReportDesignModeMenu.GetVerb(Index: integer): {$IFDEF WIN32}AnsiString{$ELSE}string{$ENDIF};
begin
  case Index of
...
begin
  RegisterComponents(SqrPaletteQReport,[TQuickRep, TQuickAbstractRep, TQRSubDetail, TQRLoopBand, TQRStringsBand,
    TQRBand, TQRWildband, TQRChildBand, TQRGroup, TQRLabel, TQRMBLabel, TQRDBText, TQRMBDBText, TQRExpr, TQRSysData, TQRMBMemo, TQRMemo, TQRExprMemo,
  ...
  RegisterPropertyEditor(TypeInfo(string), TQRMBDBText, 'DataField', TQRDataFieldProperty);  {<-- do not resource }
  ...
  RegisterNonActiveX([TQuickRep, TQRSubDetail, TQRChildBand, TQRGroup,
    TQRDBText, TQRMBDBText, TQRExpr, TQRSysData, TQRMemo, TQRDBRichText, TQRShape, TQRImage,
