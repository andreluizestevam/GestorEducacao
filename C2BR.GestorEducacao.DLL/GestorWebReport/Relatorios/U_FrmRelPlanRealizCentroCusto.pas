unit U_FrmRelPlanRealizCentroCusto;
...
type
  TFrmRelPlanRealizCentroCusto = class(TFrmRelTemplate)
    QRGroup1: TQRGroup;
    QRShape2: TQRShape;
    QRShape3: TQRShape;
    QRLabel4: TQRLabel;
  ...
  public
    { Public declarations }
    AnoIni, AnoFim: String;
    vSintetico, vDespesa: Boolean;
  end;

var
  FrmRelPlanRealizCentroCusto: TFrmRelPlanRealizCentroCusto;
...
procedure TFrmRelPlanRealizCentroCusto.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  i: integer;
...
begin
  ...
  QRLNoConta.Caption := FormatFloat('#0', QryRelatorio.FieldByName('CO_GRUP_CTA').AsFloat) + '.' +
                        ...
                        QryRelatorio.FieldByName('DE_CONTA_PC').AsString;
...
procedure TFrmRelPlanRealizCentroCusto.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var i : integer;
begin
  inherited;
...
procedure TFrmRelPlanRealizCentroCusto.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  i : integer;
begin
...
procedure TFrmRelPlanRealizCentroCusto.QRDBText1Print(sender: TObject;
  var Value: String);
begin
  inherited;
  Value := Value + ' - ' + QryRelatorio.FieldByName('DE_CENT_CUSTO').AsString;
end;

procedure TFrmRelPlanRealizCentroCusto.QuickRep1BeforePrint(
  Sender: TCustomQuickRep; var PrintReport: Boolean);
  var i : integer;
begin
  inherited;

  if not vSintetico then
...
initialization
  ...
  RegisterClasses([TFrmRelPlanRealizCentroCusto]);
