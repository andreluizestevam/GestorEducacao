unit U_FrmRelAniversarioFuncionario;
...
type
  TFrmRelAniversarioFuncionario = class(TFrmRelTemplate)
    DetailBand1: TQRBand;
    QRGroup1: TQRGroup;
    QrlUnidade: TQRLabel;
    QRLabel9: TQRLabel;
...
var
  FrmRelAniversarioFuncionario: TFrmRelAniversarioFuncionario;
...
procedure TFrmRelAniversarioFuncionario.DetailBand1BeforePrint(
...
begin
  ...
  if QrlTotal.Caption <> '-' then
    QrlTotal.Caption := IntToStr(StrToInt(QrlTotal.Caption) +1);

end;

procedure TFrmRelAniversarioFuncionario.QuickRep1BeforePrint(
