library WR_RelCurvaABCFreqFuncInst;
...
uses
  ...
  U_FrmRelCurvaABCFreqFuncInst in 'Relatorios\U_FrmRelCurvaABCFreqFuncInst.pas' {FrmRelCurvaABCFreqFuncInst};

// Controle Administrativo > Controle Frequencia Funcionário
// Relatório: EMISSÃO DA CURVA ABC DE FREQÜÊNCIA DE FUNCIONÁRIOS ***Instituição***
// STATUS : OK
function DLLRelCurvaABCFreqFuncInst(strIdentFunc, strPathReportGenerate, strReportName, strP_CO_EMP, strP_DT_INI, strP_DT_FIM, strP_TP_PONTO: PChar): Integer; export; cdecl;
var
  intReturn: Integer;
  Relatorio: TFrmRelCurvaABCFreqFuncInst;
  ...
  Try
    Try
      ...
      SqlString := ' SET LANGUAGE PORTUGUESE ' +
                     ...
                     ' WHERE C.FLA_PROFESSOR = ' + QuotedStr('N');
      ...
      Relatorio := TFrmRelCurvaABCFreqFuncInst.Create(Nil);
