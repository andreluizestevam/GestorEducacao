unit U_FrmRelRelacTipoTelefone;
...
type
  TFrmRelRelacTipoTelefone = class(TFrmRelTemplate)
    QRLabel4: TQRLabel;
    QRLPage: TQRLabel;
    QRShape1: TQRShape;
    QRLabel10: TQRLabel;
...
var
  FrmRelRelacTipoTelefone: TFrmRelRelacTipoTelefone;
...
procedure TFrmRelRelacTipoTelefone.QuickRep1BeforePrint(
...
procedure TFrmRelRelacTipoTelefone.DetailBand1BeforePrint(
