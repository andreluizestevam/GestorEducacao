...
uses
  ...
  U_FrmRelItensPatrimonio in 'Relatorios\U_FrmRelItensPatrimonio.pas' {FrmRelItensPatrimonio};
...
// STATUS: OK
function DLLRelItensPatrimonio(strIdentFunc, strPathReportGenerate, strReportName, strP_CO_EMP, strP_CO_CLASSIF_PATR, strP_TP_PATR: PChar): Integer; export; cdecl;
var
  intReturn: Integer;
  Relatorio: TFrmRelItensPatrimonio;
...
begin
  ...
  Try
    Try
      ...
      if strP_CO_CLASSIF_PATR <> 'T' then
        SqlString := SqlString + ' AND P.CO_CLASSIF_PATR = ' + strP_CO_CLASSIF_PATR;
      ...
      Relatorio := TFrmRelItensPatrimonio.Create(Nil);
