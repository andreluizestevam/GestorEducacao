...
type
  TFrmRelDistFuncGeo = class(TFrmRelTemplate)
    Detail: TQRBand;
    QRDBText7: TQRDBText;
    QRGroup1: TQRGroup;
    QRLabel22: TQRLabel;
...
var
  FrmRelDistFuncGeo: TFrmRelDistFuncGeo;
...
procedure TFrmRelDistFuncGeo.DetailBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  diasnoano: Real;
begin
...
procedure TFrmRelDistFuncGeo.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  inherited;
  QRLTotMas.Caption := '0';
...
procedure TFrmRelDistFuncGeo.SummaryBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  inherited;
  QRLTotMas.Caption := '0';
...
procedure TFrmRelDistFuncGeo.SummaryBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
...
procedure TFrmRelDistFuncGeo.QRGroup1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
  QRLCidade.Caption := 'Cidade/UF: ' + QryRelatorio.FieldByName('no_cidade').AsString + ' / ' + QryRelatorio.FieldByName('CO_ESTA_ENDE_COL').AsString;
end;
