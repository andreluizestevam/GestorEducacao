library WR_RelCurvaABCFreqProf;
...
uses
  ...
  U_FrmRelCurvaABCFreqProf in 'Relatorios\U_FrmRelCurvaABCFreqProf.pas' {FrmRelCurvaABCFreqProf};

// Controle Administrativo > Controle Frequencia Funcionário
// Relatório: EMISSÃO DA CURVA ABC DE FREQÜÊNCIA DE PROFESSORES ***Função*** (Ponto Padrão/Livre)
// STATUS: OK
function DLLRelCurvaABCFreqProf(strIdentFunc, strPathReportGenerate, strReportName, strP_CO_EMP, strP_CO_FUN, strP_DT_INI, strP_DT_FIM, strP_TP_PONTO: PChar): Integer; export; cdecl;
var
  intReturn: Integer;
  Relatorio: TFrmrelCurvaABCFreqProf;
...
begin
  ...
  Try
    Try
      ...
      Relatorio := TFrmrelCurvaABCFreqProf.Create(Nil);
