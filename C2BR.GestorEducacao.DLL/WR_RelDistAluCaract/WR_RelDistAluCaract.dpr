...
' ORDER BY BAI.NO_BAIRRO';
      ...
      // Se escolher o ANO só exibirá matrículas finalizadas - Diego Nobre 19/02/2009
     // É necessário para quando houver mais de um ano cadastrado;
     // Caso seja escolhido um ano anterior ao em andamento só exibirá as matrículas finalizadas;
      ...
      // Se o ano escolhido for o atual situação = A, senão o atual situação = F - Diego Nobre 19/02/2009
      {
