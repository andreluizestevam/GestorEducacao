inherited FrmRelDistAluCarBairro: TFrmRelDistAluCarBairro
  Left = 207
  Top = 146
  Width = 816
  Height = 588
  HorzScrollBar.Position = 340
  Caption = 'FrmRelDistAluCarBairro'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  inherited QuickRep1: TQuickRep
    ...
    inherited PageHeaderBand1: TQRBand
      ...
      inherited LblTituloRel: TQRLabel
        ...
        Size.Values = (
          ...
          2717.270833333333000000)
        Caption = 'RELA'#199#195'O DE ALUNO POR CARACTER'#205'STICA - S'#201'RIE/TURMA'
        FontSize = 12
      end
    ...
    object QRGroup1: TQRGroup
      ...
      Size.Values = (
        ...
        2717.270833333333000000)
      Expression = 'QryRelatorio.no_tur'
      FooterBand = QRBand1
      Master = QuickRep1
    ...
    object QRBand1: TQRBand
      ...
      object QRLTotalBairro: TQRLabel
        Left = 946
        Top = 3
        Width = 7
        Height = 15
  ...
  inherited QryRelatorio: TADOQuery
    SQL.Strings = (
        ...
        'SELECT a.co_alu,mo.de_modu_cur, mm.co_cur,cu.no_cur, tur.co_tur,' +
        'mm.co_alu_cad, a.nu_nis, a.no_alu, ct.co_sigla_turma as no_tur, ' +
        'RE.nu_cpf_RESP, a.dt_nasc_alu, a.co_sexo_alu, a.tp_raca, a.tp_de' +
        'f, a.renda_familiar, e.coduf, c.no_cidade, b.no_bairro,'
      #9'BE = (Case a.FLA_BOLSA_ESCOLA'
      #9#9#9'when '#39'False'#39' then '#39'N'#227'o'#39
      #9#9#9'when '#39'True'#39' then '#39'Sim'#39
      #9#9'  End),'
      #9'PASSE = (Case a.FLA_PASSE_ESCOLA'
      #9#9#9#9'when '#39'False'#39' then '#39'N'#227'o'#39
      #9#9#9#9'when '#39'True'#39' then '#39'Sim'#39
      #9#9#9' End)'
      'from tb07_aluno a'
      #9'JOIN tb905_bairro b on b.co_bairro = a.co_bairro'
      #9'JOIN tb74_UF e on e.coduf = a.co_esta_alu'
      #9'JOIN tb904_cidade c on c.co_cidade = a.co_cidade'
      
        '    JOIN tb08_matrcur mm on a.co_alu = mm.co_alu and a.co_emp = ' +
        'mm.co_emp'
      'join tb44_modulo mo on mo.co_modu_cur = mm.co_modu_cur'
      
        '    JOIN tb01_curso cu on mm.co_cur = cu.co_cur and mm.co_emp = ' +
        'cu.co_emp'
      #9'JOIN TB06_TURMAS TUR ON TUR.CO_TUR = MM.CO_TUR'
      'JOIN TB129_CADTURMAS CT ON TUR.CO_TUR = CT.CO_TUR'
      #9'JOIN TB108_RESPONSAVEL RE ON RE.CO_RESP = A.CO_RESP'
      ''
      'ORDER BY cu.no_cur,tur.no_tur,a.no_alu')
    ...
    object QryRelatorioBE: TStringField
      FieldName = 'BE'
      ReadOnly = True
      Size = 3
    end
    object QryRelatorioPASSE: TStringField
      FieldName = 'PASSE'
      ReadOnly = True
      Size = 3
    end
