library WR_RelLisAluInstEspecializadas;
...
uses
  ...
  U_FrmRelLisAluInstEspecializadas in 'Relatorios\U_FrmRelLisAluInstEspecializadas.pas' {FrmRelLisAluInstEspecializadas},
  U_Funcoes in '..\General\U_Funcoes.pas';

// Controle Administrativo > Pesquisa de Opinião / Avaliações Institucionais
// Relatório: EMISSÃO DO MAPA DE RESULTADO DE AVALIAÇÃO
//
function DLLRelLisAluInstEspecializadas(strIdentFunc, strPathReportGenerate, strReportName, strParamRel, strP_CO_EMP, strP_CO_MODU_CUR, strP_CO_CUR, strP_CO_TUR, strP_CO_INST_ESP, strP_CO_ANO_MES_MAT:PChar): Integer; export; cdecl;
var
  intReturn: Integer;
  Relatorio: TFrmRelLisAluInstEspecializadas;
...
begin
  ...
  Try
    Try
      ...
      SqlString := SqlString + ' group by a.nu_nis,cid.no_cidade,c.co_cur,c.no_cur,a.no_alu,a.co_sexo_alu,a.de_ende_alu,a.tp_def,a.de_comp_alu,a.nu_ende_alu,'+
                             'a.dt_nasc_alu,mm.co_alu_cad,ie.no_inst_esp,ie.co_inst_esp,a.nu_tele_resi_alu,res.no_resp,res.nu_tele_celu_resp,ct.co_sigla_turma,b.no_bairro,mo.de_modu_cur'+
                             ' ORDER BY C.NO_CUR,A.NO_ALU ';

      // Cria uma instância do Relatório.

      Relatorio := TFrmRelLisAluInstEspecializadas.Create(Nil);
...
exports
  ...
  //Relatórios
  DLLRelLisAluInstEspecializadas;
