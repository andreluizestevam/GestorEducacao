unit U_FrmRelRelacFuncPorUnidade;
...
type
  TFrmRelRelacFuncPorUnidade = class(TFrmRelTemplate)
    Detail: TQRBand;
    QRDBText7: TQRDBText;
    QRGroup1: TQRGroup;
    QRLabel22: TQRLabel;
...
var
  FrmRelRelacFuncPorUnidade: TFrmRelRelacFuncPorUnidade;
...
procedure TFrmRelRelacFuncPorUnidade.DetailBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  diasnoano: Real;
begin
...
procedure TFrmRelRelacFuncPorUnidade.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  inherited;
  QRLTotMas.Caption := '0';
...
procedure TFrmRelRelacFuncPorUnidade.SummaryBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  inherited;
  QRLTotMas.Caption := '0';
...
procedure TFrmRelRelacFuncPorUnidade.SummaryBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
