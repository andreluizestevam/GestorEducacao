library WR_RelRelacFuncPorUnidade;
...
uses
  ...
  U_FrmRelRelacFuncPorUnidade in 'Relatorios\U_FrmRelRelacFuncPorUnidade.pas' {FrmRelRelacFuncPorUnidade};

// Controle Administrativo > Pesquisa de Opinião / Avaliações Institucionais
// Relatório: EMISSÃO DO MAPA DE RESULTADO DE AVALIAÇÃO
//
function DLLRelRelacFuncPorUnidade(strIdentFunc, strPathReportGenerate, strReportName, strP_CO_EMP, strP_CO_EMP_COL, strP_CO_SITU_COL:PChar): Integer; export; cdecl;
var
  intReturn: Integer;
  Relatorio: TFrmRelRelacFuncPorUnidade;
...
begin
  ...
  Try
    Try
      ...
      SQLString := SQLString + ' order by e.no_fantas_emp,a.no_col';

      // Cria uma instância do Relatório.

      Relatorio := TFrmRelRelacFuncPorUnidade.Create(Nil);
