...
type
  TFrmRelTarefIncons = class(TFrmRelTemplate)
    DetailBand1: TQRBand;
    QRGroup1: TQRGroup;
    QRShape1: TQRShape;
    QRLabel4: TQRLabel;
...
var
  FrmRelTarefIncons: TFrmRelTarefIncons;
...
procedure TFrmRelTarefIncons.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
...
procedure TFrmRelTarefIncons.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  inherited;
...
procedure TFrmRelTarefIncons.QRGroup1BeforePrint(
