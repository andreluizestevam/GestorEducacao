...
procedure TFrmRelMapaGeralMatricula.DetailBeforePrint(
  ...
  var PrintBand: Boolean);
var
// cria variáveis para os valores dos meses e tipos de reseva;
...
begin
// define as variáveis como números inteiros;
  inherited;
...
begin
  inherited;
// variáveis dos totais da RESERVA como zerado como inteiro;
...
// variáveis dos totais da INSCRIÇÃO como zerado como inteiro;
...
// variáveis dos totais da MATRÍCULA como zerado como inteiro;
