...
uses
  ...
  U_FrmRelContagemEstoque in 'Relatorios\U_FrmRelContagemEstoque.pas' {FrmRelContagemEstoque};
...
// STATUS: OK
function DLLRelContagemEstoque(strIdentFunc, strPathReportGenerate, strReportName, strP_CO_EMP, strP_CO_TIP_PROD, strP_DE_TIP_PROD, strP_CO_GRUPO_ITEM, strP_CO_SUBGRP_ITEM: PChar): Integer; export; cdecl;
var
  intReturn: Integer;
  Relatorio: TFrmRelContagemEstoque;
...
begin
  ...
  Try
    Try
      ...
      Relatorio := TFrmRelContagemEstoque.Create(Nil);
