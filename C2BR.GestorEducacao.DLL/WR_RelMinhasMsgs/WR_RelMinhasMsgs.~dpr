...
uses
  ...
  U_FrmRelMinhasMsgs in 'Relatorios\U_FrmRelMinhasMsgs.pas' {FrmRelMinhasMsgs};

// Controle Administrativo > Pesquisa de Opinião / Avaliações Institucionais
// Relatório: EMISSÃO DO MAPA DE RESULTADO DE AVALIAÇÃO
//
function DLLRelMinhasMsgs(strIdentFunc, strPathReportGenerate, strReportName, strP_CO_EMP, strP_CO_EMP_COL, strP_CO_COL, strP_DT_INI, strP_DT_FIM:PChar): Integer; export; cdecl;
var
  intReturn: Integer;
  Relatorio: TFrmRelMinhasMsgs;
...
begin
  ...
  Try
    Try
      ...
      Relatorio := TFrmRelMinhasMsgs.Create(Nil);
