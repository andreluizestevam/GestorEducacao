unit U_FrmRelRelacFuncPorDepto;
...
type
  TFrmRelRelacFuncPorDepto = class(TFrmRelTemplate)
    Detail: TQRBand;
    QRDBText7: TQRDBText;
    QRGroup1: TQRGroup;
    QRLabel22: TQRLabel;
...
var
  FrmRelRelacFuncPorDepto: TFrmRelRelacFuncPorDepto;
...
procedure TFrmRelRelacFuncPorDepto.DetailBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  diasnoano: Real;
begin
...
procedure TFrmRelRelacFuncPorDepto.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  inherited;
  QRLTotMas.Caption := '0';
...
procedure TFrmRelRelacFuncPorDepto.SummaryBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  inherited;
  QRLTotMas.Caption := '0';
...
procedure TFrmRelRelacFuncPorDepto.SummaryBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
