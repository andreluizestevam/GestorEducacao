...
begin
  ...
  if not QryRelatorio.FieldByName('datanasc').IsNull then
    QRLDtNascto.Caption := FormatDateTime('dd/mm/yyyy',QryRelatorio.FieldByName('datanasc').AsDateTime);
  ...
  with q.SQL do begin
    ...
    Add('histalu.vl_media_anual [mediaAnual], ');
...
//        m146.Caption := q.FieldByName('comp4').AsString;
        ...
        //Bimestre 5 /Sintese ou Media anual
        if not q.FieldByName('mediaAnual').IsNull then
        begin
          ...
          m151.Caption := FloatToStrF((q.FieldByName('mediaAnual').AsFloat), ffFixed, 3, 1);
          if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
...
//        m246.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('mediaAnual').IsNull then
        begin
          m251.Caption := FloatToStrF((q.FieldByName('mediaAnual').AsFloat), ffFixed, 3, 1);
          if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
...
//        m346.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('mediaAnual').IsNull then
        begin
          m351.Caption := FloatToStrF((q.FieldByName('mediaAnual').AsFloat), ffFixed, 3, 1);
          if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
...
//        m446.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('mediaAnual').IsNull then
        begin
          m451.Caption := FloatToStrF((q.FieldByName('mediaAnual').AsFloat), ffFixed, 3, 1);
          if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
...
//        m546.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('mediaAnual').IsNull then
        begin
          m551.Caption := FloatToStrF((q.FieldByName('mediaAnual').AsFloat), ffFixed, 3, 1);
          if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
...
//        m646.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('mediaAnual').IsNull then
        begin
          m651.Caption := FloatToStrF((q.FieldByName('mediaAnual').AsFloat), ffFixed, 3, 1);
          if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
...
//        m746.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('mediaAnual').IsNull then
        begin
          m751.Caption := FloatToStrF((q.FieldByName('mediaAnual').AsFloat), ffFixed, 3, 1);
          if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
...
//        m846.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('mediaAnual').IsNull then
        begin
          m851.Caption := FloatToStrF((q.FieldByName('mediaAnual').AsFloat), ffFixed, 3, 1);
          if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
...
//        m946.Caption := q.FieldByName('comp4').AsString;
        ...
        if not q.FieldByName('mediaAnual').IsNull then
        begin
          m951.Caption := FloatToStrF((q.FieldByName('mediaAnual').AsFloat), ffFixed, 3, 1);
          if QryRelatorio.FieldByName('comoducur').AsInteger = 9 then
          begin
...
//        n746.Caption := q.FieldByName('comp4').AsString;
  ...
  begin
    ...
    SQL.Text := 'select c.co_mat_col, c.no_col from tb_respon_materia rm ' +
                ' join tb03_colabor c on c.co_col = rm.CO_COL_RESP and c.co_emp = rm.co_emp ' +
  ...
  ***********}
  ...
  if cnpjIntituicao <> '11489849000133' then
  begin
    m111.Font.Color := clBlack;
    m211.Font.Color := clBlack;
    m311.Font.Color := clBlack;
