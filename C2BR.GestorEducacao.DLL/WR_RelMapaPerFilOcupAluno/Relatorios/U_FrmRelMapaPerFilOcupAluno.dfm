inherited FrmRelMapaPerFilOcupAluno: TFrmRelMapaPerFilOcupAluno
  Left = 208
  Top = 149
  Width = 815
  Height = 588
  HorzScrollBar.Position = 11
  Caption = 'FrmRelMapaPerFilOcupAluno'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  inherited QuickRep1: TQuickRep
    ...
    inherited PageHeaderBand1: TQRBand
      ...
      inherited LblTituloRel: TQRLabel
        ...
        Size.Values = (
          ...
          1846.791666666667000000)
        Caption = 'MAPA DE PERFIL DE OCUPA'#199#195'O DE ALUNOS'
        FontSize = 12
      end
    ...
    object SummaryBand1: TQRBand
      ...
      object QRLLegenda: TQRLabel
        ...
        AutoStretch = False
        Caption = 
          '(QVP) Vagas Planejadas; (QRV) Reserva de Vagas; (QMN) Matr'#237'culas' +
          ' Novas; (QMR) Matr'#237'culas Renovadas; QVR (Quantidade de Vagas Rem' +
          'anescentes); QAA (Alunos Ativos); QAT (Alunos Transferidos); QAC' +
          ' (Alunos Cancelados); QEV (Alunos Evadidos); QEX (Alunos Expulso' +
          's).'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
