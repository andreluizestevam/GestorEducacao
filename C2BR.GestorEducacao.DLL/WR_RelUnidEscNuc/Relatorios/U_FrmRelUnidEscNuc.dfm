inherited FrmRelUnidEscNuc: TFrmRelUnidEscNuc
  Left = 202
  Top = 169
  Width = 820
  Height = 570
  Caption = 'FrmRelUnidEscNuc'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  inherited QuickRep1: TQuickRep
    ...
    inherited PageHeaderBand1: TQRBand
      ...
      inherited LblTituloRel: TQRLabel [2]
        ...
        Size.Values = (
          ...
          2717.270833333333000000)
        Caption = 'RELA'#199#195'O DE UNIDADES ESCOLARES POR N'#218'CLEO'
        Font.Height = -15
        FontSize = 11
      end
      ...
      object QRLabel3: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'COORDENADOR DO N'#218'CLEO'
        Color = clGray
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWhite
        Font.Height = -11
    ...
    object DetailBand1: TQRBand
      ...
      object QrlCoordNucleo: TQRLabel
        Left = 820
        Top = 1
        Width = 204
        Height = 15
    ...
    object QRGroup1: TQRGroup
      ...
      Size.Values = (
        47.625000000000000000
        2717.270833333333000000)
      Expression = 'QryRelatorio.DE_NUCLEO'
      Master = QuickRep1
  ...
  inherited QryRelatorio: TADOQuery
    SQL.Strings = (
        ...
        '       CID.NO_CIDADE, BAI.NO_BAIRRO, E.CO_TEL1_EMP,E.CO_EMP,E.CO' +
        '_DIR'
      'FROM TB25_EMPRESA E'
