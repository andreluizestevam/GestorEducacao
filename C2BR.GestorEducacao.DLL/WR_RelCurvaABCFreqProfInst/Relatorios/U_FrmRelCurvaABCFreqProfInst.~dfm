inherited FrmRelCurvaABCFreqProfInst: TFrmRelCurvaABCFreqProfInst
  Left = 196
  Top = 113
  Caption = 'FrmRelCurvaABCFreqProfInst'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  inherited QuickRep1: TQuickRep
    ...
    inherited PageHeaderBand1: TQRBand
      ...
      inherited LblTituloRel: TQRLabel
        ...
        Caption = 'Curva ABC de Frequ'#234'ncia - Professor'
        Font.Height = -15
        FontSize = 11
      end
  ...
  inherited QryRelatorio: TADOQuery
    SQL.Strings = (
        ...
        'SET LANGUAGE PORTUGUESE  SELECT DISTINCT C.NO_COL,C.CO_COL,E.NO_' +
        'RAZSOC_EMP, E.CO_EMP'
      'FROM TB03_COLABOR C '
      'JOIN TB25_EMPRESA E ON C.CO_EMP = E.CO_EMP  '
      'WHERE C.CO_EMP = 2'
      'GROUP BY C.NO_COL, E.NO_RAZSOC_EMP, E.CO_EMP,C.CO_COL')
    object QryRelatorioNO_COL: TStringField
      FieldName = 'NO_COL'
      Size = 60
    end
    object QryRelatorioNO_RAZSOC_EMP: TStringField
