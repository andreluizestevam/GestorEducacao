library WR_RelMapaEvolutProgSocia;
...
uses
  ...
  U_FrmRelMapaEvolutProgSocia in 'Relatorios\U_FrmRelMapaEvolutProgSocia.pas' {FrmRelMapaEvolutProgSocia};
...
// STATUS: OK
function DLLRelMapaEvolutProgSocia(strIdentFunc, strPathReportGenerate, strReportName, strP_CO_EMP, strP_CO_ANO_REFER, strP_CO_PROGR_TP_SOCEDU: PChar): Integer; export; cdecl;
var
  intReturn: Integer;
  Relatorio: TFrmRelMapaEvolutProgSocia;
...
begin
  ...
  Try
    Try
      ...
      Relatorio := TFrmRelMapaEvolutProgSocia.Create(Nil);
      ...
      begin
        ...
        Relatorio.anoRefer := StrToInt(strP_CO_ANO_REFER);
