inherited FrmRelMapaEstaticEmpr: TFrmRelMapaEstaticEmpr
  Left = 268
  Top = 140
  Width = 920
  Height = 634
  ...
  inherited QuickRep1: TQuickRep
    ...
    inherited PageHeaderBand1: TQRBand
      ...
      inherited LblTituloRel: TQRLabel
        ...
        Caption = 'MAPA DE EMPR'#201'STIMOS DE OBRAS - BIBLIOTECA '
        FontSize = 12
      end
    ...
    object QRBand1: TQRBand
      ...
      object qrlObra: TQRLabel
        ...
        AutoSize = False
        AutoStretch = True
        Caption = '000 - NOME COMPLETO DA OBRA'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
  ...
  inherited QryRelatorio: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT A.CO_ACERVO, A.NO_ACERVO, ebi.* FROM tb123_Empr_Bib_Itens' +
        ' ebi, TB35_ACERVO A'
      ''
      '  WHERE ebi.co_emp = 2'
      '   AND A.CO_ACERVO = EBI.CO_ACERVO'
      '   and ebi.dt_empr_acer > '#39'1/1/2008'#39
      '   and ebi.dt_empr_acer < '#39'31/12/2008'#39)
    Left = 657
    Top = 8
  end
