inherited FrmRelMapaSolicRealiz: TFrmRelMapaSolicRealiz
  Left = 205
  Top = 165
  Width = 817
  Height = 572
  Caption = 'FrmRelMapaSolicRealiz'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
    ...
    inherited PageHeaderBand1: TQRBand
      ...
      inherited LblTituloRel: TQRLabel [1]
        ...
        Size.Values = (
          ...
          1846.791666666667000000)
        Caption = 'MAPA MENSAL DE SOLICITA'#199#213'ES REALIZADAS'
        Font.Height = -15
        FontSize = 11
      end
  ...
  object QrySolic: TADOQuery
    ...
    SQL.Strings = (
      ...
      #9#9'AND MONTH(DT_ENTR_SOLI) = 1'
      #9#9'AND CO_TIPO_SOLI = 1'
      #9') JAN,'
      #9'(SELECT COUNT(CO_TIPO_SOLI) FROM TB65_HIST_SOLICIT'
      #9#9'WHERE YEAR(DT_ENTR_SOLI) = 2008'
      #9#9'AND MONTH(DT_ENTR_SOLI) = 2'
      #9#9'AND CO_TIPO_SOLI = 1'
      #9') FEV,'
      #9'(SELECT COUNT(CO_TIPO_SOLI) FROM TB65_HIST_SOLICIT'
      #9#9'WHERE YEAR(DT_ENTR_SOLI) = 2008'
      #9#9'AND MONTH(DT_ENTR_SOLI) = 3'
      #9#9'AND CO_TIPO_SOLI = 1'
      #9') MAR,'
      #9'(SELECT COUNT(CO_TIPO_SOLI) FROM TB65_HIST_SOLICIT'
      #9#9'WHERE YEAR(DT_ENTR_SOLI) = 2008'
      #9#9'AND MONTH(DT_ENTR_SOLI) = 4'
      #9#9'AND CO_TIPO_SOLI = 1'
      #9') ABR,'
      #9'(SELECT COUNT(CO_TIPO_SOLI) FROM TB65_HIST_SOLICIT'
      #9#9'WHERE YEAR(DT_ENTR_SOLI) = 2008'
      #9#9'AND MONTH(DT_ENTR_SOLI) = 5'
      #9#9'AND CO_TIPO_SOLI = 1'
      #9') MAI,'
      #9'(SELECT COUNT(CO_TIPO_SOLI) FROM TB65_HIST_SOLICIT'
      #9#9'WHERE YEAR(DT_ENTR_SOLI) = 2008'
      #9#9'AND MONTH(DT_ENTR_SOLI) = 6'
      #9#9'AND CO_TIPO_SOLI = 1'
      #9') JUN,'
      #9'(SELECT COUNT(CO_TIPO_SOLI) FROM TB65_HIST_SOLICIT'
      #9#9'WHERE YEAR(DT_ENTR_SOLI) = 2008'
      #9#9'AND MONTH(DT_ENTR_SOLI) = 7'
      #9#9'AND CO_TIPO_SOLI = 1'
      #9') JUL,'
      #9'(SELECT COUNT(CO_TIPO_SOLI) FROM TB65_HIST_SOLICIT'
      #9#9'WHERE YEAR(DT_ENTR_SOLI) = 2008'
      #9#9'AND MONTH(DT_ENTR_SOLI) = 8'
      #9#9'AND CO_TIPO_SOLI = 1'
      #9') AGO,'
      #9'(SELECT COUNT(CO_TIPO_SOLI) FROM TB65_HIST_SOLICIT'
      #9#9'WHERE YEAR(DT_ENTR_SOLI) = 2008'
      #9#9'AND MONTH(DT_ENTR_SOLI) = 9'
      #9#9'AND CO_TIPO_SOLI = 1'
      #9') SETE,'
      #9'(SELECT COUNT(CO_TIPO_SOLI) FROM TB65_HIST_SOLICIT'
      #9#9'WHERE YEAR(DT_ENTR_SOLI) = 2008'
      #9#9'AND MONTH(DT_ENTR_SOLI) = 10'
      #9#9'AND CO_TIPO_SOLI = 1'
      #9') OUT,'
      #9'(SELECT COUNT(CO_TIPO_SOLI) FROM TB65_HIST_SOLICIT'
      #9#9'WHERE YEAR(DT_ENTR_SOLI) = 2008'
      #9#9'AND MONTH(DT_ENTR_SOLI) = 11'
      #9#9'AND CO_TIPO_SOLI = 1'
      #9') NOV,'
      #9'(SELECT COUNT(CO_TIPO_SOLI) FROM TB65_HIST_SOLICIT'
      #9#9'WHERE YEAR(DT_ENTR_SOLI) = 2008'
      #9#9'AND MONTH(DT_ENTR_SOLI) = 12'
      #9#9'AND CO_TIPO_SOLI = 1'
      #9') DEZ,'
      #9'(SELECT COUNT(CO_TIPO_SOLI) FROM TB65_HIST_SOLICIT'
      #9#9'WHERE YEAR(DT_ENTR_SOLI) = 2008'
    ...
    Left = 304
    Top = 88
    object QrySolicCO_EMP: TIntegerField
      FieldName = 'CO_EMP'
    end
    object QrySolicJAN: TIntegerField
      FieldName = 'JAN'
      ReadOnly = True
    end
    object QrySolicFEV: TIntegerField
      FieldName = 'FEV'
      ReadOnly = True
    end
    object QrySolicMAR: TIntegerField
      FieldName = 'MAR'
      ReadOnly = True
    end
    object QrySolicABR: TIntegerField
      FieldName = 'ABR'
      ReadOnly = True
    end
    object QrySolicMAI: TIntegerField
      FieldName = 'MAI'
      ReadOnly = True
    end
    object QrySolicJUN: TIntegerField
      FieldName = 'JUN'
      ReadOnly = True
    end
    object QrySolicJUL: TIntegerField
      FieldName = 'JUL'
      ReadOnly = True
    end
    object QrySolicAGO: TIntegerField
      FieldName = 'AGO'
      ReadOnly = True
    end
    object QrySolicSETE: TIntegerField
      FieldName = 'SETE'
      ReadOnly = True
    end
    object QrySolicOUT: TIntegerField
      FieldName = 'OUT'
      ReadOnly = True
    end
    object QrySolicNOV: TIntegerField
      FieldName = 'NOV'
      ReadOnly = True
    end
    object QrySolicDEZ: TIntegerField
      FieldName = 'DEZ'
      ReadOnly = True
    end
    object QrySolicTOTAL: TIntegerField
      FieldName = 'TOTAL'
      ReadOnly = True
    end
  end
