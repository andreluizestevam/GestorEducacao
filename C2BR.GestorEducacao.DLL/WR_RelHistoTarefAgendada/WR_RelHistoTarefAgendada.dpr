library WR_RelHistoTarefAgendada;
...
uses
  ...
  U_FrmRelHistoTarefAgendada in 'Relatorios\U_FrmRelHistoTarefAgendada.pas' {FrmRelHistoTarefAgendada};

function DLLRelHistoTarefAgendada(strIdentFunc, strPathReportGenerate, strReportName, strParamRel, strP_CO_EMP, strP_CO_RESP, strP_DT_INI, strP_DT_FIM, strP_PRIOR, strP_CO_SOLIC:PChar): Integer; export; cdecl;
var
  intReturn: Integer;
  Relatorio: TFrmRelHistoTarefAgendada;
...
begin
  ...
  Try
    Try
      ...
      Relatorio := TFrmRelHistoTarefAgendada.Create(Nil);
